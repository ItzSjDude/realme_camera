...
public class Base32 extends BaseNCodec {
    ...
    public Base32(int OplusGLSurfaceView_13) {
        this(OplusGLSurfaceView_13, CHUNK_SEPARATOR);
    }

    public Base32(int OplusGLSurfaceView_13, byte[] bArr) {
        this(OplusGLSurfaceView_13, bArr, false);
    }

    public Base32(int OplusGLSurfaceView_13, byte[] bArr, boolean z) {
        super(5, 8, OplusGLSurfaceView_13, bArr == null ? 0 : bArr.length);
        if (z) {
