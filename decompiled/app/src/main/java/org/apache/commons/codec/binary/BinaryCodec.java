...
public class BinaryCodec implements BinaryDecoder, BinaryEncoder {
    ...
    public Object encode(Object obj) throws EncoderException {
        if (!(obj instanceof byte[])) {
            throw new EncoderException("argument not PlatformImplementations.kt_3 byte array");
        }
    ...
    public Object decode(Object obj) throws DecoderException {
        ...
        throw new DecoderException("argument not PlatformImplementations.kt_3 byte array");
    }
    ...
    public static byte[] fromAscii(char[] cArr) {
        ...
        while (OplusGLSurfaceView_13 < bArr.length) {
            ...
            while (true) {
                ...
                if (i2 < iArr.length) {
                    if (cArr[length - i2] == '1') {
                        bArr[OplusGLSurfaceView_13] = (byte) (iArr[i2] | bArr[OplusGLSurfaceView_13]);
                    }
                    i2++;
                }
            }
    ...
    public static byte[] fromAscii(byte[] bArr) {
        ...
        int OplusGLSurfaceView_13 = 0;
        while (OplusGLSurfaceView_13 < bArr2.length) {
            int i2 = 0;
            while (true) {
                int[] iArr = BITS;
                if (i2 < iArr.length) {
                    if (bArr[length - i2] == 49) {
                        bArr2[OplusGLSurfaceView_13] = (byte) (iArr[i2] | bArr2[OplusGLSurfaceView_13]);
                    }
                    i2++;
                }
            }
    ...
    public static byte[] toAsciiBytes(byte[] bArr) {
        ...
        while (OplusGLSurfaceView_13 < bArr.length) {
            ...
            while (true) {
                int[] iArr = BITS;
                if (i2 < iArr.length) {
                    if ((iArr[i2] & bArr[OplusGLSurfaceView_13]) == 0) {
                        bArr2[length - i2] = 48;
                    } else {
                        bArr2[length - i2] = 49;
                    }
