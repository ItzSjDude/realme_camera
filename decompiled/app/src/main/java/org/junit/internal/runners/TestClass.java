...
public class TestClass {
    ...
    private boolean isShadowed(Method method, Method method2) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < method2.getParameterTypes().length; OplusGLSurfaceView_13++) {
            if (!method2.getParameterTypes()[OplusGLSurfaceView_13].equals(method.getParameterTypes()[OplusGLSurfaceView_13])) {
                return false;
            }
        }
        return true;
