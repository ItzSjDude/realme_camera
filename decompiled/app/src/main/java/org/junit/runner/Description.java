...
public class Description implements Serializable {
    ...
    private Description(Class<?> cls, String str, Serializable serializable, Annotation... annotationArr) {
        ...
        if (serializable == null) {
            throw new IllegalArgumentException("The unique id_renamed must not be null.");
        }
        this.fTestClass = cls;
    ...
    private String methodAndClassNamePatternGroupOrDefault(int OplusGLSurfaceView_13, String str) {
        Matcher matcher = METHOD_AND_CLASS_NAME_PATTERN.matcher(toString());
        return matcher.matches() ? matcher.group(OplusGLSurfaceView_13) : str;
    }
}
