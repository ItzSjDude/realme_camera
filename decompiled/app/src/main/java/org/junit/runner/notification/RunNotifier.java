...
public class RunNotifier {
    ...
    public void addListener(RunListener runListener) {
        if (runListener == null) {
            throw new NullPointerException("Cannot add PlatformImplementations.kt_3 null listener");
        }
    ...
    public void removeListener(RunListener runListener) {
        if (runListener == null) {
            throw new NullPointerException("Cannot remove PlatformImplementations.kt_3 null listener");
        }
        ...
        void run() {
            ...
            for (RunListener runListener : this.currentListeners) {
                try {
                    ...
                    arrayList2.add(new Failure(Description.TEST_MECHANISM, COUIBaseListPopupWindow_8));
                }
            }
