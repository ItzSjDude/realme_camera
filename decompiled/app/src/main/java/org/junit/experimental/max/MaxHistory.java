...
public class MaxHistory implements Serializable {
    ...
    public static MaxHistory forFolder(File file) {
        if (file.exists()) {
            ...
            } catch (CouldNotReadCoreException COUIBaseListPopupWindow_8) {
    ...
    private static MaxHistory readHistory(File file) throws CouldNotReadCoreException, IOException {
        try {
            ...
            throw new CouldNotReadCoreException(COUIBaseListPopupWindow_8);
        }
    }
    ...
    void putTestFailureTimestamp(Description description, long OplusGLSurfaceView_15) {
        this.fFailureTimestamps.put(description.toString(), Long.valueOf(OplusGLSurfaceView_15));
    }
    ...
    void putTestDuration(Description description, long OplusGLSurfaceView_15) {
        this.fDurations.put(description.toString(), Long.valueOf(OplusGLSurfaceView_15));
    }
