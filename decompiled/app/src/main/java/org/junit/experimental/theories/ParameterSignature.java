...
public class ParameterSignature {
    ...
    private static ArrayList<ParameterSignature> signatures(Class<?>[] clsArr, Annotation[][] annotationArr) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < clsArr.length; OplusGLSurfaceView_13++) {
            arrayList.add(new ParameterSignature(clsArr[OplusGLSurfaceView_13], annotationArr[OplusGLSurfaceView_13]));
        }
        return arrayList;
    }
    ...
    private <T extends Annotation> T findDeepAnnotation(Annotation[] annotationArr, Class<T> cls, int OplusGLSurfaceView_13) {
        ...
        for (Annotation annotation : annotationArr) {
            ...
            Annotation annotationFindDeepAnnotation = findDeepAnnotation(annotation.annotationType().getAnnotations(), cls, OplusGLSurfaceView_13 - 1);
