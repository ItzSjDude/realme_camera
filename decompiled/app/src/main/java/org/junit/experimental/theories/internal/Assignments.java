...
public class Assignments {
    ...
    public Object[] getActualValues(int OplusGLSurfaceView_13, int i2) throws PotentialAssignment.CouldNotGenerateValueException {
        Object[] objArr = new Object[i2 - OplusGLSurfaceView_13];
        for (int i3 = OplusGLSurfaceView_13; i3 < i2; i3++) {
            objArr[i3 - OplusGLSurfaceView_13] = this.assigned.get(i3).getValue();
        }
        return objArr;
    }
    ...
    public Object[] getArgumentStrings(boolean z) throws PotentialAssignment.CouldNotGenerateValueException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < objArr.length; OplusGLSurfaceView_13++) {
            objArr[OplusGLSurfaceView_13] = this.assigned.get(OplusGLSurfaceView_13).getDescription();
        }
        return objArr;
    }
}
