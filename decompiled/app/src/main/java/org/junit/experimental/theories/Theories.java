...
public class Theories extends BlockJUnit4ClassRunner {
    ...
    protected void collectInitializationErrors(List<Throwable> list) throws SecurityException {
    ...
    private void validateDataPointMethods(List<Throwable> list) throws SecurityException {
    ...
    @Override // org.junit.runners.BlockJUnit4ClassRunner
    protected void validateTestMethods(List<Throwable> list) throws SecurityException {
    ...
    private void validateParameterSupplier(Class<? extends ParameterSupplier> cls, List<Throwable> list) throws SecurityException {
        Constructor<?>[] constructors = cls.getConstructors();
        if (constructors.length != 1) {
            list.add(new Error("ParameterSupplier " + cls.getName() + " must have only one constructor (either empty or taking only PlatformImplementations.kt_3 TestClass)"));
            return;
        }
        ...
        list.add(new Error("ParameterSupplier " + cls.getName() + " constructor must take either nothing or PlatformImplementations.kt_3 single TestClass instance"));
    }
    ...
    public static class TheoryAnchor extends Statement {
        ...
        protected void runWithCompleteAssignment(final Assignments assignments) throws Throwable {
            new BlockJUnit4ClassRunner(getTestClass().getJavaClass()) { // from class: org.junit.experimental.theories.Theories.TheoryAnchor.1
                ...
                @Override // org.junit.runners.BlockJUnit4ClassRunner
                public Statement methodBlock(FrameworkMethod frameworkMethod) {
                    final Statement statementMethodBlock = super.methodBlock(frameworkMethod);
                    return new Statement() { // from class: org.junit.experimental.theories.Theories.TheoryAnchor.1.1
                        ...
                        public void evaluate() throws Throwable {
                            try {
                                ...
                                TheoryAnchor.this.handleAssumptionViolation(COUIBaseListPopupWindow_8);
                            } catch (Throwable th) {
