...
public class Categories extends Suite {
    ...
    public Categories(Class<?> cls, RunnerBuilder runnerBuilder) throws InitializationError {
        ...
        try {
            ...
            m26265x83a71db8(getDescription());
        } catch (NoTestsRemainException COUIBaseListPopupWindow_8) {
            throw new InitializationError(COUIBaseListPopupWindow_8);
        }
    }
    ...
    /* renamed from: assertNoCategorizedDescendentsOfUncategorizeableParents */
    private static void m26265x83a71db8(Description description) throws InitializationError {
        if (!canHaveCategorizedChildren(description)) {
            assertNoDescendantsHaveCategoryAnnotations(description);
        }
        Iterator<Description> it = description.getChildren().iterator();
        while (it.hasNext()) {
            m26265x83a71db8(it.next());
        }
    }
