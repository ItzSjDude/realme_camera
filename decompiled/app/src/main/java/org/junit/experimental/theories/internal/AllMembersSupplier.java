...
public class AllMembersSupplier extends ParameterSupplier {
    ...
    private void addMultiPointFields(ParameterSignature parameterSignature, List<PotentialAssignment> list) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
    ...
    private void addDataPointsValues(Class<?> cls, ParameterSignature parameterSignature, String str, List<PotentialAssignment> list, Object obj) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        if (cls.isArray()) {
    ...
    private void addArrayValues(ParameterSignature parameterSignature, String str, List<PotentialAssignment> list, Object obj) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < Array.getLength(obj); OplusGLSurfaceView_13++) {
            ...
            if (parameterSignature.canAcceptValue(obj2)) {
                list.add(PotentialAssignment.forValue(str + "[" + OplusGLSurfaceView_13 + "]", obj2));
            }
        }
    }
    ...
    private void addIterableValues(ParameterSignature parameterSignature, String str, List<PotentialAssignment> list, Iterable<?> iterable) {
        ...
        for (Object obj : iterable) {
            if (parameterSignature.canAcceptValue(obj)) {
                list.add(PotentialAssignment.forValue(str + "[" + OplusGLSurfaceView_13 + "]", obj));
            }
