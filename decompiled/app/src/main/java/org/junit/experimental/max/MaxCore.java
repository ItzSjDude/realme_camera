...
public class MaxCore {
    ...
    public Request sortRequest(Request request) {
        ...
        List<Description> listFindLeaves = findLeaves(request);
    ...
    private Request constructLeafRequest(List<Description> list) {
        ...
        return new Request() { // from class: org.junit.experimental.max.MaxCore.1
            ...
            public Runner getRunner() {
                ...
                } catch (InitializationError COUIBaseListPopupWindow_8) {
                    return new ErrorReportingRunner(null, COUIBaseListPopupWindow_8);
                }
            }
        };
    }
    ...
    private Runner buildRunner(Description description) {
        ...
        if (testClass == null) {
            throw new RuntimeException("Can't build PlatformImplementations.kt_3 runner from description [" + description + "]");
        }
