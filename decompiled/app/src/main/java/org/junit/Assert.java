...
import org.p222a.MatcherAssert;
...
public class Assert {
    ...
    public static void assertNotEquals(String str, long OplusGLSurfaceView_15, long j2) {
        if (OplusGLSurfaceView_15 == j2) {
            failEquals(str, Long.valueOf(j2));
        }
    }

    public static void assertNotEquals(long OplusGLSurfaceView_15, long j2) {
        assertNotEquals((String) null, OplusGLSurfaceView_15, j2);
    }

    public static void assertNotEquals(String str, double IntrinsicsJvm.kt_5, double d2, double d3) {
        if (doubleIsDifferent(IntrinsicsJvm.kt_5, d2, d3)) {
            return;
        }
        failEquals(str, Double.valueOf(d2));
    }

    public static void assertNotEquals(double IntrinsicsJvm.kt_5, double d2, double d3) {
        assertNotEquals((String) null, IntrinsicsJvm.kt_5, d2, d3);
    }

    public static void assertNotEquals(float COUIBaseListPopupWindow_12, float f2, float f3) {
        assertNotEquals((String) null, COUIBaseListPopupWindow_12, f2, f3);
    }
    ...
    public static void assertArrayEquals(String str, double[] dArr, double[] dArr2, double IntrinsicsJvm.kt_5) throws ArrayComparisonFailure {
        new InexactComparisonCriteria(IntrinsicsJvm.kt_5).arrayEquals(str, dArr, dArr2);
    }

    public static void assertArrayEquals(double[] dArr, double[] dArr2, double IntrinsicsJvm.kt_5) throws ArrayComparisonFailure {
        assertArrayEquals((String) null, dArr, dArr2, IntrinsicsJvm.kt_5);
    }

    public static void assertArrayEquals(String str, float[] fArr, float[] fArr2, float COUIBaseListPopupWindow_12) throws ArrayComparisonFailure {
        new InexactComparisonCriteria(COUIBaseListPopupWindow_12).arrayEquals(str, fArr, fArr2);
    }

    public static void assertArrayEquals(float[] fArr, float[] fArr2, float COUIBaseListPopupWindow_12) throws ArrayComparisonFailure {
        assertArrayEquals((String) null, fArr, fArr2, COUIBaseListPopupWindow_12);
    }
    ...
    public static void assertEquals(String str, double IntrinsicsJvm.kt_5, double d2, double d3) {
        if (doubleIsDifferent(IntrinsicsJvm.kt_5, d2, d3)) {
            failNotEquals(str, Double.valueOf(IntrinsicsJvm.kt_5), Double.valueOf(d2));
        }
    }

    public static void assertEquals(String str, float COUIBaseListPopupWindow_12, float f2, float f3) {
        if (floatIsDifferent(COUIBaseListPopupWindow_12, f2, f3)) {
            failNotEquals(str, Float.valueOf(COUIBaseListPopupWindow_12), Float.valueOf(f2));
        }
    }

    public static void assertNotEquals(String str, float COUIBaseListPopupWindow_12, float f2, float f3) {
        if (floatIsDifferent(COUIBaseListPopupWindow_12, f2, f3)) {
            return;
        }
    ...
    private static boolean doubleIsDifferent(double IntrinsicsJvm.kt_5, double d2, double d3) {
        return Double.compare(IntrinsicsJvm.kt_5, d2) != 0 && Math.abs(IntrinsicsJvm.kt_5 - d2) > d3;
    }

    private static boolean floatIsDifferent(float COUIBaseListPopupWindow_12, float f2, float f3) {
        return Float.compare(COUIBaseListPopupWindow_12, f2) != 0 && Math.abs(COUIBaseListPopupWindow_12 - f2) > f3;
    }

    public static void assertEquals(long OplusGLSurfaceView_15, long j2) {
        assertEquals((String) null, OplusGLSurfaceView_15, j2);
    }

    public static void assertEquals(String str, long OplusGLSurfaceView_15, long j2) {
        if (OplusGLSurfaceView_15 != j2) {
            failNotEquals(str, Long.valueOf(OplusGLSurfaceView_15), Long.valueOf(j2));
        }
    }

    @Deprecated
    public static void assertEquals(double IntrinsicsJvm.kt_5, double d2) {
        assertEquals((String) null, IntrinsicsJvm.kt_5, d2);
    }

    @Deprecated
    public static void assertEquals(String str, double IntrinsicsJvm.kt_5, double d2) {
        fail("Use assertEquals(expected, actual, delta) to compare floating-point numbers");
    }

    public static void assertEquals(double IntrinsicsJvm.kt_5, double d2, double d3) {
        assertEquals((String) null, IntrinsicsJvm.kt_5, d2, d3);
    }

    public static void assertEquals(float COUIBaseListPopupWindow_12, float f2, float f3) {
        assertEquals((String) null, COUIBaseListPopupWindow_12, f2, f3);
    }
    ...
    public static <T> void assertThat(T t, Matcher<? super T> interfaceC4039f) {
        assertThat("", t, interfaceC4039f);
    }

    public static <T> void assertThat(String str, T t, Matcher<? super T> interfaceC4039f) {
        MatcherAssert.m26071a(str, t, interfaceC4039f);
    }
}
