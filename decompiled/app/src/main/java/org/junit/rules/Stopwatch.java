...
public abstract class Stopwatch implements TestRule {
    ...
    protected void failed(long OplusGLSurfaceView_15, Throwable th, Description description) {
    }

    protected void finished(long OplusGLSurfaceView_15, Description description) {
    }

    protected void skipped(long OplusGLSurfaceView_15, AssumptionViolatedException assumptionViolatedException, Description description) {
    }

    protected void succeeded(long OplusGLSurfaceView_15, Description description) {
    }
