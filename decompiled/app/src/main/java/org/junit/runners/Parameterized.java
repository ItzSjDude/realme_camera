...
public class Parameterized extends Suite {
    ...
    private TestWithParameters createTestWithNotNormalizedParameters(String str, int OplusGLSurfaceView_13, Object obj) {
        return createTestWithParameters(getTestClass(), str, OplusGLSurfaceView_13, obj instanceof Object[] ? (Object[]) obj : new Object[]{obj});
    }
    ...
    private List<TestWithParameters> createTestsForParameters(Iterable<Object> iterable, String str) throws Exception {
        ...
        while (it.hasNext()) {
            arrayList.add(createTestWithNotNormalizedParameters(str, OplusGLSurfaceView_13, it.next()));
    ...
    private static TestWithParameters createTestWithParameters(TestClass testClass, String str, int OplusGLSurfaceView_13, Object[] objArr) {
        return new TestWithParameters("[" + MessageFormat.format(str.replaceAll("\\{index\\}", Integer.toString(OplusGLSurfaceView_13)), objArr) + "]", testClass, Arrays.asList(objArr));
    }
}
