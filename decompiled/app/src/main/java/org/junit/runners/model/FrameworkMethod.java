...
public class FrameworkMethod extends FrameworkMember<FrameworkMethod> {
    ...
    public boolean isShadowedBy(FrameworkMethod frameworkMethod) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < frameworkMethod.getParameterTypes().length; OplusGLSurfaceView_13++) {
            if (!frameworkMethod.getParameterTypes()[OplusGLSurfaceView_13].equals(getParameterTypes()[OplusGLSurfaceView_13])) {
                return false;
            }
        }
        return true;
