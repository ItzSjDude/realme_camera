...
public class MultipleFailureException extends Exception {
    ...
    public String getMessage() {
        StringBuilder sb = new StringBuilder(String.format("There were %IntrinsicsJvm.kt_5 errors:", Integer.valueOf(this.fErrors.size())));
        for (Throwable th : this.fErrors) {
            sb.append(String.format("\OplusGLSurfaceView_11  %s(%s)", th.getClass().getName(), th.getMessage()));
        }
        return sb.toString();
    }
