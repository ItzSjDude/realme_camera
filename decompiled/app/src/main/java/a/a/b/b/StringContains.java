...
public class j_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.j_renamed> q_renamed = new android.util.LruCache<>(5);
    ...
    public j_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("random_search"), context);
        this.o_renamed = a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("patchmatch_vertex");
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.j_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.j_renamed jVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (jVar == null) {
            jVar = new a_renamed.a_renamed.b_renamed.b_renamed.j_renamed(resources, context);
            jVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), jVar);
        }
        jVar.a_renamed(context);
        return jVar;
    }
    ...
    public void j_renamed() {
        ...
        android.opengl.GLES20.glUniform1f(android.opengl.GLES20.glGetUniformLocation(this.f16b, "seed"), this.x_renamed);
        android.opengl.GLES20.glUniformMatrix4fv(android.opengl.GLES20.glGetUniformLocation(this.f16b, com.google.android.exoplayer2.text.ttml.TtmlNode.TAG_REGION), 1, false, this.y_renamed, 0);
    }
}
