...
public class bi_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.bi_renamed> q_renamed = new android.util.LruCache<>(5);
    ...
    public bi_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("maximization"), context);
        this.o_renamed = a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("patchmatch_vertex");
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.bi_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.bi_renamed biVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (biVar == null) {
            biVar = new a_renamed.a_renamed.b_renamed.b_renamed.bi_renamed(resources, context);
            biVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), biVar);
        }
        biVar.a_renamed(context);
        return biVar;
    }
    ...
    public void j_renamed() {
        ...
        int iGlGetUniformLocation4 = android.opengl.GLES20.glGetUniformLocation(this.f16b, "target_size");
        float[] fArr = this.u_renamed;
        android.opengl.GLES20.glUniform2f(iGlGetUniformLocation4, fArr[0], fArr[1]);
        int iGlGetUniformLocation5 = android.opengl.GLES20.glGetUniformLocation(this.f16b, "full_size");
        float[] fArr2 = this.v_renamed;
        android.opengl.GLES20.glUniform2f(iGlGetUniformLocation5, fArr2[0], fArr2[1]);
        android.opengl.GLES20.glUniformMatrix4fv(android.opengl.GLES20.glGetUniformLocation(this.f16b, com.google.android.exoplayer2.text.ttml.TtmlNode.TAG_REGION), 1, false, this.w_renamed, 0);
    }
}
