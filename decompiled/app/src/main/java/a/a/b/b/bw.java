...
public class bw_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.bw_renamed> q_renamed = new android.util.LruCache<>(5);
    public float[] r_renamed;
    public co_renamed.polarr.renderer.entities.Mesh s_renamed;

    public bw_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("darkchannel_2"), context);
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.bw_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.bw_renamed bwVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (bwVar == null) {
            bwVar = new a_renamed.a_renamed.b_renamed.b_renamed.bw_renamed(resources, context);
            bwVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), bwVar);
        }
        bwVar.a_renamed(context);
        return bwVar;
    }
