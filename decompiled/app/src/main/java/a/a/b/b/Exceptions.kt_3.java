...
public class az_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.az_renamed> q_renamed = new android.util.LruCache<>(5);
    public int r_renamed;
    public int s_renamed;
    public int t_renamed;
    public co_renamed.polarr.renderer.entities.Mesh u_renamed;

    public az_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("combine"), context);
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.az_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.az_renamed azVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (azVar == null) {
            azVar = new a_renamed.a_renamed.b_renamed.b_renamed.az_renamed(resources, context);
            azVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), azVar);
        }
        azVar.a_renamed(context);
        return azVar;
    }
    ...
    public void e_renamed() {
        int iGlGetUniformLocation = android.opengl.GLES20.glGetUniformLocation(this.f16b, "a_renamed");
        android.opengl.GLES20.glActiveTexture(33984);
        android.opengl.GLES20.glBindTexture(3553, this.r_renamed);
        android.opengl.GLES20.glUniform1i(iGlGetUniformLocation, 0);
        int iGlGetUniformLocation2 = android.opengl.GLES20.glGetUniformLocation(this.f16b, "b_renamed");
        ...
        int iGlGetUniformLocation3 = android.opengl.GLES20.glGetUniformLocation(this.f16b, "I_renamed");
