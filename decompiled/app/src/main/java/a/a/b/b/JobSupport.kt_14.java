...
public class at_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.at_renamed> q_renamed = new android.util.LruCache<>(5);
    public float[] r_renamed;
    public co_renamed.polarr.renderer.entities.Mesh s_renamed;

    public at_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("darkchannel_1"), context);
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.at_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.at_renamed atVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (atVar == null) {
            atVar = new a_renamed.a_renamed.b_renamed.b_renamed.at_renamed(resources, context);
            atVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), atVar);
        }
        atVar.a_renamed(context);
        return atVar;
    }
