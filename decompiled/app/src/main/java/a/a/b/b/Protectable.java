...
public class c_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public c_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("dehaze"), context);
        this.o_renamed = a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("distortion_vertex");
        a_renamed(new java.lang.String[]{"dehaze"});
    }
    ...
    public void j_renamed() {
        super.j_renamed();
        int iGlGetUniformLocation = android.opengl.GLES20.glGetUniformLocation(this.f16b, "dehazeMap");
        ...
        android.opengl.GLES20.glUniform3fv(android.opengl.GLES20.glGetUniformLocation(this.f16b, "average"), 1, this.f15a.thresholdAverage, 0);
