...
public class am_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.am_renamed> q_renamed = new android.util.LruCache<>(5);
    public float[] r_renamed;
    public co_renamed.polarr.renderer.entities.Mesh s_renamed;

    public am_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("paint_box_blur"), context);
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.am_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.am_renamed amVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (amVar == null) {
            amVar = new a_renamed.a_renamed.b_renamed.b_renamed.am_renamed(resources, context);
            amVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), amVar);
        }
        amVar.a_renamed(context);
        return amVar;
    }
