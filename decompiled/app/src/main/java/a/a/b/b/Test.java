...
public class d_renamed extends a_renamed.a_renamed.b_renamed.b_renamed.a_renamed.b_renamed {
    public static android.util.LruCache<java.lang.String, a_renamed.a_renamed.b_renamed.b_renamed.d_renamed> q_renamed = new android.util.LruCache<>(5);
    public int r_renamed;
    public int s_renamed;
    public int t_renamed;
    public co_renamed.polarr.renderer.entities.Mesh u_renamed;

    public d_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        super(resources, a_renamed.a_renamed.b_renamed.f_renamed.m_renamed.a_renamed("compute_b"), context);
    }

    public static a_renamed.a_renamed.b_renamed.b_renamed.d_renamed a_renamed(android.content.res.Resources resources, co_renamed.polarr.renderer.entities.Context context) {
        a_renamed.a_renamed.b_renamed.b_renamed.d_renamed dVar = q_renamed.get(java.lang.Thread.currentThread().getName());
        if (dVar == null) {
            dVar = new a_renamed.a_renamed.b_renamed.b_renamed.d_renamed(resources, context);
            dVar.a_renamed();
            q_renamed.put(java.lang.Thread.currentThread().getName(), dVar);
        }
        dVar.a_renamed(context);
        return dVar;
    }
    ...
    public void e_renamed() {
        ...
        int iGlGetUniformLocation2 = android.opengl.GLES20.glGetUniformLocation(this.f16b, "mean_p");
        ...
        int iGlGetUniformLocation3 = android.opengl.GLES20.glGetUniformLocation(this.f16b, "a_renamed");
