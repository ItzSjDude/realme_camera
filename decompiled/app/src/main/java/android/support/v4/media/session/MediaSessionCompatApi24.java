...
class MediaSessionCompatApi24 {
    ...
    public static java.lang.String getCallingPackage(java.lang.Object obj) {
        ...
        try {
            ...
            android.util.Log.e_renamed(TAG, "Cannot execute MediaSession.getCallingPackage()", e_renamed);
            return null;
        }
    }

    static class CallbackProxy<T_renamed extends android.support.v4.media.session.MediaSessionCompatApi24.Callback> extends android.support.v4.media.session.MediaSessionCompatApi23.CallbackProxy<T_renamed> {
