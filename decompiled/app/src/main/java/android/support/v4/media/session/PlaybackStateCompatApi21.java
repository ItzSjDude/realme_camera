...
class PlaybackStateCompatApi21 {
    ...
    public static Object newInstance(int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, long j2, float COUIBaseListPopupWindow_12, long j3, CharSequence charSequence, long j4, List<Object> list, long j5) {
        PlaybackState.Builder builder = new PlaybackState.Builder();
        builder.setState(OplusGLSurfaceView_13, OplusGLSurfaceView_15, COUIBaseListPopupWindow_12, j4);
    ...
    static final class CustomAction {
        ...
        public static Object newInstance(String str, CharSequence charSequence, int OplusGLSurfaceView_13, Bundle bundle) {
            PlaybackState.CustomAction.Builder builder = new PlaybackState.CustomAction.Builder(str, charSequence, OplusGLSurfaceView_13);
