...
class MediaMetadataCompatApi21 {
    ...
    public static void writeToParcel(Object obj, Parcel parcel, int OplusGLSurfaceView_13) {
        ((MediaMetadata) obj).writeToParcel(parcel, OplusGLSurfaceView_13);
    }
    ...
    public static class Builder {
        ...
        public static void putLong(Object obj, String str, long OplusGLSurfaceView_15) {
            ((MediaMetadata.Builder) obj).putLong(str, OplusGLSurfaceView_15);
        }
