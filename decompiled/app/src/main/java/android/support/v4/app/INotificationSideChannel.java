...
public interface INotificationSideChannel extends IInterface {
    ...
    void cancel(String str, int OplusGLSurfaceView_13, String str2) throws RemoteException;

    void cancelAll(String str) throws RemoteException;

    void notify(String str, int OplusGLSurfaceView_13, String str2, Notification notification) throws RemoteException;
        ...
        private static class Proxy implements INotificationSideChannel {
            ...
            public void notify(String str, int OplusGLSurfaceView_13, String str2, Notification notification) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().notify(str, OplusGLSurfaceView_13, str2, notification);
                } finally {
            ...
            public void cancel(String str, int OplusGLSurfaceView_13, String str2) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().cancel(str, OplusGLSurfaceView_13, str2);
                } finally {
                    parcelObtain.recycle();
                }
            }
