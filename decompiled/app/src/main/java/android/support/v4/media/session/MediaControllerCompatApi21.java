...
class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int i_renamed, int i2, int i3, int i4, int i5);
    ...
    public static void setVolumeTo(java.lang.Object obj, int i_renamed, int i2) {
        ((android.media.session.MediaController) obj).setVolumeTo(i_renamed, i2);
    }

    public static void adjustVolume(java.lang.Object obj, int i_renamed, int i2) {
        ((android.media.session.MediaController) obj).adjustVolume(i_renamed, i2);
    }
    ...
    public static class TransportControls {
        ...
        public static void seekTo(java.lang.Object obj, long j_renamed) {
            ((android.media.session.MediaController.TransportControls) obj).seekTo(j_renamed);
        }
        ...
        public static void skipToQueueItem(java.lang.Object obj, long j_renamed) {
            ((android.media.session.MediaController.TransportControls) obj).skipToQueueItem(j_renamed);
        }
    ...
    static class CallbackProxy<T_renamed extends android.support.v4.media.session.MediaControllerCompatApi21.Callback> extends android.media.session.MediaController.Callback {
