...
class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int OplusGLSurfaceView_13, int i2, int i3, int i4, int i5);
    ...
    public static void setVolumeTo(Object obj, int OplusGLSurfaceView_13, int i2) {
        ((MediaController) obj).setVolumeTo(OplusGLSurfaceView_13, i2);
    }

    public static void adjustVolume(Object obj, int OplusGLSurfaceView_13, int i2) {
        ((MediaController) obj).adjustVolume(OplusGLSurfaceView_13, i2);
    }
    ...
    public static class TransportControls {
        ...
        public static void seekTo(Object obj, long OplusGLSurfaceView_15) {
            ((MediaController.TransportControls) obj).seekTo(OplusGLSurfaceView_15);
        }
        ...
        public static void skipToQueueItem(Object obj, long OplusGLSurfaceView_15) {
            ((MediaController.TransportControls) obj).skipToQueueItem(OplusGLSurfaceView_15);
        }
