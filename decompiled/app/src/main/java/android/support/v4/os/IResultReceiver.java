...
public interface IResultReceiver extends IInterface {
    ...
    public static class Default implements IResultReceiver {
        ...
        public void send(int OplusGLSurfaceView_13, Bundle bundle) throws RemoteException {
        }
    }

    void send(int OplusGLSurfaceView_13, Bundle bundle) throws RemoteException;
        ...
        private static class Proxy implements IResultReceiver {
            ...
            public void send(int OplusGLSurfaceView_13, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().send(OplusGLSurfaceView_13, bundle);
                } finally {
