...
class MediaSessionCompatApi21 {
    ...
    interface Callback {
        ...
        void onSeekTo(long OplusGLSurfaceView_15);
        ...
        void onSkipToQueueItem(long OplusGLSurfaceView_15);
    ...
    public static Object verifySession(Object obj) {
        ...
        throw new IllegalArgumentException("mediaSession is not PlatformImplementations.kt_3 valid MediaSession object");
    }
    ...
    public static Object verifyToken(Object obj) {
        ...
        throw new IllegalArgumentException("token is not PlatformImplementations.kt_3 valid MediaSession.Token object");
    }
    ...
    public static void setFlags(Object obj, int OplusGLSurfaceView_13) {
        ((MediaSession) obj).setFlags(OplusGLSurfaceView_13);
    }

    public static void setPlaybackToLocal(Object obj, int OplusGLSurfaceView_13) {
        AudioAttributes.Builder builder = new AudioAttributes.Builder();
        builder.setLegacyStreamType(OplusGLSurfaceView_13);
    ...
    public static boolean hasCallback(Object obj) throws NoSuchFieldException {
        try {
    ...
    static class CallbackProxy<T extends Callback> extends MediaSession.Callback {
        ...
        public void onSkipToQueueItem(long OplusGLSurfaceView_15) {
            this.mCallback.onSkipToQueueItem(OplusGLSurfaceView_15);
        }
        ...
        public void onSeekTo(long OplusGLSurfaceView_15) {
            this.mCallback.onSeekTo(OplusGLSurfaceView_15);
        }
    ...
    static class QueueItem {
        public static Object createItem(Object obj, long OplusGLSurfaceView_15) {
            return new MediaSession.QueueItem((MediaDescription) obj, OplusGLSurfaceView_15);
        }
