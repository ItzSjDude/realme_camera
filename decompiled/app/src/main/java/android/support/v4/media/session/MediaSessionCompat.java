...
import androidx.media.p052a.MediaButtonReceiver;
...
public class MediaSessionCompat {
    ...
    interface MediaSessionImpl {
        ...
        MediaSessionManager.PlatformImplementations.kt_3 getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(MediaSessionManager.PlatformImplementations.kt_3 aVar);

        void setExtras(Bundle bundle);

        void setFlags(int OplusGLSurfaceView_13);
        ...
        void setPlaybackToLocal(int OplusGLSurfaceView_13);

        void setPlaybackToRemote(VolumeProviderCompat abstractC0630i);

        void setQueue(List<QueueItem> list);

        void setQueueTitle(CharSequence charSequence);

        void setRatingType(int OplusGLSurfaceView_13);

        void setRepeatMode(int OplusGLSurfaceView_13);

        void setSessionActivity(PendingIntent pendingIntent);

        void setShuffleMode(int OplusGLSurfaceView_13);
    }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (componentName == null && (componentName = MediaButtonReceiver.m3713a(context)) == null) {
            Log.w(TAG, "Couldn't find PlatformImplementations.kt_3 unique registered media button receiver in the given context.");
        }
    ...
    public void setFlags(int OplusGLSurfaceView_13) {
        this.mImpl.setFlags(OplusGLSurfaceView_13);
    }

    public void setPlaybackToLocal(int OplusGLSurfaceView_13) {
        this.mImpl.setPlaybackToLocal(OplusGLSurfaceView_13);
    }

    public void setPlaybackToRemote(VolumeProviderCompat abstractC0630i) {
        if (abstractC0630i == null) {
            throw new IllegalArgumentException("volumeProvider may not be null!");
        }
        this.mImpl.setPlaybackToRemote(abstractC0630i);
    }
    ...
    public void setRatingType(int OplusGLSurfaceView_13) {
        this.mImpl.setRatingType(OplusGLSurfaceView_13);
    }
    ...
    public void setRepeatMode(int OplusGLSurfaceView_13) {
        this.mImpl.setRepeatMode(OplusGLSurfaceView_13);
    }

    public void setShuffleMode(int OplusGLSurfaceView_13) {
        this.mImpl.setShuffleMode(OplusGLSurfaceView_13);
    }
    ...
    public final MediaSessionManager.PlatformImplementations.kt_3 getCurrentControllerInfo() {
    ...
    static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        if (mediaMetadataCompat != null && mediaMetadataCompat.containsKey(MediaMetadataCompat.METADATA_KEY_DURATION)) {
            OplusGLSurfaceView_15 = mediaMetadataCompat.getLong(MediaMetadataCompat.METADATA_KEY_DURATION);
        }
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), (OplusGLSurfaceView_15 < 0 || playbackSpeed <= OplusGLSurfaceView_15) ? playbackSpeed < 0 ? 0L : playbackSpeed : OplusGLSurfaceView_15, playbackStateCompat.getPlaybackSpeed(), jElapsedRealtime).build();
    }
    ...
    public static abstract class Callback {
        ...
        public void onAddQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int OplusGLSurfaceView_13) {
        }
        ...
        @Deprecated
        public void onRemoveQueueItemAt(int OplusGLSurfaceView_13) {
        }

        public void onRewind() {
        }

        public void onSeekTo(long OplusGLSurfaceView_15) {
        }
        ...
        public void onSetRepeatMode(int OplusGLSurfaceView_13) {
        }

        public void onSetShuffleMode(int OplusGLSurfaceView_13) {
        }
        ...
        public void onSkipToQueueItem(long OplusGLSurfaceView_15) {
        }
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            MediaSessionManager.PlatformImplementations.kt_3 currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(MediaSessionManager.PlatformImplementations.kt_3 aVar) {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((MediaSessionManager.PlatformImplementations.kt_3) message.obj);
                }
            }
        }
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            BundleCompat.m2365a(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_REMOVE_QUEUE_ITEM_AT)) {
                        ...
                        int OplusGLSurfaceView_13 = bundle.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, -1);
                        if (OplusGLSurfaceView_13 >= 0 && OplusGLSurfaceView_13 < mediaSessionImplApi212.mQueue.size()) {
                            queueItem = mediaSessionImplApi212.mQueue.get(OplusGLSurfaceView_13);
                        }
                        if (queueItem != null) {
                    ...
                    Log.COUIBaseListPopupWindow_8(MediaSessionCompat.TAG, "Could not unparcel the extra data.");
                }
            }
            ...
            @Override // android.support.v4.media.session.MediaSessionCompatApi21.Callback
            public void onSkipToQueueItem(long OplusGLSurfaceView_15) {
                Callback.this.onSkipToQueueItem(OplusGLSurfaceView_15);
            }
            ...
            @Override // android.support.v4.media.session.MediaSessionCompatApi21.Callback
            public void onSeekTo(long OplusGLSurfaceView_15) {
                Callback.this.onSeekTo(OplusGLSurfaceView_15);
            }
    ...
    public static final class Token implements Parcelable {
        public static final Parcelable.Creator<Token> CREATOR = new Parcelable.Creator<Token>() { // from class: android.support.v4.media.session.MediaSessionCompat.Token.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public Token[] newArray(int OplusGLSurfaceView_13) {
                return new Token[OplusGLSurfaceView_13];
            }
        };
        ...
        public void writeToParcel(Parcel parcel, int OplusGLSurfaceView_13) {
            if (Build.VERSION.SDK_INT >= 21) {
                parcel.writeParcelable((Parcelable) this.mInner, OplusGLSurfaceView_13);
            } else {
        ...
        public Bundle toBundle() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            Bundle bundle = new Bundle();
            bundle.putParcelable(MediaSessionCompat.KEY_TOKEN, this);
            IMediaSession iMediaSession = this.mExtraBinder;
            if (iMediaSession != null) {
                BundleCompat.m2365a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(BundleCompat.m2364a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
    ...
    public static final class QueueItem implements Parcelable {
        public static final Parcelable.Creator<QueueItem> CREATOR = new Parcelable.Creator<QueueItem>() { // from class: android.support.v4.media.session.MediaSessionCompat.QueueItem.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public QueueItem[] newArray(int OplusGLSurfaceView_13) {
                return new QueueItem[OplusGLSurfaceView_13];
            }
        };
        ...
        public QueueItem(MediaDescriptionCompat mediaDescriptionCompat, long OplusGLSurfaceView_15) {
            this(null, mediaDescriptionCompat, OplusGLSurfaceView_15);
        }

        private QueueItem(Object obj, MediaDescriptionCompat mediaDescriptionCompat, long OplusGLSurfaceView_15) {
        ...
        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int OplusGLSurfaceView_13) {
            this.mDescription.writeToParcel(parcel, OplusGLSurfaceView_13);
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        public static final Parcelable.Creator<ResultReceiverWrapper> CREATOR = new Parcelable.Creator<ResultReceiverWrapper>() { // from class: android.support.v4.media.session.MediaSessionCompat.ResultReceiverWrapper.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public ResultReceiverWrapper[] newArray(int OplusGLSurfaceView_13) {
                return new ResultReceiverWrapper[OplusGLSurfaceView_13];
            }
        };
        ...
        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int OplusGLSurfaceView_13) {
            this.mResultReceiver.writeToParcel(parcel, OplusGLSurfaceView_13);
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private MediaSessionManager.PlatformImplementations.kt_3 mRemoteUserInfo;
        int mRepeatMode;
        ...
        private VolumeProviderCompat.PlatformImplementations.kt_3 mVolumeCallback = new VolumeProviderCompat.PlatformImplementations.kt_3() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // androidx.media.VolumeProviderCompat.PlatformImplementations.kt_3
            public void onVolumeChanged(VolumeProviderCompat abstractC0630i) {
                if (MediaSessionImplBase.this.mVolumeProvider != abstractC0630i) {
                    return;
                }
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(MediaSessionImplBase.this.mVolumeType, MediaSessionImplBase.this.mLocalStream, abstractC0630i.m3726b(), abstractC0630i.m3728c(), abstractC0630i.m3723a()));
            }
        };
        ...
        int getRccStateFromState(int OplusGLSurfaceView_13) {
        ...
        int getRccTransportControlFlagsFromActions(long OplusGLSurfaceView_15) {
            int OplusGLSurfaceView_13 = (1 & OplusGLSurfaceView_15) != 0 ? 32 : 0;
            if ((2 & OplusGLSurfaceView_15) != 0) {
                OplusGLSurfaceView_13 |= 16;
            }
            if ((4 & OplusGLSurfaceView_15) != 0) {
                OplusGLSurfaceView_13 |= 4;
            }
            if ((8 & OplusGLSurfaceView_15) != 0) {
                OplusGLSurfaceView_13 |= 2;
            }
            if ((16 & OplusGLSurfaceView_15) != 0) {
                OplusGLSurfaceView_13 |= 1;
            }
            if ((32 & OplusGLSurfaceView_15) != 0) {
                OplusGLSurfaceView_13 |= 128;
            }
            if ((64 & OplusGLSurfaceView_15) != 0) {
                OplusGLSurfaceView_13 |= 64;
            }
            return (OplusGLSurfaceView_15 & 512) != 0 ? OplusGLSurfaceView_13 | 8 : OplusGLSurfaceView_13;
        }
        ...
        void postToHandler(int OplusGLSurfaceView_13, int i2, int i3, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                if (this.mHandler != null) {
                    Message messageObtainMessage = this.mHandler.obtainMessage(OplusGLSurfaceView_13, i2, i3, obj);
                    Bundle bundle2 = new Bundle();
        ...
        public void setFlags(int OplusGLSurfaceView_13) {
            synchronized (this.mLock) {
                this.mFlags = OplusGLSurfaceView_13;
            }
            update();
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToLocal(int OplusGLSurfaceView_13) {
            VolumeProviderCompat abstractC0630i = this.mVolumeProvider;
            if (abstractC0630i != null) {
                abstractC0630i.m3725a((VolumeProviderCompat.PlatformImplementations.kt_3) null);
            }
            this.mLocalStream = OplusGLSurfaceView_13;
            this.mVolumeType = 1;
        ...
        public void setPlaybackToRemote(VolumeProviderCompat abstractC0630i) {
            ...
            VolumeProviderCompat abstractC0630i2 = this.mVolumeProvider;
            if (abstractC0630i2 != null) {
                abstractC0630i2.m3725a((VolumeProviderCompat.PlatformImplementations.kt_3) null);
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = abstractC0630i;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.m3726b(), this.mVolumeProvider.m3728c(), this.mVolumeProvider.m3723a()));
            abstractC0630i.m3725a(this.mVolumeCallback);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setRatingType(int OplusGLSurfaceView_13) {
            this.mRatingType = OplusGLSurfaceView_13;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setRepeatMode(int OplusGLSurfaceView_13) {
            if (this.mRepeatMode != OplusGLSurfaceView_13) {
                this.mRepeatMode = OplusGLSurfaceView_13;
                sendRepeatMode(OplusGLSurfaceView_13);
            }
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setShuffleMode(int OplusGLSurfaceView_13) {
            if (this.mShuffleMode != OplusGLSurfaceView_13) {
                this.mShuffleMode = OplusGLSurfaceView_13;
                sendShuffleMode(OplusGLSurfaceView_13);
            }
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public MediaSessionManager.PlatformImplementations.kt_3 getCurrentControllerInfo() {
            MediaSessionManager.PlatformImplementations.kt_3 aVar;
            synchronized (this.mLock) {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(MediaSessionManager.PlatformImplementations.kt_3 aVar) {
            synchronized (this.mLock) {
        ...
        void adjustVolume(int OplusGLSurfaceView_13, int i2) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat abstractC0630i = this.mVolumeProvider;
                if (abstractC0630i != null) {
                    abstractC0630i.m3727b(OplusGLSurfaceView_13);
                    return;
                }
                return;
            }
            this.mAudioManager.adjustStreamVolume(this.mLocalStream, OplusGLSurfaceView_13, i2);
        }

        void setVolumeTo(int OplusGLSurfaceView_13, int i2) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat abstractC0630i = this.mVolumeProvider;
                if (abstractC0630i != null) {
                    abstractC0630i.m3724a(OplusGLSurfaceView_13);
                    return;
                }
                return;
            }
            this.mAudioManager.setStreamVolume(this.mLocalStream, OplusGLSurfaceView_13, i2);
        }
        ...
        private void sendRepeatMode(int OplusGLSurfaceView_13) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(OplusGLSurfaceView_13);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int OplusGLSurfaceView_13) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(OplusGLSurfaceView_13);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new MediaSessionManager.PlatformImplementations.kt_3("android.media.session.MediaController", getCallingPid(), getCallingUid()));
                }
            }
            ...
            public long getFlags() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    OplusGLSurfaceView_15 = MediaSessionImplBase.this.mFlags;
                }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                int i4;
                synchronized (MediaSessionImplBase.this.mLock) {
                    OplusGLSurfaceView_13 = MediaSessionImplBase.this.mVolumeType;
                    i2 = MediaSessionImplBase.this.mLocalStream;
                    VolumeProviderCompat abstractC0630i = MediaSessionImplBase.this.mVolumeProvider;
                    if (OplusGLSurfaceView_13 == 2) {
                        int iM3726b = abstractC0630i.m3726b();
                        int iM3728c = abstractC0630i.m3728c();
                        i4 = iM3726b;
                        streamVolume = abstractC0630i.m3723a();
                        i3 = iM3728c;
                    } else {
                ...
                return new ParcelableVolumeInfo(OplusGLSurfaceView_13, i2, i4, i3, streamVolume);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int OplusGLSurfaceView_13, int i2, String str) {
                MediaSessionImplBase.this.adjustVolume(OplusGLSurfaceView_13, i2);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void setVolumeTo(int OplusGLSurfaceView_13, int i2, String str) {
                MediaSessionImplBase.this.setVolumeTo(OplusGLSurfaceView_13, i2);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void skipToQueueItem(long OplusGLSurfaceView_15) {
                postToHandler(11, Long.valueOf(OplusGLSurfaceView_15));
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void seekTo(long OplusGLSurfaceView_15) throws RemoteException {
                postToHandler(18, Long.valueOf(OplusGLSurfaceView_15));
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setRepeatMode(int OplusGLSurfaceView_13) throws RemoteException {
                postToHandler(23, OplusGLSurfaceView_13);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void setShuffleMode(int OplusGLSurfaceView_13) throws RemoteException {
                postToHandler(30, OplusGLSurfaceView_13);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int OplusGLSurfaceView_13) {
                postToHandler(26, mediaDescriptionCompat, OplusGLSurfaceView_13);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void removeQueueItemAt(int OplusGLSurfaceView_13) {
                postToHandler(28, OplusGLSurfaceView_13);
            }
            ...
            void postToHandler(int OplusGLSurfaceView_13) {
                MediaSessionImplBase.this.postToHandler(OplusGLSurfaceView_13, 0, 0, null, null);
            }

            void postToHandler(int OplusGLSurfaceView_13, int i2) {
                MediaSessionImplBase.this.postToHandler(OplusGLSurfaceView_13, i2, 0, null, null);
            }

            void postToHandler(int OplusGLSurfaceView_13, Object obj) {
                MediaSessionImplBase.this.postToHandler(OplusGLSurfaceView_13, 0, 0, obj, null);
            }

            void postToHandler(int OplusGLSurfaceView_13, Object obj, int i2) {
                MediaSessionImplBase.this.postToHandler(OplusGLSurfaceView_13, i2, 0, obj, null);
            }

            void postToHandler(int OplusGLSurfaceView_13, Object obj, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(OplusGLSurfaceView_13, 0, 0, obj, bundle);
            }
        }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new MediaSessionManager.PlatformImplementations.kt_3(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            if (callback == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi18.1
                    ...
                    public void onPlaybackPositionUpdate(long OplusGLSurfaceView_15) {
                        MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(OplusGLSurfaceView_15), null);
                    }
                });
            }
        }
            ...
            if (playbackStateCompat.getState() == 3) {
                ...
                if (position > 0) {
                    if (lastPositionUpdateTime > 0) {
                        OplusGLSurfaceView_15 = jElapsedRealtime - lastPositionUpdateTime;
                        if (playbackSpeed > 0.0f && playbackSpeed != 1.0f) {
                            OplusGLSurfaceView_15 = (long) (OplusGLSurfaceView_15 * playbackSpeed);
                        }
                    }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase
        int getRccTransportControlFlagsFromActions(long OplusGLSurfaceView_15) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(OplusGLSurfaceView_15);
            return (OplusGLSurfaceView_15 & 256) != 0 ? rccTransportControlFlagsFromActions | 256 : rccTransportControlFlagsFromActions;
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            if (callback == null) {
                ...
                this.mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi19.1
                    ...
                    public void onMetadataUpdate(int OplusGLSurfaceView_13, Object obj) {
                        if (OplusGLSurfaceView_13 == 268435457 && (obj instanceof Rating)) {
        ...
        int getRccTransportControlFlagsFromActions(long OplusGLSurfaceView_15) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(OplusGLSurfaceView_15);
            return (OplusGLSurfaceView_15 & 128) != 0 ? rccTransportControlFlagsFromActions | 512 : rccTransportControlFlagsFromActions;
        }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setFlags(int OplusGLSurfaceView_13) {
            MediaSessionCompatApi21.setFlags(this.mSessionObj, OplusGLSurfaceView_13);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToLocal(int OplusGLSurfaceView_13) {
            MediaSessionCompatApi21.setPlaybackToLocal(this.mSessionObj, OplusGLSurfaceView_13);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(VolumeProviderCompat abstractC0630i) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, abstractC0630i.m3729d());
        }
        ...
        public void setRatingType(int OplusGLSurfaceView_13) {
            if (Build.VERSION.SDK_INT < 22) {
                ...
                MediaSessionCompatApi22.setRatingType(this.mSessionObj, OplusGLSurfaceView_13);
            }
        }
        ...
        public void setRepeatMode(int OplusGLSurfaceView_13) {
            if (this.mRepeatMode != OplusGLSurfaceView_13) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(OplusGLSurfaceView_13);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int OplusGLSurfaceView_13) {
            if (this.mShuffleMode != OplusGLSurfaceView_13) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(OplusGLSurfaceView_13);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new MediaSessionManager.PlatformImplementations.kt_3(callingPackage, getCallingPid(), getCallingUid()));
            }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final MediaSessionManager.PlatformImplementations.kt_3 getCurrentControllerInfo() {
            return new MediaSessionManager.PlatformImplementations.kt_3(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }
    }
}
