...
public interface IMediaSession extends IInterface {
    ...
    void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int OplusGLSurfaceView_13) throws RemoteException;

    void adjustVolume(int OplusGLSurfaceView_13, int i2, String str) throws RemoteException;
    ...
    void removeQueueItemAt(int OplusGLSurfaceView_13) throws RemoteException;

    void rewind() throws RemoteException;

    void seekTo(long OplusGLSurfaceView_15) throws RemoteException;
    ...
    void setRepeatMode(int OplusGLSurfaceView_13) throws RemoteException;

    void setShuffleMode(int OplusGLSurfaceView_13) throws RemoteException;

    void setShuffleModeEnabledRemoved(boolean z) throws RemoteException;

    void setVolumeTo(int OplusGLSurfaceView_13, int i2, String str) throws RemoteException;

    void skipToQueueItem(long OplusGLSurfaceView_15) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        private static class Proxy implements IMediaSession {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int OplusGLSurfaceView_13, int i2, String str) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setVolumeTo(int OplusGLSurfaceView_13, int i2, String str) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int OplusGLSurfaceView_13) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void removeQueueItemAt(int OplusGLSurfaceView_13) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void skipToQueueItem(long OplusGLSurfaceView_15) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
