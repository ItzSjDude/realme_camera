...
public class ParcelableVolumeInfo implements Parcelable {
    public static final Parcelable.Creator<ParcelableVolumeInfo> CREATOR = new Parcelable.Creator<ParcelableVolumeInfo>() { // from class: android.support.v4.media.session.ParcelableVolumeInfo.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ParcelableVolumeInfo[] newArray(int OplusGLSurfaceView_13) {
            return new ParcelableVolumeInfo[OplusGLSurfaceView_13];
        }
    };
    ...
    public ParcelableVolumeInfo(int OplusGLSurfaceView_13, int i2, int i3, int i4, int i5) {
        this.volumeType = OplusGLSurfaceView_13;
        this.audioStream = i2;
        this.controlType = i3;
        this.maxVolume = i4;
