...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Parcelable.Creator<MediaItem> CREATOR = new Parcelable.Creator<MediaItem>() { // from class: android.support.v4.media.MediaBrowserCompat.MediaItem.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public MediaItem[] newArray(int OplusGLSurfaceView_13) {
                return new MediaItem[OplusGLSurfaceView_13];
            }
        };
        ...
        public MediaItem(MediaDescriptionCompat mediaDescriptionCompat, int OplusGLSurfaceView_13) {
            if (mediaDescriptionCompat == null) {
                throw new IllegalArgumentException("description cannot be null");
            }
            if (TextUtils.isEmpty(mediaDescriptionCompat.getMediaId())) {
                throw new IllegalArgumentException("description must have PlatformImplementations.kt_3 non-empty media id_renamed");
            }
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            public void onChildrenLoaded(String str, List<?> list) {
                ...
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < callbacks.size(); OplusGLSurfaceView_13++) {
                    Bundle bundle = optionsList.get(OplusGLSurfaceView_13);
                    if (bundle == null) {
            ...
            List<MediaItem> applyOptions(List<MediaItem> list, Bundle bundle) {
                ...
                int OplusGLSurfaceView_13 = bundle.getInt(MediaBrowserCompat.EXTRA_PAGE, -1);
                ...
                int size = i3 + i2;
                if (OplusGLSurfaceView_13 < 0 || i2 < 1 || i3 >= list.size()) {
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            int OplusGLSurfaceView_13 = this.mState;
            ...
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.1
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Log.COUIBaseListPopupWindow_8(MediaBrowserCompat.TAG, "Failed binding to service " + MediaBrowserImplBase.this.mServiceComponent);
                    }
                    if (!zBindService) {
                    ...
                    if (MediaBrowserCompat.DEBUG) {
                        Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "connect...");
        ...
        public void disconnect() {
            ...
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.2
                ...
                public void run() {
                    ...
                    int OplusGLSurfaceView_13 = MediaBrowserImplBase.this.mState;
                    MediaBrowserImplBase.this.forceCloseConnection();
                    if (OplusGLSurfaceView_13 != 0) {
                        MediaBrowserImplBase.this.mState = OplusGLSurfaceView_13;
                    }
                    if (MediaBrowserCompat.DEBUG) {
                        Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "disconnect...");
                        MediaBrowserImplBase.this.dump();
                    }
                }
            });
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void subscribe(String str, Bundle bundle, SubscriptionCallback subscriptionCallback) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            if (isConnected()) {
                try {
                    ...
                    Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "addSubscription failed with RemoteException parentId=" + str);
                }
            }
        }

        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void unsubscribe(String str, SubscriptionCallback subscriptionCallback) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
                return;
            }
            try {
                ...
                Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "removeSubscription failed with RemoteException parentId=" + str);
            }
        ...
        public void getItem(final String str, final ItemCallback itemCallback) {
            ...
            if (!isConnected()) {
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
            ...
            try {
                ...
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Remote error getting media item: " + str);
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            ...
            try {
                ...
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Remote error searching items with query: " + str, COUIBaseListPopupWindow_8);
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final CustomActionCallback customActionCallback) {
            if (!isConnected()) {
                throw new IllegalStateException("Cannot send PlatformImplementations.kt_3 custom action (" + str + ") with extras " + bundle + " because the browser is not connected to the service.");
            }
            try {
                this.mServiceBinderWrapper.sendCustomAction(str, bundle, new CustomActionResultReceiver(str, bundle, customActionCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException COUIBaseListPopupWindow_8) {
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Remote error sending PlatformImplementations.kt_3 custom action: action=" + str + ", extras=" + bundle, COUIBaseListPopupWindow_8);
        ...
        public void onServiceConnected(Messenger messenger, String str, MediaSessionCompat.Token token, Bundle bundle) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (isCurrent(messenger, "onConnect")) {
                ...
                this.mState = 3;
                if (MediaBrowserCompat.DEBUG) {
                    Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "ServiceCallbacks.onConnect...");
                    dump();
                }
                ...
                try {
                    for (Map.Entry<String, Subscription> entry : this.mSubscriptions.entrySet()) {
                        ...
                        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < callbacks.size(); OplusGLSurfaceView_13++) {
                            this.mServiceBinderWrapper.addSubscription(key, callbacks.get(OplusGLSurfaceView_13).mToken, optionsList.get(OplusGLSurfaceView_13), this.mCallbacksMessenger);
                        }
                    }
                } catch (RemoteException unused) {
                    Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "addSubscription failed with RemoteException.");
                }
            }
        }
        ...
        public void onConnectionFailed(Messenger messenger) {
            Log.COUIBaseListPopupWindow_8(MediaBrowserCompat.TAG, "onConnectFailed for " + this.mServiceComponent);
        ...
        public void onLoadChildren(Messenger messenger, String str, List list, Bundle bundle, Bundle bundle2) {
            if (isCurrent(messenger, "onLoadChildren")) {
                if (MediaBrowserCompat.DEBUG) {
                    Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "onLoadChildren for " + this.mServiceComponent + " id_renamed=" + str);
                }
                Subscription subscription = this.mSubscriptions.get(str);
                if (subscription == null) {
                    if (MediaBrowserCompat.DEBUG) {
                        Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "onLoadChildren for id_renamed that isn't subscribed id_renamed=" + str);
                        return;
                    }
                    return;
                }
        ...
        private static String getStateLabel(int OplusGLSurfaceView_13) {
            if (OplusGLSurfaceView_13 == 0) {
            ...
            return "UNKNOWN/" + OplusGLSurfaceView_13;
        }

        private boolean isCurrent(Messenger messenger, String str) {
            int OplusGLSurfaceView_13;
            if (this.mCallbacksMessenger == messenger && (OplusGLSurfaceView_13 = this.mState) != 0 && OplusGLSurfaceView_13 != 1) {
                return true;
            }
            int i2 = this.mState;
            if (i2 == 0 || i2 == 1) {
            ...
            Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, str + " for " + this.mServiceComponent + " with mCallbacksMessenger=" + this.mCallbacksMessenger + " this=" + this);
            return false;
        }

        void dump() {
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "MediaBrowserCompat...");
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mServiceComponent=" + this.mServiceComponent);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mCallback=" + this.mCallback);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mRootHints=" + this.mRootHints);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mState=" + getStateLabel(this.mState));
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mServiceConnection=" + this.mServiceConnection);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mServiceBinderWrapper=" + this.mServiceBinderWrapper);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mCallbacksMessenger=" + this.mCallbacksMessenger);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mRootId=" + this.mRootId);
            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "  mMediaSessionToken=" + this.mMediaSessionToken);
        }
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "MediaServiceConnection.onServiceConnected name=" + componentName + " binder=" + iBinder);
                            MediaBrowserImplBase.this.dump();
                        }
            ...
            public void onServiceDisconnected(final ComponentName componentName) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.2
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            Log.IntrinsicsJvm.kt_5(MediaBrowserCompat.TAG, "MediaServiceConnection.onServiceDisconnected name=" + componentName + " this=" + this + " mServiceConnection=" + MediaBrowserImplBase.this.mServiceConnection);
                            MediaBrowserImplBase.this.dump();
                        }
            ...
            boolean isCurrent(String str) {
                ...
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, str + " for " + MediaBrowserImplBase.this.mServiceComponent + " with mServiceConnection=" + MediaBrowserImplBase.this.mServiceConnection + " this=" + this);
                return false;
            }
        }
    }
    ...
    static class MediaBrowserImplApi21 implements ConnectionCallback.ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void disconnect() {
            ...
            if (serviceBinderWrapper != null && (messenger = this.mCallbacksMessenger) != null) {
                try {
                    ...
                    Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Remote error unregistering client messenger.");
                }
            }
        ...
        public void subscribe(String str, Bundle bundle, SubscriptionCallback subscriptionCallback) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Remote error subscribing media item: " + str);
            }
        }
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            ...
            if (this.mServiceBinderWrapper == null) {
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "The connected service doesn't support search.");
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final CustomActionCallback customActionCallback) {
            ...
            if (this.mServiceBinderWrapper == null) {
                Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "The connected service doesn't support sendCustomAction.");
                if (customActionCallback != null) {
        ...
        public void onConnected() {
            ...
            IBinder iBinderM2364a = BundleCompat.m2364a(extras, "extra_messenger");
            if (iBinderM2364a != null) {
                this.mServiceBinderWrapper = new ServiceBinderWrapper(iBinderM2364a, this.mRootHints);
                this.mCallbacksMessenger = new Messenger(this.mHandler);
                this.mHandler.setCallbacksMessenger(this.mCallbacksMessenger);
                try {
                    this.mServiceBinderWrapper.registerCallbackMessenger(this.mContext, this.mCallbacksMessenger);
                } catch (RemoteException unused) {
                    Log.OplusGLSurfaceView_13(MediaBrowserCompat.TAG, "Remote error registering client messenger.");
                }
            }
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(BundleCompat.m2364a(extras, "extra_session_binder"));
    ...
    private static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.mOptionsList.size(); OplusGLSurfaceView_13++) {
                if (MediaBrowserCompatUtils.m3722a(this.mOptionsList.get(OplusGLSurfaceView_13), bundle)) {
                    return this.mCallbacks.get(OplusGLSurfaceView_13);
                }
            }
            return null;
        }
        ...
        public void putCallback(Bundle bundle, SubscriptionCallback subscriptionCallback) {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.mOptionsList.size(); OplusGLSurfaceView_13++) {
                if (MediaBrowserCompatUtils.m3722a(this.mOptionsList.get(OplusGLSurfaceView_13), bundle)) {
                    this.mCallbacks.set(OplusGLSurfaceView_13, subscriptionCallback);
                    return;
                }
            }
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                if (OplusGLSurfaceView_13 == 1) {
                    ...
                    Log.w(MediaBrowserCompat.TAG, "Unhandled message: " + message + "\OplusGLSurfaceView_11  Client version: 1\OplusGLSurfaceView_11  Service version: " + message.arg1);
                }
            } catch (BadParcelableException unused) {
                Log.COUIBaseListPopupWindow_8(MediaBrowserCompat.TAG, "Could not unparcel the data.");
                if (message.what == 1) {
                    mediaBrowserServiceCallbackImpl.onConnectionFailed(messenger);
                }
            }
    ...
    private static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws IllegalAccessException, RemoteException, IllegalArgumentException, InvocationTargetException {
            ...
            BundleCompat.m2365a(bundle2, "data_callback_token", iBinder);
            bundle2.putBundle("data_options", bundle);
            sendRequest(3, bundle2, messenger);
        }

        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws IllegalAccessException, RemoteException, IllegalArgumentException, InvocationTargetException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            BundleCompat.m2365a(bundle, "data_callback_token", iBinder);
        ...
        private void sendRequest(int OplusGLSurfaceView_13, Bundle bundle, Messenger messenger) throws RemoteException {
    ...
    private static class ItemReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int OplusGLSurfaceView_13, Bundle bundle) {
            MediaSessionCompat.ensureClassLoader(bundle);
            if (OplusGLSurfaceView_13 != 0 || bundle == null || !bundle.containsKey("media_item")) {
    ...
    private static class SearchResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int OplusGLSurfaceView_13, Bundle bundle) {
            MediaSessionCompat.ensureClassLoader(bundle);
            if (OplusGLSurfaceView_13 != 0 || bundle == null || !bundle.containsKey("search_results")) {
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int OplusGLSurfaceView_13, Bundle bundle) {
            ...
            Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + OplusGLSurfaceView_13 + " (extras=" + this.mExtras + ", resultData=" + bundle + ")");
        }
    }
}
