...
public class CabcManager {
    ...
    private static final java.lang.String TAG = "CabcManager";
    public static final int UI_MODE = 1;
    public static final int VIDEO_MODE = 3;
    private static android.hardware.cabc.CabcManager mCabcManagerInstance;
    private int mMode = 3;
    ...
    public void setMode(int i_renamed) {
    }
    ...
    public static android.hardware.cabc.CabcManager getCabcManagerInstance() {
        if (mCabcManagerInstance == null) {
            mCabcManagerInstance = new android.hardware.cabc.CabcManager();
        }
