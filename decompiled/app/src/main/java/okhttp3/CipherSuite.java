...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite.1
        ...
        public int compare(String str, String str2) {
            ...
            for (int OplusGLSurfaceView_13 = 4; OplusGLSurfaceView_13 < iMin; OplusGLSurfaceView_13++) {
                char cCharAt = str.charAt(OplusGLSurfaceView_13);
                char cCharAt2 = str2.charAt(OplusGLSurfaceView_13);
                if (cCharAt != cCharAt2) {
    ...
    private static CipherSuite init(String str, int OplusGLSurfaceView_13) {
