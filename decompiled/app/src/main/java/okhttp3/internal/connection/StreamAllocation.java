...
public final class StreamAllocation {
    ...
    public HttpCodec newStream(OkHttpClient okHttpClient, Interceptor.Chain chain, boolean z) {
        try {
            ...
            throw new RouteException(COUIBaseListPopupWindow_8);
        }
    }

    private RealConnection findHealthyConnection(int OplusGLSurfaceView_13, int i2, int i3, int i4, boolean z, boolean z2) throws Throwable {
        while (true) {
            RealConnection realConnectionFindConnection = findConnection(OplusGLSurfaceView_13, i2, i3, i4, z);
            synchronized (this.connectionPool) {
    ...
    private RealConnection findConnection(int OplusGLSurfaceView_13, int i2, int i3, int i4, boolean z) throws Throwable {
        ...
        realConnection3.connect(OplusGLSurfaceView_13, i2, i3, i4, z, this.call, this.eventListener);
    ...
    public void streamFinished(boolean z, HttpCodec httpCodec, long OplusGLSurfaceView_15, IOException iOException) {
        RealConnection realConnection;
        Socket socketDeallocate;
        boolean z2;
        this.eventListener.responseBodyEnd(this.call, OplusGLSurfaceView_15);
        synchronized (this.connectionPool) {
            if (httpCodec != null) {
    ...
    */
    ...
    private void release(RealConnection realConnection) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            if (realConnection.allocations.get(OplusGLSurfaceView_13).get() == this) {
                realConnection.allocations.remove(OplusGLSurfaceView_13);
                return;
            }
        }
        throw new IllegalStateException();
