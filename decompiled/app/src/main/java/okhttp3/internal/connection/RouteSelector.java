...
public final class RouteSelector {
    ...
    public Selection next() throws IOException {
        ...
        while (hasNextProxy()) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                Route route = new Route(this.address, proxyNextProxy, this.inetSocketAddresses.get(OplusGLSurfaceView_13));
    ...
    private Proxy nextProxy() throws IOException {
        ...
        int OplusGLSurfaceView_13 = this.nextProxyIndex;
        this.nextProxyIndex = OplusGLSurfaceView_13 + 1;
        Proxy proxy = list.get(OplusGLSurfaceView_13);
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            this.inetSocketAddresses.add(new InetSocketAddress(listLookup.get(OplusGLSurfaceView_13), iPort));
        }
    }
    ...
    public static final class Selection {
        ...
        public Route next() {
            ...
            int OplusGLSurfaceView_13 = this.nextRouteIndex;
            this.nextRouteIndex = OplusGLSurfaceView_13 + 1;
