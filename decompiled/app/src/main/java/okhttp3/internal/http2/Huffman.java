...
class Huffman {
    ...
    void encode(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        ...
        for (int i2 = 0; i2 < byteString.size(); i2++) {
            ...
            OplusGLSurfaceView_15 = (OplusGLSurfaceView_15 << b2) | i4;
            OplusGLSurfaceView_13 += b2;
            while (OplusGLSurfaceView_13 >= 8) {
                OplusGLSurfaceView_13 -= 8;
                bufferedSink.writeByte((int) (OplusGLSurfaceView_15 >> OplusGLSurfaceView_13));
            }
        }
        if (OplusGLSurfaceView_13 > 0) {
            bufferedSink.writeByte((int) ((OplusGLSurfaceView_15 << (8 - OplusGLSurfaceView_13)) | (255 >>> OplusGLSurfaceView_13)));
        }
    }

    int encodedLength(ByteString byteString) {
        long OplusGLSurfaceView_15 = 0;
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < byteString.size(); OplusGLSurfaceView_13++) {
            OplusGLSurfaceView_15 += CODE_LENGTHS[byteString.getByte(OplusGLSurfaceView_13) & 255];
        }
        return (int) ((OplusGLSurfaceView_15 + 7) >> 3);
    }
    ...
    byte[] decode(byte[] bArr) {
        ...
        int i2 = 0;
        for (byte b2 : bArr) {
            OplusGLSurfaceView_13 = (OplusGLSurfaceView_13 << 8) | (b2 & 255);
            i2 += 8;
            while (i2 >= 8) {
                node = node.children[(OplusGLSurfaceView_13 >>> (i2 - 8)) & 255];
        ...
        while (i2 > 0) {
            Node node2 = node.children[(OplusGLSurfaceView_13 << (8 - i2)) & 255];
    ...
    private void buildTree() {
        ...
        while (true) {
            ...
            addCode(OplusGLSurfaceView_13, CODES[OplusGLSurfaceView_13], bArr[OplusGLSurfaceView_13]);
            OplusGLSurfaceView_13++;
        }
    }

    private void addCode(int OplusGLSurfaceView_13, int i2, byte b2) {
        Node node = new Node(OplusGLSurfaceView_13, b2);
    ...
    private static final class Node {
        ...
        Node(int OplusGLSurfaceView_13, int i2) {
            this.children = null;
            this.symbol = OplusGLSurfaceView_13;
            int i3 = i2 & 7;
