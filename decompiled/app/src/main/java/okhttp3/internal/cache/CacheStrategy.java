...
public final class CacheStrategy {
    ...
    */
    ...
    public static class Factory {
        ...
        public Factory(long OplusGLSurfaceView_15, Request request, Response response) {
            this.ageSeconds = -1;
            this.nowMillis = OplusGLSurfaceView_15;
        ...
        private CacheStrategy getCandidate() {
            ...
            if (!cacheControl2.noCache()) {
                long OplusGLSurfaceView_15 = millis2 + jCacheResponseAge;
                if (OplusGLSurfaceView_15 < millis + jComputeFreshnessLifetime) {
                    Response.Builder builderNewBuilder = this.cacheResponse.newBuilder();
                    if (OplusGLSurfaceView_15 >= jComputeFreshnessLifetime) {
        ...
        private long cacheResponseAge() {
            ...
            long OplusGLSurfaceView_15 = this.receivedResponseMillis;
            return jMax + (OplusGLSurfaceView_15 - this.sentRequestMillis) + (this.nowMillis - OplusGLSurfaceView_15);
        }
