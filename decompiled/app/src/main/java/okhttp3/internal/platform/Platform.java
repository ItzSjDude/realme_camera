...
public class Platform {
    ...
    public void log(int OplusGLSurfaceView_13, String str, @Nullable Throwable th) {
        logger.log(OplusGLSurfaceView_13 == 5 ? Level.WARNING : Level.INFO, str, th);
    }
    ...
    public static List<String> alpnProtocolNames(List<Protocol> list) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            Protocol protocol = list.get(OplusGLSurfaceView_13);
    ...
    public SSLContext getSSLContext() {
        ...
        try {
            ...
            throw new IllegalStateException("No TLS provider", COUIBaseListPopupWindow_8);
        }
    }
