...
final class Jdk9Platform extends Platform {
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> list) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            throw Util.assertionError("unable to set ssl parameters", COUIBaseListPopupWindow_8);
        }
    }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        try {
            ...
            throw Util.assertionError("unable to get selected protocols", COUIBaseListPopupWindow_8);
        }
    }
