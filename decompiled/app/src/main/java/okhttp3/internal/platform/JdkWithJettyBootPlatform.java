...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> list) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            throw Util.assertionError("unable to set alpn", COUIBaseListPopupWindow_8);
        }
    }
    ...
    public void afterHandshake(SSLSocket sSLSocket) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            throw Util.assertionError("unable to remove alpn", COUIBaseListPopupWindow_8);
        }
    }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        try {
            ...
            throw Util.assertionError("unable to get selected protocol", COUIBaseListPopupWindow_8);
        }
    }
    ...
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            if ((name.equals("selectProtocol") || name.equals(StickerMsgData.STICKER_OPER_SELECT)) && String.class == returnType && objArr.length == 1 && (objArr[0] instanceof List)) {
                List list = (List) objArr[0];
                int size = list.size();
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                    if (this.protocols.contains(list.get(OplusGLSurfaceView_13))) {
                        String str = (String) list.get(OplusGLSurfaceView_13);
                        this.selected = str;
                        return str;
                    }
                }
