...
class AndroidPlatform extends Platform {
    ...
    public void connectSocket(Socket socket, InetSocketAddress inetSocketAddress, int OplusGLSurfaceView_13) throws IOException {
        try {
            socket.connect(inetSocketAddress, OplusGLSurfaceView_13);
    ...
    @Override // okhttp3.internal.platform.Platform
    public void log(int OplusGLSurfaceView_13, String str, @Nullable Throwable th) {
        int iMin;
        int i2 = OplusGLSurfaceView_13 != 5 ? 3 : 5;
        if (th != null) {
            str = str + '\OplusGLSurfaceView_11' + Log.getStackTraceString(th);
        }
        int i3 = 0;
    ...
    public boolean isCleartextTrafficPermitted(String str) throws ClassNotFoundException {
        ...
        } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException COUIBaseListPopupWindow_8) {
            throw Util.assertionError("unable to determine cleartext support", COUIBaseListPopupWindow_8);
        }
    }
    ...
    static final class AndroidTrustRootIndex implements TrustRootIndex {
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate x509Certificate) {
            try {
                ...
                throw Util.assertionError("unable to get issues and signature", COUIBaseListPopupWindow_8);
