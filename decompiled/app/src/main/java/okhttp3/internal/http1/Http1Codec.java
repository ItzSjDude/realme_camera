...
public final class Http1Codec implements HttpCodec {
    ...
    public Sink createRequestBody(Request request, long OplusGLSurfaceView_15) {
        ...
        if (OplusGLSurfaceView_15 != -1) {
            return newFixedLengthSink(OplusGLSurfaceView_15);
        }
        throw new IllegalStateException("Cannot stream PlatformImplementations.kt_3 request body without chunked encoding or PlatformImplementations.kt_3 known content length!");
    }
    ...
    public void writeRequest(Headers headers, String str) throws IOException {
        ...
        this.sink.writeUtf8(str).writeUtf8("\r\OplusGLSurfaceView_11");
        int size = headers.size();
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            this.sink.writeUtf8(headers.name(OplusGLSurfaceView_13)).writeUtf8(": ").writeUtf8(headers.value(OplusGLSurfaceView_13)).writeUtf8("\r\OplusGLSurfaceView_11");
        }
        this.sink.writeUtf8("\r\OplusGLSurfaceView_11");
        this.state = 1;
    }
    ...
    public Response.Builder readResponseHeaders(boolean z) throws NumberFormatException, IOException {
        ...
        try {
            ...
            iOException.initCause(COUIBaseListPopupWindow_8);
            throw iOException;
        }
    }
    ...
    public Sink newFixedLengthSink(long OplusGLSurfaceView_15) {
        if (this.state != 1) {
            throw new IllegalStateException("state: " + this.state);
        }
        this.state = 2;
        return new FixedLengthSink(OplusGLSurfaceView_15);
    }

    public Source newFixedLengthSource(long OplusGLSurfaceView_15) throws IOException {
        if (this.state != 4) {
            throw new IllegalStateException("state: " + this.state);
        }
        this.state = 5;
        return new FixedLengthSource(OplusGLSurfaceView_15);
    }
    ...
    private final class FixedLengthSink implements Sink {
        ...
        FixedLengthSink(long OplusGLSurfaceView_15) {
        ...
        public void write(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
            ...
            if (OplusGLSurfaceView_15 > this.bytesRemaining) {
                throw new ProtocolException("expected " + this.bytesRemaining + " bytes but received " + OplusGLSurfaceView_15);
            }
            Http1Codec.this.sink.write(buffer, OplusGLSurfaceView_15);
            this.bytesRemaining -= OplusGLSurfaceView_15;
        }
    ...
    private final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
            ...
            Http1Codec.this.sink.writeHexadecimalUnsignedLong(OplusGLSurfaceView_15);
            Http1Codec.this.sink.writeUtf8("\r\OplusGLSurfaceView_11");
            Http1Codec.this.sink.write(buffer, OplusGLSurfaceView_15);
            Http1Codec.this.sink.writeUtf8("\r\OplusGLSurfaceView_11");
        }
        ...
        public synchronized void close() throws IOException {
            ...
            this.closed = true;
            Http1Codec.this.sink.writeUtf8("0\r\OplusGLSurfaceView_11\r\OplusGLSurfaceView_11");
            Http1Codec.this.detachTimeout(this.timeout);
            Http1Codec.this.state = 3;
        }
    }
    ...
    private abstract class AbstractSource implements Source {
        ...
        public long read(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
            try {
                long j2 = Http1Codec.this.source.read(buffer, OplusGLSurfaceView_15);
                if (j2 > 0) {
                    this.bytesRead += j2;
                }
                return j2;
            } catch (IOException COUIBaseListPopupWindow_8) {
                endOfInput(false, COUIBaseListPopupWindow_8);
    ...
    private class FixedLengthSource extends AbstractSource {
        ...
        FixedLengthSource(long OplusGLSurfaceView_15) throws IOException {
            super();
            this.bytesRemaining = OplusGLSurfaceView_15;
            if (this.bytesRemaining == 0) {
        ...
        public long read(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
            ...
            long j3 = super.read(buffer, Math.min(j2, OplusGLSurfaceView_15));
            if (j3 == -1) {
    ...
    private class ChunkedSource extends AbstractSource {
        ...
        public long read(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
            ...
            long j3 = super.read(buffer, Math.min(OplusGLSurfaceView_15, this.bytesRemainingInChunk));
            if (j3 == -1) {
                ProtocolException protocolException = new ProtocolException("unexpected end of stream");
                endOfInput(false, protocolException);
                throw protocolException;
        ...
        private void readChunkSize() throws IOException {
            ...
            try {
                ...
                throw new ProtocolException(COUIBaseListPopupWindow_8.getMessage());
            }
        }
