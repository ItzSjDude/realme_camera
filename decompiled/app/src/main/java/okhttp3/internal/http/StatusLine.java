...
public final class StatusLine {
    ...
    public StatusLine(Protocol protocol, int OplusGLSurfaceView_13, String str) {
    ...
    public static StatusLine parse(String str) throws NumberFormatException, IOException {
        ...
        try {
            int i3 = Integer.parseInt(str.substring(OplusGLSurfaceView_13, i2));
            if (str.length() <= i2) {
                strSubstring = "";
            } else {
                if (str.charAt(i2) != ' ') {
                ...
                strSubstring = str.substring(OplusGLSurfaceView_13 + 4);
            }
