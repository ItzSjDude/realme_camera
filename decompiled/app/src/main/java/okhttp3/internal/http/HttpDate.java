    ...
    public static Date parse(String str) {
        ...
        synchronized (BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
                DateFormat simpleDateFormat = BROWSER_COMPATIBLE_DATE_FORMATS[OplusGLSurfaceView_13];
                if (simpleDateFormat == null) {
                    simpleDateFormat = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[OplusGLSurfaceView_13], Locale.US);
                    simpleDateFormat.setTimeZone(Util.UTC);
                    BROWSER_COMPATIBLE_DATE_FORMATS[OplusGLSurfaceView_13] = simpleDateFormat;
                }
