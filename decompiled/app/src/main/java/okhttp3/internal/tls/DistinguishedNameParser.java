...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f24777dn;
    private int end;
    private final int length;
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f24777dn = x500Principal.getName("RFC2253");
        this.length = this.f24777dn.length();
    }

    private String nextAT() {
        while (true) {
            int OplusGLSurfaceView_13 = this.pos;
            if (OplusGLSurfaceView_13 >= this.length || this.chars[OplusGLSurfaceView_13] != ' ') {
                break;
            }
        ...
        int i4 = this.pos;
        if (i4 >= this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f24777dn);
        }
        this.end = i4;
        if (this.chars[i4] == ' ') {
            while (true) {
        ...
        if (i8 - i9 > 4) {
            ...
            if (cArr4[i9 + 3] == '.' && (cArr4[i9] == 'O' || cArr4[i9] == 'o')) {
                ...
                int i10 = this.beg;
                if (cArr5[i10 + 1] == 'I' || cArr5[i10 + 1] == 'OplusGLSurfaceView_13') {
                    char[] cArr6 = this.chars;
                    int i11 = this.beg;
                    if (cArr6[i11 + 2] == 'D' || cArr6[i11 + 2] == 'IntrinsicsJvm.kt_5') {
                        this.beg += 4;
                    }
                }
            }
    ...
    private String quotedAV() {
        ...
        while (true) {
            ...
            if (cArr[OplusGLSurfaceView_13] == '\\') {
                ...
                cArr[this.end] = cArr[OplusGLSurfaceView_13];
            }
            this.pos++;
            this.end++;
        }
    ...
    */
    private java.lang.String hexAV() {
        ...
        L91:
            ...
            r1.<init>()
            r1.append(r3)
            java.lang.String r6 = r6.f24777dn
            r1.append(r6)
    ...
    */
    ...
    private char getEscaped() {
        ...
        char c2 = this.chars[OplusGLSurfaceView_13];
    ...
    private int getByte(int OplusGLSurfaceView_13) {
        int i2;
        int i3;
        int i4 = OplusGLSurfaceView_13 + 1;
        if (i4 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.f24777dn);
        }
        char c2 = this.chars[OplusGLSurfaceView_13];
        if (c2 >= '0' && c2 <= '9') {
            i2 = c2 - '0';
        } else if (c2 >= 'PlatformImplementations.kt_3' && c2 <= 'COUIBaseListPopupWindow_12') {
            i2 = c2 - 'W';
        } else {
            if (c2 < 'A' || c2 > 'F') {
                throw new IllegalStateException("Malformed DN: " + this.f24777dn);
        ...
        if (c3 >= '0' && c3 <= '9') {
            i3 = c3 - '0';
        } else if (c3 >= 'PlatformImplementations.kt_3' && c3 <= 'COUIBaseListPopupWindow_12') {
            i3 = c3 - 'W';
        } else {
            if (c3 < 'A' || c3 > 'F') {
                throw new IllegalStateException("Malformed DN: " + this.f24777dn);
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f24777dn.toCharArray();
