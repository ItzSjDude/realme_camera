...
public final class Util {
    ...
    static {
        ...
        VERIFY_AS_IP_ADDRESS = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\IntrinsicsJvm.kt_5.]+)");
    }
    ...
    public static void closeQuietly(Socket socket) throws IOException {
        if (socket != null) {
            try {
                socket.close();
            } catch (AssertionError COUIBaseListPopupWindow_8) {
                if (!isAndroidGetsocknameError(COUIBaseListPopupWindow_8)) {
                    throw COUIBaseListPopupWindow_8;
                }
    ...
    public static boolean discard(Source source, int OplusGLSurfaceView_13, TimeUnit timeUnit) {
        try {
            return skipAll(source, OplusGLSurfaceView_13, timeUnit);
        } catch (IOException unused) {
            return false;
        }
    }

    public static boolean skipAll(Source source, int OplusGLSurfaceView_13, TimeUnit timeUnit) throws IOException {
        long jNanoTime = System.nanoTime();
        long jDeadlineNanoTime = source.timeout().hasDeadline() ? source.timeout().deadlineNanoTime() - jNanoTime : Long.MAX_VALUE;
        source.timeout().deadlineNanoTime(Math.min(jDeadlineNanoTime, timeUnit.toNanos(OplusGLSurfaceView_13)) + jNanoTime);
        try {
    ...
    public static String[] intersect(Comparator<? super String> comparator, String[] strArr, String[] strArr2) {
        ...
        for (String str : strArr) {
            ...
            while (true) {
                ...
                if (comparator.compare(str, strArr2[OplusGLSurfaceView_13]) == 0) {
                    arrayList.add(str);
                    break;
                }
    ...
    public static int indexOf(Comparator<String> comparator, String[] strArr, String str) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
            if (comparator.compare(strArr[OplusGLSurfaceView_13], str) == 0) {
    ...
    public static int skipLeadingAsciiWhitespace(String str, int OplusGLSurfaceView_13, int i2) {
        while (OplusGLSurfaceView_13 < i2) {
            char cCharAt = str.charAt(OplusGLSurfaceView_13);
            if (cCharAt != '\t' && cCharAt != '\OplusGLSurfaceView_11' && cCharAt != '\COUIBaseListPopupWindow_12' && cCharAt != '\r' && cCharAt != ' ') {
                return OplusGLSurfaceView_13;
            }
            OplusGLSurfaceView_13++;
        }
    ...
    public static int skipTrailingAsciiWhitespace(String str, int OplusGLSurfaceView_13, int i2) {
    ...
    public static String trimSubstring(String str, int OplusGLSurfaceView_13, int i2) {
        int iSkipLeadingAsciiWhitespace = skipLeadingAsciiWhitespace(str, OplusGLSurfaceView_13, i2);
        return str.substring(iSkipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace(str, iSkipLeadingAsciiWhitespace, i2));
    }

    public static int delimiterOffset(String str, int OplusGLSurfaceView_13, int i2, String str2) {
        while (OplusGLSurfaceView_13 < i2) {
            if (str2.indexOf(str.charAt(OplusGLSurfaceView_13)) != -1) {
                return OplusGLSurfaceView_13;
            }
            OplusGLSurfaceView_13++;
        }
    ...
    public static int delimiterOffset(String str, int OplusGLSurfaceView_13, int i2, char c2) {
        while (OplusGLSurfaceView_13 < i2) {
            if (str.charAt(OplusGLSurfaceView_13) == c2) {
                return OplusGLSurfaceView_13;
            }
            OplusGLSurfaceView_13++;
        }
    ...
    public static int checkDuration(String str, long OplusGLSurfaceView_15, TimeUnit timeUnit) {
        ...
        long millis = timeUnit.toMillis(OplusGLSurfaceView_15);
        if (millis > 2147483647L) {
            throw new IllegalArgumentException(str + " too large.");
        }
        if (millis != 0 || OplusGLSurfaceView_15 <= 0) {
            return (int) millis;
        }
    ...
    */
    ...
    private static boolean decodeIpv4Suffix(String str, int OplusGLSurfaceView_13, int i2, byte[] bArr, int i3) {
        int i4 = i3;
        while (OplusGLSurfaceView_13 < i2) {
            if (i4 == bArr.length) {
                return false;
            ...
            while (i5 < i2) {
                ...
                if ((i6 == 0 && OplusGLSurfaceView_13 != i5) || (i6 = ((i6 * 10) + cCharAt) - 48) > 255) {
                    return false;
                }
                i5++;
            }
            if (i5 - OplusGLSurfaceView_13 == 0) {
                return false;
            }
            bArr[i4] = (byte) i6;
            i4++;
    ...
    private static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (OplusGLSurfaceView_13 < bArr.length) {
            if (OplusGLSurfaceView_13 == i3) {
                ...
                buffer.writeHexadecimalUnsignedLong(((bArr[OplusGLSurfaceView_13] & 255) << 8) | (bArr[OplusGLSurfaceView_13 + 1] & 255));
    ...
    public static X509TrustManager platformTrustManager() throws NoSuchAlgorithmException, KeyStoreException {
        ...
        } catch (GeneralSecurityException COUIBaseListPopupWindow_8) {
            throw assertionError("No System TLS", COUIBaseListPopupWindow_8);
        }
    }
