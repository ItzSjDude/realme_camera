...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long OplusGLSurfaceView_15) {
        ...
        this.random = random;
        this.pingIntervalMillis = OplusGLSurfaceView_15;
        byte[] bArr = new byte[16];
        random.nextBytes(bArr);
        this.key = ByteString.m26009of(bArr).base64();
            ...
            public void run() throws IOException {
                do {
                    try {
                        ...
                        RealWebSocket.this.failWebSocket(COUIBaseListPopupWindow_8, null);
                        return;
                    }
    ...
    boolean processNextFrame() throws IOException {
        try {
            ...
            this.failWebSocket(COUIBaseListPopupWindow_8, null);
            return false;
        }
    }

    void awaitTermination(int OplusGLSurfaceView_13, TimeUnit timeUnit) throws InterruptedException {
        this.executor.awaitTermination(OplusGLSurfaceView_13, timeUnit);
    }
    ...
    @Override // okhttp3.internal.ws.WebSocketReader.FrameCallback
    public void onReadClose(int OplusGLSurfaceView_13, String str) throws IOException {
        Streams streams;
        ...
        synchronized (this) {
            ...
            this.receivedCloseCode = OplusGLSurfaceView_13;
        ...
        try {
            this.listener.onClosing(this, OplusGLSurfaceView_13, str);
            if (streams != null) {
                this.listener.onClosed(this, OplusGLSurfaceView_13, str);
            }
        } finally {
    ...
    private synchronized boolean send(ByteString byteString, int OplusGLSurfaceView_13) {
        if (!this.failed && !this.enqueuedClose) {
            if (this.queueSize + byteString.size() > 16777216) {
                close(CommonStatusCodes.AUTHENTICATE_SUCCESS, null);
                return false;
            }
            this.queueSize += byteString.size();
            this.messageAndCloseQueue.add(new Message(OplusGLSurfaceView_13, byteString));
            runWriter();
            return true;
        }
        return false;
    ...
    @Override // okhttp3.WebSocket
    public boolean close(int OplusGLSurfaceView_13, String str) {
        return close(OplusGLSurfaceView_13, str, 60000L);
    }

    synchronized boolean close(int OplusGLSurfaceView_13, String str, long OplusGLSurfaceView_15) {
        ...
        if (!this.failed && !this.enqueuedClose) {
            ...
            this.messageAndCloseQueue.add(new Close(OplusGLSurfaceView_13, byteStringEncodeUtf8, OplusGLSurfaceView_15));
            runWriter();
            return true;
        }
        return false;
        ...
        synchronized (this) {
            ...
            if (byteStringPoll == null) {
                ...
                if (objPoll instanceof Close) {
                    OplusGLSurfaceView_13 = this.receivedCloseCode;
    ...
    void writePingFrame() throws IOException {
        synchronized (this) {
            ...
            WebSocketWriter webSocketWriter = this.writer;
            int OplusGLSurfaceView_13 = this.awaitingPong ? this.sentPingCount : -1;
            this.sentPingCount++;
            this.awaitingPong = true;
            if (OplusGLSurfaceView_13 != -1) {
                failWebSocket(new SocketTimeoutException("sent ping but didn't receive pong within " + this.pingIntervalMillis + "ms (after " + (OplusGLSurfaceView_13 - 1) + " successful ping/pongs)"), null);
                return;
            }
            try {
                webSocketWriter.writePing(ByteString.EMPTY);
            } catch (IOException COUIBaseListPopupWindow_8) {
                failWebSocket(COUIBaseListPopupWindow_8, null);
            }
        }
    }
    ...
    static final class Message {
        ...
        Message(int OplusGLSurfaceView_13, ByteString byteString) {
            this.formatOpcode = OplusGLSurfaceView_13;
    ...
    static final class Close {
        ...
        Close(int OplusGLSurfaceView_13, ByteString byteString, long OplusGLSurfaceView_15) {
            this.code = OplusGLSurfaceView_13;
            this.reason = byteString;
            this.cancelAfterCloseMillis = OplusGLSurfaceView_15;
        }
    }
