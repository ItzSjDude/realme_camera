...
public abstract class RequestBody {
    ...
    public static RequestBody create(@Nullable final MediaType mediaType, final byte[] bArr, final int OplusGLSurfaceView_13, final int i2) {
        if (bArr == null) {
        ...
        return new RequestBody() { // from class: okhttp3.RequestBody.2
            ...
            @Override // okhttp3.RequestBody
            public void writeTo(BufferedSink bufferedSink) throws IOException {
                bufferedSink.write(bArr, OplusGLSurfaceView_13, i2);
            }
        };
    }
