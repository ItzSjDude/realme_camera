...
public final class Cache implements Closeable, Flushable {
    ...
    public Cache(File file, long OplusGLSurfaceView_15) {
        this(file, OplusGLSurfaceView_15, FileSystem.SYSTEM);
    }

    Cache(File file, long OplusGLSurfaceView_15, FileSystem fileSystem) {
        ...
        this.cache = DiskLruCache.create(fileSystem, file, VERSION, 2, OplusGLSurfaceView_15);
    }
    ...
    private static final class Entry {
        ...
        Entry(Source source) throws IOException {
            ...
            try {
                ...
                int OplusGLSurfaceView_13 = Cache.readInt(bufferedSourceBuffer);
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                bufferedSinkBuffer.writeUtf8(this.varyHeaders.name(OplusGLSurfaceView_13)).writeUtf8(": ").writeUtf8(this.varyHeaders.value(OplusGLSurfaceView_13)).writeByte(10);
            }
        ...
        private List<Certificate> readCertificateList(BufferedSource bufferedSource) throws IOException, CertificateException {
            int OplusGLSurfaceView_13 = Cache.readInt(bufferedSource);
            ...
            try {
                ...
                return arrayList;
            } catch (CertificateException COUIBaseListPopupWindow_8) {
                throw new IOException(COUIBaseListPopupWindow_8.getMessage());
            }
        }
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                    bufferedSink.writeUtf8(ByteString.m26009of(list.get(OplusGLSurfaceView_13).getEncoded()).base64()).writeByte(10);
                }
            } catch (CertificateEncodingException COUIBaseListPopupWindow_8) {
                throw new IOException(COUIBaseListPopupWindow_8.getMessage());
            }
        }
