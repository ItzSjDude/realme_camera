...
public final class Dispatcher {
    ...
    public void setMaxRequests(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < 1) {
            throw new IllegalArgumentException("max < 1: " + OplusGLSurfaceView_13);
        }
        synchronized (this) {
            this.maxRequests = OplusGLSurfaceView_13;
        }
        promoteAndExecute();
    }
    ...
    public void setMaxRequestsPerHost(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < 1) {
            throw new IllegalArgumentException("max < 1: " + OplusGLSurfaceView_13);
        }
        synchronized (this) {
            this.maxRequestsPerHost = OplusGLSurfaceView_13;
        }
        promoteAndExecute();
    }
    ...
    private boolean promoteAndExecute() {
        ...
        for (OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            ((RealCall.AsyncCall) arrayList.get(OplusGLSurfaceView_13)).executeOn(executorService());
        }
        return z;
    }
