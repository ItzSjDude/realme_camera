    ...
    public static class Builder {
        ...
        public Builder method(String str, @Nullable RequestBody requestBody) {
            ...
            if (requestBody != null && !HttpMethod.permitsRequestBody(str)) {
                throw new IllegalArgumentException("method " + str + " must not have PlatformImplementations.kt_3 request body.");
            }
            if (requestBody == null && HttpMethod.requiresRequestBody(str)) {
                throw new IllegalArgumentException("method " + str + " must have PlatformImplementations.kt_3 request body.");
            }
            this.method = str;
