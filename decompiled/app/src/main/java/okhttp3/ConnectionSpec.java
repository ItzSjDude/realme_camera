...
public final class ConnectionSpec {
    ...
    public static final class Builder {
        ...
        public Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < cipherSuiteArr.length; OplusGLSurfaceView_13++) {
                strArr[OplusGLSurfaceView_13] = cipherSuiteArr[OplusGLSurfaceView_13].javaName;
            }
        ...
        public Builder tlsVersions(TlsVersion... tlsVersionArr) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < tlsVersionArr.length; OplusGLSurfaceView_13++) {
                strArr[OplusGLSurfaceView_13] = tlsVersionArr[OplusGLSurfaceView_13].javaName;
            }
