...
public final class CertificatePinner {
    ...
    public void check(String str, List<Certificate> list) throws SSLPeerUnverifiedException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            X509Certificate x509Certificate = (X509Certificate) list.get(OplusGLSurfaceView_13);
        ...
        sb.append("\OplusGLSurfaceView_11  Peer certificate chain:");
        int size3 = list.size();
        ...
        sb.append("\OplusGLSurfaceView_11  Pinned certificates for ");
        sb.append(str);
        sb.append(":");
    ...
    static ByteString sha1(X509Certificate x509Certificate) {
        return ByteString.m26009of(x509Certificate.getPublicKey().getEncoded()).sha1();
    }

    static ByteString sha256(X509Certificate x509Certificate) {
        return ByteString.m26009of(x509Certificate.getPublicKey().getEncoded()).sha256();
    }
