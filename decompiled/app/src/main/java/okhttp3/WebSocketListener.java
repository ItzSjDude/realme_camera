...
public abstract class WebSocketListener {
    public void onClosed(okhttp3.WebSocket webSocket, int i_renamed, java.lang.String str) {
    }

    public void onClosing(okhttp3.WebSocket webSocket, int i_renamed, java.lang.String str) {
    }
