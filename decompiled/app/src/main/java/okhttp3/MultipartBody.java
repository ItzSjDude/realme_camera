...
public final class MultipartBody extends RequestBody {
    ...
    public Part part(int OplusGLSurfaceView_13) {
        return this.parts.get(OplusGLSurfaceView_13);
    }
    ...
    public long contentLength() throws IOException {
        long OplusGLSurfaceView_15 = this.contentLength;
    ...
    private long writeOrCountBytes(@Nullable BufferedSink bufferedSink, boolean z) throws IOException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            Part part = this.parts.get(OplusGLSurfaceView_13);
            ...
            bufferedSink.write(CRLF);
            if (z) {
                OplusGLSurfaceView_15 += jContentLength;
            } else {
        ...
        long size3 = OplusGLSurfaceView_15 + buffer.size();
        buffer.clear();
        return size3;
    }
    ...
    static StringBuilder appendQuotedString(StringBuilder sb, String str) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
            ...
            if (cCharAt == '\OplusGLSurfaceView_11') {
                sb.append("%0A");
            } else if (cCharAt == '\r') {
                sb.append("%0D");
            } else if (cCharAt == '\"') {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            ...
            return create(Headers.m26006of("Content-Disposition", sb.toString()), requestBody);
        }
