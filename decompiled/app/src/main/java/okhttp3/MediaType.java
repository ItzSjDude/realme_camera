...
public final class MediaType {
    ...
    private static final String TOKEN = "([PlatformImplementations.kt_3-zA-Z0-9-!#$%&'*+.^_`{|}~]+)";
    ...
    private static final Pattern TYPE_SUBTYPE = Pattern.compile("([PlatformImplementations.kt_3-zA-Z0-9-!#$%&'*+.^_`{|}~]+)/([PlatformImplementations.kt_3-zA-Z0-9-!#$%&'*+.^_`{|}~]+)");
    private static final Pattern PARAMETER = Pattern.compile(";\\s*(?:([PlatformImplementations.kt_3-zA-Z0-9-!#$%&'*+.^_`{|}~]+)=(?:([PlatformImplementations.kt_3-zA-Z0-9-!#$%&'*+.^_`{|}~]+)|\"([^\"]*)\"))?");
