...
public final class FormBody extends RequestBody {
    ...
    public String encodedName(int OplusGLSurfaceView_13) {
        return this.encodedNames.get(OplusGLSurfaceView_13);
    }

    public String name(int OplusGLSurfaceView_13) {
        return HttpUrl.percentDecode(encodedName(OplusGLSurfaceView_13), true);
    }

    public String encodedValue(int OplusGLSurfaceView_13) {
        return this.encodedValues.get(OplusGLSurfaceView_13);
    }

    public String value(int OplusGLSurfaceView_13) {
        return HttpUrl.percentDecode(encodedValue(OplusGLSurfaceView_13), true);
    }
    ...
    private long writeOrCountBytes(@Nullable BufferedSink bufferedSink, boolean z) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            ...
            buffer.writeUtf8(this.encodedNames.get(OplusGLSurfaceView_13));
            buffer.writeByte(61);
            buffer.writeUtf8(this.encodedValues.get(OplusGLSurfaceView_13));
        }
        if (!z) {
            return 0L;
        }
