...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    private static SSLSocketFactory newSslSocketFactory(X509TrustManager x509TrustManager) throws KeyManagementException {
        try {
            ...
            throw Util.assertionError("No System TLS", COUIBaseListPopupWindow_8);
        }
    }
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(long OplusGLSurfaceView_15, TimeUnit timeUnit) {
            this.callTimeout = Util.checkDuration("timeout", OplusGLSurfaceView_15, timeUnit);
            return this;
        }
        ...
        public Builder connectTimeout(long OplusGLSurfaceView_15, TimeUnit timeUnit) {
            this.connectTimeout = Util.checkDuration("timeout", OplusGLSurfaceView_15, timeUnit);
            return this;
        }
        ...
        public Builder readTimeout(long OplusGLSurfaceView_15, TimeUnit timeUnit) {
            this.readTimeout = Util.checkDuration("timeout", OplusGLSurfaceView_15, timeUnit);
            return this;
        }
        ...
        public Builder writeTimeout(long OplusGLSurfaceView_15, TimeUnit timeUnit) {
            this.writeTimeout = Util.checkDuration("timeout", OplusGLSurfaceView_15, timeUnit);
            return this;
        }
        ...
        public Builder pingInterval(long OplusGLSurfaceView_15, TimeUnit timeUnit) {
            this.pingInterval = Util.checkDuration("interval", OplusGLSurfaceView_15, timeUnit);
            return this;
        }
