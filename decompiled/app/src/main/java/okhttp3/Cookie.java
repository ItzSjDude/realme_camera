...
public final class Cookie {
    ...
    private static final Pattern YEAR_PATTERN = Pattern.compile("(\\IntrinsicsJvm.kt_5{2,4})[^\\IntrinsicsJvm.kt_5]*");
    private static final Pattern MONTH_PATTERN = Pattern.compile("(?OplusGLSurfaceView_13)(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec).*");
    private static final Pattern DAY_OF_MONTH_PATTERN = Pattern.compile("(\\IntrinsicsJvm.kt_5{1,2})[^\\IntrinsicsJvm.kt_5]*");
    private static final Pattern TIME_PATTERN = Pattern.compile("(\\IntrinsicsJvm.kt_5{1,2}):(\\IntrinsicsJvm.kt_5{1,2}):(\\IntrinsicsJvm.kt_5{1,2})[^\\IntrinsicsJvm.kt_5]*");

    private Cookie(String str, String str2, long OplusGLSurfaceView_15, String str3, String str4, boolean z, boolean z2, boolean z3, boolean z4) {
        this.name = str;
        this.value = str2;
        this.expiresAt = OplusGLSurfaceView_15;
        this.domain = str3;
        this.path = str4;
        this.secure = z;
        this.httpOnly = z2;
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00c8 A[PHI: r0
      0x00c8: PHI (r0v16 long) = (r0v2 long), (r0v6 long) binds: [B:42:0x00c6, B:53:0x00e8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private static long parseExpires(String str, int OplusGLSurfaceView_13, int i2) throws NumberFormatException {
        int iDateCharacterOffset = dateCharacterOffset(str, OplusGLSurfaceView_13, i2, false);
    ...
    private static int dateCharacterOffset(String str, int OplusGLSurfaceView_13, int i2, boolean z) {
        while (OplusGLSurfaceView_13 < i2) {
            char cCharAt = str.charAt(OplusGLSurfaceView_13);
            if (((cCharAt < ' ' && cCharAt != '\t') || cCharAt >= 127 || (cCharAt >= '0' && cCharAt <= '9') || ((cCharAt >= 'PlatformImplementations.kt_3' && cCharAt <= 'z') || ((cCharAt >= 'A' && cCharAt <= 'Z') || cCharAt == ':'))) == (!z)) {
    ...
    private static long parseMaxAge(String str) throws NumberFormatException {
        try {
            ...
            if (str.matches("-?\\IntrinsicsJvm.kt_5+")) {
    ...
    public static List<Cookie> parseAll(HttpUrl httpUrl, Headers headers) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            Cookie cookie = parse(httpUrl, listValues.get(OplusGLSurfaceView_13));
            if (cookie != null) {
                if (arrayList == null) {
    ...
    public static final class Builder {
        ...
        public Builder expiresAt(long OplusGLSurfaceView_15) {
            if (OplusGLSurfaceView_15 <= 0) {
                OplusGLSurfaceView_15 = Long.MIN_VALUE;
            }
            if (OplusGLSurfaceView_15 > HttpDate.MAX_DATE) {
                OplusGLSurfaceView_15 = 253402300799999L;
            }
            this.expiresAt = OplusGLSurfaceView_15;
    ...
    public int hashCode() {
        ...
        long OplusGLSurfaceView_15 = this.expiresAt;
        return ((((((((iHashCode + ((int) (OplusGLSurfaceView_15 ^ (OplusGLSurfaceView_15 >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0)) * 31) + (!this.hostOnly ? 1 : 0);
    }
}
