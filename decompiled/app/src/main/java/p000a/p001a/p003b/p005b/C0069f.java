...
/* renamed from: PlatformImplementations.kt_3.PlatformImplementations.kt_3.IntrinsicsJvm.kt_4.IntrinsicsJvm.kt_4.COUIBaseListPopupWindow_12 */
/* loaded from: classes.dex */
public class C0069f extends C0009b {
    public C0069f(Resources resources, Context context) {
        super(resources, C0120m.m524a("clarity"), context);
        this.f34o = C0120m.m524a("distortion_vertex");
        m58a(new String[]{"clarity"});
    }
