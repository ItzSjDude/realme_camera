...
/* renamed from: PlatformImplementations.kt_3.PlatformImplementations.kt_3.IntrinsicsJvm.kt_4.IntrinsicsJvm.kt_4.IntrinsicsJvm.kt_3 */
/* loaded from: classes.dex */
public class C0065c extends C0009b {
    public C0065c(Resources resources, Context context) {
        super(resources, C0120m.m524a("dehaze"), context);
        this.f34o = C0120m.m524a("distortion_vertex");
        m58a(new String[]{"dehaze"});
    }
    ...
    public void mo23j() {
        super.mo23j();
        int iGlGetUniformLocation = GLES20.glGetUniformLocation(this.f22b, "dehazeMap");
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, this.f21a.dehazeTexture.f387a);
        GLES20.glUniform1i(iGlGetUniformLocation, 1);
        GLES20.glUniform3fv(GLES20.glGetUniformLocation(this.f22b, "average"), 1, this.f21a.thresholdAverage, 0);
