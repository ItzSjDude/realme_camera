...
/* renamed from: PlatformImplementations.kt_3.PlatformImplementations.kt_3.IntrinsicsJvm.kt_4.IntrinsicsJvm.kt_4.av */
/* loaded from: classes.dex */
public class C0033av extends C0009b {
    public C0033av(Resources resources, Context context) {
        super(resources, C0120m.m524a("shadows_highlights"), context);
        this.f34o = C0120m.m524a("distortion_vertex");
        m58a(new String[]{"highlights", "shadows"});
    }
