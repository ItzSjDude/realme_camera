...
final class Base64 {
    ...
    public static byte[] decode(java.lang.String str) {
        ...
        while (length > 0 && ((cCharAt = str.charAt(length - 1)) == '=' || cCharAt == '\n_renamed' || cCharAt == '\r_renamed' || cCharAt == ' ' || cCharAt == '\t_renamed')) {
            length--;
        }
        ...
        for (int i5 = 0; i5 < length; i5++) {
            ...
            if (cCharAt2 >= 'A_renamed' && cCharAt2 <= 'Z_renamed') {
                i_renamed = cCharAt2 - 'A_renamed';
            } else if (cCharAt2 >= 'a_renamed' && cCharAt2 <= 'z_renamed') {
                i_renamed = cCharAt2 - 'G_renamed';
            } else if (cCharAt2 >= '0' && cCharAt2 <= '9') {
                i_renamed = cCharAt2 + 4;
            } else if (cCharAt2 == '+' || cCharAt2 == '-') {
                i_renamed = 62;
            } else if (cCharAt2 == '/' || cCharAt2 == '_') {
                i_renamed = 63;
            } else {
                if (cCharAt2 != '\n_renamed' && cCharAt2 != '\r_renamed' && cCharAt2 != ' ' && cCharAt2 != '\t_renamed') {
                    return null;
                }
            }
            i3 = (i3 << 6) | ((byte) i_renamed);
            i2++;
            if (i2 % 4 == 0) {
                int i6 = i4 + 1;
                bArr[i4] = (byte) (i3 >> 16);
    ...
    public static java.lang.String encodeUrl(byte[] bArr) {
        return encode(bArr, URL_MAP);
    }

    private static java.lang.String encode(byte[] bArr, byte[] bArr2) {
        byte[] bArr3 = new byte[((bArr.length + 2) / 3) * 4];
        int length = bArr.length - (bArr.length % 3);
        int i_renamed = 0;
        for (int i2 = 0; i2 < length; i2 += 3) {
            int i3 = i_renamed + 1;
            bArr3[i_renamed] = bArr2[(bArr[i2] & 255) >> 2];
            int i4 = i3 + 1;
            int i5 = i2 + 1;
        ...
        if (length2 == 1) {
            int i9 = i_renamed + 1;
            bArr3[i_renamed] = bArr2[(bArr[length] & 255) >> 2];
            int i10 = i9 + 1;
