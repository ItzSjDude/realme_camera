...
public final class Pipe {
    ...
    public Pipe(long OplusGLSurfaceView_15) {
        if (OplusGLSurfaceView_15 < 1) {
            throw new IllegalArgumentException("maxBufferSize < 1: " + OplusGLSurfaceView_15);
        }
        this.maxBufferSize = OplusGLSurfaceView_15;
    }
    ...
    final class PipeSink implements Sink {
        ...
        public void write(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
                ...
                if (!Pipe.this.sinkClosed) {
                    while (true) {
                        ...
                        if (size == 0) {
                            ...
                            long jMin = Math.min(size, OplusGLSurfaceView_15);
            ...
            if (sink != null) {
                ...
                try {
                    sink.write(buffer, OplusGLSurfaceView_15);
                } finally {
                    this.timeout.pop();
                }
            }
    ...
    final class PipeSource implements Source {
        ...
        public long read(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
            synchronized (Pipe.this.buffer) {
                ...
                long j2 = Pipe.this.buffer.read(buffer, OplusGLSurfaceView_15);
                Pipe.this.buffer.notifyAll();
                return j2;
            }
        }
