...
public final class GzipSink implements Sink {
    ...
    public void write(Buffer buffer, long OplusGLSurfaceView_15) throws IOException {
        ...
        updateCrc(buffer, OplusGLSurfaceView_15);
        this.deflaterSink.write(buffer, OplusGLSurfaceView_15);
    }
    ...
    private void updateCrc(Buffer buffer, long OplusGLSurfaceView_15) {
