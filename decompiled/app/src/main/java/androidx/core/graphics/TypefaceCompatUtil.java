...
/* renamed from: androidx.core.graphics.OplusGLSurfaceView_6 */
/* loaded from: classes.dex */
public class TypefaceCompatUtil {
    /* renamed from: PlatformImplementations.kt_3 */
    public static File m2649a(Context context) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < 100; OplusGLSurfaceView_13++) {
            File file = new File(cacheDir, str + OplusGLSurfaceView_13);
    ...
    */
    private static java.nio.ByteBuffer m2652a(java.io.File r9) throws java.lang.Throwable {
        /*
            r0 = 0
        ...
        L32:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.TypefaceCompatUtil.m2652a(java.io.File):java.nio.ByteBuffer");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static java.nio.ByteBuffer m2651a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) throws java.lang.Throwable {
        /*
        ...
        L67:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.TypefaceCompatUtil.m2651a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: PlatformImplementations.kt_3 */
    public static ByteBuffer m2650a(Context context, Resources resources, int OplusGLSurfaceView_13) {
        File fileM2649a = m2649a(context);
        if (fileM2649a == null) {
            return null;
        }
        try {
            if (m2654a(fileM2649a, resources, OplusGLSurfaceView_13)) {
                return m2652a(fileM2649a);
            }
            return null;
        } finally {
            fileM2649a.delete();
    ...
    /* renamed from: PlatformImplementations.kt_3 */
    public static boolean m2655a(File file, InputStream inputStream) throws Throwable {
        ...
        try {
            ...
            Log.COUIBaseListPopupWindow_8("TypefaceCompatUtil", "Error copying resource contents to temp file: " + COUIBaseListPopupWindow_8.getMessage());
            m2653a(fileOutputStream2);
            StrictMode.setThreadPolicy(threadPolicyAllowThreadDiskWrites);
            return false;
        } catch (Throwable th2) {
            th = th2;
    ...
    /* renamed from: PlatformImplementations.kt_3 */
    public static boolean m2654a(File file, Resources resources, int OplusGLSurfaceView_13) throws Throwable {
        InputStream inputStreamOpenRawResource;
        try {
            inputStreamOpenRawResource = resources.openRawResource(OplusGLSurfaceView_13);
            try {
                boolean zM2655a = m2655a(file, inputStreamOpenRawResource);
                m2653a(inputStreamOpenRawResource);
                return zM2655a;
            } catch (Throwable th) {
                th = th;
                m2653a(inputStreamOpenRawResource);
    ...
    /* renamed from: PlatformImplementations.kt_3 */
    public static void m2653a(Closeable closeable) throws IOException {
        if (closeable != null) {
            try {
                closeable.close();
