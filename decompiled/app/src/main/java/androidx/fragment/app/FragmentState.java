...
final class FragmentState implements Parcelable {
    public static final Parcelable.Creator<FragmentState> CREATOR = new Parcelable.Creator<FragmentState>() { // from class: androidx.fragment.app.FragmentState.1
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: PlatformImplementations.kt_3, reason: merged with bridge method [inline-methods] */
        public FragmentState[] newArray(int OplusGLSurfaceView_13) {
            return new FragmentState[OplusGLSurfaceView_13];
        }
    };
    ...
    public Fragment instantiate(ClassLoader classLoader, FragmentFactory c0584f) {
        if (this.mInstance == null) {
            Bundle bundle = this.mArguments;
            if (bundle != null) {
                bundle.setClassLoader(classLoader);
            }
            this.mInstance = c0584f.mo3384c(classLoader, this.mClassName);
            ...
            fragment.mMaxState = Lifecycle.IntrinsicsJvm.kt_4.values()[this.mMaxLifecycleState];
