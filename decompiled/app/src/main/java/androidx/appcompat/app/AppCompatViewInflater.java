...
public class AppCompatViewInflater {
    ...
    final View createView(View view, String str, Context context, AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z4) {
            context2 = TintContextWrapper.m1536a(context2);
        }
        switch (str) {
            case "TextView":
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < sClassPrefixList.length; OplusGLSurfaceView_13++) {
                View viewCreateViewByPrefix = createViewByPrefix(context, str, sClassPrefixList[OplusGLSurfaceView_13]);
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (Build.VERSION.SDK_INT < 15 || ViewCompat.m2827E(view)) {
                TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, sOnClickAttrs);
                String string = typedArrayObtainStyledAttributes.getString(0);
                if (string != null) {
                    view.setOnClickListener(new ViewOnClickListenerC0202a(view, string));
                }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        if (z2 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.View_theme, 0)) != 0) {
            Log.OplusGLSurfaceView_13(LOG_TAG, "app:theme is now deprecated. Please move to using android:theme instead.");
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    /* renamed from: androidx.appcompat.app.AppCompatViewInflater$PlatformImplementations.kt_3 */
    private static class ViewOnClickListenerC0202a implements View.OnClickListener {
        ...
        private Method f1003c;

        /* renamed from: IntrinsicsJvm.kt_5 */
        private Context f1004d;

        public ViewOnClickListenerC0202a(View view, String str) {
            this.f1001a = view;
            this.f1002b = str;
        }
        ...
        public void onClick(View view) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (this.f1003c == null) {
                m874a(this.f1001a.getContext(), this.f1002b);
            }
            try {
                this.f1003c.invoke(this.f1004d, view);
            } catch (IllegalAccessException COUIBaseListPopupWindow_8) {
                throw new IllegalStateException("Could not execute non-public method for android:onClick", COUIBaseListPopupWindow_8);
        ...
        /* renamed from: PlatformImplementations.kt_3 */
        private void m874a(Context context, String str) {
            String str2;
            Method method;
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f1002b, View.class)) != null) {
                        this.f1003c = method;
                        this.f1004d = context;
                        return;
                    }
            ...
            int id_renamed = this.f1001a.getId();
            if (id_renamed == -1) {
                str2 = "";
            } else {
                str2 = " with id_renamed '" + this.f1001a.getContext().getResources().getResourceEntryName(id_renamed) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f1002b + "(View) in PlatformImplementations.kt_3 parent or ancestor Context for android:onClick attribute defined on view " + this.f1001a.getClass() + str2);
        }
    }
}
