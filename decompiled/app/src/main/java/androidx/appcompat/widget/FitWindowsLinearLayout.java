...
public class FitWindowsLinearLayout extends android.widget.LinearLayout implements androidx.appcompat.widget.ac_renamed {

    /* renamed from: a_renamed, reason: collision with root package name */
    private androidx.appcompat.widget.ac_renamed.a_renamed f480a;
    ...
    protected boolean fitSystemWindows(android.graphics.Rect rect) {
        androidx.appcompat.widget.ac_renamed.a_renamed aVar = this.f480a;
        if (aVar != null) {
            aVar.a_renamed(rect);
        }
