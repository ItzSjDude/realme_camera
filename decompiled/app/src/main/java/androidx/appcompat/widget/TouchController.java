...
public class l_renamed extends android.widget.ImageButton implements androidx.core.h_renamed.u_renamed, androidx.core.widget.l_renamed {
    ...
    public l_renamed(android.content.Context context, android.util.AttributeSet attributeSet, int i_renamed) {
    ...
    public void setImageResource(int i_renamed) {
        this.mImageHelper.a_renamed(i_renamed);
    }
