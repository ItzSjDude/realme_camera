...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() { // from class: androidx.customview.view.AbsSavedState.2
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: PlatformImplementations.kt_3, reason: merged with bridge method [inline-methods] */
        public AbsSavedState[] newArray(int OplusGLSurfaceView_13) {
            return new AbsSavedState[OplusGLSurfaceView_13];
        }
    };
    ...
    public void writeToParcel(Parcel parcel, int OplusGLSurfaceView_13) {
        parcel.writeParcelable(this.mSuperState, OplusGLSurfaceView_13);
    }
}
