...
public class d_renamed {
    public static android.view.animation.Interpolator a_renamed(android.content.Context context, int i_renamed) throws android.content.res.Resources.NotFoundException {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            return android.view.animation.AnimationUtils.loadInterpolator(context, i_renamed);
        }
        android.content.res.XmlResourceParser xmlResourceParser = null;
        try {
            try {
                if (i_renamed == 17563663) {
                    return new androidx.d_renamed.a_renamed.a_renamed.a_renamed();
                }
                if (i_renamed == 17563661) {
                    return new androidx.d_renamed.a_renamed.a_renamed.b_renamed();
                }
                if (i_renamed == 17563662) {
                    return new androidx.d_renamed.a_renamed.a_renamed.c_renamed();
                }
                android.content.res.XmlResourceParser animation = context.getResources().getAnimation(i_renamed);
                android.view.animation.Interpolator interpolatorA = a_renamed(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B_renamed:45:0x00ca, code lost:
    ...
    */
    private static android.view.animation.Interpolator a_renamed(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        La1:
            ...
            if (r0 == 0) goto Laf
            androidx.vectordrawable.a_renamed.a_renamed.g_renamed r0 = new androidx.vectordrawable.a_renamed.a_renamed.g_renamed
            r0.<init>(r2, r4, r5)
            goto L3c
        Laf:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.a_renamed.a_renamed.d_renamed.a_renamed(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
