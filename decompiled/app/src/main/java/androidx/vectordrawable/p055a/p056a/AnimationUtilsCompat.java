...
/* renamed from: androidx.vectordrawable.PlatformImplementations.kt_3.PlatformImplementations.kt_3.IntrinsicsJvm.kt_5 */
/* loaded from: classes.dex */
public class AnimationUtilsCompat {
    /* renamed from: PlatformImplementations.kt_3 */
    public static Interpolator m4840a(Context context, int OplusGLSurfaceView_13) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 21) {
            return AnimationUtils.loadInterpolator(context, OplusGLSurfaceView_13);
        }
        XmlResourceParser xmlResourceParser = null;
        try {
            try {
                if (OplusGLSurfaceView_13 == 17563663) {
                    return new FastOutLinearInInterpolator();
                }
                if (OplusGLSurfaceView_13 == 17563661) {
                    return new FastOutSlowInInterpolator();
                }
                if (OplusGLSurfaceView_13 == 17563662) {
                    return new LinearOutSlowInInterpolator();
                }
                XmlResourceParser animation = context.getResources().getAnimation(OplusGLSurfaceView_13);
                Interpolator interpolatorM4841a = m4841a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return interpolatorM4841a;
    ...
    */
    private static android.view.animation.Interpolator m4841a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        La1:
            ...
            if (r0 == 0) goto Laf
            androidx.vectordrawable.PlatformImplementations.kt_3.PlatformImplementations.kt_3.COUIBaseListPopupWindow_11 r0 = new androidx.vectordrawable.PlatformImplementations.kt_3.PlatformImplementations.kt_3.COUIBaseListPopupWindow_11
            r0.<init>(r2, r4, r5)
            goto L3c
        Laf:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.vectordrawable.p055a.p056a.AnimationUtilsCompat.m4841a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
