...
public final class AFConstants {
    ...
    public static final int ADAPTER_STATE_CONNECTERROR = -1;
    ...
    public static final java.lang.String EXTRA_AGENT_ID = "agentId";
    public static final java.lang.String EXTRA_AGENT_IMPL_CLASS = "agentImplclass";
    public static final java.lang.String EXTRA_CERTIFICATE_TYPE = "CERT_TYPE";
    public static final java.lang.String EXTRA_CHANNEL_ID = "channelId";
    public static final java.lang.String EXTRA_CLIENT_ID = "clientId";
    public static final java.lang.String EXTRA_CONNECT_PARAM_ACCOUNT_LIST = "connect_param_account_list";
    public static final java.lang.String EXTRA_CONNECT_PARAM_ACCOUNT_SIZE = "connect_param_account_size";
    public static final java.lang.String EXTRA_CONNECT_PARAM_DEVICE_ID = "connect_param_device_id";
    public static final java.lang.String EXTRA_CONNECT_PARAM_KSC = "connect_param_ksc";
    public static final java.lang.String EXTRA_CONNECT_PARAM_KSC_ALIAS = "connect_param_ksc_alias";
    public static final java.lang.String EXTRA_CONNNECTION_ID = "connectionId";
    public static final java.lang.String EXTRA_DEVICE_ID = "deviceId";
    public static final java.lang.String EXTRA_DEVICE_TYPE = "deviceType";
    public static final java.lang.String EXTRA_DORMANT_STATE = "extra_dormant_state";
    public static final java.lang.String EXTRA_ERROR_CODE = "errorcode";
    public static final java.lang.String EXTRA_INTENT_ACTION = "action";
    public static final java.lang.String EXTRA_KEY_MAX_FOOTER_LEN = "com.heytap.accessory.adapter.extra.FOOTER_LEN";
    public static final java.lang.String EXTRA_KEY_MAX_HEADER_LEN = "com.heytap.accessory.adapter.extra.HEADER_LEN";
    public static final java.lang.String EXTRA_KEY_MAX_MSG_HEADER_LEN = "com.heytap.accessory.adapter.extra.MSG_HEADER_LEN";
    public static final java.lang.String EXTRA_KEY_PROCESS_ID = "com.heytap.accessory.adapter.extra.PROCESS_ID";
    public static final java.lang.String EXTRA_LOCAL_DEVICE_ID = "extra_local_device_id";
    public static final java.lang.String EXTRA_LOCAL_DEVICE_TYPE = "extra_local_device_type";
    public static final java.lang.String EXTRA_PACKAGE_NAME = "packageName";
    public static final java.lang.String EXTRA_PARAMS = "params";
    public static final java.lang.String EXTRA_PEER_ACCESSORIES = "peerAccessories";
    public static final java.lang.String EXTRA_PEER_ACCESSORY = "peerAccessory";
    public static final java.lang.String EXTRA_PEER_AGENT = "peerAgent";
    public static final java.lang.String EXTRA_PEER_AGENTS = "peerAgents";
    public static final java.lang.String EXTRA_PEER_AGENT_STATUS = "peerAgentStatus";
    public static final java.lang.String EXTRA_PEER_AUTH_KEY = "PEER_AGENT_KEY";
    public static final java.lang.String EXTRA_PRIORITY = "priority";
    public static final java.lang.String EXTRA_READ_BYTES = "com.heytap.accessory.adapter.extra.READ_BYTES";
    public static final java.lang.String EXTRA_READ_LENGHT = "com.heytap.accessory.adapter.extra.READ_LENGHT";
    public static final java.lang.String EXTRA_READ_OFFSET = "com.heytap.accessory.adapter.extra.READ_OFFSET";
    public static final java.lang.String EXTRA_SERVER_CONNECT_FLAG = "extra_server_conn_flag";
    public static final java.lang.String EXTRA_SERVICE_DESCRIPTION = "serviceDescription";
    public static final java.lang.String EXTRA_STATUS = "status";
    public static final java.lang.String EXTRA_TRANSACTION_ID = "transactionId";
    public static final java.lang.String EXTRA_UUID = "uuid";
    public static final int INVALID_CLIENT_ID = -1;
    public static final java.lang.String KEY_BUSINESS_TYPE = "business_type";
    public static final int KEY_BUSINESS_TYPE_PC = 1;
    public static final java.lang.String KEY_MODEL_ID = "model_id";
    public static final java.lang.String KEY_REMOTE_DEVICE_ID = "remote_device_id";
    public static final java.lang.String KEY_SUB_SERVICE = "KEY_SUB_SERVICE";
    public static final int LENGTH_DEVICE_ID = 6;
    public static final int MAX_BIND_ATTEMPT = 3;
    public static final java.lang.String PERMISSION_ACCESSORY_FRAMEWORK = "com.heytap.accessory.permission.ACCESSORY_FRAMEWORK";
    ...
    public static final java.lang.String SCAN_SERVICE_INTENT = "com.heytap.accessory.ScanService";
