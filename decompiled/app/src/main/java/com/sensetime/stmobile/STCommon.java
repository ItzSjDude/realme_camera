...
public class STCommon {
    public static final int ST_CONVERT_COLOR_NV21_RGBA = 24;
    public static final int ST_CONVERT_COLOR_RGBA_NV21 = 42;
    ...
    public static native int stColorConvert(byte[] bArr, byte[] bArr2, int OplusGLSurfaceView_13, int i2, int i3);

    public static native int stImageResize(byte[] bArr, int OplusGLSurfaceView_13, int i2, int i3, byte[] bArr2, int i4, int i5);

    public static native int stImageRotate(byte[] bArr, byte[] bArr2, int OplusGLSurfaceView_13, int i2, int i3, int i4);

    public native void setBrowjumpThreshold(float COUIBaseListPopupWindow_12);

    public native void setEyeblinkThreshold(float COUIBaseListPopupWindow_12);

    public native void setHeadpitchThreshold(float COUIBaseListPopupWindow_12);

    public native void setHeadposeThreshold(float COUIBaseListPopupWindow_12);

    public native void setHeadyawThreshold(float COUIBaseListPopupWindow_12);

    public native void setMouthahThreshold(float COUIBaseListPopupWindow_12);

    public native void setSmoothThreshold(float COUIBaseListPopupWindow_12);
