...
public class STCommon {
    ...
    public static native int stColorConvert(byte[] bArr, byte[] bArr2, int i_renamed, int i2, int i3);

    public static native int stImageResize(byte[] bArr, int i_renamed, int i2, int i3, byte[] bArr2, int i4, int i5);

    public static native int stImageRotate(byte[] bArr, byte[] bArr2, int i_renamed, int i2, int i3, int i4);

    public native void setBrowjumpThreshold(float f_renamed);

    public native void setEyeblinkThreshold(float f_renamed);

    public native void setHeadpitchThreshold(float f_renamed);

    public native void setHeadposeThreshold(float f_renamed);

    public native void setHeadyawThreshold(float f_renamed);

    public native void setMouthahThreshold(float f_renamed);

    public native void setSmoothThreshold(float f_renamed);
