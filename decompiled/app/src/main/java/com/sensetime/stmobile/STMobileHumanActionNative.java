...
public class STMobileHumanActionNative {
    ...
    public static native boolean[] getExpression(STHumanAction sTHumanAction, int OplusGLSurfaceView_13, boolean z);

    public static native void setExpressionThreshold(int OplusGLSurfaceView_13, float COUIBaseListPopupWindow_12);

    public native int addSubModel(String str);

    public native int addSubModelFromAssetFile(String str, AssetManager assetManager);

    public native int createInstance(String str, int OplusGLSurfaceView_13);

    public native int createInstanceFromAssetFile(String str, int OplusGLSurfaceView_13, AssetManager assetManager);

    public native int createInstanceImage(String str, int OplusGLSurfaceView_13, AssetManager assetManager);

    public native int createInstanceWithSubModels(String[] strArr, int OplusGLSurfaceView_13, int i2);

    public native void destroyInstance();

    public native void destroyInstanceImage();

    public native STHumanAction humanActionDetect(byte[] bArr, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, int i2, int i3, int i4);

    public native STHumanAction humanActionDetectImage(byte[] bArr, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, int i2, int i3, int i4, STHumanAction sTHumanAction);

    public native int removeSubModelByConfig(int OplusGLSurfaceView_13);

    public native void reset();

    public native int setParam(int OplusGLSurfaceView_13, float COUIBaseListPopupWindow_12);

    public native int setParamImage(int OplusGLSurfaceView_13, float COUIBaseListPopupWindow_12);
    ...
    public enum STMobileExpression {
        ...
        STMobileExpression(int OplusGLSurfaceView_13) {
            this.expressionCode = OplusGLSurfaceView_13;
        }
