...
public class STStickerModuleParamType {
    ...
    /* renamed from: ST_STICKER_PARAM_MODULE_ANIMATION_EVENT_CALLBACK_PTR */
    public static final int f24197x3b790955 = 106;
    public static final int ST_STICKER_PARAM_MODULE_ENABLED_BOOL = 102;

    /* renamed from: ST_STICKER_PARAM_MODULE_KEY_FRAME_EVENT_CALLBACK_PTR */
    public static final int f24198xee58a6cc = 112;
