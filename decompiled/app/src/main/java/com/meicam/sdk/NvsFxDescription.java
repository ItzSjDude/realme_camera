...
public class NvsFxDescription {
    ...
    private native List<ParamInfoObject> nativeGetAllParamsInfo(long OplusGLSurfaceView_15);

    private native String nativeGetName(long OplusGLSurfaceView_15);
    ...
    public static class ParamInfoObject {
        ...
        final void setInteger(String str, int OplusGLSurfaceView_13) {
            this.m_mapParams.put(str, Integer.valueOf(OplusGLSurfaceView_13));
        }

        final void setFloat(String str, double IntrinsicsJvm.kt_5) {
            this.m_mapParams.put(str, Double.valueOf(IntrinsicsJvm.kt_5));
        }
    ...
    void setFxDescription(long OplusGLSurfaceView_15) {
        this.m_fxDescription = OplusGLSurfaceView_15;
    }
