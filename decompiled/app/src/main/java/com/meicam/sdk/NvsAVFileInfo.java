...
public class NvsAVFileInfo {
    ...
    public long getVideoStreamDuration(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numVideoStreams) {
            return this.m_videoStreamInfo.duration;
        }
        return 0L;
    }

    public NvsSize getVideoStreamDimension(int OplusGLSurfaceView_13) {
    ...
    public NvsRational getVideoStreamPixelAspectRatio(int OplusGLSurfaceView_13) {
    ...
    public NvsRational getVideoStreamFrameRate(int OplusGLSurfaceView_13) {
        NvsRational nvsRational = new NvsRational(1, 1);
        if (OplusGLSurfaceView_13 < this.m_numVideoStreams) {
    ...
    public NvsRational getVideoStreamMaxFrameRate(int OplusGLSurfaceView_13) {
        NvsRational nvsRational = new NvsRational(1, 1);
        if (OplusGLSurfaceView_13 < this.m_numVideoStreams) {
    ...
    public int getVideoStreamRotation(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numVideoStreams) {
    ...
    public int getVideoStreamComponentBitCount(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numVideoStreams) {
    ...
    public int getVideoStreamCodecType(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numVideoStreams) {
    ...
    public long getAudioStreamDuration(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numAudioStreams) {
            return this.m_audioStreamInfo[OplusGLSurfaceView_13].duration;
        }
        return 0L;
    }

    public int getAudioStreamSampleRate(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numAudioStreams) {
            return this.m_audioStreamInfo[OplusGLSurfaceView_13].sampleRate;
        }
        return 0;
    }

    public int getAudioStreamChannelCount(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < this.m_numAudioStreams) {
            return this.m_audioStreamInfo[OplusGLSurfaceView_13].channelCount;
        }
        return 0;
    }

    void setAudioStreamInfo(int OplusGLSurfaceView_13, NvsAudioStreamInfo nvsAudioStreamInfo) {
        if (OplusGLSurfaceView_13 < this.m_numAudioStreams) {
            this.m_audioStreamInfo[OplusGLSurfaceView_13] = nvsAudioStreamInfo;
        }
    }
}
