...
public class NvsLiveWindowExt extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private native void nativeSetVideoFrameCallback(long OplusGLSurfaceView_15, NvsLiveWindow.InternalVideoFrameCallback internalVideoFrameCallback);
    ...
    public NvsLiveWindowExt(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13) {
    ...
    public NvsLiveWindowExt(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13, int i2) {
