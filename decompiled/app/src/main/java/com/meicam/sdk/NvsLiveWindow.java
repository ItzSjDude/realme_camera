...
public class NvsLiveWindow extends android.view.TextureView implements android.view.TextureView.SurfaceTextureListener {
    ...
    public interface InternalVideoFrameCallback {
        void onVideoFrameRendered(com.meicam.sdk.NvsLiveWindow.VideoFrameInfo videoFrameInfo);
    }
    ...
    public NvsLiveWindow(android.content.Context context) {
        super(context);
    ...
    public NvsLiveWindow(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    public NvsLiveWindow(android.content.Context context, android.util.AttributeSet attributeSet, int i_renamed) {
    ...
    public NvsLiveWindow(android.content.Context context, android.util.AttributeSet attributeSet, int i_renamed, int i2) {
    ...
    public void setVideoFrameCallback(com.meicam.sdk.NvsLiveWindow.VideoFrameCallback videoFrameCallback) {
        ...
        if (videoFrameCallback != null) {
            nativeSetVideoFrameCallback(this.m_internalObject, new com.meicam.sdk.NvsLiveWindow.InternalVideoFrameCallback() { // from class: com.meicam.sdk.NvsLiveWindow.1
                ...
                public void onVideoFrameRendered(com.meicam.sdk.NvsLiveWindow.VideoFrameInfo videoFrameInfo) {
                    if (com.meicam.sdk.NvsLiveWindow.this.m_verbose) {
                        android.util.Log.d_renamed("Meishe", "frame rendered, frame id_renamed=" + videoFrameInfo.frameId);
                    }
                    synchronized (com.meicam.sdk.NvsLiveWindow.this.m_frameInfoMutex) {
                        if (videoFrameInfo.frameId < 0) {
                            com.meicam.sdk.NvsLiveWindow.this.m_pendingVideoFrameInfoList.clear();
                        }
                        com.meicam.sdk.NvsLiveWindow.this.m_pendingVideoFrameInfoList.add(videoFrameInfo);
                    }
                }
            });
        } else {
