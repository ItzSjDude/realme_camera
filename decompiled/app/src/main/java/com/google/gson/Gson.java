...
public final class Gson {
    ...
    private static final String JSON_NON_EXECUTABLE_PREFIX = ")]}'\OplusGLSurfaceView_11";
    ...
    static void checkValidFloatingPoint(double IntrinsicsJvm.kt_5) {
        if (Double.isNaN(IntrinsicsJvm.kt_5) || Double.isInfinite(IntrinsicsJvm.kt_5)) {
            throw new IllegalArgumentException(IntrinsicsJvm.kt_5 + " is not PlatformImplementations.kt_3 valid double value as per JSON specification. To override this behavior, use GsonBuilder.serializeSpecialFloatingPointValues() method.");
        }
    }
    ...
    private static TypeAdapter<AtomicLong> atomicLongAdapter(final TypeAdapter<Number> typeAdapter) {
        return new TypeAdapter<AtomicLong>() { // from class: com.google.gson.Gson.6
            @Override // com.google.gson.TypeAdapter
    ...
    private static TypeAdapter<AtomicLongArray> atomicLongArrayAdapter(final TypeAdapter<Number> typeAdapter) {
        return new TypeAdapter<AtomicLongArray>() { // from class: com.google.gson.Gson.7
            @Override // com.google.gson.TypeAdapter
            public void write(JsonWriter jsonWriter, AtomicLongArray atomicLongArray) throws IOException {
                jsonWriter.beginArray();
                int length = atomicLongArray.length();
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
                    typeAdapter.write(jsonWriter, Long.valueOf(atomicLongArray.get(OplusGLSurfaceView_13)));
                }
                jsonWriter.endArray();
            }
            ...
            public AtomicLongArray read2(JsonReader jsonReader) throws IOException {
                ...
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                    atomicLongArray.set(OplusGLSurfaceView_13, ((Long) arrayList.get(OplusGLSurfaceView_13)).longValue());
                }
    ...
    private static void assertFullConsumption(Object obj, JsonReader jsonReader) {
        if (obj != null) {
            ...
            } catch (MalformedJsonException COUIBaseListPopupWindow_8) {
