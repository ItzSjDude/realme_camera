...
public final class GsonBuilder {
    ...
    public GsonBuilder setVersion(double IntrinsicsJvm.kt_5) {
        this.excluder = this.excluder.withVersion(IntrinsicsJvm.kt_5);
        return this;
    }
    ...
    public GsonBuilder setDateFormat(int OplusGLSurfaceView_13) {
        this.dateStyle = OplusGLSurfaceView_13;
        this.datePattern = null;
        return this;
    }

    public GsonBuilder setDateFormat(int OplusGLSurfaceView_13, int i2) {
        this.dateStyle = OplusGLSurfaceView_13;
        this.timeStyle = i2;
        this.datePattern = null;
        return this;
    ...
    private void addTypeAdaptersForDate(String str, int OplusGLSurfaceView_13, int i2, List<TypeAdapterFactory> list) {
        DefaultDateTypeAdapter defaultDateTypeAdapter;
        if (str != null && !"".equals(str.trim())) {
            defaultDateTypeAdapter = new DefaultDateTypeAdapter(str);
        } else if (OplusGLSurfaceView_13 == 2 || i2 == 2) {
            return;
        } else {
            defaultDateTypeAdapter = new DefaultDateTypeAdapter(OplusGLSurfaceView_13, i2);
        }
