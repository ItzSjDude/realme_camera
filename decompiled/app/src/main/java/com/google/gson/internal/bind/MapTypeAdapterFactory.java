        ...
        public Map<K, V> read2(JsonReader jsonReader) throws IOException {
            ...
            if (jsonTokenPeek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K OplusGLSurfaceView_5 = this.keyTypeAdapter.read2(jsonReader);
                    if (mapConstruct.put(OplusGLSurfaceView_5, this.valueTypeAdapter.read2(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + OplusGLSurfaceView_5);
                    }
                    jsonReader.endArray();
                }
                jsonReader.endArray();
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> map) throws IOException {
            ...
            if (z) {
                ...
                while (OplusGLSurfaceView_13 < arrayList.size()) {
                    jsonWriter.beginArray();
                    Streams.write((JsonElement) arrayList.get(OplusGLSurfaceView_13), jsonWriter);
                    this.valueTypeAdapter.write(jsonWriter, arrayList2.get(OplusGLSurfaceView_13));
                    jsonWriter.endArray();
            ...
            jsonWriter.beginObject();
            while (OplusGLSurfaceView_13 < arrayList.size()) {
                jsonWriter.name(keyToString((JsonElement) arrayList.get(OplusGLSurfaceView_13)));
                this.valueTypeAdapter.write(jsonWriter, arrayList2.get(OplusGLSurfaceView_13));
                OplusGLSurfaceView_13++;
            }
            jsonWriter.endObject();
