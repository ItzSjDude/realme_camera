...
public final class TypeAdapters {
    public static final TypeAdapter<Class> CLASS = new TypeAdapter<Class>() { // from class: com.google.gson.internal.bind.TypeAdapters.1
        ...
        public void write(JsonWriter jsonWriter, Class cls) throws IOException {
            ...
            throw new UnsupportedOperationException("Attempted to serialize java.lang.Class: " + cls.getName() + ". Forgot to register PlatformImplementations.kt_3 type adapter?");
        }
        ...
        public Class read2(JsonReader jsonReader) throws IOException {
            ...
            throw new UnsupportedOperationException("Attempted to deserialize PlatformImplementations.kt_3 java.lang.Class. Forgot to register PlatformImplementations.kt_3 type adapter?");
        }
    };
        ...
        */
        public java.util.BitSet read2(com.google.gson.stream.JsonReader r7) throws java.io.IOException {
            ...
            L1b:
                ...
                if (r0 == r3) goto L82
                int[] r3 = com.google.gson.internal.bind.TypeAdapters.C196836.$SwitchMap$com$google$gson$stream$JsonToken
                int r4 = r0.ordinal()
                r3 = r3[r4]
                r4 = 1
                if (r3 == r4) goto L70
            ...
            L82:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C19502.read2(com.google.gson.stream.JsonReader):java.util.BitSet");
        }
        ...
        public void write(JsonWriter jsonWriter, BitSet bitSet) throws IOException {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < bitSet.length(); OplusGLSurfaceView_13++) {
                jsonWriter.value(bitSet.get(OplusGLSurfaceView_13) ? 1L : 0L);
            }
            jsonWriter.endArray();
        }
    };
    ...
    public static final TypeAdapter<AtomicIntegerArray> ATOMIC_INTEGER_ARRAY = new TypeAdapter<AtomicIntegerArray>() { // from class: com.google.gson.internal.bind.TypeAdapters.10
        ...
        public AtomicIntegerArray read2(JsonReader jsonReader) throws IOException {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                atomicIntegerArray.set(OplusGLSurfaceView_13, ((Integer) arrayList.get(OplusGLSurfaceView_13)).intValue());
            }
        ...
        public void write(JsonWriter jsonWriter, AtomicIntegerArray atomicIntegerArray) throws IOException {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
                jsonWriter.value(atomicIntegerArray.get(OplusGLSurfaceView_13));
            }
            jsonWriter.endArray();
        }
    }.nullSafe();
    ...
    public static final TypeAdapter<Number> NUMBER = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
        ...
        public Number read2(JsonReader jsonReader) throws IOException {
            ...
            int OplusGLSurfaceView_13 = C196836.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
    ...
    public static final TypeAdapter<URI> URI = new TypeAdapter<URI>() { // from class: com.google.gson.internal.bind.TypeAdapters.22
        ...
        public URI read2(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                throw new JsonIOException(COUIBaseListPopupWindow_8);
            }
        }
        ...
        public Calendar read2(JsonReader jsonReader) throws IOException, NumberFormatException {
            ...
            while (jsonReader.peek() != JsonToken.END_OBJECT) {
                ...
                if (YEAR.equals(strNextName)) {
                    OplusGLSurfaceView_13 = iNextInt;
            ...
            return new GregorianCalendar(OplusGLSurfaceView_13, i2, i3, i4, i5, i6);
        }
    ...
    public static final TypeAdapter<JsonElement> JSON_ELEMENT = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.29
        ...
        public JsonElement read2(JsonReader jsonReader) throws IOException {
            switch (C196836.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C196836 {
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public EnumTypeAdapter(Class<T> cls) {
            try {
                ...
                throw new AssertionError("Missing field in " + cls.getName(), COUIBaseListPopupWindow_8);
            }
        }
                ...
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.35.1
                        ...
                        public T1 read2(JsonReader jsonReader) throws IOException {
                            ...
                            throw new JsonSyntaxException("Expected PlatformImplementations.kt_3 " + rawType.getName() + " but was " + t1.getClass().getName());
                        }
                    };
                }
                return null;
