...
public final class $Gson$Types {
    ...
    public static ParameterizedType newParameterizedTypeWithOwner(Type type, Type type2, Type... typeArr) {
        return new $Gson$Types_2(type, type2, typeArr);
    }

    public static GenericArrayType arrayOf(Type type) {
        return new $Gson$Types_3(type);
    }

    public static WildcardType subtypeOf(Type type) {
        return new $Gson$Types_4(new Type[]{type}, EMPTY_TYPE_ARRAY);
    }

    public static WildcardType supertypeOf(Type type) {
        return new $Gson$Types_4(new Type[]{Object.class}, new Type[]{type});
    }
    ...
    public static Type canonicalize(Type type) {
        if (type instanceof Class) {
            ...
            if (genericArrayTypeImpl.isArray()) {
                genericArrayTypeImpl = new $Gson$Types_3(canonicalize(genericArrayTypeImpl.getComponentType()));
            }
            return genericArrayTypeImpl;
        }
        if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new $Gson$Types_2(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
            return new $Gson$Types_3(((GenericArrayType) type).getGenericComponentType());
        }
        if (!(type instanceof WildcardType)) {
            return type;
        }
        WildcardType wildcardType = (WildcardType) type;
        return new $Gson$Types_4(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
    }
    ...
    public static Class<?> getRawType(Type type) {
        ...
        throw new IllegalArgumentException("Expected PlatformImplementations.kt_3 Class, ParameterizedType, or GenericArrayType, but <" + type + "> is of type " + (type == null ? "null" : type.getClass().getName()));
    }
    ...
    static Type getGenericSupertype(Type type, Class<?> cls, Class<?> cls2) {
        ...
        if (cls2.isInterface()) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
                if (interfaces[OplusGLSurfaceView_13] == cls2) {
                    return cls.getGenericInterfaces()[OplusGLSurfaceView_13];
                }
                if (cls2.isAssignableFrom(interfaces[OplusGLSurfaceView_13])) {
                    return getGenericSupertype(cls.getGenericInterfaces()[OplusGLSurfaceView_13], interfaces[OplusGLSurfaceView_13], cls2);
                }
            }
        }
        if (!cls.isInterface()) {
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type3 instanceof ParameterizedType) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[OplusGLSurfaceView_13]);
                if (typeResolve4 != actualTypeArguments[OplusGLSurfaceView_13]) {
                    if (!z) {
                        actualTypeArguments = (Type[]) actualTypeArguments.clone();
                        z = true;
                    }
                    actualTypeArguments[OplusGLSurfaceView_13] = typeResolve4;
                }
            }
    ...
    private static int indexOf(Object[] objArr, Object obj) {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < objArr.length; OplusGLSurfaceView_13++) {
            if (obj.equals(objArr[OplusGLSurfaceView_13])) {
    ...
    private static final class $Gson$Types_2 implements Serializable, ParameterizedType {
        private static final long serialVersionUID = 0;
        private final Type ownerType;
        private final Type rawType;
        private final Type[] typeArguments;

        public $Gson$Types_2(Type type, Type type2, Type... typeArr) {
            ...
            while (true) {
                ...
                if (OplusGLSurfaceView_13 >= typeArr2.length) {
                    return;
                }
                C$Gson$Preconditions.checkNotNull(typeArr2[OplusGLSurfaceView_13]);
                $Gson$Types.checkNotPrimitive(this.typeArguments[OplusGLSurfaceView_13]);
                Type[] typeArr3 = this.typeArguments;
                typeArr3[OplusGLSurfaceView_13] = $Gson$Types.canonicalize(typeArr3[OplusGLSurfaceView_13]);
        ...
        public int hashCode() {
            return $Gson$Types.hashCodeOrZero(this.ownerType) ^ (Arrays.hashCode(this.typeArguments) ^ this.rawType.hashCode());
        }
        ...
        public String toString() {
            ...
            for (int OplusGLSurfaceView_13 = 1; OplusGLSurfaceView_13 < this.typeArguments.length; OplusGLSurfaceView_13++) {
                sb.append(", ");
                sb.append($Gson$Types.typeToString(this.typeArguments[OplusGLSurfaceView_13]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class $Gson$Types_3 implements Serializable, GenericArrayType {
        private static final long serialVersionUID = 0;
        private final Type componentType;

        public $Gson$Types_3(Type type) {
    ...
    private static final class $Gson$Types_4 implements Serializable, WildcardType {
        private static final long serialVersionUID = 0;
        private final Type lowerBound;
        private final Type upperBound;

        public $Gson$Types_4(Type[] typeArr, Type[] typeArr2) {
