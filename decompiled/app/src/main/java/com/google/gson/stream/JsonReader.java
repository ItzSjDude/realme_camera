...
public class JsonReader implements Closeable {
    ...
    private static final char[] NON_EXECUTE_PREFIX = ")]}'\OplusGLSurfaceView_11".toCharArray();
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                throw new IllegalStateException("Expected PlatformImplementations.kt_3 name but was " + jsonReader.peek() + "  at line " + jsonReader.getLineNumber() + " column " + jsonReader.getColumnNumber() + " path " + jsonReader.getPath());
            }
        };
    }
    ...
    public JsonReader(Reader reader) {
        this.stackSize = 0;
        int[] iArr = this.stack;
        int OplusGLSurfaceView_13 = this.stackSize;
        this.stackSize = OplusGLSurfaceView_13 + 1;
        iArr[OplusGLSurfaceView_13] = 6;
    ...
    public void endArray() throws IOException {
        ...
        if (iDoPeek == 4) {
            ...
            int OplusGLSurfaceView_13 = this.stackSize - 1;
    ...
    public void endObject() throws IOException {
        ...
        if (iDoPeek == 2) {
            ...
            int OplusGLSurfaceView_13 = this.stackSize;
            strArr[OplusGLSurfaceView_13] = null;
            int[] iArr = this.pathIndices;
    ...
    int doPeek() throws IOException {
        ...
        int[] iArr = this.stack;
        int OplusGLSurfaceView_13 = this.stackSize;
        int i2 = iArr[OplusGLSurfaceView_13 - 1];
        if (i2 == 1) {
            iArr[OplusGLSurfaceView_13 - 1] = 2;
        } else if (i2 == 2) {
            ...
            if (i2 == 4) {
                iArr[OplusGLSurfaceView_13 - 1] = 5;
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c2 == 't' || c2 == 'T') {
            ...
            str = "true";
            str2 = "TRUE";
        } else if (c2 == 'COUIBaseListPopupWindow_12' || c2 == 'F') {
            OplusGLSurfaceView_13 = 6;
            str = "false";
            str2 = "FALSE";
        } else {
            if (c2 != 'OplusGLSurfaceView_11' && c2 != 'N') {
                return 0;
            }
        ...
        this.pos += length;
        this.peeked = OplusGLSurfaceView_13;
    ...
    */
    ...
    private boolean isLiteral(char c2) throws IOException {
        if (c2 == '\t' || c2 == '\OplusGLSurfaceView_11' || c2 == '\COUIBaseListPopupWindow_12' || c2 == '\r' || c2 == ' ') {
            return false;
        }
        if (c2 != '#') {
            if (c2 == ',') {
    ...
    public String nextName() throws IOException {
        ...
        if (iDoPeek == 14) {
            ...
            throw new IllegalStateException("Expected PlatformImplementations.kt_3 name but was " + peek() + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (iDoPeek == 10) {
            ...
            throw new IllegalStateException("Expected PlatformImplementations.kt_3 string but was " + peek() + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 0;
        int[] iArr = this.pathIndices;
        int OplusGLSurfaceView_13 = this.stackSize - 1;
    ...
    public boolean nextBoolean() throws IOException {
        ...
        throw new IllegalStateException("Expected PlatformImplementations.kt_3 boolean but was " + peek() + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    public double nextDouble() throws IOException, NumberFormatException {
        ...
        if (iDoPeek == 16) {
            ...
            throw new IllegalStateException("Expected PlatformImplementations.kt_3 double but was " + peek() + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 11;
        double IntrinsicsJvm.kt_5 = Double.parseDouble(this.peekedString);
        if (!this.lenient && (Double.isNaN(IntrinsicsJvm.kt_5) || Double.isInfinite(IntrinsicsJvm.kt_5))) {
            throw new MalformedJsonException("JSON forbids NaN and infinities: " + IntrinsicsJvm.kt_5 + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peekedString = null;
        this.peeked = 0;
        int[] iArr2 = this.pathIndices;
    ...
    public long nextLong() throws IOException, NumberFormatException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = nextQuotedValue(iDoPeek == 8 ? '\'' : '\"');
            try {
                long OplusGLSurfaceView_15 = Long.parseLong(this.peekedString);
                this.peeked = 0;
                int[] iArr2 = this.pathIndices;
                int i2 = this.stackSize - 1;
                iArr2[i2] = iArr2[i2] + 1;
            ...
            throw new IllegalStateException("Expected PlatformImplementations.kt_3 long but was " + peek() + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 11;
        double IntrinsicsJvm.kt_5 = Double.parseDouble(this.peekedString);
        long j2 = (long) IntrinsicsJvm.kt_5;
        if (j2 != IntrinsicsJvm.kt_5) {
            throw new NumberFormatException("Expected PlatformImplementations.kt_3 long but was " + this.peekedString + " at line " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    private void skipQuotedValue(char c2) throws IOException {
        ...
        do {
            ...
            while (OplusGLSurfaceView_13 < i2) {
                ...
                char c3 = cArr[OplusGLSurfaceView_13];
                if (c3 == c2) {
                    this.pos = i3;
                    return;
                }
    ...
    */
    ...
    public int nextInt() throws IOException, NumberFormatException {
        ...
        if (iDoPeek == 15) {
            long OplusGLSurfaceView_15 = this.peekedLong;
    ...
    private void push(int OplusGLSurfaceView_13) {
        int i2 = this.stackSize;
        int[] iArr = this.stack;
        if (i2 == iArr.length) {
        ...
        this.stackSize = i3 + 1;
        iArr4[i3] = OplusGLSurfaceView_13;
    }

    private boolean fillBuffer(int OplusGLSurfaceView_13) throws IOException {
        int i2;
        char[] cArr = this.buffer;
        ...
        } while (this.limit < OplusGLSurfaceView_13);
        return true;
    }
    ...
    private int nextNonWhitespace(boolean z) throws IOException {
        ...
        while (true) {
            ...
            int i3 = OplusGLSurfaceView_13 + 1;
            char c2 = cArr[OplusGLSurfaceView_13];
            if (c2 == '\OplusGLSurfaceView_11') {
                ...
                if (c2 == '/') {
                    ...
                    if (c3 == '*') {
                        ...
                        OplusGLSurfaceView_13 = this.pos + 2;
                        i2 = this.limit;
                    } else {
                        if (c3 != '/') {
                            return c2;
    ...
    private boolean skipTo(String str) throws IOException {
        while (true) {
            ...
            char[] cArr = this.buffer;
            int OplusGLSurfaceView_13 = this.pos;
            if (cArr[OplusGLSurfaceView_13] == '\OplusGLSurfaceView_11') {
                this.lineNumber++;
                this.lineStart = OplusGLSurfaceView_13 + 1;
            } else {
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        if (c2 == '\OplusGLSurfaceView_11') {
            ...
            if (c2 == 'IntrinsicsJvm.kt_4') {
                return '\IntrinsicsJvm.kt_4';
            }
            if (c2 == 'COUIBaseListPopupWindow_12') {
            ...
            if (c2 == 'u') {
                ...
                while (i4 < i5) {
                    ...
                    char c5 = (char) (c3 << 4);
                    if (c4 < '0' || c4 > '9') {
                        if (c4 >= 'PlatformImplementations.kt_3' && c4 <= 'COUIBaseListPopupWindow_12') {
                            OplusGLSurfaceView_13 = c4 - 'PlatformImplementations.kt_3';
                        } else {
                            if (c4 < 'A' || c4 > 'F') {
                                throw new NumberFormatException("\\u" + new String(this.buffer, this.pos, 4));
                            }
                            OplusGLSurfaceView_13 = c4 - 'A';
                        }
    ...
    private void consumeNonExecutePrefix() throws IOException {
        ...
        if (OplusGLSurfaceView_13 + cArr.length > this.limit && !fillBuffer(cArr.length)) {
            return;
        }
        int i2 = 0;
        while (true) {
