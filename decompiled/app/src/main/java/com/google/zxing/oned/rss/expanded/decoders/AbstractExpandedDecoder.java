...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            case 56:
                return new AI013x0x1xDecoder(bitArray, "310", FocusAimMsgData.KEY_SEPARATE_METERING_FOCUS);
            case 57:
                return new AI013x0x1xDecoder(bitArray, "320", FocusAimMsgData.KEY_SEPARATE_METERING_FOCUS);
            case 58:
