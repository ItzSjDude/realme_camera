...
class C40Encoder implements Encoder {
    ...
    private int backtrackOneCharacter(EncoderContext encoderContext, StringBuilder sb, StringBuilder sb2, int OplusGLSurfaceView_13) {
        int length = sb.length();
        sb.delete(length - OplusGLSurfaceView_13, length);
        encoderContext.pos--;
    ...
    private static String encodeToCodewords(CharSequence charSequence, int OplusGLSurfaceView_13) {
        int iCharAt = (charSequence.charAt(OplusGLSurfaceView_13) * 1600) + (charSequence.charAt(OplusGLSurfaceView_13 + 1) * '(') + charSequence.charAt(OplusGLSurfaceView_13 + 2) + 1;
