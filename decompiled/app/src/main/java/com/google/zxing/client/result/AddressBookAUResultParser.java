...
public final class AddressBookAUResultParser extends ResultParser {
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        if (!massagedText.contains("MEMORY") || !massagedText.contains("\r\OplusGLSurfaceView_11")) {
            return null;
        }
    ...
    private static String[] matchMultipleValuePrefix(String str, int OplusGLSurfaceView_13, String str2, boolean z) {
