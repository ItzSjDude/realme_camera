...
public final class CodaBarReader extends OneDReader {
    ...
    public Result decodeRow(int OplusGLSurfaceView_13, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        float COUIBaseListPopupWindow_12 = i8;
        while (iFindStartPattern < i3) {
            i8 += this.counters[iFindStartPattern];
            iFindStartPattern++;
        }
        float f2 = OplusGLSurfaceView_13;
        return new Result(this.decodeRowResult.toString(), null, new ResultPoint[]{new ResultPoint(COUIBaseListPopupWindow_12, f2), new ResultPoint(i8, f2)}, BarcodeFormat.CODABAR);
    }

    private void validatePattern(int OplusGLSurfaceView_13) throws NotFoundException {
        int[] iArr = {0, 0, 0, 0};
        int[] iArr2 = {0, 0, 0, 0};
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            fArr2[i8] = 0.0f;
            int i9 = i8 + 2;
            fArr2[i9] = ((iArr[i8] / iArr2[i8]) + (iArr[i9] / iArr2[i9])) / MAX_ACCEPTABLE;
            fArr[i8] = fArr2[i9];
            fArr[i9] = ((iArr[i9] * MAX_ACCEPTABLE) + PADDING) / iArr2[i9];
        }
        loop3: while (true) {
            int i10 = CHARACTER_ENCODINGS[this.decodeRowResult.charAt(i2)];
            for (int i11 = 6; i11 >= 0; i11--) {
                int i12 = (i11 & 1) + ((i10 & 1) << 1);
                float COUIBaseListPopupWindow_12 = this.counters[OplusGLSurfaceView_13 + i11];
                if (COUIBaseListPopupWindow_12 < fArr2[i12] || COUIBaseListPopupWindow_12 > fArr[i12]) {
                    break loop3;
                }
                i10 >>= 1;
            }
    ...
    private void setCounters(BitArray bitArray) throws NotFoundException {
        ...
        while (nextUnset < size) {
            if (bitArray.get(nextUnset) != z) {
                ...
                counterAppend(OplusGLSurfaceView_13);
                z = !z;
    ...
    private void counterAppend(int OplusGLSurfaceView_13) {
    ...
    private int findStartPattern() throws NotFoundException {
        for (int OplusGLSurfaceView_13 = 1; OplusGLSurfaceView_13 < this.counterLength; OplusGLSurfaceView_13 += 2) {
            int narrowWidePattern = toNarrowWidePattern(OplusGLSurfaceView_13);
            if (narrowWidePattern != -1 && arrayContains(STARTEND_ENCODING, ALPHABET[narrowWidePattern])) {
                int i2 = 0;
                for (int i3 = OplusGLSurfaceView_13; i3 < OplusGLSurfaceView_13 + 7; i3++) {
                    i2 += this.counters[i3];
                }
                if (OplusGLSurfaceView_13 == 1 || this.counters[OplusGLSurfaceView_13 - 1] >= i2 / 2) {
    ...
    private int toNarrowWidePattern(int OplusGLSurfaceView_13) {
        ...
        int i6 = 0;
        for (int i7 = OplusGLSurfaceView_13; i7 < i2; i7 += 2) {
            int i8 = iArr[i7];
            if (i8 < i5) {
                i5 = i8;
            }
        ...
        int i9 = (i5 + i6) / 2;
        int i10 = 0;
        for (int i11 = OplusGLSurfaceView_13 + 1; i11 < i2; i11 += 2) {
            int i12 = iArr[i11];
            if (i12 < i3) {
                i3 = i12;
            }
        ...
        for (int i16 = 0; i16 < 7; i16++) {
            i14 >>= 1;
            if (iArr[OplusGLSurfaceView_13 + i16] > ((i16 & 1) == 0 ? i9 : i13)) {
                i15 |= i14;
            }
        }
        while (true) {
