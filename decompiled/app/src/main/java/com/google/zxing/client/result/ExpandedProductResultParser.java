...
public final class ExpandedProductResultParser extends ResultParser {
    ...
    */
    ...
    private static String findAIvalue(int OplusGLSurfaceView_13, String str) {
        if (str.charAt(OplusGLSurfaceView_13) != '(') {
            return null;
        }
        String strSubstring = str.substring(OplusGLSurfaceView_13 + 1);
    ...
    private static String findValue(int OplusGLSurfaceView_13, String str) {
        StringBuilder sb = new StringBuilder();
