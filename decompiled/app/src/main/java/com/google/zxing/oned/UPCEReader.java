...
public final class UPCEReader extends UPCEANReader {
    ...
    protected int decodeMiddle(BitArray bitArray, int[] iArr, StringBuilder sb) throws NotFoundException {
        ...
        int i2 = 0;
        int i3 = 0;
        while (i2 < 6 && OplusGLSurfaceView_13 < size) {
            int iDecodeDigit = decodeDigit(bitArray, iArr2, OplusGLSurfaceView_13, L_AND_G_PATTERNS);
    ...
    @Override // com.google.zxing.oned.UPCEANReader
    protected int[] decodeEnd(BitArray bitArray, int OplusGLSurfaceView_13) throws NotFoundException {
        return findGuardPattern(bitArray, OplusGLSurfaceView_13, true, MIDDLE_END_PATTERN);
    }
    ...
    private static void determineNumSysAndCheckDigit(StringBuilder sb, int OplusGLSurfaceView_13) throws NotFoundException {
        for (int i2 = 0; i2 <= 1; i2++) {
            for (int i3 = 0; i3 < 10; i3++) {
                if (OplusGLSurfaceView_13 == NUMSYS_AND_CHECK_DIGIT_PATTERNS[i2][i3]) {
