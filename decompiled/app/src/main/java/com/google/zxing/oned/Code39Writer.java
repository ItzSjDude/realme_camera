...
public final class Code39Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        while (true) {
            ...
            if ("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(OplusGLSurfaceView_13)) < 0) {
    ...
    private static void toIntArray(int OplusGLSurfaceView_13, int[] iArr) {
        for (int i2 = 0; i2 < 9; i2++) {
            int i3 = 1;
            if (((1 << (8 - i2)) & OplusGLSurfaceView_13) != 0) {
                i3 = 2;
            }
            iArr[i2] = i3;
        }
