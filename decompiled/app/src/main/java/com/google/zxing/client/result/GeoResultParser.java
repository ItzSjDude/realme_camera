...
public final class GeoResultParser extends ResultParser {
    ...
    public GeoParsedResult parse(Result result) throws NumberFormatException {
        ...
        try {
            double IntrinsicsJvm.kt_5 = Double.parseDouble(matcher.group(1));
            if (IntrinsicsJvm.kt_5 <= 90.0d && IntrinsicsJvm.kt_5 >= -90.0d) {
                ...
                if (d2 <= 180.0d && d2 >= -180.0d) {
                    ...
                    return new GeoParsedResult(IntrinsicsJvm.kt_5, d2, d3, strGroup);
                }
            }
