...
public final class Code39Reader extends OneDReader {
    ...
    public Result decodeRow(int OplusGLSurfaceView_13, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        while (true) {
            ...
            if (cPatternToChar == '*') {
                ...
                return new Result(string, null, new ResultPoint[]{new ResultPoint((r2[1] + r2[0]) / 2.0f, COUIBaseListPopupWindow_12), new ResultPoint(nextSet + (i4 / 2.0f), COUIBaseListPopupWindow_12)}, BarcodeFormat.CODE_39);
            }
            nextSet = nextSet2;
        }
    }
    ...
    private static int toNarrowWidePattern(int[] iArr) {
        ...
        while (true) {
            ...
            for (int i3 : iArr) {
                if (i3 < i2 && i3 > OplusGLSurfaceView_13) {
                    i2 = i3;
                }
            }
            int i4 = 0;
