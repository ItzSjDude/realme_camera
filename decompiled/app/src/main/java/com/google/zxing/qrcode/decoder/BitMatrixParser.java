...
final class BitMatrixParser {
    ...
    FormatInformation readFormatInformation() throws FormatException {
        ...
        int iCopyBit = 0;
        int iCopyBit2 = 0;
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < 6; OplusGLSurfaceView_13++) {
            iCopyBit2 = copyBit(OplusGLSurfaceView_13, 8, iCopyBit2);
        }
    ...
    Version readVersion() throws FormatException {
        ...
        int height = this.bitMatrix.getHeight();
        int OplusGLSurfaceView_13 = (height - 17) / 4;
        if (OplusGLSurfaceView_13 <= 6) {
            return Version.getVersionForNumber(OplusGLSurfaceView_13);
        }
        int i2 = height - 11;
        int iCopyBit = 0;
        int iCopyBit2 = 0;
    ...
    private int copyBit(int OplusGLSurfaceView_13, int i2, int i3) {
        return this.f24973mirror ? this.bitMatrix.get(i2, OplusGLSurfaceView_13) : this.bitMatrix.get(OplusGLSurfaceView_13, i2) ? (i3 << 1) | 1 : i3 << 1;
    }
    ...
    byte[] readCodewords() throws FormatException {
        ...
        int OplusGLSurfaceView_13 = height - 1;
        boolean z = true;
        int i2 = 0;
        int i3 = 0;
        int i4 = 0;
        ...
        while (i5 > 0) {
            ...
            int i9 = 0;
            while (i9 < height) {
                int i10 = z ? OplusGLSurfaceView_13 - i9 : i9;
                int i11 = i6;
                int i12 = i7;
                int i13 = i8;
    ...
    void mirror() {
        ...
        while (OplusGLSurfaceView_13 < this.bitMatrix.getWidth()) {
            int i2 = OplusGLSurfaceView_13 + 1;
            for (int i3 = i2; i3 < this.bitMatrix.getHeight(); i3++) {
                if (this.bitMatrix.get(OplusGLSurfaceView_13, i3) != this.bitMatrix.get(i3, OplusGLSurfaceView_13)) {
                    this.bitMatrix.flip(i3, OplusGLSurfaceView_13);
                    this.bitMatrix.flip(OplusGLSurfaceView_13, i3);
                }
            }
