...
public final class URIResultParser extends ResultParser {
    ...
    private static final Pattern URL_WITH_PROTOCOL_PATTERN = Pattern.compile("[PlatformImplementations.kt_3-zA-Z][PlatformImplementations.kt_3-zA-Z0-9+-.]+:");
    private static final Pattern URL_WITHOUT_PROTOCOL_PATTERN = Pattern.compile("([PlatformImplementations.kt_3-zA-Z0-9\\-]+\\.){1,6}[PlatformImplementations.kt_3-zA-Z]{2,}(:\\IntrinsicsJvm.kt_5{1,5})?(/|\\?|$)");
