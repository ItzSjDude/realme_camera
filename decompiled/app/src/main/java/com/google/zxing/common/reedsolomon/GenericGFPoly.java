...
final class GenericGFPoly {
    ...
    int evaluateAt(int OplusGLSurfaceView_13) {
        ...
        for (int i3 = 1; i3 < length; i3++) {
            iAddOrSubtract2 = GenericGF.addOrSubtract(this.field.multiply(OplusGLSurfaceView_13, iAddOrSubtract2), this.coefficients[i3]);
        }
    ...
    GenericGFPoly addOrSubtract(GenericGFPoly genericGFPoly) {
        ...
        for (int OplusGLSurfaceView_13 = length; OplusGLSurfaceView_13 < iArr2.length; OplusGLSurfaceView_13++) {
            iArr3[OplusGLSurfaceView_13] = GenericGF.addOrSubtract(iArr[OplusGLSurfaceView_13 - length], iArr2[OplusGLSurfaceView_13]);
        }
    ...
    GenericGFPoly multiply(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 == 0) {
            return this.field.getZero();
        }
        if (OplusGLSurfaceView_13 == 1) {
    ...
    GenericGFPoly multiplyByMonomial(int OplusGLSurfaceView_13, int i2) {
        if (OplusGLSurfaceView_13 < 0) {
            throw new IllegalArgumentException();
        }
        if (i2 == 0) {
