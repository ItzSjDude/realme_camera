...
public final class Version {
    ...
    private Version(int OplusGLSurfaceView_13, int[] iArr, ECBlocks... eCBlocksArr) {
        ...
        for (ECB ecb : eCBlocksArr[0].getECBlocks()) {
            count += ecb.getCount() * (ecb.getDataCodewords() + eCCodewordsPerBlock);
        }
    ...
    public static Version getProvisionalVersionForDimension(int OplusGLSurfaceView_13) throws FormatException {
        if (OplusGLSurfaceView_13 % 4 != 1) {
            throw FormatException.getFormatInstance();
        }
        try {
            return getVersionForNumber((OplusGLSurfaceView_13 - 17) / 4);
        } catch (IllegalArgumentException unused) {
            throw FormatException.getFormatInstance();
        }
    }

    public static Version getVersionForNumber(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 <= 0 || OplusGLSurfaceView_13 > 40) {
            throw new IllegalArgumentException();
        }
        return VERSIONS[OplusGLSurfaceView_13 - 1];
    }

    static Version decodeVersionInformation(int OplusGLSurfaceView_13) {
        int i2 = 0;
        ...
        while (true) {
            ...
            int iNumBitsDiffering = FormatInformation.numBitsDiffering(OplusGLSurfaceView_13, i5);
            if (iNumBitsDiffering < i3) {
                i4 = i2 + 7;
    ...
    BitMatrix buildFunctionPattern() {
        ...
        int OplusGLSurfaceView_13 = dimensionForVersion - 8;
        bitMatrix.setRegion(OplusGLSurfaceView_13, 0, 8, 9);
        bitMatrix.setRegion(0, OplusGLSurfaceView_13, 9, 8);
    ...
    public static final class ECBlocks {
        ...
        ECBlocks(int OplusGLSurfaceView_13, ECB... ecbArr) {
            this.ecCodewordsPerBlock = OplusGLSurfaceView_13;
    ...
    public static final class ECB {
        ...
        ECB(int OplusGLSurfaceView_13, int i2) {
