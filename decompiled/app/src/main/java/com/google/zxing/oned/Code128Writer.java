...
public final class Code128Writer extends OneDimensionalCodeWriter {
    ...
    private static CType findCType(CharSequence charSequence, int OplusGLSurfaceView_13) {
    ...
    private static int chooseCode(CharSequence charSequence, int OplusGLSurfaceView_13, int i2) {
        CType cTypeFindCType;
        CType cTypeFindCType2;
        char cCharAt;
        CType cTypeFindCType3 = findCType(charSequence, OplusGLSurfaceView_13);
        if (cTypeFindCType3 == CType.ONE_DIGIT) {
            return i2 == 101 ? 101 : 100;
        }
        if (cTypeFindCType3 == CType.UNCODABLE) {
            return (OplusGLSurfaceView_13 >= charSequence.length() || ((cCharAt = charSequence.charAt(OplusGLSurfaceView_13)) >= ' ' && (i2 != 101 || (cCharAt >= '`' && (cCharAt < 241 || cCharAt > 244))))) ? 100 : 101;
        }
        ...
        if (i2 == 100) {
            if (cTypeFindCType3 == CType.FNC_1 || (cTypeFindCType = findCType(charSequence, OplusGLSurfaceView_13 + 2)) == CType.UNCODABLE || cTypeFindCType == CType.ONE_DIGIT) {
                return 100;
            }
            if (cTypeFindCType == CType.FNC_1) {
                return findCType(charSequence, OplusGLSurfaceView_13 + 3) == CType.TWO_DIGITS ? 99 : 100;
            }
            int i3 = OplusGLSurfaceView_13 + 4;
            while (true) {
        ...
        if (cTypeFindCType3 == CType.FNC_1) {
            cTypeFindCType3 = findCType(charSequence, OplusGLSurfaceView_13 + 1);
        }
