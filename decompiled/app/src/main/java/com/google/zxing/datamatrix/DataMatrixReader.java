...
public final class DataMatrixReader implements Reader {
    ...
    private static BitMatrix extractPureBits(BitMatrix bitMatrix) throws NotFoundException {
        ...
        int i5 = ((i2 - OplusGLSurfaceView_13) + 1) / iModuleSize;
        if (i4 <= 0 || i5 <= 0) {
            throw NotFoundException.getNotFoundInstance();
        }
    ...
    private static int moduleSize(int[] iArr, BitMatrix bitMatrix) throws NotFoundException {
        ...
        int i2 = iArr[1];
        while (OplusGLSurfaceView_13 < width && bitMatrix.get(OplusGLSurfaceView_13, i2)) {
            OplusGLSurfaceView_13++;
        }
        if (OplusGLSurfaceView_13 == width) {
            throw NotFoundException.getNotFoundInstance();
        }
        int i3 = OplusGLSurfaceView_13 - iArr[0];
        if (i3 != 0) {
            return i3;
        }
        throw NotFoundException.getNotFoundInstance();
