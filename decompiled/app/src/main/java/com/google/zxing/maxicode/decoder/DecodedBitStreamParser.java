...
final class DecodedBitStreamParser {
    ...
    private static final char FS_renamed = 28;
    private static final char GS_renamed = 29;
    private static final char LATCHA = 65527;
    private static final char LATCHB = 65528;
    private static final char LOCK = 65529;
    private static final char NS_renamed = 65531;
    private static final char PAD = 65532;
    private static final char RS_renamed = 30;
    private static final java.lang.String[] SETS = {"\nABCDEFGHIJKLMNOPQRSTUVWXYZ\ufffa\u001c\u001d\u001e\ufffb ￼\"#$%&'()*+,-./0123456789:\ufff1\ufff2\ufff3\ufff4\ufff8", "`abcdefghijklmnopqrstuvwxyz\ufffa\u001c\u001d\u001e\ufffb{￼}~\u007f;<=>?[\\]^_ ,./:@!|￼\ufff5\ufff6￼\ufff0\ufff2\ufff3\ufff4\ufff7", "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚ\ufffa\u001c\u001d\u001eÛÜÝÞßª¬±²³µ¹º¼½¾\u0080\u0081\u0082\u0083\u0084\u0085\u0086\u0087\u0088\u0089\ufff7 \ufff9\ufff3\ufff4\ufff8", "àáâãäåæçèéêëìíîïðñòóôõö÷øùú\ufffa\u001c\u001d\u001e\ufffbûüýþÿ¡¨«¯°´·¸»¿\u008a\u008b\u008c\u008d\u008e\u008f\u0090\u0091\u0092\u0093\u0094\ufff7 \ufff2\ufff9\ufff4\ufff8", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b_renamed\t_renamed\n_renamed\u000b\f_renamed\r_renamed\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\ufffa￼￼\u001b\ufffb\u001c\u001d\u001e\u001f\u009f ¢£¤¥¦§©\u00ad®¶\u0095\u0096\u0097\u0098\u0099\u009a\u009b\u009c\u009d\u009e\ufff7 \ufff2\ufff3\ufff9\ufff8", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b_renamed\t_renamed\n_renamed\u000b\f_renamed\r_renamed\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?"};
    ...
    static com.google.zxing.common.DecoderResult decode(byte[] bArr, int i_renamed) {
        java.lang.String postCode3;
        java.lang.StringBuilder sb = new java.lang.StringBuilder(144);
        if (i_renamed == 2 || i_renamed == 3) {
            if (i_renamed == 2) {
                postCode3 = new java.text.DecimalFormat("0000000000".substring(0, getPostCode2Length(bArr))).format(getPostCode2(bArr));
            } else {
                postCode3 = getPostCode3(bArr);
            }
            java.text.DecimalFormat decimalFormat = new java.text.DecimalFormat("000");
            java.lang.String str = decimalFormat.format(getCountry(bArr));
            java.lang.String str2 = decimalFormat.format(getServiceClass(bArr));
            sb.append(getMessage(bArr, 10, 84));
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + GS_renamed + str + GS_renamed + str2 + GS_renamed);
            } else {
                sb.insert(0, postCode3 + GS_renamed + str + GS_renamed + str2 + GS_renamed);
            }
        } else if (i_renamed == 4) {
        ...
        return new com.google.zxing.common.DecoderResult(bArr, sb.toString(), null, java.lang.String.valueOf(i_renamed));
    }

    private static int getBit(int i_renamed, byte[] bArr) {
        int i2 = i_renamed - 1;
    ...
    private static int getInt(byte[] bArr, byte[] bArr2) {
        ...
        int bit = 0;
        for (int i_renamed = 0; i_renamed < bArr2.length; i_renamed++) {
            bit += getBit(bArr2[i_renamed], bArr) << ((bArr2.length - i_renamed) - 1);
        }
        return bit;
    }
        ...
        while (i3 < i_renamed + i2) {
            ...
            switch (cCharAt) {
                ...
                case 65531:
                    ...
                    i3 = i13 + 1;
                    sb.append(new java.text.DecimalFormat("000000000").format(i14 + bArr[i3]));
                    break;
            }
            int i15 = i6 - 1;
            if (i6 == 0) {
