...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f9335FS = 28;

    /* renamed from: GS */
    private static final char f9336GS = 29;
    private static final char LATCHA = 65527;
    private static final char LATCHB = 65528;
    private static final char LOCK = 65529;

    /* renamed from: NS */
    private static final char f9337NS = 65531;
    private static final char PAD = 65532;

    /* renamed from: RS */
    private static final char f9338RS = 30;
    private static final String[] SETS = {"\nABCDEFGHIJKLMNOPQRSTUVWXYZ\ufffa\u001c\u001d\u001e\ufffb ￼\"#$%&'()*+,-./0123456789:\ufff1\ufff2\ufff3\ufff4\ufff8", "`abcdefghijklmnopqrstuvwxyz\ufffa\u001c\u001d\u001e\ufffb{￼}~\u007f;<=>?[\\]^_ ,./:@!|￼\ufff5\ufff6￼\ufff0\ufff2\ufff3\ufff4\ufff7", "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚ\ufffa\u001c\u001d\u001eÛÜÝÞßª¬±²³µ¹º¼½¾\u0080\u0081\u0082\u0083\u0084\u0085\u0086\u0087\u0088\u0089\ufff7 \ufff9\ufff3\ufff4\ufff8", "àáâãäåæçèéêëìíîïðñòóôõö÷øùú\ufffa\u001c\u001d\u001e\ufffbûüýþÿ¡¨«¯°´·¸»¿\u008a\u008b\u008c\u008d\u008e\u008f\u0090\u0091\u0092\u0093\u0094\ufff7 \ufff2\ufff9\ufff4\ufff8", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\IntrinsicsJvm.kt_4\t\OplusGLSurfaceView_11\u000b\COUIBaseListPopupWindow_12\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\ufffa￼￼\u001b\ufffb\u001c\u001d\u001e\u001f\u009f ¢£¤¥¦§©\u00ad®¶\u0095\u0096\u0097\u0098\u0099\u009a\u009b\u009c\u009d\u009e\ufff7 \ufff2\ufff3\ufff9\ufff8", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\IntrinsicsJvm.kt_4\t\OplusGLSurfaceView_11\u000b\COUIBaseListPopupWindow_12\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?"};
    ...
    static DecoderResult decode(byte[] bArr, int OplusGLSurfaceView_13) {
        String postCode3;
        ...
        if (OplusGLSurfaceView_13 == 2 || OplusGLSurfaceView_13 == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + f9336GS + str + f9336GS + str2 + f9336GS);
            } else {
                sb.insert(0, postCode3 + f9336GS + str + f9336GS + str2 + f9336GS);
            }
        ...
        return new DecoderResult(bArr, sb.toString(), null, String.valueOf(OplusGLSurfaceView_13));
    }

    private static int getBit(int OplusGLSurfaceView_13, byte[] bArr) {
    ...
    private static int getInt(byte[] bArr, byte[] bArr2) {
        ...
        int bit = 0;
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < bArr2.length; OplusGLSurfaceView_13++) {
            bit += getBit(bArr2[OplusGLSurfaceView_13], bArr) << ((bArr2.length - OplusGLSurfaceView_13) - 1);
        }
        return bit;
    }
    ...
    private static String getMessage(byte[] bArr, int OplusGLSurfaceView_13, int i2) {
