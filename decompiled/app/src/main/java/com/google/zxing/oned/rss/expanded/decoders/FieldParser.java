...
import com.anc.humansdk.doubleexposure.BuildConfig;
...
final class FieldParser {
    ...
    private static final Object[][] TWO_DIGIT_DATA_LENGTH = {new Object[]{"00", 18}, new Object[]{"01", 14}, new Object[]{"02", 14}, new Object[]{FocusAimMsgData.KEY_INTELLIGENCE_VIEW_FOCUS_TYPE, VARIABLE_LENGTH, 20}, new Object[]{FocusAimMsgData.KEY_SEPARATE_METERING_FOCUS, 6}, new Object[]{"12", 6}, new Object[]{"13", 6}, new Object[]{"15", 6}, new Object[]{"17", 6}, new Object[]{"20", 2}, new Object[]{"21", VARIABLE_LENGTH, 20}, new Object[]{"22", VARIABLE_LENGTH, 29}, new Object[]{VideoMode.VIDEO_DEFAULT_FPS, VARIABLE_LENGTH, 8}, new Object[]{FilmModeMsgData.FUNC_KEY_ID_GRID, VARIABLE_LENGTH, 8}, new Object[]{"90", VARIABLE_LENGTH, 30}, new Object[]{"91", VARIABLE_LENGTH, 30}, new Object[]{"92", VARIABLE_LENGTH, 30}, new Object[]{"93", VARIABLE_LENGTH, 30}, new Object[]{"94", VARIABLE_LENGTH, 30}, new Object[]{"95", VARIABLE_LENGTH, 30}, new Object[]{"96", VARIABLE_LENGTH, 30}, new Object[]{"97", VARIABLE_LENGTH, 30}, new Object[]{"98", VARIABLE_LENGTH, 30}, new Object[]{"99", VARIABLE_LENGTH, 30}};
    ...
    private static String processFixedAI(int OplusGLSurfaceView_13, int i2, String str) throws NotFoundException {
        if (str.length() < OplusGLSurfaceView_13) {
            throw NotFoundException.getNotFoundInstance();
        }
        String strSubstring = str.substring(0, OplusGLSurfaceView_13);
        int i3 = i2 + OplusGLSurfaceView_13;
        if (str.length() < i3) {
            throw NotFoundException.getNotFoundInstance();
        }
        String strSubstring2 = str.substring(OplusGLSurfaceView_13, i3);
    ...
    private static String processVariableAI(int OplusGLSurfaceView_13, int i2, String str) throws NotFoundException {
        String strSubstring = str.substring(0, OplusGLSurfaceView_13);
        int iMin = Math.min(str.length(), i2 + OplusGLSurfaceView_13);
        String strSubstring2 = str.substring(OplusGLSurfaceView_13, iMin);
        String str2 = "(" + strSubstring + ')' + strSubstring2;
