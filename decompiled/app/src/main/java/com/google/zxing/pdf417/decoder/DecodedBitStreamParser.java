...
final class DecodedBitStreamParser {
    ...
    /* renamed from: AL */
    private static final int f9344AL = 28;

    /* renamed from: AS */
    private static final int f9345AS = 27;
    ...
    /* renamed from: LL */
    private static final int f9346LL = 27;
    ...
    /* renamed from: ML */
    private static final int f9347ML = 28;
    ...
    /* renamed from: PL */
    private static final int f9348PL = 25;

    /* renamed from: PS */
    private static final int f9349PS = 29;
    private static final int TEXT_COMPACTION_MODE_LATCH = 900;
    private static final char[] PUNCT_CHARS = ";<>@[\\]_`~!\r\t,:\OplusGLSurfaceView_11-.$/\"|*()?{}'".toCharArray();
    ...
    static {
        ...
        while (true) {
            ...
            if (OplusGLSurfaceView_13 >= bigIntegerArr2.length) {
                return;
            }
            bigIntegerArr2[OplusGLSurfaceView_13] = bigIntegerArr2[OplusGLSurfaceView_13 - 1].multiply(bigIntegerValueOf);
    ...
    */
    ...
    static int decodeMacroBlock(int[] iArr, int OplusGLSurfaceView_13, PDF417ResultMetadata pDF417ResultMetadata) throws FormatException {
        if (OplusGLSurfaceView_13 + 2 > iArr[0]) {
    ...
    private static int textCompaction(int[] iArr, int OplusGLSurfaceView_13, StringBuilder sb) {
        int[] iArr2 = new int[(iArr[0] - OplusGLSurfaceView_13) << 1];
        int[] iArr3 = new int[(iArr[0] - OplusGLSurfaceView_13) << 1];
        boolean z = false;
        int i2 = 0;
        while (OplusGLSurfaceView_13 < iArr[0] && !z) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:67:0x00d3 A[PHI: r1
     ...
     binds: [B:61:0x00c2, B:49:0x00a1, B:38:0x007e, B:24:0x0051] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not found exit edge by exit block: B:30:0x0067
    ...
    */
    ...
    private static String decodeBase900toBase10(int[] iArr, int OplusGLSurfaceView_13) throws FormatException {
        BigInteger bigIntegerAdd = BigInteger.ZERO;
        for (int i2 = 0; i2 < OplusGLSurfaceView_13; i2++) {
            bigIntegerAdd = bigIntegerAdd.add(EXP900[(OplusGLSurfaceView_13 - i2) - 1].multiply(BigInteger.valueOf(iArr[i2])));
        }
