...
public abstract class GridSampler {
    ...
    public abstract BitMatrix sampleGrid(BitMatrix bitMatrix, int OplusGLSurfaceView_13, int i2, float COUIBaseListPopupWindow_12, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16) throws NotFoundException;

    public abstract BitMatrix sampleGrid(BitMatrix bitMatrix, int OplusGLSurfaceView_13, int i2, PerspectiveTransform perspectiveTransform) throws NotFoundException;
