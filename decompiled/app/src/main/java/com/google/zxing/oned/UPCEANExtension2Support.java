...
final class UPCEANExtension2Support {
    ...
    private int decodeMiddle(BitArray bitArray, int[] iArr, StringBuilder sb) throws NotFoundException {
        ...
        int i2 = 0;
        while (OplusGLSurfaceView_13 < 2 && nextUnset < size) {
            ...
            if (iDecodeDigit >= 10) {
                i2 = (1 << (1 - OplusGLSurfaceView_13)) | i2;
            }
            nextUnset = OplusGLSurfaceView_13 != 1 ? bitArray.getNextUnset(bitArray.getNextSet(i3)) : i3;
