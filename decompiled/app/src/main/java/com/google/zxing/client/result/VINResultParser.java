...
public final class VINResultParser extends ResultParser {
    ...
    private static boolean checkChecksum(CharSequence charSequence) {
        ...
        while (OplusGLSurfaceView_13 < charSequence.length()) {
            int i2 = OplusGLSurfaceView_13 + 1;
            iVinPositionWeight += vinPositionWeight(i2) * vinCharValue(charSequence.charAt(OplusGLSurfaceView_13));
    ...
    private static int vinPositionWeight(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 > 0 && OplusGLSurfaceView_13 <= 7) {
            return 9 - OplusGLSurfaceView_13;
        }
        ...
        if (OplusGLSurfaceView_13 < 10 || OplusGLSurfaceView_13 > 17) {
            throw new IllegalArgumentException();
        }
        return 19 - OplusGLSurfaceView_13;
    }

    private static char checkChar(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 < 10) {
            return (char) (OplusGLSurfaceView_13 + 48);
        }
        if (OplusGLSurfaceView_13 == 10) {
            return 'X';
        }
