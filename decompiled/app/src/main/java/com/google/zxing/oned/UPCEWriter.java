...
public final class UPCEWriter extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length == 7) {
            ...
            } catch (FormatException COUIBaseListPopupWindow_8) {
        ...
        int OplusGLSurfaceView_13 = UPCEReader.NUMSYS_AND_CHECK_DIGIT_PATTERNS[iDigit][Character.digit(str.charAt(7), 10)];
        ...
        for (int i2 = 1; i2 <= 6; i2++) {
            ...
            if (((OplusGLSurfaceView_13 >> (6 - i2)) & 1) == 1) {
                iDigit2 += 10;
            }
