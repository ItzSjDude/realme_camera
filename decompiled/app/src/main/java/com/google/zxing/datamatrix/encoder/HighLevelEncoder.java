...
public final class HighLevelEncoder {
    ...
    private static char randomize253State(char c2, int OplusGLSurfaceView_13) {
        int i2 = c2 + ((OplusGLSurfaceView_13 * 149) % 253) + 1;
        if (i2 > 254) {
            i2 -= 254;
        }
        return (char) i2;
    ...
    static int lookAheadTest(CharSequence charSequence, int OplusGLSurfaceView_13, int i2) {
        float[] fArr;
        char c2;
        if (OplusGLSurfaceView_13 >= charSequence.length()) {
            return i2;
        }
        if (i2 == 0) {
        ...
        while (true) {
            ...
            if (i3 >= 4) {
                ...
                if (iArr2[1] + 1 < iArr2[0] && iArr2[1] + 1 < iArr2[5] && iArr2[1] + 1 < iArr2[4] && iArr2[1] + 1 < iArr2[2]) {
                    ...
                    if (iArr2[1] == iArr2[3]) {
                        for (int i5 = OplusGLSurfaceView_13 + i3 + 1; i5 < charSequence.length(); i5++) {
    ...
    private static int findMinimums(float[] fArr, int[] iArr, int OplusGLSurfaceView_13, byte[] bArr) {
    ...
    public static int determineConsecutiveDigitCount(CharSequence charSequence, int OplusGLSurfaceView_13) {
