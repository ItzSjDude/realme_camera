...
public final class HighLevelEncoder {
    ...
    private static final java.lang.String MACRO_05_HEADER = "[)>\u001e05\u001d";
    private static final char MACRO_06 = 237;
    private static final java.lang.String MACRO_06_HEADER = "[)>\u001e06\u001d";
    ...
    private static boolean isX12TermSep(char c2) {
        return c2 == '\r_renamed' || c2 == '*' || c2 == '>';
    }

    private HighLevelEncoder() {
    }

    private static char randomize253State(char c2, int i_renamed) {
        int i2 = c2 + ((i_renamed * 149) % 253) + 1;
        if (i2 > 254) {
            i2 -= 254;
        }
        return (char) i2;
    ...
    public static java.lang.String encodeHighLevel(java.lang.String str) {
        return encodeHighLevel(str, com.google.zxing.datamatrix.encoder.SymbolShapeHint.FORCE_NONE, null, null);
    }
    ...
    static int lookAheadTest(java.lang.CharSequence charSequence, int i_renamed, int i2) {
        float[] fArr;
        char c2;
        if (i_renamed >= charSequence.length()) {
            return i2;
        }
        if (i2 == 0) {
        ...
        while (true) {
            ...
            if (isDigit(cCharAt)) {
                ...
                fArr[0] = (float) java.lang.Math.ceil(fArr[0]);
                fArr[0] = fArr[0] + 2.0f;
            } else {
                fArr[0] = (float) java.lang.Math.ceil(fArr[0]);
                fArr[0] = fArr[0] + 1.0f;
            ...
            if (i3 >= 4) {
                ...
                if (iArr2[1] + 1 < iArr2[0] && iArr2[1] + 1 < iArr2[5] && iArr2[1] + 1 < iArr2[4] && iArr2[1] + 1 < iArr2[2]) {
                    ...
                    if (iArr2[1] == iArr2[3]) {
                        for (int i5 = i_renamed + i3 + 1; i5 < charSequence.length(); i5++) {
    ...
    private static int findMinimums(float[] fArr, int[] iArr, int i_renamed, byte[] bArr) {
        java.util.Arrays.fill(bArr, (byte) 0);
        int i2 = i_renamed;
        for (int i3 = 0; i3 < 6; i3++) {
            iArr[i3] = (int) java.lang.Math.ceil(fArr[i3]);
            int i4 = iArr[i3];
            if (i2 > i4) {
                java.util.Arrays.fill(bArr, (byte) 0);
                i2 = i4;
    ...
    public static int determineConsecutiveDigitCount(java.lang.CharSequence charSequence, int i_renamed) {
    ...
    static void illegalCharacter(char c2) {
        ...
        throw new java.lang.IllegalArgumentException("Illegal character: " + c2 + " (0x" + ("0000".substring(0, 4 - hexString.length()) + hexString) + ')');
    }
}
