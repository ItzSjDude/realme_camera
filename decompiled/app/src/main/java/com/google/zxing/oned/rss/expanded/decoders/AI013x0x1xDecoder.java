...
final class AI013x0x1xDecoder extends AI01weightDecoder {
    ...
    private void encodeCompressedDate(StringBuilder sb, int OplusGLSurfaceView_13) {
        int iExtractNumericValueFromBitArray = getGeneralDecoder().extractNumericValueFromBitArray(OplusGLSurfaceView_13, 16);
    ...
    protected void addWeightCode(StringBuilder sb, int OplusGLSurfaceView_13) {
        ...
        sb.append(OplusGLSurfaceView_13 / 100000);
        sb.append(')');
    }

    @Override // com.google.zxing.oned.rss.expanded.decoders.AI01weightDecoder
    protected int checkWeight(int OplusGLSurfaceView_13) {
        return OplusGLSurfaceView_13 % 100000;
    }
}
