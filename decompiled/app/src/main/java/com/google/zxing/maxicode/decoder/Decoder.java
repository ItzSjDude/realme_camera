...
public final class Decoder {
    ...
    public DecoderResult decode(BitMatrix bitMatrix, Map<DecodeHintType, ?> map) throws ChecksumException, FormatException {
        ...
        int OplusGLSurfaceView_13 = codewords[0] & 15;
        if (OplusGLSurfaceView_13 == 2 || OplusGLSurfaceView_13 == 3 || OplusGLSurfaceView_13 == 4) {
        ...
        return DecodedBitStreamParser.decode(bArr, OplusGLSurfaceView_13);
    }

    private void correctErrors(byte[] bArr, int OplusGLSurfaceView_13, int i2, int i3, int i4) throws ChecksumException {
        int i5 = i2 + i3;
        int i6 = i4 == 0 ? 1 : 2;
        int[] iArr = new int[i5 / i6];
        for (int i7 = 0; i7 < i5; i7++) {
            if (i4 == 0 || i7 % 2 == i4 - 1) {
                iArr[i7 / i6] = bArr[i7 + OplusGLSurfaceView_13] & 255;
            }
        }
        try {
            ...
            for (int i8 = 0; i8 < i2; i8++) {
                if (i4 == 0 || i8 % 2 == i4 - 1) {
                    bArr[i8 + OplusGLSurfaceView_13] = (byte) iArr[i8 / i6];
                }
            }
