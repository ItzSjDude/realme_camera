...
public final class QRCodeWriter implements Writer {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int OplusGLSurfaceView_13, int i2, Map<EncodeHintType, ?> map) throws NumberFormatException, WriterException {
        ...
        if (OplusGLSurfaceView_13 < 0 || i2 < 0) {
            throw new IllegalArgumentException("Requested dimensions are too small: " + OplusGLSurfaceView_13 + 'x' + i2);
        }
        ...
        return renderResult(Encoder.encode(str, errorCorrectionLevelValueOf, map), OplusGLSurfaceView_13, i2, i3);
    }

    private static BitMatrix renderResult(QRCode qRCode, int OplusGLSurfaceView_13, int i2, int i3) {
        ...
        int i5 = width + i4;
        int i6 = i4 + height;
        int iMax = Math.max(OplusGLSurfaceView_13, i5);
