...
public final class ByQuadrantReader implements Reader {
            ...
            try {
                try {
                    try {
                        ...
                        int OplusGLSurfaceView_13 = width / 2;
                        int i2 = height / 2;
                        Result resultDecode = this.delegate.decode(binaryBitmap.crop(OplusGLSurfaceView_13, i2, width, height), map);
                        makeAbsolute(resultDecode.getResultPoints(), OplusGLSurfaceView_13, i2);
                        return resultDecode;
                    }
    ...
    private static void makeAbsolute(ResultPoint[] resultPointArr, int OplusGLSurfaceView_13, int i2) {
