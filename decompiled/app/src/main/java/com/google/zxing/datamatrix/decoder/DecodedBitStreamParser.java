...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (modeDecodeAsciiSegment == Mode.ASCII_ENCODE) {
                ...
                int OplusGLSurfaceView_13 = C21171.f9334xb73eb560[modeDecodeAsciiSegment.ordinal()];
    ...
    static /* synthetic */ class C21171 {

        /* renamed from: $SwitchMap$com$google$zxing$datamatrix$decoder$DecodedBitStreamParser$Mode */
        static final /* synthetic */ int[] f9334xb73eb560 = new int[Mode.values().length];

        static {
            try {
                f9334xb73eb560[Mode.C40_ENCODE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9334xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9334xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9334xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9334xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
    ...
    private static Mode decodeAsciiSegment(BitSource bitSource, StringBuilder sb, StringBuilder sb2) throws FormatException {
        ...
        do {
            ...
            if (bits > 128) {
                if (bits != 129) {
                    if (bits <= 229) {
                        int OplusGLSurfaceView_13 = bits - 130;
    ...
    private static void parseTwoBytes(int OplusGLSurfaceView_13, int i2, int[] iArr) {
        int i3 = ((OplusGLSurfaceView_13 << 8) + i2) - 1;
        int i4 = i3 / 1600;
        iArr[0] = i4;
        int i5 = i3 - (i4 * 1600);
        int i6 = i5 / 40;
    ...
    private static void decodeBase256Segment(BitSource bitSource, StringBuilder sb, Collection<byte[]> collection) throws FormatException {
        ...
        int OplusGLSurfaceView_13 = byteOffset + 1;
        ...
        if (iUnrandomize255State == 0) {
            ...
            iUnrandomize255State = ((iUnrandomize255State - 249) * 250) + unrandomize255State(bitSource.readBits(8), OplusGLSurfaceView_13);
        ...
        while (i2 < iUnrandomize255State) {
            ...
            bArr[i2] = (byte) unrandomize255State(bitSource.readBits(8), OplusGLSurfaceView_13);
            i2++;
            OplusGLSurfaceView_13++;
        }
        collection.add(bArr);
        try {
            ...
            throw new IllegalStateException("Platform does not support required encoding: ".concat(String.valueOf(COUIBaseListPopupWindow_8)));
        }
    }

    private static int unrandomize255State(int OplusGLSurfaceView_13, int i2) {
        int i3 = OplusGLSurfaceView_13 - (((i2 * 149) % 255) + 1);
