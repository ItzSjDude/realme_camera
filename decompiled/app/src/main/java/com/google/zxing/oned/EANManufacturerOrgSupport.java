...
final class EANManufacturerOrgSupport {
    ...
    java.lang.String lookupCountryIdentifier(java.lang.String str) throws java.lang.NumberFormatException {
        int[] iArr;
        int i_renamed;
        initIfNeeded();
        int i2 = java.lang.Integer.parseInt(str.substring(0, 3));
        int size = this.ranges.size();
        for (int i3 = 0; i3 < size && i2 >= (i_renamed = (iArr = this.ranges.get(i3))[0]); i3++) {
            if (iArr.length != 1) {
                i_renamed = iArr[1];
            }
            if (i2 <= i_renamed) {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{478}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{com.oplus.ocs.camera.CameraParameter.VideoFps.FPS_480}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            add(new int[]{com.android.providers.downloads.Downloads.Impl.STATUS_CANNOT_RESUME}, "HK");
            add(new int[]{com.android.providers.downloads.Downloads.Impl.STATUS_CANCELED, 499}, "JP");
            ...
            add(new int[]{com.arcsoft.arcsoftjni.ArcSoftOffscreen.ASVL_PAF_RGB32_B8G8R8A8}, "CO");
            add(new int[]{com.arcsoft.arcsoftjni.ArcSoftOffscreen.ASVL_PAF_RGB32_R8G8B8A8}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
            add(new int[]{780}, "CL");
            ...
            add(new int[]{885}, "TH");
            add(new int[]{888}, "SG");
            add(new int[]{890}, "IN_renamed");
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID_renamed");
            add(new int[]{com.oplus.tblplayer.IMediaPlayer.MEDIA_INFO_TIMED_TEXT_ERROR, 919}, "AT");
