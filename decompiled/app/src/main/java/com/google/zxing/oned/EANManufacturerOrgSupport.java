...
final class EANManufacturerOrgSupport {
    ...
    String lookupCountryIdentifier(String str) throws NumberFormatException {
        ...
        for (int i3 = 0; i3 < size && i2 >= (OplusGLSurfaceView_13 = (iArr = this.ranges.get(i3))[0]); i3++) {
            if (iArr.length != 1) {
                OplusGLSurfaceView_13 = iArr[1];
            }
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{478}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{CameraParameter.VideoFps.FPS_480}, "PH");
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            ...
            add(new int[]{ArcSoftOffscreen.ASVL_PAF_RGB32_B8G8R8A8}, "CO");
            add(new int[]{ArcSoftOffscreen.ASVL_PAF_RGB32_R8G8B8A8}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
            add(new int[]{780}, "CL");
            ...
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
            add(new int[]{IMediaPlayer.MEDIA_INFO_TIMED_TEXT_ERROR, 919}, "AT");
