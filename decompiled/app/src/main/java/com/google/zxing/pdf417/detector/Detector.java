...
public final class Detector {
    ...
    public static PDF417DetectorResult detect(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z) throws NotFoundException {
        ...
        if (listDetect.isEmpty()) {
            blackMatrix = blackMatrix.m26295clone();
    ...
    */
    ...
    private static ResultPoint[] findVertices(BitMatrix bitMatrix, int OplusGLSurfaceView_13, int i2) {
        int height = bitMatrix.getHeight();
        int width = bitMatrix.getWidth();
        ResultPoint[] resultPointArr = new ResultPoint[8];
        copyToResult(resultPointArr, findRowsWithPattern(bitMatrix, height, width, OplusGLSurfaceView_13, i2, START_PATTERN), INDEXES_START_PATTERN);
        if (resultPointArr[4] != null) {
            i2 = (int) resultPointArr[4].getX();
            OplusGLSurfaceView_13 = (int) resultPointArr[4].getY();
        }
        copyToResult(resultPointArr, findRowsWithPattern(bitMatrix, height, width, OplusGLSurfaceView_13, i2, STOP_PATTERN), INDEXES_STOP_PATTERN);
        return resultPointArr;
    }

    private static void copyToResult(ResultPoint[] resultPointArr, ResultPoint[] resultPointArr2, int[] iArr) {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < iArr.length; OplusGLSurfaceView_13++) {
            resultPointArr[iArr[OplusGLSurfaceView_13]] = resultPointArr2[OplusGLSurfaceView_13];
        }
    }

    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int OplusGLSurfaceView_13, int i2, int i3, int i4, int[] iArr) {
        boolean z;
        int i5;
        int[] iArr2;
        ...
        while (true) {
            ...
            if (iArrFindGuardPattern != null) {
                ...
                float COUIBaseListPopupWindow_12 = i6;
                resultPointArr[0] = new ResultPoint(iArr2[0], COUIBaseListPopupWindow_12);
                resultPointArr[1] = new ResultPoint(iArr2[1], COUIBaseListPopupWindow_12);
                z = true;
            } else {
                i6 += 5;
            }
    ...
    private static int[] findGuardPattern(BitMatrix bitMatrix, int OplusGLSurfaceView_13, int i2, int i3, boolean z, int[] iArr, int[] iArr2) {
        Arrays.fill(iArr2, 0, iArr2.length, 0);
        int i4 = 0;
        while (bitMatrix.get(OplusGLSurfaceView_13, i2) && OplusGLSurfaceView_13 > 0) {
            int i5 = i4 + 1;
            if (i4 >= 3) {
                break;
            }
        ...
        while (true) {
            if (OplusGLSurfaceView_13 >= i3) {
                ...
                return new int[]{i6, OplusGLSurfaceView_13 - 1};
            }
            if (bitMatrix.get(OplusGLSurfaceView_13, i2) != z2) {
                iArr2[i7] = iArr2[i7] + 1;
            } else {
                if (i7 != length - 1) {
                    i7++;
                    ...
                    if (patternMatchVariance(iArr2, iArr, MAX_INDIVIDUAL_VARIANCE) < MAX_AVG_VARIANCE) {
                        return new int[]{i6, OplusGLSurfaceView_13};
                    }
                    i6 += iArr2[0] + iArr2[1];
                    int i8 = i7 - 1;
    ...
    private static float patternMatchVariance(int[] iArr, int[] iArr2, float COUIBaseListPopupWindow_12) {
        int length = iArr.length;
