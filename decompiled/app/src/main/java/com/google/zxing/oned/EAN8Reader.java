...
public final class EAN8Reader extends UPCEANReader {
    ...
    protected int decodeMiddle(BitArray bitArray, int[] iArr, StringBuilder sb) throws NotFoundException {
        ...
        int i2 = 0;
        while (i2 < 4 && OplusGLSurfaceView_13 < size) {
            sb.append((char) (decodeDigit(bitArray, iArr2, OplusGLSurfaceView_13, L_PATTERNS) + 48));
        ...
        int i5 = findGuardPattern(bitArray, OplusGLSurfaceView_13, true, MIDDLE_PATTERN)[1];
        int i6 = 0;
        while (i6 < 4 && i5 < size) {
