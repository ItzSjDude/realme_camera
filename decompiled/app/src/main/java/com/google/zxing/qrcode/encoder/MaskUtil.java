...
final class MaskUtil {
    ...
    /* renamed from: N1 */
    private static final int f9356N1 = 3;

    /* renamed from: N2 */
    private static final int f9357N2 = 3;

    /* renamed from: N3 */
    private static final int f9358N3 = 40;

    /* renamed from: N4 */
    private static final int f9359N4 = 10;
    ...
    static int applyMaskPenaltyRule2(ByteMatrix byteMatrix) {
        ...
        int i2 = 0;
        while (OplusGLSurfaceView_13 < height - 1) {
            byte[] bArr = array[OplusGLSurfaceView_13];
            int i3 = i2;
            int i4 = 0;
            while (i4 < width - 1) {
                byte b2 = bArr[i4];
    ...
    static int applyMaskPenaltyRule3(ByteMatrix byteMatrix) {
        ...
        int OplusGLSurfaceView_13 = 0;
        int i2 = 0;
        while (OplusGLSurfaceView_13 < height) {
            int i3 = i2;
            for (int i4 = 0; i4 < width; i4++) {
                ...
                int i6 = OplusGLSurfaceView_13 + 6;
                if (i6 < height && array[OplusGLSurfaceView_13][i4] == 1 && array[OplusGLSurfaceView_13 + 1][i4] == 0 && array[OplusGLSurfaceView_13 + 2][i4] == 1 && array[OplusGLSurfaceView_13 + 3][i4] == 1 && array[OplusGLSurfaceView_13 + 4][i4] == 1 && array[OplusGLSurfaceView_13 + 5][i4] == 0 && array[i6][i4] == 1 && (isWhiteVertical(array, i4, OplusGLSurfaceView_13 - 4, OplusGLSurfaceView_13) || isWhiteVertical(array, i4, OplusGLSurfaceView_13 + 7, OplusGLSurfaceView_13 + 11))) {
                    i3++;
                }
            }
            OplusGLSurfaceView_13++;
    ...
    private static boolean isWhiteHorizontal(byte[] bArr, int OplusGLSurfaceView_13, int i2) {
        int iMin = Math.min(i2, bArr.length);
        for (int iMax = Math.max(OplusGLSurfaceView_13, 0); iMax < iMin; iMax++) {
            if (bArr[iMax] == 1) {
                return false;
            }
        }
    ...
    private static boolean isWhiteVertical(byte[][] bArr, int OplusGLSurfaceView_13, int i2, int i3) {
        int iMin = Math.min(i3, bArr.length);
        for (int iMax = Math.max(i2, 0); iMax < iMin; iMax++) {
            if (bArr[iMax][OplusGLSurfaceView_13] == 1) {
                return false;
            }
        }
        return true;
