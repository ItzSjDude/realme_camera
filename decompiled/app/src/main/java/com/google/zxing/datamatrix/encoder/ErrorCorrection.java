...
public final class ErrorCorrection {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 255; i2++) {
            ALOG[i2] = OplusGLSurfaceView_13;
            LOG[OplusGLSurfaceView_13] = i2;
            OplusGLSurfaceView_13 <<= 1;
            if (OplusGLSurfaceView_13 >= 256) {
                OplusGLSurfaceView_13 ^= 301;
            }
        }
    }
    ...
    public static String encodeECC200(String str, SymbolInfo symbolInfo) {
        ...
        if (interleavedBlockCount == 1) {
            ...
            while (OplusGLSurfaceView_13 < interleavedBlockCount) {
                int i2 = OplusGLSurfaceView_13 + 1;
                iArr[OplusGLSurfaceView_13] = symbolInfo.getDataLengthForInterleavedBlock(i2);
                iArr2[OplusGLSurfaceView_13] = symbolInfo.getErrorLengthForInterleavedBlock(i2);
    ...
    private static String createECCBlock(CharSequence charSequence, int OplusGLSurfaceView_13) {
        return createECCBlock(charSequence, 0, charSequence.length(), OplusGLSurfaceView_13);
    }

    private static String createECCBlock(CharSequence charSequence, int OplusGLSurfaceView_13, int i2, int i3) {
        int i4 = 0;
        while (true) {
        ...
        for (int i6 = OplusGLSurfaceView_13; i6 < OplusGLSurfaceView_13 + i2; i6++) {
            int i7 = i3 - 1;
