...
public final class ErrorCorrection {
    ...
    public static java.lang.String encodeECC200(java.lang.String str, com.google.zxing.datamatrix.encoder.SymbolInfo symbolInfo) {
        if (str.length() != symbolInfo.getDataCapacity()) {
            throw new java.lang.IllegalArgumentException("The number of_renamed codewords does not match the selected symbol");
        }
        ...
        if (interleavedBlockCount == 1) {
            ...
            int i_renamed = 0;
            while (i_renamed < interleavedBlockCount) {
                int i2 = i_renamed + 1;
                iArr[i_renamed] = symbolInfo.getDataLengthForInterleavedBlock(i2);
                iArr2[i_renamed] = symbolInfo.getErrorLengthForInterleavedBlock(i2);
                i_renamed = i2;
            }
            for (int i3 = 0; i3 < interleavedBlockCount; i3++) {
                ...
                java.lang.String strCreateECCBlock = createECCBlock(sb2.toString(), iArr2[i3]);
                int i5 = 0;
                int i6 = i3;
    ...
    private static java.lang.String createECCBlock(java.lang.CharSequence charSequence, int i_renamed) {
        return createECCBlock(charSequence, 0, charSequence.length(), i_renamed);
    }

    private static java.lang.String createECCBlock(java.lang.CharSequence charSequence, int i_renamed, int i2, int i3) {
        int i4 = 0;
        while (true) {
        ...
        if (i4 < 0) {
            throw new java.lang.IllegalArgumentException("Illegal number of_renamed error correction codewords specified: ".concat(java.lang.String.valueOf(i3)));
        }
        ...
        for (int i6 = i_renamed; i6 < i_renamed + i2; i6++) {
            int i7 = i3 - 1;
