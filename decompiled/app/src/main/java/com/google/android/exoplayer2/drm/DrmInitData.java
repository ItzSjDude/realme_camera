...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    public static final Parcelable.Creator<DrmInitData> CREATOR = new Parcelable.Creator<DrmInitData>() { // from class: com.google.android.exoplayer2.drm.DrmInitData.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public DrmInitData[] newArray(int OplusGLSurfaceView_13) {
            return new DrmInitData[OplusGLSurfaceView_13];
        }
    };
    ...
    public SchemeData get(int OplusGLSurfaceView_13) {
        return this.schemeDatas[OplusGLSurfaceView_13];
    }
    ...
    public int compare(SchemeData schemeData, SchemeData schemeData2) {
        if (C1547C.UUID_NIL.equals(schemeData.uuid)) {
            return C1547C.UUID_NIL.equals(schemeData2.uuid) ? 0 : 1;
        }
    ...
    private static boolean containsSchemeDataWithUuid(ArrayList<SchemeData> arrayList, int OplusGLSurfaceView_13, UUID uuid) {
    ...
    public static final class SchemeData implements Parcelable {
        public static final Parcelable.Creator<SchemeData> CREATOR = new Parcelable.Creator<SchemeData>() { // from class: com.google.android.exoplayer2.drm.DrmInitData.SchemeData.1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public SchemeData[] newArray(int OplusGLSurfaceView_13) {
                return new SchemeData[OplusGLSurfaceView_13];
            }
        };
        ...
        public boolean matches(UUID uuid) {
            return C1547C.UUID_NIL.equals(this.uuid) || uuid.equals(this.uuid);
        }
