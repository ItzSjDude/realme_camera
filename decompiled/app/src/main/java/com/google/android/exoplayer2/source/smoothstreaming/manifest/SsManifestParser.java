...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    private static abstract class ElementParser {
        ...
        public final Object parse(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
            ...
            while (true) {
                ...
                if (eventType == 2) {
                    ...
                    if (eventType == 4 && z && OplusGLSurfaceView_13 == 0) {
        ...
        protected final Object getNormalizedAttribute(String str) {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.normalizedAttributes.size(); OplusGLSurfaceView_13++) {
                Pair<String, Object> pair = this.normalizedAttributes.get(OplusGLSurfaceView_13);
        ...
        protected final int parseInt(XmlPullParser xmlPullParser, String str, int OplusGLSurfaceView_13) throws ParserException {
            String attributeValue = xmlPullParser.getAttributeValue(null, str);
            if (attributeValue == null) {
        ...
        protected final long parseLong(XmlPullParser xmlPullParser, String str, long OplusGLSurfaceView_15) throws ParserException {
            String attributeValue = xmlPullParser.getAttributeValue(null, str);
            if (attributeValue == null) {
        ...
        public Object build() {
            ...
            if (protectionElement != null) {
                ...
                for (SsManifest.StreamElement streamElement : streamElementArr) {
                    int OplusGLSurfaceView_13 = streamElement.type;
                    if (OplusGLSurfaceView_13 == 2 || OplusGLSurfaceView_13 == 1) {
    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private static final String KEY_FRAGMENT_DURATION = "IntrinsicsJvm.kt_5";
        ...
        private static final String TAG_STREAM_FRAGMENT = "IntrinsicsJvm.kt_3";
        private final String baseUri;
        ...
        private void parseStreamFragmentStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            long OplusGLSurfaceView_15 = parseLong(xmlPullParser, KEY_FRAGMENT_REPEAT_COUNT, 1L);
            if (OplusGLSurfaceView_15 > 1 && this.lastChunkDuration == -9223372036854775807L) {
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (iIntValue == 2) {
                this.format = Format.createVideoContainerFormat(attributeValue, str, MimeTypes.VIDEO_MP4, strFourCCToMimeType, null, requiredInt, parseRequiredInt(xmlPullParser, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser.getAttributeValue(null, KEY_CODEC_PRIVATE_DATA)), 0);
                return;
            }
            if (iIntValue != 1) {
                if (iIntValue == 3) {
                    this.format = Format.createTextContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, strFourCCToMimeType, null, requiredInt, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
                    return;
                } else {
                    this.format = Format.createContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, strFourCCToMimeType, null, requiredInt, 0, null);
                    return;
                }
            }
            ...
            this.format = Format.createAudioContainerFormat(attributeValue, str, MimeTypes.AUDIO_MP4, strFourCCToMimeType, null, requiredInt, requiredInt2, requiredInt3, listBuildCodecSpecificData, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
        }
        ...
        private static String fourCCToMimeType(String str) {
            if (str.equalsIgnoreCase(CameraParameter.VideoEncoder.H264) || str.equalsIgnoreCase("X264") || str.equalsIgnoreCase("AVC1") || str.equalsIgnoreCase("DAVC")) {
