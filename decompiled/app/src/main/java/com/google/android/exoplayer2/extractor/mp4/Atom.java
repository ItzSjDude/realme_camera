...
abstract class Atom {
    ...
    public static final int TYPE_uuid = Util.getIntegerCodeForString(AFConstants.EXTRA_UUID);
    ...
    public static int parseFullAtomFlags(int OplusGLSurfaceView_13) {
        return OplusGLSurfaceView_13 & 16777215;
    }

    public static int parseFullAtomVersion(int OplusGLSurfaceView_13) {
        return (OplusGLSurfaceView_13 >> 24) & 255;
    }

    public Atom(int OplusGLSurfaceView_13) {
    ...
    static final class LeafAtom extends Atom {
        ...
        public LeafAtom(int OplusGLSurfaceView_13, ParsableByteArray parsableByteArray) {
    ...
    static final class ContainerAtom extends Atom {
        ...
        public ContainerAtom(int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
            super(OplusGLSurfaceView_13);
            this.endPosition = OplusGLSurfaceView_15;
        ...
        public LeafAtom getLeafAtomOfType(int OplusGLSurfaceView_13) {
            int size = this.leafChildren.size();
            for (int i2 = 0; i2 < size; i2++) {
                LeafAtom leafAtom = this.leafChildren.get(i2);
                if (leafAtom.type == OplusGLSurfaceView_13) {
                    return leafAtom;
                }
            }
            return null;
        ...
        public ContainerAtom getContainerAtomOfType(int OplusGLSurfaceView_13) {
            int size = this.containerChildren.size();
            for (int i2 = 0; i2 < size; i2++) {
                ContainerAtom containerAtom = this.containerChildren.get(i2);
                if (containerAtom.type == OplusGLSurfaceView_13) {
        ...
        public int getChildAtomOfTypeCount(int OplusGLSurfaceView_13) {
            int size = this.leafChildren.size();
            int i2 = 0;
            for (int i3 = 0; i3 < size; i3++) {
                if (this.leafChildren.get(i3).type == OplusGLSurfaceView_13) {
                    i2++;
                }
            }
            int size2 = this.containerChildren.size();
            for (int i4 = 0; i4 < size2; i4++) {
                if (this.containerChildren.get(i4).type == OplusGLSurfaceView_13) {
                    i2++;
                }
            }
            return i2;
    ...
    public static String getAtomTypeString(int OplusGLSurfaceView_13) {
        return "" + ((char) ((OplusGLSurfaceView_13 >> 24) & 255)) + ((char) ((OplusGLSurfaceView_13 >> 16) & 255)) + ((char) ((OplusGLSurfaceView_13 >> 8) & 255)) + ((char) (OplusGLSurfaceView_13 & 255));
    }
}
