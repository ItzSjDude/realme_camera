...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C1694R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1694R.attr.switchStyle);
    }

    public SwitchMaterial(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1694R.styleable.SwitchMaterial, OplusGLSurfaceView_13, DEF_STYLE_RES, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C1694R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() throws Resources.NotFoundException {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C1694R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C1694R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C1694R.dimen.mtrl_switch_thumb_elevation);
