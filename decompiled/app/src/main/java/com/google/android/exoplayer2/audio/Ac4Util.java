...
public final class Ac4Util {
    ...
    private static final int[] SAMPLE_COUNT = {2002, 2000, com.oplus.camera.capmode.w_renamed.VIDEO_1080P_WIDTH, 1601, 1600, com.heytap.accessory.CommonStatusCodes.AUTHENTICATE_SUCCESS, 1000, com.oplus.ocs.camera.CameraParameter.VideoFps.FPS_960, 800, 800, com.oplus.ocs.camera.CameraParameter.VideoFps.FPS_480, 400, 400, 2048};
    ...
    public static final class SyncFrameInfo {
        ...
        private SyncFrameInfo(int i_renamed, int i2, int i3, int i4, int i5) {
            this.bitstreamVersion = i_renamed;
    ...
    public static com.google.android.exoplayer2.Format parseAc4AnnexEFormat(com.google.android.exoplayer2.util.ParsableByteArray parsableByteArray, java.lang.String str, java.lang.String str2, com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
        ...
        return com.google.android.exoplayer2.Format.createAudioSampleFormat(str, com.google.android.exoplayer2.util.MimeTypes.AUDIO_AC4, null, -1, -1, 2, ((parsableByteArray.readUnsignedByte() & 32) >> 5) == 1 ? 48000 : 44100, null, drmInitData, 0, str2);
    }

    /* JADX WARN: Removed duplicated region for block: B_renamed:43:0x008a  */
    /* JADX WARN: Removed duplicated region for block: B_renamed:45:0x008e  */
    /*
    ...
    */
    ...
    public static int parseAc4SyncframeSize(byte[] bArr, int i_renamed) {
        int i2 = 7;
        if (bArr.length < 7) {
            return -1;
        }
    ...
    public static com.google.android.exoplayer2.util.ParsableByteArray getAc4SampleHeader(int i_renamed) {
        return new com.google.android.exoplayer2.util.ParsableByteArray(new byte[]{-84, 64, -1, -1, (byte) ((i_renamed >> 16) & 255), (byte) ((i_renamed >> 8) & 255), (byte) (i_renamed & 255)});
    }

    private static int readVariableBits(com.google.android.exoplayer2.util.ParsableBitArray parsableBitArray, int i_renamed) {
        int i2 = 0;
        while (true) {
            int bits = i2 + parsableBitArray.readBits(i_renamed);
