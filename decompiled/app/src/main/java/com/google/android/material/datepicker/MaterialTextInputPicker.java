...
public final class MaterialTextInputPicker<S> extends PickerFragment<S> {
    ...
    public DateSelector<S> getDateSelector() {
        ...
        throw new IllegalStateException("dateSelector should not be null. Use MaterialTextInputPicker#newInstance() to create this fragment with PlatformImplementations.kt_3 DateSelector, and call this method after the fragment has been created.");
    }
}
