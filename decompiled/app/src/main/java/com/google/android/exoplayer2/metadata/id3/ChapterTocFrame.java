...
public final class ChapterTocFrame extends Id3Frame {
    public static final Parcelable.Creator<ChapterTocFrame> CREATOR = new Parcelable.Creator<ChapterTocFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.ChapterTocFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ChapterTocFrame[] newArray(int OplusGLSurfaceView_13) {
            return new ChapterTocFrame[OplusGLSurfaceView_13];
        }
    };

    /* renamed from: ID */
    public static final String f8994ID = "CTOC";
    ...
    public int hashCode() {
        int OplusGLSurfaceView_13 = (((527 + (this.isRoot ? 1 : 0)) * 31) + (this.isOrdered ? 1 : 0)) * 31;
