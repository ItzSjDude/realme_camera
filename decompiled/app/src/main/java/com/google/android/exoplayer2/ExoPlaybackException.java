...
public final class ExoPlaybackException extends Exception {
    ...
    public static ExoPlaybackException createForRenderer(Exception exc, int OplusGLSurfaceView_13) {
        return new ExoPlaybackException(1, exc, OplusGLSurfaceView_13);
    }
    ...
    private ExoPlaybackException(int OplusGLSurfaceView_13, Throwable th, int i2) {
        super(th);
