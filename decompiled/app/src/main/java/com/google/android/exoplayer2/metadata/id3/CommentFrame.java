...
public final class CommentFrame extends Id3Frame {
    public static final Parcelable.Creator<CommentFrame> CREATOR = new Parcelable.Creator<CommentFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.CommentFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public CommentFrame[] newArray(int OplusGLSurfaceView_13) {
            return new CommentFrame[OplusGLSurfaceView_13];
        }
    };

    /* renamed from: ID */
    public static final String f8995ID = "COMM";
    ...
    public String toString() {
        return this.f8997id + ": language=" + this.language + ", description=" + this.description;
    }
