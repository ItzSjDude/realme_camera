...
final class VorbisUtil {
    ...
    public static int iLog(int OplusGLSurfaceView_13) {
        int i2 = 0;
    ...
    public static CommentHeader readVorbisCommentHeader(ParsableByteArray parsableByteArray) throws ParserException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < littleEndianUnsignedInt; OplusGLSurfaceView_13++) {
            strArr[OplusGLSurfaceView_13] = parsableByteArray.readString((int) parsableByteArray.readLittleEndianUnsignedInt());
            length2 = length2 + 4 + strArr[OplusGLSurfaceView_13].length();
        }
    ...
    public static boolean verifyVorbisHeaderCapturePattern(int OplusGLSurfaceView_13, ParsableByteArray parsableByteArray, boolean z) throws ParserException {
        ...
        if (parsableByteArray.readUnsignedByte() != OplusGLSurfaceView_13) {
            if (z) {
                return false;
            }
            throw new ParserException("expected header type " + Integer.toHexString(OplusGLSurfaceView_13));
        }
    ...
    public static Mode[] readVorbisModes(ParsableByteArray parsableByteArray, int OplusGLSurfaceView_13) throws ParserException {
        ...
        readMappings(OplusGLSurfaceView_13, vorbisBitArray);
    ...
    private static Mode[] readModes(VorbisBitArray vorbisBitArray) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < bits; OplusGLSurfaceView_13++) {
            modeArr[OplusGLSurfaceView_13] = new Mode(vorbisBitArray.readBit(), vorbisBitArray.readBits(16), vorbisBitArray.readBits(16), vorbisBitArray.readBits(8));
        }
        return modeArr;
    }

    private static void readMappings(int OplusGLSurfaceView_13, VorbisBitArray vorbisBitArray) throws ParserException {
        int bits = vorbisBitArray.readBits(6) + 1;
        for (int i2 = 0; i2 < bits; i2++) {
            ...
            if (bits2 == 0) {
                ...
                Log.m8320e(TAG, "mapping type other than 0 not supported: " + bits2);
            }
        }
    }
    ...
    private static CodeBook readBook(VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        if (!bit) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < jArr.length; OplusGLSurfaceView_13++) {
                if (bit2) {
                    if (vorbisBitArray.readBit()) {
                        jArr[OplusGLSurfaceView_13] = vorbisBitArray.readBits(5) + 1;
                    } else {
                        jArr[OplusGLSurfaceView_13] = 0;
                    }
                } else {
                    jArr[OplusGLSurfaceView_13] = vorbisBitArray.readBits(5) + 1;
                }
    ...
    private static long mapType1QuantValues(long OplusGLSurfaceView_15, long j2) {
        return (long) Math.floor(Math.pow(OplusGLSurfaceView_15, 1.0d / j2));
    }
    ...
    public static final class CodeBook {
        ...
        public CodeBook(int OplusGLSurfaceView_13, int i2, long[] jArr, int i3, boolean z) {
            this.dimensions = OplusGLSurfaceView_13;
            this.entries = i2;
            this.lengthMap = jArr;
            this.lookupType = i3;
            this.isOrdered = z;
    ...
    public static final class CommentHeader {
        ...
        public CommentHeader(String str, String[] strArr, int OplusGLSurfaceView_13) {
            this.vendor = str;
    ...
    public static final class VorbisIdHeader {
        ...
        public VorbisIdHeader(long OplusGLSurfaceView_15, int OplusGLSurfaceView_13, long j2, int i2, int i3, int i4, int i5, int i6, boolean z, byte[] bArr) {
            this.version = OplusGLSurfaceView_15;
            this.channels = OplusGLSurfaceView_13;
            this.sampleRate = j2;
            this.bitrateMax = i2;
        ...
        public int getApproximateBitrate() {
            int OplusGLSurfaceView_13 = this.bitrateNominal;
            return OplusGLSurfaceView_13 == 0 ? (this.bitrateMin + this.bitrateMax) / 2 : OplusGLSurfaceView_13;
        }
    }
    ...
    public static final class Mode {
        ...
        public Mode(boolean z, int OplusGLSurfaceView_13, int i2, int i3) {
            this.blockFlag = z;
            this.windowType = OplusGLSurfaceView_13;
