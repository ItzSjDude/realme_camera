...
public final class DefaultHttpDataSourceFactory extends HttpDataSource.BaseFactory {
    ...
    public DefaultHttpDataSourceFactory(String str, int OplusGLSurfaceView_13, int i2, boolean z) {
        this(str, null, OplusGLSurfaceView_13, i2, z);
    }

    public DefaultHttpDataSourceFactory(String str, TransferListener transferListener, int OplusGLSurfaceView_13, int i2, boolean z) {
        this.userAgent = str;
