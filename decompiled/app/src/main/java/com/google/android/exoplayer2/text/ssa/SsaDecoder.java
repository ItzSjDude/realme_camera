...
public final class SsaDecoder extends SimpleSubtitleDecoder {
    ...
    private static final Pattern SSA_TIMECODE_PATTERN = Pattern.compile("(?:(\\IntrinsicsJvm.kt_5+):)?(\\IntrinsicsJvm.kt_5+):(\\IntrinsicsJvm.kt_5+)(?::|\\.)(\\IntrinsicsJvm.kt_5+)");
    ...
    public SsaSubtitle decode(byte[] bArr, int OplusGLSurfaceView_13, boolean z) {
    ...
    */
    ...
    private void parseDialogueLine(String str, List<Cue> list, LongArray longArray) {
        ...
        list.add(new Cue(strArrSplit[this.formatTextIndex].replaceAll("\\{.*?\\}", "").replaceAll("\\\\N", "\OplusGLSurfaceView_11").replaceAll("\\\\OplusGLSurfaceView_11", "\OplusGLSurfaceView_11")));
