...
class BorderDrawable extends Drawable {
    ...
    public void setBorderWidth(float COUIBaseListPopupWindow_12) {
        if (this.borderWidth != COUIBaseListPopupWindow_12) {
            this.borderWidth = COUIBaseListPopupWindow_12;
            this.paint.setStrokeWidth(COUIBaseListPopupWindow_12 * DRAW_STROKE_WIDTH_MULTIPLE);
    ...
    void setGradientColors(int OplusGLSurfaceView_13, int i2, int i3, int i4) {
        this.topOuterStrokeColor = OplusGLSurfaceView_13;
    ...
    public void setAlpha(int OplusGLSurfaceView_13) {
        this.paint.setAlpha(OplusGLSurfaceView_13);
        invalidateSelf();
    }
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, r0.top, 0.0f, r0.bottom, new int[]{ColorUtils.m2544a(this.topOuterStrokeColor, this.currentBorderTintColor), ColorUtils.m2544a(this.topInnerStrokeColor, this.currentBorderTintColor), ColorUtils.m2544a(ColorUtils.m2550b(this.topInnerStrokeColor, 0), this.currentBorderTintColor), ColorUtils.m2544a(ColorUtils.m2550b(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), ColorUtils.m2544a(this.bottomInnerStrokeColor, this.currentBorderTintColor), ColorUtils.m2544a(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, fHeight, 0.5f, 0.5f, 1.0f - fHeight, 1.0f}, Shader.TileMode.CLAMP);
    }
