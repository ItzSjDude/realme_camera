...
public final class InternalFrame extends Id3Frame {
    public static final Parcelable.Creator<InternalFrame> CREATOR = new Parcelable.Creator<InternalFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.InternalFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public InternalFrame[] newArray(int OplusGLSurfaceView_13) {
            return new InternalFrame[OplusGLSurfaceView_13];
        }
    };

    /* renamed from: ID */
    public static final String f8998ID = "----";
    ...
    public String toString() {
        return this.f8997id + ": domain=" + this.domain + ", description=" + this.description;
    }
