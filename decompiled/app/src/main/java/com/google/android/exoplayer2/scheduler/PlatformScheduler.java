...
public final class PlatformScheduler implements Scheduler {
    ...
    public PlatformScheduler(Context context, int OplusGLSurfaceView_13) {
        this.jobId = OplusGLSurfaceView_13;
    ...
    private static JobInfo buildJobInfo(int OplusGLSurfaceView_13, ComponentName componentName, Requirements requirements, String str, String str2) {
        JobInfo.Builder builder = new JobInfo.Builder(OplusGLSurfaceView_13, componentName);
