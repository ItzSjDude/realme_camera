...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    @Override // com.google.android.material.transformation.ExpandableBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0408b
    public boolean layoutDependsOn(CoordinatorLayout coordinatorLayout, View view, View view2) {
        if (view.getVisibility() == 8) {
            throw new IllegalStateException("This behavior cannot be attached to PlatformImplementations.kt_3 GONE view. Set the view to INVISIBLE instead.");
        }
    ...
    protected AnimatorSet onCreateExpandedStateChangeAnimation(final View view, final View view2, final boolean z, boolean z2) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
            animatorSet.addListener(arrayList2.get(OplusGLSurfaceView_13));
        }
        return animatorSet;
    }
    ...
    private void createElevationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        float fM2896o = ViewCompat.m2896o(view2) - ViewCompat.m2896o(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-fM2896o);
            }
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, 0.0f);
        } else {
            objectAnimatorOfFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, -fM2896o);
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void createExpansionAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, float COUIBaseListPopupWindow_12, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                animatorCreateCircularReveal = CircularRevealCompat.createCircularReveal(circularRevealWidget, fCalculateRevealCenterX, fCalculateRevealCenterY, MathUtils.distanceToFurthestCorner(fCalculateRevealCenterX, fCalculateRevealCenterY, 0.0f, 0.0f, COUIBaseListPopupWindow_12, f2));
                ...
                int OplusGLSurfaceView_13 = (int) fCalculateRevealCenterX;
                int i2 = (int) fCalculateRevealCenterY;
                createPreFillRadialExpansion(view2, timing.getDelay(), OplusGLSurfaceView_13, i2, f3, list);
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), OplusGLSurfaceView_13, i2, fWidth, list);
    ...
    private void createColorAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            int OplusGLSurfaceView_13 = 16777215 & backgroundTint;
            if (z) {
                if (!z2) {
                    circularRevealWidget.setCircularRevealScrimColor(backgroundTint);
                }
                objectAnimatorOfInt = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, OplusGLSurfaceView_13);
            } else {
    ...
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float COUIBaseListPopupWindow_12, float f2, boolean z, FabTransformationSpec fabTransformationSpec) {
        MotionTiming timing;
        MotionTiming timing2;
        if (COUIBaseListPopupWindow_12 == 0.0f || f2 == 0.0f) {
    ...
    private float calculateTranslationX(View view, View view2, Positioning positioning) {
        ...
        int OplusGLSurfaceView_13 = positioning.gravity & 7;
        if (OplusGLSurfaceView_13 == 1) {
            ...
            return COUIBaseListPopupWindow_12 + positioning.xAdjustment;
        }
        COUIBaseListPopupWindow_12 = fCenterX - fCenterX2;
        return COUIBaseListPopupWindow_12 + positioning.xAdjustment;
    }
    ...
    private float calculateTranslationY(View view, View view2, Positioning positioning) {
        ...
        calculateDependencyWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
        int OplusGLSurfaceView_13 = positioning.gravity & 112;
        if (OplusGLSurfaceView_13 == 16) {
            fCenterY = rectF2.centerY();
            fCenterY2 = rectF.centerY();
        } else if (OplusGLSurfaceView_13 == 48) {
            fCenterY = rectF2.top;
            fCenterY2 = rectF.top;
            ...
            COUIBaseListPopupWindow_12 = 0.0f;
            return COUIBaseListPopupWindow_12 + positioning.yAdjustment;
        }
        COUIBaseListPopupWindow_12 = fCenterY - fCenterY2;
        return COUIBaseListPopupWindow_12 + positioning.yAdjustment;
    }
    ...
    private void calculateChildVisibleBoundsAtEndOfExpansion(View view, FabTransformationSpec fabTransformationSpec, MotionTiming motionTiming, MotionTiming motionTiming2, float COUIBaseListPopupWindow_12, float f2, float f3, float f4, RectF rectF) {
        float fCalculateValueOfAnimationAtEndOfExpansion = calculateValueOfAnimationAtEndOfExpansion(fabTransformationSpec, motionTiming, COUIBaseListPopupWindow_12, f3);
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(FabTransformationSpec fabTransformationSpec, MotionTiming motionTiming, float COUIBaseListPopupWindow_12, float f2) {
        long delay = motionTiming.getDelay();
        long duration = motionTiming.getDuration();
        MotionTiming timing = fabTransformationSpec.timings.getTiming("expansion");
        return AnimationUtils.lerp(COUIBaseListPopupWindow_12, f2, motionTiming.getInterpolator().getInterpolation((((timing.getDelay() + timing.getDuration()) + 17) - delay) / duration));
    }

    private ViewGroup calculateChildContentContainer(View view) {
        View viewFindViewById = view.findViewById(C1694R.id_renamed.mtrl_child_content_container);
    ...
    private int getBackgroundTint(View view) {
        ColorStateList colorStateListM2904w = ViewCompat.m2904w(view);
        if (colorStateListM2904w != null) {
            return colorStateListM2904w.getColorForState(view.getDrawableState(), colorStateListM2904w.getDefaultColor());
        }
        return 0;
    }

    private void createPreFillRadialExpansion(View view, long OplusGLSurfaceView_15, int OplusGLSurfaceView_13, int i2, float COUIBaseListPopupWindow_12, List<Animator> list) {
        if (Build.VERSION.SDK_INT < 21 || OplusGLSurfaceView_15 <= 0) {
            return;
        }
        Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, OplusGLSurfaceView_13, i2, COUIBaseListPopupWindow_12, COUIBaseListPopupWindow_12);
        animatorCreateCircularReveal.setStartDelay(0L);
        animatorCreateCircularReveal.setDuration(OplusGLSurfaceView_15);
        list.add(animatorCreateCircularReveal);
    }

    private void createPostFillRadialExpansion(View view, long OplusGLSurfaceView_15, long j2, long j3, int OplusGLSurfaceView_13, int i2, float COUIBaseListPopupWindow_12, List<Animator> list) {
        if (Build.VERSION.SDK_INT >= 21) {
