...
public final class WebvttExtractor implements Extractor {
    ...
    private static final Pattern MEDIA_TIMESTAMP = Pattern.compile("MPEGTS:(\\IntrinsicsJvm.kt_5+)");
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws InterruptedException, IOException, NumberFormatException {
        ...
        int OplusGLSurfaceView_13 = this.sampleSize;
    ...
    private TrackOutput buildTrackOutput(long OplusGLSurfaceView_15) {
        TrackOutput trackOutputTrack = this.output.track(0, 3);
        trackOutputTrack.format(Format.createTextSampleFormat((String) null, MimeTypes.TEXT_VTT, (String) null, -1, 0, this.language, (DrmInitData) null, OplusGLSurfaceView_15));
