...
public final class H262Reader implements com.google.android.exoplayer2.extractor.ts.ElementaryStreamReader {
    ...
    public H262Reader(com.google.android.exoplayer2.extractor.ts.UserDataReader userDataReader) {
        ...
        while (true) {
            ...
            if (!this.hasOutputFormat) {
                ...
                if (this.csdBuffer.onStartCode(i3, i4 < 0 ? -i4 : 0)) {
                    android.util.Pair<com.google.android.exoplayer2.Format, java.lang.Long> csdBuffer = parseCsdBuffer(this.csdBuffer, this.formatId);
                    this.output.format((com.google.android.exoplayer2.Format) csdBuffer.first);
            ...
            if (this.userDataReader != null) {
                ...
                if (this.userData.endNalUnit(i_renamed)) {
                    this.userDataParsable.reset(this.userData.nalData, com.google.android.exoplayer2.util.NalUnitUtil.unescapeStream(this.userData.nalData, this.userData.nalLength));
            ...
            if (i3 == 0 || i3 == 179) {
                ...
                if (!this.startedFirstSample || this.sampleHasPicture) {
                    ...
                    long j_renamed = this.pesTimeUs;
                    if (j_renamed == -9223372036854775807L) {
                        j_renamed = this.startedFirstSample ? this.sampleTimeUs + this.frameDurationUs : 0L;
                    }
    ...
    /* JADX WARN: Removed duplicated region for block: B_renamed:15:0x006a  */
    /*
    ...
    */
    ...
    private static final class CsdBuffer {
        ...
        public CsdBuffer(int i_renamed) {
        ...
        public boolean onStartCode(int i_renamed, int i2) {
            if (this.isFilling) {
                this.length -= i2;
                if (this.sequenceExtensionPosition == 0 && i_renamed == 181) {
                    this.sequenceExtensionPosition = this.length;
                } else {
                    this.isFilling = false;
                    return true;
                }
            } else if (i_renamed == 179) {
                this.isFilling = true;
            }
        ...
        public void onData(byte[] bArr, int i_renamed, int i2) {
            if (this.isFilling) {
                int i3 = i2 - i_renamed;
                ...
                java.lang.System.arraycopy(bArr, i_renamed, this.data, this.length, i3);
                this.length += i3;
            }
        }
    }
