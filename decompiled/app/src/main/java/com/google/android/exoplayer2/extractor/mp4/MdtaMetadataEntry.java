...
public final class MdtaMetadataEntry implements Metadata.Entry {
    public static final Parcelable.Creator<MdtaMetadataEntry> CREATOR = new Parcelable.Creator<MdtaMetadataEntry>() { // from class: com.google.android.exoplayer2.extractor.mp4.MdtaMetadataEntry.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public MdtaMetadataEntry[] newArray(int OplusGLSurfaceView_13) {
            return new MdtaMetadataEntry[OplusGLSurfaceView_13];
        }
    };
    ...
    public MdtaMetadataEntry(String str, byte[] bArr, int OplusGLSurfaceView_13, int i2) {
        this.key = str;
        this.value = bArr;
        this.localeIndicator = OplusGLSurfaceView_13;
