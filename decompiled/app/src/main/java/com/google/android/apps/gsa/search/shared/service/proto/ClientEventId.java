...
public enum ClientEventId implements Internal.EnumLite {
    ...
    /* renamed from: PERSISTENT_SEARCH_NOTIFICATION_SETTING_CHANGED_VALUE */
    public static final int f8941x668e1612 = 119;
    ...
    /* renamed from: PROACTIVE_MARK_ALL_CARDS_RENDERED_NON_TAB_STREAM_VALUE */
    public static final int f8942x7b90feb8 = 243;
    public static final int PROACTIVE_MARK_ALL_CARDS_RENDERED_VALUE = 242;

    /* renamed from: PROACTIVE_MAYBE_SHOW_LOCATION_PERMISSION_NOTIFICATION_VALUE */
    public static final int f8944x1bc96702 = 230;
    ...
    /* renamed from: PROACTIVE_REQUEST_ENABLE_SEARCH_HISTORY_FOR_ACTIVE_ACCOUNT_VALUE */
    public static final int f8946x586bc91e = 216;
    public static final int PROACTIVE_REQUEST_HELP_INTENT_VALUE = 224;

    /* renamed from: PROACTIVE_REQUEST_IS_REMINDER_SMART_ACTION_SUPPORTED_VALUE */
    public static final int f8948x5bc0b5c1 = 213;

    /* renamed from: PROACTIVE_REQUEST_LOCATION_SETTINGS_RESOLUTION_VALUE */
    public static final int f8949xdadc744c = 233;

    /* renamed from: PROACTIVE_REQUEST_NEW_CARDS_INFO_NON_TAB_STREAM_VALUE */
    public static final int f8950xf7eec5a8 = 245;
    ...
    /* renamed from: PROACTIVE_UPDATE_BACK_OF_CARD_FOLLOW_CLICK_FOR_ENTRY_VALUE */
    public static final int f8952xbbdf9b5e = 247;
    ...
    /* renamed from: SEARCH_PLATE_MIC_TAPPED_FOR_OPA_PROMO_NOTIFICATIONS_VALUE */
    public static final int f8954xf2cb4a7a = 272;
    ...
    /* renamed from: SHOW_BACKGROUND_RETRY_DISABLE_DATA_SAVER_DIALOG_VALUE */
    public static final int f8955xb1d1745c = 178;

    /* renamed from: SHOW_BACKGROUND_RETRY_ENABLE_NOTIFICATIONS_DIALOG_VALUE */
    public static final int f8956x86571467 = 179;
    ...
    private static final Internal.EnumLiteMap<ClientEventId> internalValueMap = new Internal.EnumLiteMap<ClientEventId>() { // from class: com.google.android.apps.gsa.search.shared.service.proto.ClientEventId.1
        ...
        public ClientEventId findValueByNumber(int OplusGLSurfaceView_13) {
            return ClientEventId.forNumber(OplusGLSurfaceView_13);
        }
    };
    ...
    public static ClientEventId forNumber(int OplusGLSurfaceView_13) {
    ...
    ClientEventId(int OplusGLSurfaceView_13) {
