...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13) {
        super(context, attributeSet, OplusGLSurfaceView_13);
        this.checkable = true;
        this.pressable = true;
        ViewCompat.m2854a(this, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat c0483d) {
                ...
                c0483d.m2684a(CheckableImageButton.this.isCheckable());
                c0483d.m2692b(CheckableImageButton.this.isChecked());
            }
        });
    }
    ...
    public int[] onCreateDrawableState(int OplusGLSurfaceView_13) {
        if (this.checked) {
            return mergeDrawableStates(super.onCreateDrawableState(OplusGLSurfaceView_13 + DRAWABLE_STATE_CHECKED.length), DRAWABLE_STATE_CHECKED);
        }
