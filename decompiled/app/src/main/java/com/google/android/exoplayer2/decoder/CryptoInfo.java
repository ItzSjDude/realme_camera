...
public final class CryptoInfo {
    ...
    public void set(int OplusGLSurfaceView_13, int[] iArr, int[] iArr2, byte[] bArr, byte[] bArr2, int i2, int i3, int i4) {
        this.numSubSamples = OplusGLSurfaceView_13;
    ...
    private static final class PatternHolderV24 {
        ...
        public void set(int OplusGLSurfaceView_13, int i2) {
            this.pattern.set(OplusGLSurfaceView_13, i2);
