...
public final class AesCipherDataSink implements DataSink {
    ...
    public void write(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws IOException {
        if (this.scratch == null) {
            this.cipher.updateInPlace(bArr, OplusGLSurfaceView_13, i2);
            this.wrappedDataSink.write(bArr, OplusGLSurfaceView_13, i2);
            return;
        }
        int i3 = 0;
        while (i3 < i2) {
            int iMin = Math.min(i2 - i3, this.scratch.length);
            this.cipher.update(bArr, OplusGLSurfaceView_13 + i3, iMin, this.scratch, 0);
