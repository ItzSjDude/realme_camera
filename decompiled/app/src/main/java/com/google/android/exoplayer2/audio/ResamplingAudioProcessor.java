...
final class ResamplingAudioProcessor implements AudioProcessor {
    ...
    public boolean configure(int OplusGLSurfaceView_13, int i2, int i3) throws AudioProcessor.UnhandledFormatException {
        ...
        if (this.sampleRateHz == OplusGLSurfaceView_13 && this.channelCount == i2 && this.encoding == i3) {
            return false;
        }
    ...
    public boolean isActive() {
        int OplusGLSurfaceView_13 = this.encoding;
        return (OplusGLSurfaceView_13 == 0 || OplusGLSurfaceView_13 == 2) ? false : true;
    }
