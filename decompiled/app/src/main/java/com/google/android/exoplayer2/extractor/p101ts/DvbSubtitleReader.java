...
public final class DvbSubtitleReader implements ElementaryStreamReader {
    ...
    public void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator trackIdGenerator) {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.outputs.length; OplusGLSurfaceView_13++) {
            TsPayloadReader.DvbSubtitleInfo dvbSubtitleInfo = this.subtitleInfos.get(OplusGLSurfaceView_13);
    ...
    private boolean checkNextByte(ParsableByteArray parsableByteArray, int OplusGLSurfaceView_13) {
