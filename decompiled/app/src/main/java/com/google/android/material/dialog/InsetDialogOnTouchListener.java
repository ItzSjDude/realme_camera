...
public class InsetDialogOnTouchListener implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        View viewFindViewById = view.findViewById(R.id_renamed.content);
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ...
            int OplusGLSurfaceView_13 = this.prePieSlop;
            motionEventObtain.setLocation((-OplusGLSurfaceView_13) - 1, (-OplusGLSurfaceView_13) - 1);
        }
        view.performClick();
