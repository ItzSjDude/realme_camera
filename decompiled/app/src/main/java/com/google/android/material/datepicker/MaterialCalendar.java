...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    interface OnDayClickListener {
        void onDayClick(long OplusGLSurfaceView_15);
    }

    static <T> MaterialCalendar<T> newInstance(DateSelector<T> dateSelector, int OplusGLSurfaceView_13, CalendarConstraints calendarConstraints) {
        MaterialCalendar<T> materialCalendar = new MaterialCalendar<>();
        Bundle bundle = new Bundle();
        bundle.putInt(THEME_RES_ID_KEY, OplusGLSurfaceView_13);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) throws Resources.NotFoundException {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            OplusGLSurfaceView_13 = C1694R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            OplusGLSurfaceView_13 = C1694R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(OplusGLSurfaceView_13, viewGroup, false);
        GridView gridView = (GridView) viewInflate.findViewById(C1694R.id_renamed.mtrl_calendar_days_of_week);
        ViewCompat.m2854a(gridView, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.1
        ...
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C1694R.id_renamed.mtrl_calendar_months);
        ...
        MonthsPagerAdapter monthsPagerAdapter = new MonthsPagerAdapter(contextThemeWrapper, this.dateSelector, this.calendarConstraints, new OnDayClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.3
            ...
            public void onDayClick(long OplusGLSurfaceView_15) {
                if (MaterialCalendar.this.calendarConstraints.getDateValidator().isValid(OplusGLSurfaceView_15)) {
                    MaterialCalendar.this.dateSelector.select(OplusGLSurfaceView_15);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C1694R.integer.mtrl_calendar_year_selector_span);
        this.yearSelector = (RecyclerView) viewInflate.findViewById(C1694R.id_renamed.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C1694R.id_renamed.month_navigation_fragment_toggle) != null) {
            addActionsToMonthNavigation(viewInflate, monthsPagerAdapter);
        }
        if (!MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            new LinearSnapHelper().m4549a(this.recyclerView);
        }
        this.recyclerView.scrollToPosition(monthsPagerAdapter.getPosition(this.current));
        return viewInflate;
    }

    private RecyclerView.AbstractC0692h createItemDecoration() {
        return new RecyclerView.AbstractC0692h() { // from class: com.google.android.material.datepicker.MaterialCalendar.4
            private final Calendar startItem = UtcDates.getUtcCalendar();
            private final Calendar endItem = UtcDates.getUtcCalendar();

            @Override // androidx.recyclerview.widget.RecyclerView.AbstractC0692h
            public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.C0704t c0704t) {
                int width;
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    YearGridAdapter yearGridAdapter = (YearGridAdapter) recyclerView.getAdapter();
                    GridLayoutManager gridLayoutManager = (GridLayoutManager) recyclerView.getLayoutManager();
                    for (Pair<Long, Long> c0457d : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        if (c0457d.f2937a != null && c0457d.f2938b != null) {
                            this.startItem.setTimeInMillis(c0457d.f2937a.longValue());
                            this.endItem.setTimeInMillis(c0457d.f2938b.longValue());
                            ...
                            int iM4055a = positionForYear / gridLayoutManager.m4055a();
                            int iM4055a2 = positionForYear2 / gridLayoutManager.m4055a();
                            int OplusGLSurfaceView_13 = iM4055a;
                            while (OplusGLSurfaceView_13 <= iM4055a2) {
                                View viewFindViewByPosition3 = gridLayoutManager.findViewByPosition(gridLayoutManager.m4055a() * OplusGLSurfaceView_13);
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    int left = OplusGLSurfaceView_13 == iM4055a ? viewFindViewByPosition.getLeft() + (viewFindViewByPosition.getWidth() / 2) : 0;
                                    if (OplusGLSurfaceView_13 == iM4055a2) {
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C1694R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C1694R.id_renamed.month_navigation_fragment_toggle);
        materialButton.setTag(SELECTOR_TOGGLE_TAG);
        ViewCompat.m2854a(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            @Override // androidx.core.p036h.AccessibilityDelegateCompat
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat c0483d) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C1694R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C1694R.string.mtrl_picker_toggle_to_day_selection);
                }
                c0483d.m2705f(string);
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C1694R.id_renamed.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C1694R.id_renamed.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C1694R.id_renamed.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C1694R.id_renamed.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        materialButton.setText(this.current.getLongName());
        this.recyclerView.addOnScrollListener(new RecyclerView.AbstractC0698n() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
    ...
    private void postSmoothRecyclerViewScroll(final int OplusGLSurfaceView_13) {
        this.recyclerView.post(new Runnable() { // from class: com.google.android.material.datepicker.MaterialCalendar.10
            @Override // java.lang.Runnable
            public void run() {
                MaterialCalendar.this.recyclerView.smoothScrollToPosition(OplusGLSurfaceView_13);
            }
        });
    }
