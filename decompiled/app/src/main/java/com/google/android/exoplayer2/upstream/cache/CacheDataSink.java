...
public final class CacheDataSink implements DataSink {
    ...
    public CacheDataSink(Cache cache, long OplusGLSurfaceView_15) {
        this(cache, OplusGLSurfaceView_15, DEFAULT_BUFFER_SIZE);
    }

    public CacheDataSink(Cache cache, long OplusGLSurfaceView_15, int OplusGLSurfaceView_13) {
    ...
    public void open(DataSpec dataSpec) throws CacheDataSinkException {
        ...
        try {
            ...
            throw new CacheDataSinkException(COUIBaseListPopupWindow_8);
        }
    }
    ...
    public void write(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws IOException {
        ...
        while (i3 < i2) {
            try {
                ...
                this.outputStream.write(bArr, OplusGLSurfaceView_13 + i3, iMin);
                i3 += iMin;
                long OplusGLSurfaceView_15 = iMin;
                this.outputStreamBytesWritten += OplusGLSurfaceView_15;
                this.dataSpecBytesWritten += OplusGLSurfaceView_15;
            } catch (IOException COUIBaseListPopupWindow_8) {
                throw new CacheDataSinkException(COUIBaseListPopupWindow_8);
            }
        }
    ...
    private void openNextOutputStream() throws IOException {
        ...
        if (OplusGLSurfaceView_13 > 0) {
            ...
            if (reusableBufferedOutputStream == null) {
                this.bufferedOutputStream = new ReusableBufferedOutputStream(this.underlyingFileOutputStream, OplusGLSurfaceView_13);
            } else {
