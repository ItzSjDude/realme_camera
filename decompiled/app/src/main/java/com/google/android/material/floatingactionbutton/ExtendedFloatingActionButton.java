...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.InterfaceC0407a {
    private static final int ANIM_STATE_HIDING = 1;
    private static final int ANIM_STATE_NONE = 0;
    private static final int ANIM_STATE_SHOWING = 2;
    private int animState;
    private final CoordinatorLayout.AbstractC0408b<ExtendedFloatingActionButton> behavior;
    ...
    private static final int DEF_STYLE_RES = C1694R.style.f9141x286a39aa;
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, "width") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
        ...
        public void set(View view, Float COUIBaseListPopupWindow_12) {
            view.getLayoutParams().width = COUIBaseListPopupWindow_12.intValue();
            view.requestLayout();
        }
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, "height") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.5
        @Override // android.util.Property
        public void set(View view, Float COUIBaseListPopupWindow_12) {
            view.getLayoutParams().height = COUIBaseListPopupWindow_12.intValue();
            view.requestLayout();
        }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1694R.attr.extendedFloatingActionButtonStyle);
    }

    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1694R.styleable.ExtendedFloatingActionButton, OplusGLSurfaceView_13, DEF_STYLE_RES, new int[0]);
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C1694R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C1694R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec motionSpecCreateFromAttribute3 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C1694R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec motionSpecCreateFromAttribute4 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C1694R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
        ...
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context2, attributeSet, OplusGLSurfaceView_13, DEF_STYLE_RES, ShapeAppearanceModel.PILL).build());
    }
    ...
    public CoordinatorLayout.AbstractC0408b<ExtendedFloatingActionButton> getBehavior() {
    ...
    public void setExtendMotionSpecResource(int OplusGLSurfaceView_13) {
        setExtendMotionSpec(MotionSpec.createFromResource(getContext(), OplusGLSurfaceView_13));
    }
    ...
    public void setShrinkMotionSpecResource(int OplusGLSurfaceView_13) {
        setShrinkMotionSpec(MotionSpec.createFromResource(getContext(), OplusGLSurfaceView_13));
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return ViewCompat.m2823A(this) && !isInEditMode();
    }

    int getCollapsedSize() {
        return (Math.min(ViewCompat.m2891j(this), ViewCompat.m2892k(this)) * 2) + getIconSize();
    }

    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.AbstractC0408b<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1694R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C1694R.styleable.f9183xd13d7f3e, false);
            this.autoShrinkEnabled = typedArrayObtainStyledAttributes.getBoolean(C1694R.styleable.f9184x8a985905, true);
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        private boolean shouldUpdateVisibility(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((CoordinatorLayout.C0411e) extendedFloatingActionButton.getLayoutParams()).m2216a() == view.getId();
        }
        ...
        private boolean updateFabVisibilityForBottomSheet(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if (view.getTop() < (extendedFloatingActionButton.getHeight() / 2) + ((CoordinatorLayout.C0411e) extendedFloatingActionButton.getLayoutParams()).topMargin) {
                shrinkOrHide(extendedFloatingActionButton);
                return true;
            }
            extendOrShow(extendedFloatingActionButton);
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0408b
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, ExtendedFloatingActionButton extendedFloatingActionButton, int OplusGLSurfaceView_13) {
            ...
            coordinatorLayout.onLayoutChild(extendedFloatingActionButton, OplusGLSurfaceView_13);
            return true;
        }
    }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1694R.animator.mtrl_extended_fab_change_size_motion_spec;
        }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C1694R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C1694R.animator.mtrl_extended_fab_hide_motion_spec;
        }
