...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1694R.styleable.ForegroundLinearLayout, OplusGLSurfaceView_13, 0, new int[0]);
        this.foregroundGravity = typedArrayObtainStyledAttributes.getInt(C1694R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.foregroundGravity);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C1694R.styleable.ForegroundLinearLayout_android_foreground);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = typedArrayObtainStyledAttributes.getBoolean(C1694R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
    ...
    @Override // android.view.View
    public void setForegroundGravity(int OplusGLSurfaceView_13) {
        if (this.foregroundGravity != OplusGLSurfaceView_13) {
            ...
            this.foregroundGravity = OplusGLSurfaceView_13;
