...
public final class ExoPlayerFactory {
    ...
    @Deprecated
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int OplusGLSurfaceView_13) {
        return newSimpleInstance(context, new DefaultRenderersFactory(context).setExtensionRendererMode(OplusGLSurfaceView_13), trackSelector, loadControl, drmSessionManager);
    }

    @Deprecated
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
        return newSimpleInstance(context, new DefaultRenderersFactory(context).setExtensionRendererMode(OplusGLSurfaceView_13).setAllowedVideoJoiningTimeMs(OplusGLSurfaceView_15), trackSelector, loadControl, drmSessionManager);
    }
    ...
    public static SimpleExoPlayer newSimpleInstance(RenderersFactory renderersFactory, TrackSelector trackSelector) {
        return newSimpleInstance((Context) null, renderersFactory, trackSelector, new DefaultLoadControl());
    }
