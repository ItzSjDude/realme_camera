...
public class BaselineLayout extends ViewGroup {
    ...
    public BaselineLayout(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13) {
    ...
    protected void onMeasure(int OplusGLSurfaceView_13, int i2) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(iMax4, getSuggestedMinimumWidth()), OplusGLSurfaceView_13, iCombineMeasuredStates), View.resolveSizeAndState(Math.max(iMax3, getSuggestedMinimumHeight()), i2, iCombineMeasuredStates << 16));
    }
    ...
    protected void onLayout(boolean z, int OplusGLSurfaceView_13, int i2, int i3, int i4) {
        ...
        int paddingRight = ((i3 - OplusGLSurfaceView_13) - getPaddingRight()) - paddingLeft;
