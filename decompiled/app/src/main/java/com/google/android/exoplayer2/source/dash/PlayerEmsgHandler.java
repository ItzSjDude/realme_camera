...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    boolean maybeRefreshManifestBeforeLoadingNextChunk(long OplusGLSurfaceView_15) {
        boolean z = false;
        ...
        if (entryCeilingExpiryEntryForPublishTime != null && entryCeilingExpiryEntryForPublishTime.getValue().longValue() < OplusGLSurfaceView_15) {
    ...
    boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        long OplusGLSurfaceView_15 = this.lastLoadedChunkEndTimeUs;
        if (!(OplusGLSurfaceView_15 != -9223372036854775807L && OplusGLSurfaceView_15 < chunk.startTimeUs)) {
            return false;
        }
        maybeNotifyDashManifestRefreshNeeded();
        return true;
    ...
    private void handleManifestExpiredMessage(long OplusGLSurfaceView_15, long j2) {
        Long OplusGLSurfaceView_14 = this.manifestPublishTimeToExpiryTimeUs.get(Long.valueOf(j2));
        if (OplusGLSurfaceView_14 == null) {
            this.manifestPublishTimeToExpiryTimeUs.put(Long.valueOf(j2), Long.valueOf(OplusGLSurfaceView_15));
        } else if (OplusGLSurfaceView_14.longValue() > OplusGLSurfaceView_15) {
            this.manifestPublishTimeToExpiryTimeUs.put(Long.valueOf(j2), Long.valueOf(OplusGLSurfaceView_15));
        }
    }

    private Map.Entry<Long, Long> ceilingExpiryEntryForPublishTime(long OplusGLSurfaceView_15) {
        return this.manifestPublishTimeToExpiryTimeUs.ceilingEntry(Long.valueOf(OplusGLSurfaceView_15));
    }
    ...
    private void maybeNotifyDashManifestRefreshNeeded() {
        long OplusGLSurfaceView_15 = this.lastLoadedChunkEndTimeBeforeRefreshUs;
        if (OplusGLSurfaceView_15 == -9223372036854775807L || OplusGLSurfaceView_15 != this.lastLoadedChunkEndTimeUs) {
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        public int sampleData(ExtractorInput extractorInput, int OplusGLSurfaceView_13, boolean z) throws InterruptedException, IOException {
            return this.sampleQueue.sampleData(extractorInput, OplusGLSurfaceView_13, z);
        }

        @Override // com.google.android.exoplayer2.extractor.TrackOutput
        public void sampleData(ParsableByteArray parsableByteArray, int OplusGLSurfaceView_13) {
            this.sampleQueue.sampleData(parsableByteArray, OplusGLSurfaceView_13);
        }
        ...
        public void sampleMetadata(long OplusGLSurfaceView_15, int OplusGLSurfaceView_13, int i2, int i3, TrackOutput.CryptoData cryptoData) {
            this.sampleQueue.sampleMetadata(OplusGLSurfaceView_15, OplusGLSurfaceView_13, i2, i3, cryptoData);
            parseAndDiscardSamples();
        }

        public boolean maybeRefreshManifestBeforeLoadingNextChunk(long OplusGLSurfaceView_15) {
            return PlayerEmsgHandler.this.maybeRefreshManifestBeforeLoadingNextChunk(OplusGLSurfaceView_15);
        }
        ...
        private void parseAndDiscardSamples() {
            while (this.sampleQueue.hasNextSample()) {
                ...
                if (metadataInputBufferDequeueSample != null) {
                    long OplusGLSurfaceView_15 = metadataInputBufferDequeueSample.timeUs;
                    ...
                    if (PlayerEmsgHandler.isPlayerEmsgEvent(eventMessage.schemeIdUri, eventMessage.value)) {
                        parsePlayerEmsgEvent(OplusGLSurfaceView_15, eventMessage);
                    }
                }
            }
        ...
        private void parsePlayerEmsgEvent(long OplusGLSurfaceView_15, EventMessage eventMessage) {
            ...
            onManifestExpiredMessageEncountered(OplusGLSurfaceView_15, manifestPublishTimeMsInEmsg);
        }

        private void onManifestExpiredMessageEncountered(long OplusGLSurfaceView_15, long j2) {
            PlayerEmsgHandler.this.handler.sendMessage(PlayerEmsgHandler.this.handler.obtainMessage(1, new ManifestExpiryEventInfo(OplusGLSurfaceView_15, j2)));
        }
    }
    ...
    private static final class ManifestExpiryEventInfo {
        ...
        public ManifestExpiryEventInfo(long OplusGLSurfaceView_15, long j2) {
            this.eventTimeUs = OplusGLSurfaceView_15;
