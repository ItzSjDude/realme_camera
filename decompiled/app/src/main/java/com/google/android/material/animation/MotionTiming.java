...
public class MotionTiming {
    ...
    public MotionTiming(long OplusGLSurfaceView_15, long j2) {
        this.delay = 0L;
        this.duration = 300L;
        this.interpolator = null;
        this.repeatCount = 0;
        this.repeatMode = 1;
        this.delay = OplusGLSurfaceView_15;
        this.duration = j2;
    }

    public MotionTiming(long OplusGLSurfaceView_15, long j2, TimeInterpolator timeInterpolator) {
        this.delay = 0L;
        this.duration = 300L;
        this.interpolator = null;
        this.repeatCount = 0;
    ...
    public String toString() {
        return '\OplusGLSurfaceView_11' + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " delay: " + getDelay() + " duration: " + getDuration() + " interpolator: " + getInterpolator().getClass() + " repeatCount: " + getRepeatCount() + " repeatMode: " + getRepeatMode() + "}\OplusGLSurfaceView_11";
    }
}
