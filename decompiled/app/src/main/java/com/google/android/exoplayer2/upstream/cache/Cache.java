...
public interface Cache {
    ...
    long getCachedLength(String str, long OplusGLSurfaceView_15, long j2);
    ...
    boolean isCached(String str, long OplusGLSurfaceView_15, long j2);
    ...
    void setContentLength(String str, long OplusGLSurfaceView_15) throws CacheException;

    File startFile(String str, long OplusGLSurfaceView_15, long j2) throws CacheException;

    CacheSpan startReadWrite(String str, long OplusGLSurfaceView_15) throws InterruptedException, CacheException;

    CacheSpan startReadWriteNonBlocking(String str, long OplusGLSurfaceView_15) throws CacheException;
