...
public final class PsExtractor implements Extractor {
    ...
    public void seek(long OplusGLSurfaceView_15, long j2) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.psPayloadReaders.size(); OplusGLSurfaceView_13++) {
            this.psPayloadReaders.valueAt(OplusGLSurfaceView_13).seek();
        }
    }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws InterruptedException, IOException {
        ...
        int OplusGLSurfaceView_13 = this.psPacketBuffer.readInt();
        if (OplusGLSurfaceView_13 == MPEG_PROGRAM_END_CODE) {
            return -1;
        }
        if (OplusGLSurfaceView_13 == PACK_START_CODE) {
    ...
    private void maybeOutputSeekMap(long OplusGLSurfaceView_15) {
        ...
        if (this.durationReader.getDurationUs() != -9223372036854775807L) {
            this.psBinarySearchSeeker = new PsBinarySearchSeeker(this.durationReader.getScrTimestampAdjuster(), this.durationReader.getDurationUs(), OplusGLSurfaceView_15);
