...
class CutoutDrawable extends MaterialShapeDrawable {
    ...
    void setCutout(float COUIBaseListPopupWindow_12, float f2, float f3, float f4) {
        if (COUIBaseListPopupWindow_12 == this.cutoutBounds.left && f2 == this.cutoutBounds.top && f3 == this.cutoutBounds.right && f4 == this.cutoutBounds.bottom) {
            return;
        }
        this.cutoutBounds.set(COUIBaseListPopupWindow_12, f2, f3, f4);
        invalidateSelf();
    }
