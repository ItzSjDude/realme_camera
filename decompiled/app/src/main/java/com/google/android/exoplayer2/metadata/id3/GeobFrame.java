...
public final class GeobFrame extends Id3Frame {
    public static final Parcelable.Creator<GeobFrame> CREATOR = new Parcelable.Creator<GeobFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.GeobFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public GeobFrame[] newArray(int OplusGLSurfaceView_13) {
            return new GeobFrame[OplusGLSurfaceView_13];
        }
    };

    /* renamed from: ID */
    public static final String f8996ID = "GEOB";
    ...
    public String toString() {
        return this.f8997id + ": mimeType=" + this.mimeType + ", filename=" + this.filename + ", description=" + this.description;
    }
