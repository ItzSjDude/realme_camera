...
public final class ByteArrayDataSource extends BaseDataSource {
    ...
    public long open(DataSpec dataSpec) throws IOException {
        ...
        int OplusGLSurfaceView_13 = this.bytesRemaining;
        if (OplusGLSurfaceView_13 <= 0 || this.readPosition + OplusGLSurfaceView_13 > this.data.length) {
    ...
    public int read(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws IOException {
        ...
        System.arraycopy(this.data, this.readPosition, bArr, OplusGLSurfaceView_13, iMin);
