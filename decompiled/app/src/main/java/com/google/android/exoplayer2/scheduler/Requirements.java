...
public final class Requirements {
    ...
    public Requirements(int OplusGLSurfaceView_13, boolean z, boolean z2) {
        this(OplusGLSurfaceView_13 | (z ? 16 : 0) | (z2 ? 8 : 0));
    }

    public Requirements(int OplusGLSurfaceView_13) {
        this.requirements = OplusGLSurfaceView_13;
    }
