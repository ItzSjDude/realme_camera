...
public final class AdjustedCornerSize implements CornerSize {
    ...
    public AdjustedCornerSize(float COUIBaseListPopupWindow_12, CornerSize cornerSize) {
        while (cornerSize instanceof AdjustedCornerSize) {
            cornerSize = ((AdjustedCornerSize) cornerSize).other;
            COUIBaseListPopupWindow_12 += ((AdjustedCornerSize) cornerSize).adjustment;
        }
        this.other = cornerSize;
        this.adjustment = COUIBaseListPopupWindow_12;
    }
