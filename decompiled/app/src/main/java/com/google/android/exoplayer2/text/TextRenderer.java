...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    @Override // com.google.android.exoplayer2.BaseRenderer
    protected void onPositionReset(long OplusGLSurfaceView_15, boolean z) {
        clearOutput();
    ...
    public void render(long OplusGLSurfaceView_15, long j2) throws ExoPlaybackException {
        ...
        if (this.nextSubtitle == null) {
            this.decoder.setPositionUs(OplusGLSurfaceView_15);
            try {
        ...
        if (this.subtitle != null) {
            ...
            z = false;
            while (nextEventTime <= OplusGLSurfaceView_15) {
        ...
        if (subtitleOutputBuffer != null) {
            if (subtitleOutputBuffer.isEndOfStream()) {
            ...
            } else if (this.nextSubtitle.timeUs <= OplusGLSurfaceView_15) {
                ...
                this.nextSubtitleEventIndex = this.subtitle.getNextEventTimeIndex(OplusGLSurfaceView_15);
                z = true;
            }
        }
        if (z) {
            updateOutput(this.subtitle.getCues(OplusGLSurfaceView_15));
        }
        if (this.decoderReplacementState == 2) {
            return;
        }
    ...
    private long getNextEventTime() {
        int OplusGLSurfaceView_13 = this.nextSubtitleEventIndex;
        if (OplusGLSurfaceView_13 == -1 || OplusGLSurfaceView_13 >= this.subtitle.getEventTimeCount()) {
