...
class ViewOffsetBehavior<V extends View> extends CoordinatorLayout.AbstractC0408b<V> {
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int OplusGLSurfaceView_13) {
        layoutChild(coordinatorLayout, v, OplusGLSurfaceView_13);
    ...
    protected void layoutChild(CoordinatorLayout coordinatorLayout, V v, int OplusGLSurfaceView_13) {
    ...
    public boolean setTopAndBottomOffset(int OplusGLSurfaceView_13) {
        ...
        if (viewOffsetHelper != null) {
            return viewOffsetHelper.setTopAndBottomOffset(OplusGLSurfaceView_13);
        }
        this.tempTopBottomOffset = OplusGLSurfaceView_13;
        return false;
    }
    ...
    public boolean setLeftAndRightOffset(int OplusGLSurfaceView_13) {
        ViewOffsetHelper viewOffsetHelper = this.viewOffsetHelper;
        if (viewOffsetHelper != null) {
            return viewOffsetHelper.setLeftAndRightOffset(OplusGLSurfaceView_13);
        }
        this.tempLeftRightOffset = OplusGLSurfaceView_13;
        return false;
    }
