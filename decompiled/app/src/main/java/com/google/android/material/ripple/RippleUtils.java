...
public class RippleUtils {
    ...
    static final String TRANSPARENT_DEFAULT_COLOR_WARNING = "Use PlatformImplementations.kt_3 non-transparent color for the default color as it will be used to finish ripple animations.";
    ...
    public static boolean shouldDrawRippleCompat(int[] iArr) {
        ...
        for (int OplusGLSurfaceView_13 : iArr) {
            if (OplusGLSurfaceView_13 == 16842910) {
                z = true;
            } else if (OplusGLSurfaceView_13 == 16842908 || OplusGLSurfaceView_13 == 16842919 || OplusGLSurfaceView_13 == 16843623) {
                z2 = true;
            }
        }
        return z && z2;
    ...
    @TargetApi(21)
    private static int doubleAlpha(int OplusGLSurfaceView_13) {
        return ColorUtils.m2550b(OplusGLSurfaceView_13, Math.min(Color.alpha(OplusGLSurfaceView_13) * 2, 255));
    }
}
