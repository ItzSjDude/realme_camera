...
public final class CalendarConstraints implements Parcelable {
    public static final Parcelable.Creator<CalendarConstraints> CREATOR = new Parcelable.Creator<CalendarConstraints>() { // from class: com.google.android.material.datepicker.CalendarConstraints.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public CalendarConstraints[] newArray(int OplusGLSurfaceView_13) {
            return new CalendarConstraints[OplusGLSurfaceView_13];
        }
    };
    ...
    public interface DateValidator extends Parcelable {
        boolean isValid(long OplusGLSurfaceView_15);
    }
    ...
    boolean isWithinBounds(long OplusGLSurfaceView_15) {
        if (this.start.getDay(1) <= OplusGLSurfaceView_15) {
            Month month = this.end;
            if (OplusGLSurfaceView_15 <= month.getDay(month.daysInMonth)) {
                return true;
            }
        }
        return false;
    ...
    public static final class Builder {
        ...
        public Builder setStart(long OplusGLSurfaceView_15) {
            this.start = OplusGLSurfaceView_15;
            return this;
        }

        public Builder setEnd(long OplusGLSurfaceView_15) {
            this.end = OplusGLSurfaceView_15;
            return this;
        }

        public Builder setOpenAt(long OplusGLSurfaceView_15) {
            this.openAt = Long.valueOf(OplusGLSurfaceView_15);
            return this;
        }
