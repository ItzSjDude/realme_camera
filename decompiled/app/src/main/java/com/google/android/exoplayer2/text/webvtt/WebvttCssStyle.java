...
public final class WebvttCssStyle {
    ...
    /* renamed from: ON */
    private static final int f9017ON = 1;
    ...
    public WebvttCssStyle setFontColor(int OplusGLSurfaceView_13) {
    ...
    public WebvttCssStyle setBackgroundColor(int OplusGLSurfaceView_13) {
    ...
    public WebvttCssStyle setFontSize(float COUIBaseListPopupWindow_12) {
    ...
    public void cascadeFrom(WebvttCssStyle webvttCssStyle) {
        ...
        int OplusGLSurfaceView_13 = webvttCssStyle.bold;
        if (OplusGLSurfaceView_13 != -1) {
            this.bold = OplusGLSurfaceView_13;
        }
    ...
    private static int updateScoreForMatch(int OplusGLSurfaceView_13, String str, String str2, int i2) {
        if (str.isEmpty() || OplusGLSurfaceView_13 == -1) {
