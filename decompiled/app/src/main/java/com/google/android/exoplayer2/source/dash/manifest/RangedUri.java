...
public final class RangedUri {
    ...
    public RangedUri(String str, long OplusGLSurfaceView_15, long j2) {
    ...
    public RangedUri attemptMerge(RangedUri rangedUri, String str) {
        ...
        if (rangedUri != null && strResolveUriString.equals(rangedUri.resolveUriString(str))) {
            long OplusGLSurfaceView_15 = this.length;
            if (OplusGLSurfaceView_15 != -1) {
                long j2 = this.start;
                if (j2 + OplusGLSurfaceView_15 == rangedUri.start) {
                    long j3 = rangedUri.length;
                    return new RangedUri(strResolveUriString, j2, j3 != -1 ? OplusGLSurfaceView_15 + j3 : -1L);
                }
            }
            ...
            if (j4 != -1) {
                ...
                if (j5 + j4 == this.start) {
                    long j6 = this.length;
                    return new RangedUri(strResolveUriString, j5, j6 != -1 ? j4 + j6 : -1L);
                }
            }
        }
        return null;
