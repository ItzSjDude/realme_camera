...
final class TtmlSubtitle implements Subtitle {
    ...
    public int getNextEventTimeIndex(long OplusGLSurfaceView_15) {
        int iBinarySearchCeil = Util.binarySearchCeil(this.eventTimesUs, OplusGLSurfaceView_15, false, false);
    ...
    public long getEventTime(int OplusGLSurfaceView_13) {
        return this.eventTimesUs[OplusGLSurfaceView_13];
    }
    ...
    public List<Cue> getCues(long OplusGLSurfaceView_15) {
        return this.root.getCues(OplusGLSurfaceView_15, this.globalStyles, this.regionMap, this.imageMap);
    }
