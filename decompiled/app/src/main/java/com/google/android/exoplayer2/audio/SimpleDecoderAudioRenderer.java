...
public abstract class SimpleDecoderAudioRenderer extends BaseRenderer implements MediaClock {
    ...
    protected final boolean supportsOutput(int OplusGLSurfaceView_13, int i2) {
        return this.audioSink.supportsOutput(OplusGLSurfaceView_13, i2);
    }
    ...
    private void maybeInitDecoder() throws ExoPlaybackException {
        ...
        } catch (AudioDecoderException COUIBaseListPopupWindow_8) {
            throw ExoPlaybackException.createForRenderer(COUIBaseListPopupWindow_8, getIndex());
        }
    }
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSessionId(int OplusGLSurfaceView_13) {
            SimpleDecoderAudioRenderer.this.eventDispatcher.audioSessionId(OplusGLSurfaceView_13);
            SimpleDecoderAudioRenderer.this.onAudioSessionId(OplusGLSurfaceView_13);
        }
        ...
        public void onUnderrun(int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, long j2) {
            SimpleDecoderAudioRenderer.this.eventDispatcher.audioTrackUnderrun(OplusGLSurfaceView_13, OplusGLSurfaceView_15, j2);
            SimpleDecoderAudioRenderer.this.onAudioTrackUnderrun(OplusGLSurfaceView_13, OplusGLSurfaceView_15, j2);
        }
    }
}
