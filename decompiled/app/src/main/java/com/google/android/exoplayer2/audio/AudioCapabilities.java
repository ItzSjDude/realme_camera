...
public final class AudioCapabilities {
    ...
    public AudioCapabilities(int[] iArr, int OplusGLSurfaceView_13) {
        if (iArr != null) {
        ...
        this.maxChannelCount = OplusGLSurfaceView_13;
    }

    public boolean supportsEncoding(int OplusGLSurfaceView_13) {
        return Arrays.binarySearch(this.supportedEncodings, OplusGLSurfaceView_13) >= 0;
    }
