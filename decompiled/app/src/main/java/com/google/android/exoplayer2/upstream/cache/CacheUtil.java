...
public final class CacheUtil {
    ...
    public static final com.google.android.exoplayer2.upstream.cache.CacheKeyFactory DEFAULT_CACHE_KEY_FACTORY = new com.google.android.exoplayer2.upstream.cache.CacheKeyFactory() { // from class: com.google.android.exoplayer2.upstream.cache.-$$Lambda$u97poD-IIwob7OPYcVJkh9jokx0
        @Override // com.google.android.exoplayer2.upstream.cache.CacheKeyFactory
        public final java.lang.String buildCacheKey(com.google.android.exoplayer2.upstream.DataSpec dataSpec) {
            return com.google.android.exoplayer2.upstream.cache.CacheUtil.getKey(dataSpec);
        }
    };
    ...
    public static java.lang.String getKey(com.google.android.exoplayer2.upstream.DataSpec dataSpec) {
        return dataSpec.key != null ? dataSpec.key : generateKey(dataSpec.uri);
    }

    public static void getCached(com.google.android.exoplayer2.upstream.DataSpec dataSpec, com.google.android.exoplayer2.upstream.cache.Cache cache, com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters cachingCounters) {
        java.lang.String key = getKey(dataSpec);
        long j_renamed = dataSpec.absoluteStreamPosition;
    ...
    public static void cache(com.google.android.exoplayer2.upstream.DataSpec dataSpec, com.google.android.exoplayer2.upstream.cache.Cache cache, com.google.android.exoplayer2.upstream.DataSource dataSource, com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters cachingCounters, java.util.concurrent.atomic.AtomicBoolean atomicBoolean) throws java.lang.InterruptedException, java.io.IOException {
        cache(dataSpec, cache, new com.google.android.exoplayer2.upstream.cache.CacheDataSource(cache, dataSource), new byte[131072], null, 0, cachingCounters, atomicBoolean, false);
    }

    public static void cache(com.google.android.exoplayer2.upstream.DataSpec dataSpec, com.google.android.exoplayer2.upstream.cache.Cache cache, com.google.android.exoplayer2.upstream.cache.CacheDataSource cacheDataSource, byte[] bArr, com.google.android.exoplayer2.util.PriorityTaskManager priorityTaskManager, int i_renamed, com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters cachingCounters, java.util.concurrent.atomic.AtomicBoolean atomicBoolean, boolean z_renamed) throws java.lang.InterruptedException, java.io.IOException {
        long j_renamed;
        com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters cachingCounters2 = cachingCounters;
        com.google.android.exoplayer2.util.Assertions.checkNotNull(cacheDataSource);
        ...
        if (cachingCounters2 != null) {
            ...
            cachingCounters2 = new com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters();
        }
        com.google.android.exoplayer2.upstream.cache.CacheUtil.CachingCounters cachingCounters3 = cachingCounters2;
        java.lang.String key = getKey(dataSpec);
        ...
        while (contentLength != 0) {
            ...
            if (cachedLength > 0) {
                j_renamed = cachedLength;
            } else {
                long j3 = -cachedLength;
                j_renamed = j3;
                if (readAndDiscard(dataSpec, j2, j3, cacheDataSource, bArr, priorityTaskManager, i_renamed, cachingCounters3, atomicBoolean) < j_renamed) {
                    if (z_renamed && contentLength != -1) {
            ...
            contentLength -= j_renamed;
        }
    }

    /* JADX WARN: Code restructure failed: missing block: B_renamed:23:0x006c, code lost:
    
        if (r26.contentLength != (-1)) goto L43;
     */
    /* JADX WARN: Code restructure failed: missing block: B_renamed:24:0x006e, code lost:
    ...
    */
    ...
    public static void remove(com.google.android.exoplayer2.upstream.cache.Cache cache, java.lang.String str) {
        java.util.Iterator<com.google.android.exoplayer2.upstream.cache.CacheSpan> it = cache.getCachedSpans(str).iterator();
        while (it.hasNext()) {
            try {
    ...
    private static void throwExceptionIfInterruptedOrCancelled(java.util.concurrent.atomic.AtomicBoolean atomicBoolean) throws java.lang.InterruptedException {
        if (java.lang.Thread.interrupted() || (atomicBoolean != null && atomicBoolean.get())) {
