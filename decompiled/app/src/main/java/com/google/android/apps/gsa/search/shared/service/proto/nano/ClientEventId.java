...
public interface ClientEventId {
    ...
    /* renamed from: PROACTIVE_MAYBE_SHOW_LOCATION_PERMISSION_NOTIFICATION */
    @NanoEnumValue(legacy = false, value = ClientEventId.class)
    public static final int f8970x72e42eb0 = 230;
    ...
    /* renamed from: PROACTIVE_REQUEST_ENABLE_SEARCH_HISTORY_FOR_ACTIVE_ACCOUNT */
    @NanoEnumValue(legacy = false, value = ClientEventId.class)
    public static final int f8971xe91155cc = 216;

    @NanoEnumValue(legacy = false, value = ClientEventId.class)
    public static final int PROACTIVE_REQUEST_HELP_INTENT = 224;

    /* renamed from: PROACTIVE_REQUEST_IS_REMINDER_SMART_ACTION_SUPPORTED */
    @NanoEnumValue(legacy = false, value = ClientEventId.class)
    public static final int f8972x173138af = 213;
    ...
    /* renamed from: PROACTIVE_UPDATE_BACK_OF_CARD_FOLLOW_CLICK_FOR_ENTRY */
    @NanoEnumValue(legacy = false, value = ClientEventId.class)
    public static final int f8973x9b5fd80c = 247;
    ...
    /* renamed from: SEARCH_PLATE_MIC_TAPPED_FOR_OPA_PROMO_NOTIFICATIONS */
    @NanoEnumValue(legacy = false, value = ClientEventId.class)
    public static final int f8974x9c140c28 = 272;
