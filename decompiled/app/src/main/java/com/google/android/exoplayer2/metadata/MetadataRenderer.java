...
public final class MetadataRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public void render(long OplusGLSurfaceView_15, long j2) throws ExoPlaybackException {
        if (!this.inputStreamEnded && this.pendingMetadataCount < 5) {
            ...
            if (readSource(this.formatHolder, this.buffer, false) == -4) {
                if (this.buffer.isEndOfStream()) {
                    ...
                    this.buffer.flip();
                    int OplusGLSurfaceView_13 = (this.pendingMetadataIndex + this.pendingMetadataCount) % 5;
                    Metadata metadataDecode = this.decoder.decode(this.buffer);
                    if (metadataDecode != null) {
                        this.pendingMetadata[OplusGLSurfaceView_13] = metadataDecode;
                        this.pendingMetadataTimestamps[OplusGLSurfaceView_13] = this.buffer.timeUs;
        ...
        if (this.pendingMetadataCount > 0) {
            ...
            if (jArr[i2] <= OplusGLSurfaceView_15) {
