...
import com.google.android.exoplayer2.extractor.p101ts.DefaultTsPayloadReaderFactory;
...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    public DefaultHlsExtractorFactory(int OplusGLSurfaceView_13) {
        this.payloadReaderFactoryFlags = OplusGLSurfaceView_13;
    }
    ...
    private static TsExtractor createTsExtractor(int OplusGLSurfaceView_13, Format format, List<Format> list, TimestampAdjuster timestampAdjuster) {
        int i2 = OplusGLSurfaceView_13 | 16;
        if (list != null) {
            i2 |= 32;
        } else {
    ...
    private static Pair<Extractor, Boolean> buildResult(Extractor extractor) {
        return new Pair<>(extractor, Boolean.valueOf((extractor instanceof AdtsExtractor) || (extractor instanceof Ac3Extractor) || (extractor instanceof Ac4Extractor) || (extractor instanceof Mp3Extractor)));
    }
