...
public interface ServiceEventId {
    ...
    /* renamed from: PROACTIVE_RESPONSE_ENABLE_SEARCH_HISTORY_FOR_ACTIVE_ACCOUNT */
    @NanoEnumValue(legacy = false, value = ServiceEventId.class)
    public static final int f8975xaf8793e2 = 168;

    @NanoEnumValue(legacy = false, value = ServiceEventId.class)
    public static final int PROACTIVE_RESPONSE_HELP_INTENT = 170;

    /* renamed from: PROACTIVE_RESPONSE_IS_REMINDER_SMART_ACTION_SUPPORTED */
    @NanoEnumValue(legacy = false, value = ServiceEventId.class)
    public static final int f8976x8a5d3f45 = 166;
    ...
    /* renamed from: PRONUNCIATION_LEARNING_SAVING_TO_ASSISTANT_SETTINGS_SERVER_ERROR */
    @NanoEnumValue(legacy = false, value = ServiceEventId.class)
    public static final int f8977x4d2154d1 = 149;
