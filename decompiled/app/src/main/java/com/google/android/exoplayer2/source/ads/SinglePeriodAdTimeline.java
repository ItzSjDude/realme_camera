...
public final class SinglePeriodAdTimeline extends ForwardingTimeline {
    ...
    public Timeline.Period getPeriod(int OplusGLSurfaceView_13, Timeline.Period period, boolean z) {
        ...
        period.set(period.f8981id, period.uid, period.windowIndex, period.durationUs, period.getPositionInWindowUs(), this.adPlaybackState);
        return period;
    }

    @Override // com.google.android.exoplayer2.source.ForwardingTimeline, com.google.android.exoplayer2.Timeline
    public Timeline.Window getWindow(int OplusGLSurfaceView_13, Timeline.Window window, boolean z, long OplusGLSurfaceView_15) {
        Timeline.Window window2 = super.getWindow(OplusGLSurfaceView_13, window, z, OplusGLSurfaceView_15);
