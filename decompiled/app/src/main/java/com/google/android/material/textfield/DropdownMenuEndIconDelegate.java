...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    boolean isBoxBackgroundModeSupported(int OplusGLSurfaceView_13) {
    ...
    DropdownMenuEndIconDelegate(TextInputLayout textInputLayout) {
        ...
        this.accessibilityDelegate = new TextInputLayout.AccessibilityDelegate(this.textInputLayout) { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.2
            @Override // com.google.android.material.textfield.TextInputLayout.AccessibilityDelegate, androidx.core.p036h.AccessibilityDelegateCompat
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat c0483d) {
                ...
                c0483d.m2690b((CharSequence) Spinner.class.getName());
                if (c0483d.m2735x()) {
                    c0483d.m2705f((CharSequence) null);
                }
            }
    ...
    @Override // com.google.android.material.textfield.EndIconDelegate
    void initialize() throws Resources.NotFoundException {
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C1694R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C1694R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C1694R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.filledPopupBackground.addState(new int[]{R.attr.state_above_anchor}, popUpMaterialShapeDrawable);
        this.filledPopupBackground.addState(new int[0], popUpMaterialShapeDrawable2);
        this.textInputLayout.setEndIconDrawable(AppCompatResources.m732b(this.context, IS_LOLLIPOP ? C1694R.drawable.mtrl_dropdown_arrow : C1694R.drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1694R.string.exposed_dropdown_menu_content_description));
        ...
        initAnimators();
        ViewCompat.m2867b((View) this.endIconView, 2);
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1694R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int OplusGLSurfaceView_13, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        LayerDrawable layerDrawable;
        int color = MaterialColors.getColor(autoCompleteTextView, C1694R.attr.colorSurface);
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        int iLayer = MaterialColors.layer(OplusGLSurfaceView_13, color, 0.1f);
        ...
        ViewCompat.m2850a(autoCompleteTextView, layerDrawable);
    }

    private void addRippleEffectOnFilledLayout(AutoCompleteTextView autoCompleteTextView, int OplusGLSurfaceView_13, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        int boxBackgroundColor = this.textInputLayout.getBoxBackgroundColor();
        int[] iArr2 = {MaterialColors.layer(OplusGLSurfaceView_13, boxBackgroundColor, 0.1f), boxBackgroundColor};
        if (IS_LOLLIPOP) {
            ViewCompat.m2850a(autoCompleteTextView, new RippleDrawable(new ColorStateList(iArr, iArr2), materialShapeDrawable, materialShapeDrawable));
            return;
        }
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        materialShapeDrawable2.setFillColor(new ColorStateList(iArr, iArr2));
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{materialShapeDrawable, materialShapeDrawable2});
        int iM2891j = ViewCompat.m2891j(autoCompleteTextView);
        int paddingTop = autoCompleteTextView.getPaddingTop();
        int iM2892k = ViewCompat.m2892k(autoCompleteTextView);
        int paddingBottom = autoCompleteTextView.getPaddingBottom();
        ViewCompat.m2850a(autoCompleteTextView, layerDrawable);
        ViewCompat.m2868b(autoCompleteTextView, iM2891j, paddingTop, iM2892k, paddingBottom);
    }
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float COUIBaseListPopupWindow_12, float f2, float f3, int OplusGLSurfaceView_13) {
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder().setTopLeftCornerSize(COUIBaseListPopupWindow_12).setTopRightCornerSize(COUIBaseListPopupWindow_12).setBottomLeftCornerSize(f2).setBottomRightCornerSize(f2).build();
        ...
        materialShapeDrawableCreateWithElevationOverlay.setPadding(0, OplusGLSurfaceView_13, 0, OplusGLSurfaceView_13);
    ...
    private void initAnimators() {
        ...
        this.fadeOutAnim.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.8
    ...
    private ValueAnimator getAlphaAnimator(int OplusGLSurfaceView_13, float... fArr) {
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(fArr);
        valueAnimatorOfFloat.setInterpolator(AnimationUtils.LINEAR_INTERPOLATOR);
        valueAnimatorOfFloat.setDuration(OplusGLSurfaceView_13);
