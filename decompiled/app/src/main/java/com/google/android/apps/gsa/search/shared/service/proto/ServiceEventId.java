...
public enum ServiceEventId implements Internal.EnumLite {
    ...
    /* renamed from: FETCH_SEARCH_SERVICE_BACKGROUND_TASK_NAMES_RESULT_VALUE */
    public static final int f8960xc51315cb = 231;
    ...
    /* renamed from: PROACTIVE_RESPONSE_ENABLE_SEARCH_HISTORY_FOR_ACTIVE_ACCOUNT_VALUE */
    public static final int f8962x3c849eb4 = 168;
    public static final int PROACTIVE_RESPONSE_HELP_INTENT_VALUE = 170;

    /* renamed from: PROACTIVE_RESPONSE_IS_REMINDER_SMART_ACTION_SUPPORTED_VALUE */
    public static final int f8964x2236f3d7 = 166;

    /* renamed from: PROACTIVE_RESPONSE_LOCATION_SETTINGS_RESOLUTION_VALUE */
    public static final int f8965x4e087ae2 = 174;

    /* renamed from: PROACTIVE_RESPONSE_NEW_CARDS_INFO_NON_TAB_STREAM_VALUE */
    public static final int f8966xea4391d2 = 179;
    ...
    /* renamed from: PRONUNCIATION_LEARNING_SAVING_TO_ASSISTANT_SETTINGS_SERVER_ERROR_VALUE */
    public static final int f8968x92bfb063 = 149;
    ...
    private static final Internal.EnumLiteMap<ServiceEventId> internalValueMap = new Internal.EnumLiteMap<ServiceEventId>() { // from class: com.google.android.apps.gsa.search.shared.service.proto.ServiceEventId.1
        ...
        public ServiceEventId findValueByNumber(int OplusGLSurfaceView_13) {
            return ServiceEventId.forNumber(OplusGLSurfaceView_13);
        }
    };
    ...
    public static ServiceEventId forNumber(int OplusGLSurfaceView_13) {
    ...
    ServiceEventId(int OplusGLSurfaceView_13) {
