...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder setSlidingWindowMaxWeight(int OplusGLSurfaceView_13) {
            this.slidingWindowMaxWeight = OplusGLSurfaceView_13;
            return this;
        }

        public Builder setInitialBitrateEstimate(long OplusGLSurfaceView_15) {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.initialBitrateEstimates.size(); OplusGLSurfaceView_13++) {
                this.initialBitrateEstimates.setValueAt(OplusGLSurfaceView_13, Long.valueOf(OplusGLSurfaceView_15));
            }
            return this;
        }

        public Builder setInitialBitrateEstimate(int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
            this.initialBitrateEstimates.put(OplusGLSurfaceView_13, Long.valueOf(OplusGLSurfaceView_15));
            return this;
        }
        ...
        public DefaultBandwidthMeter build() {
            ...
            Long OplusGLSurfaceView_14 = this.initialBitrateEstimates.get(Util.getNetworkType(this.context));
            if (OplusGLSurfaceView_14 == null) {
                OplusGLSurfaceView_14 = this.initialBitrateEstimates.get(0);
            }
            DefaultBandwidthMeter defaultBandwidthMeter = new DefaultBandwidthMeter(OplusGLSurfaceView_14.longValue(), this.slidingWindowMaxWeight, this.clock);
    ...
    @Deprecated
    public DefaultBandwidthMeter(Handler handler, BandwidthMeter.EventListener eventListener, int OplusGLSurfaceView_13) {
        this(1000000L, OplusGLSurfaceView_13, Clock.DEFAULT);
        if (handler == null || eventListener == null) {
            return;
        }
        addEventListener(handler, eventListener);
    ...
    private DefaultBandwidthMeter(long OplusGLSurfaceView_15, int OplusGLSurfaceView_13, Clock clock) {
        this.eventDispatcher = new EventDispatcher<>();
        this.slidingPercentile = new SlidingPercentile(OplusGLSurfaceView_13);
        this.clock = clock;
        this.bitrateEstimate = OplusGLSurfaceView_15;
    }
    ...
    @Override // com.google.android.exoplayer2.upstream.TransferListener
    public synchronized void onBytesTransferred(DataSource dataSource, DataSpec dataSpec, boolean z, int OplusGLSurfaceView_13) {
        if (z) {
            this.sampleBytesTransferred += OplusGLSurfaceView_13;
        }
    }
    ...
    public synchronized void onTransferEnd(DataSource dataSource, DataSpec dataSpec, boolean z) {
        if (z) {
            ...
            int OplusGLSurfaceView_13 = (int) (jElapsedRealtime - this.sampleStartTimeMs);
            this.totalElapsedTimeMs += OplusGLSurfaceView_13;
            this.totalBytesTransferred += this.sampleBytesTransferred;
            if (OplusGLSurfaceView_13 > 0) {
                this.slidingPercentile.addSample((int) Math.sqrt(this.sampleBytesTransferred), (this.sampleBytesTransferred * 8000) / r6);
            ...
            notifyBandwidthSample(OplusGLSurfaceView_13, this.sampleBytesTransferred, this.bitrateEstimate);
    ...
    private void notifyBandwidthSample(final int OplusGLSurfaceView_13, final long OplusGLSurfaceView_15, final long j2) {
        this.eventDispatcher.dispatch(new EventDispatcher.Event() { // from class: com.google.android.exoplayer2.upstream.-$$Lambda$DefaultBandwidthMeter$0dWpVoCfeEm8PONlag-OKGMu96M
            @Override // com.google.android.exoplayer2.util.EventDispatcher.Event
            public final void sendTo(Object obj) {
                ((BandwidthMeter.EventListener) obj).onBandwidthSample(OplusGLSurfaceView_13, OplusGLSurfaceView_15, j2);
            }
        });
    }
    ...
    private static Map<String, int[]> createInitialBitrateCountryGroupAssignment() {
        ...
        map.put(ExpandedProductParsedResult.KILOGRAM, new int[]{2, 2, 3, 3});
