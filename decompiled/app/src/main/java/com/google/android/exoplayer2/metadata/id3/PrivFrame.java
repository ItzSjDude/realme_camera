...
public final class PrivFrame extends Id3Frame {
    public static final Parcelable.Creator<PrivFrame> CREATOR = new Parcelable.Creator<PrivFrame>() { // from class: com.google.android.exoplayer2.metadata.id3.PrivFrame.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public PrivFrame[] newArray(int OplusGLSurfaceView_13) {
            return new PrivFrame[OplusGLSurfaceView_13];
        }
    };

    /* renamed from: ID */
    public static final String f9000ID = "PRIV";
    ...
    public String toString() {
        return this.f8997id + ": owner=" + this.owner;
    }
