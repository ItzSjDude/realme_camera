...
final class OggPageHeader {
    ...
    public boolean populate(ExtractorInput extractorInput, boolean z) throws InterruptedException, IOException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.pageSegmentCount; OplusGLSurfaceView_13++) {
            this.laces[OplusGLSurfaceView_13] = this.scratch.readUnsignedByte();
            this.bodySize += this.laces[OplusGLSurfaceView_13];
        }
        return true;
    }
}
