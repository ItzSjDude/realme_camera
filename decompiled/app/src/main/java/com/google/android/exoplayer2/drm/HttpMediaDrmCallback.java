...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeProvisionRequest(UUID uuid, ExoMediaDrm.ProvisionRequest provisionRequest) throws IOException {
        return executePost(this.dataSourceFactory, provisionRequest.getDefaultUrl() + "&signedRequest=" + Util.fromUtf8Bytes(provisionRequest.getData()), Util.EMPTY_BYTE_ARRAY, null);
    }
    ...
    public byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest) throws Exception {
        ...
        if (C1547C.PLAYREADY_UUID.equals(uuid)) {
            str = "text/xml";
        } else {
            str = C1547C.CLEARKEY_UUID.equals(uuid) ? "application/json" : "application/octet-stream";
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x006c A[Catch: all -> 0x004f, TRY_LEAVE, TryCatch #1 {all -> 0x004f, blocks: (B:10:0x0047, B:17:0x0053, B:19:0x0059, B:28:0x006c, B:33:0x007d, B:23:0x0062), top: B:36:0x0047, inners: #0 }] */
