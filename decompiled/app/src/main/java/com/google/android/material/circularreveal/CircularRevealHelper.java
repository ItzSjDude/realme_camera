...
public class CircularRevealHelper {
    ...
    public void setCircularRevealScrimColor(int OplusGLSurfaceView_13) {
        this.scrimPaint.setColor(OplusGLSurfaceView_13);
        this.view.invalidate();
    }
    ...
    public void draw(Canvas canvas) {
        if (shouldDrawCircularReveal()) {
            int OplusGLSurfaceView_13 = STRATEGY;
    ...
    private void drawDebugCircle(Canvas canvas, int OplusGLSurfaceView_13, float COUIBaseListPopupWindow_12) {
        this.debugPaint.setColor(OplusGLSurfaceView_13);
        this.debugPaint.setStrokeWidth(COUIBaseListPopupWindow_12);
        canvas.drawCircle(this.revealInfo.centerX, this.revealInfo.centerY, this.revealInfo.radius - (COUIBaseListPopupWindow_12 / 2.0f), this.debugPaint);
    }
}
