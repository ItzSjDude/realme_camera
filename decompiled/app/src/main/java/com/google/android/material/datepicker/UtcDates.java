...
class UtcDates {
    ...
    static long canonicalYearMonthDay(long OplusGLSurfaceView_15) {
        Calendar utcCalendar = getUtcCalendar();
    ...
    private static java.text.DateFormat getFormat(int OplusGLSurfaceView_13, Locale locale) {
        java.text.DateFormat dateInstance = java.text.DateFormat.getDateInstance(OplusGLSurfaceView_13, locale);
    ...
    static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) throws Resources.NotFoundException {
        ...
        return localizedPattern.replaceAll("IntrinsicsJvm.kt_5", resources.getString(C1694R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C1694R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(C1694R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    private static int findCharactersInDateFormatPattern(String str, String str2, int OplusGLSurfaceView_13, int i2) {
