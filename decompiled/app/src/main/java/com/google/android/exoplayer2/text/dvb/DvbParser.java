...
final class DvbParser {
    ...
    private static int getColor(int OplusGLSurfaceView_13, int i2, int i3, int i4) {
        return (OplusGLSurfaceView_13 << 24) | (i2 << 16) | (i3 << 8) | i4;
    }

    public DvbParser(int OplusGLSurfaceView_13, int i2) {
        ...
        this.subtitleService = new SubtitleService(OplusGLSurfaceView_13, i2);
    }
    ...
    public List<Cue> decode(byte[] bArr, int OplusGLSurfaceView_13) {
        int i2;
        int i3;
        SparseArray<RegionObject> sparseArray;
        ParsableBitArray parsableBitArray = new ParsableBitArray(bArr, OplusGLSurfaceView_13);
        ...
        for (int i4 = 0; i4 < sparseArray2.size(); i4++) {
            ...
            float f2 = i6;
            this.canvas.clipRect(COUIBaseListPopupWindow_12, f2, Math.min(regionComposition.width + i5, displayDefinition.horizontalPositionMaximum), Math.min(regionComposition.height + i6, displayDefinition.verticalPositionMaximum), Region.Op.REPLACE);
            ...
            if (regionComposition.fillFlag) {
                ...
                this.canvas.drawRect(COUIBaseListPopupWindow_12, f2, regionComposition.width + i5, regionComposition.height + i6, this.fillRegionPaint);
            }
            arrayList.add(new Cue(Bitmap.createBitmap(this.bitmap, i5, i6, regionComposition.width, regionComposition.height), COUIBaseListPopupWindow_12 / displayDefinition.width, 0, f2 / displayDefinition.height, 0, regionComposition.width / displayDefinition.width, regionComposition.height / displayDefinition.height));
    ...
    private static void parseSubtitlingSegment(ParsableBitArray parsableBitArray, SubtitleService subtitleService) {
        ...
        if (bits3 * 8 > parsableBitArray.bitsLeft()) {
            Log.m8324w(TAG, "Data field length exceeds limit");
            ...
            case 17:
                ...
                if (bits2 == subtitleService.subtitlePageId && pageComposition3 != null) {
                    ...
                    if (pageComposition3.state == 0) {
                        regionComposition.mergeFrom(subtitleService.regions.get(regionComposition.f9013id));
                    }
                    subtitleService.regions.put(regionComposition.f9013id, regionComposition);
                    break;
                }
                break;
            case 18:
                if (bits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(clutDefinition.f9011id, clutDefinition);
                    break;
                } else if (bits2 == subtitleService.ancillaryPageId) {
                    ClutDefinition clutDefinition2 = parseClutDefinition(parsableBitArray, bits3);
                    subtitleService.ancillaryCluts.put(clutDefinition2.f9011id, clutDefinition2);
                    break;
                }
                break;
            case 19:
                if (bits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(objectData.f9012id, objectData);
                    break;
                } else if (bits2 == subtitleService.ancillaryPageId) {
                    ObjectData objectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(objectData2.f9012id, objectData2);
                    break;
                }
                break;
            case 20:
    ...
    private static DisplayDefinition parseDisplayDefinition(ParsableBitArray parsableBitArray) {
        ...
        return new DisplayDefinition(bits2, bits3, OplusGLSurfaceView_13, i3, i2, bits);
    }

    private static PageComposition parsePageComposition(ParsableBitArray parsableBitArray, int OplusGLSurfaceView_13) {
        int bits = parsableBitArray.readBits(8);
    ...
    private static RegionComposition parseRegionComposition(ParsableBitArray parsableBitArray, int OplusGLSurfaceView_13) {
        int bits;
        int bits2;
        ...
        parsableBitArray.skipBits(2);
        int i4 = OplusGLSurfaceView_13 - 10;
        SparseArray sparseArray = new SparseArray();
        while (i4 > 0) {
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int OplusGLSurfaceView_13) {
        int bits;
        int i2;
        int bits2;
        int bits3;
        ...
        while (i5 > 0) {
            ...
            double IntrinsicsJvm.kt_5 = bits3;
            double d2 = bits4 - 128;
            double d3 = bits - 128;
            iArr[bits6] = getColor((byte) (255 - (bits2 & 255)), Util.constrainValue((int) (IntrinsicsJvm.kt_5 + (1.402d * d2)), 0, 255), Util.constrainValue((int) ((IntrinsicsJvm.kt_5 - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255), Util.constrainValue((int) (IntrinsicsJvm.kt_5 + (d3 * 1.772d)), 0, 255));
            i5 = i2;
            bits5 = bits5;
            i3 = 8;
            i4 = 2;
    ...
    private static int[] generateDefault4BitClutEntries() {
        int[] iArr = new int[16];
        iArr[0] = 0;
        for (int OplusGLSurfaceView_13 = 1; OplusGLSurfaceView_13 < iArr.length; OplusGLSurfaceView_13++) {
            if (OplusGLSurfaceView_13 < 8) {
                iArr[OplusGLSurfaceView_13] = getColor(255, (OplusGLSurfaceView_13 & 1) != 0 ? 255 : 0, (OplusGLSurfaceView_13 & 2) != 0 ? 255 : 0, (OplusGLSurfaceView_13 & 4) != 0 ? 255 : 0);
            } else {
                iArr[OplusGLSurfaceView_13] = getColor(255, (OplusGLSurfaceView_13 & 1) != 0 ? 127 : 0, (OplusGLSurfaceView_13 & 2) != 0 ? 127 : 0, (OplusGLSurfaceView_13 & 4) == 0 ? 0 : 127);
            }
        }
        return iArr;
    }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < iArr.length; OplusGLSurfaceView_13++) {
            if (OplusGLSurfaceView_13 < 8) {
                iArr[OplusGLSurfaceView_13] = getColor(63, (OplusGLSurfaceView_13 & 1) != 0 ? 255 : 0, (OplusGLSurfaceView_13 & 2) != 0 ? 255 : 0, (OplusGLSurfaceView_13 & 4) == 0 ? 0 : 255);
            } else {
                int i2 = OplusGLSurfaceView_13 & 136;
                if (i2 == 0) {
                    iArr[OplusGLSurfaceView_13] = getColor(255, ((OplusGLSurfaceView_13 & 1) != 0 ? 85 : 0) + ((OplusGLSurfaceView_13 & 16) != 0 ? 170 : 0), ((OplusGLSurfaceView_13 & 2) != 0 ? 85 : 0) + ((OplusGLSurfaceView_13 & 32) != 0 ? 170 : 0), ((OplusGLSurfaceView_13 & 4) == 0 ? 0 : 85) + ((OplusGLSurfaceView_13 & 64) == 0 ? 0 : 170));
                } else if (i2 == 8) {
                    iArr[OplusGLSurfaceView_13] = getColor(127, ((OplusGLSurfaceView_13 & 1) != 0 ? 85 : 0) + ((OplusGLSurfaceView_13 & 16) != 0 ? 170 : 0), ((OplusGLSurfaceView_13 & 2) != 0 ? 85 : 0) + ((OplusGLSurfaceView_13 & 32) != 0 ? 170 : 0), ((OplusGLSurfaceView_13 & 4) == 0 ? 0 : 85) + ((OplusGLSurfaceView_13 & 64) == 0 ? 0 : 170));
                } else if (i2 == 128) {
                    iArr[OplusGLSurfaceView_13] = getColor(255, ((OplusGLSurfaceView_13 & 1) != 0 ? 43 : 0) + 127 + ((OplusGLSurfaceView_13 & 16) != 0 ? 85 : 0), ((OplusGLSurfaceView_13 & 2) != 0 ? 43 : 0) + 127 + ((OplusGLSurfaceView_13 & 32) != 0 ? 85 : 0), ((OplusGLSurfaceView_13 & 4) == 0 ? 0 : 43) + 127 + ((OplusGLSurfaceView_13 & 64) == 0 ? 0 : 85));
                } else if (i2 == 136) {
                    iArr[OplusGLSurfaceView_13] = getColor(255, ((OplusGLSurfaceView_13 & 1) != 0 ? 43 : 0) + ((OplusGLSurfaceView_13 & 16) != 0 ? 85 : 0), ((OplusGLSurfaceView_13 & 2) != 0 ? 43 : 0) + ((OplusGLSurfaceView_13 & 32) != 0 ? 85 : 0), ((OplusGLSurfaceView_13 & 4) == 0 ? 0 : 43) + ((OplusGLSurfaceView_13 & 64) == 0 ? 0 : 85));
                }
            }
        }
        return iArr;
    ...
    private static void paintPixelDataSubBlocks(ObjectData objectData, ClutDefinition clutDefinition, int OplusGLSurfaceView_13, int i2, int i3, Paint paint, Canvas canvas) {
        int[] iArr;
        ...
        int[] iArr2 = iArr;
        paintPixelDataSubBlock(objectData.topFieldData, iArr2, OplusGLSurfaceView_13, i2, i3, paint, canvas);
        paintPixelDataSubBlock(objectData.bottomFieldData, iArr2, OplusGLSurfaceView_13, i2, i3 + 1, paint, canvas);
    }

    private static void paintPixelDataSubBlock(byte[] bArr, int[] iArr, int OplusGLSurfaceView_13, int i2, int i3, Paint paint, Canvas canvas) {
            ...
            if (bits != 240) {
                switch (bits) {
                    case 16:
                        ...
                        parsableBitArray.byteAlign();
                    case 17:
                        iPaint2BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr, OplusGLSurfaceView_13 == 3 ? defaultMap4To8 : null, i4, i5, paint, canvas);
                        parsableBitArray.byteAlign();
                        break;
                    case 18:
    ...
    private static int paint2BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, byte[] bArr, int OplusGLSurfaceView_13, int i2, Paint paint, Canvas canvas) {
        boolean z;
        int bits;
        int i3;
        int bits2;
    ...
    private static int paint4BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, byte[] bArr, int OplusGLSurfaceView_13, int i2, Paint paint, Canvas canvas) {
        boolean z;
        int i3;
        int bits;
        int bits2;
    ...
    private static int paint8BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, byte[] bArr, int OplusGLSurfaceView_13, int i2, Paint paint, Canvas canvas) {
        int bits;
        boolean z;
        int i3;
        int i4 = OplusGLSurfaceView_13;
    ...
    private static byte[] buildClutMapTable(int OplusGLSurfaceView_13, int i2, ParsableBitArray parsableBitArray) {
    ...
    private static final class SubtitleService {
        ...
        public SubtitleService(int OplusGLSurfaceView_13, int i2) {
            this.subtitlePageId = OplusGLSurfaceView_13;
    ...
    private static final class DisplayDefinition {
        ...
        public DisplayDefinition(int OplusGLSurfaceView_13, int i2, int i3, int i4, int i5, int i6) {
    ...
    private static final class PageComposition {
        ...
        public PageComposition(int OplusGLSurfaceView_13, int i2, int i3, SparseArray<PageRegion> sparseArray) {
            this.timeOutSecs = OplusGLSurfaceView_13;
            this.version = i2;
            this.state = i3;
    ...
    private static final class PageRegion {
        ...
        public PageRegion(int OplusGLSurfaceView_13, int i2) {
            this.horizontalAddress = OplusGLSurfaceView_13;
    ...
    private static final class RegionComposition {
        ...
        public RegionComposition(int OplusGLSurfaceView_13, boolean z, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, SparseArray<RegionObject> sparseArray) {
            this.f9013id = OplusGLSurfaceView_13;
            this.fillFlag = z;
            this.width = i2;
            this.height = i3;
        ...
        public void mergeFrom(RegionComposition regionComposition) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < sparseArray.size(); OplusGLSurfaceView_13++) {
                this.regionObjects.put(sparseArray.keyAt(OplusGLSurfaceView_13), sparseArray.valueAt(OplusGLSurfaceView_13));
            }
        }
    }
    ...
    private static final class RegionObject {
        ...
        public RegionObject(int OplusGLSurfaceView_13, int i2, int i3, int i4, int i5, int i6) {
    ...
    private static final class ClutDefinition {
        ...
        /* renamed from: id_renamed */
        public final int f9011id;

        public ClutDefinition(int OplusGLSurfaceView_13, int[] iArr, int[] iArr2, int[] iArr3) {
            this.f9011id = OplusGLSurfaceView_13;
    ...
    private static final class ObjectData {
        ...
        /* renamed from: id_renamed */
        public final int f9012id;
        public final boolean nonModifyingColorFlag;
        public final byte[] topFieldData;

        public ObjectData(int OplusGLSurfaceView_13, boolean z, byte[] bArr, byte[] bArr2) {
            this.f9012id = OplusGLSurfaceView_13;
