...
public interface AnalyticsListener {
    ...
    default void onAudioSessionId(EventTime eventTime, int OplusGLSurfaceView_13) {
    }

    default void onAudioUnderrun(EventTime eventTime, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, long j2) {
    }

    default void onBandwidthEstimate(EventTime eventTime, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, long j2) {
    }

    default void onDecoderDisabled(EventTime eventTime, int OplusGLSurfaceView_13, DecoderCounters decoderCounters) {
    }

    default void onDecoderEnabled(EventTime eventTime, int OplusGLSurfaceView_13, DecoderCounters decoderCounters) {
    }

    default void onDecoderInitialized(EventTime eventTime, int OplusGLSurfaceView_13, String str, long OplusGLSurfaceView_15) {
    }

    default void onDecoderInputFormatChanged(EventTime eventTime, int OplusGLSurfaceView_13, Format format) {
    }
    ...
    default void onDroppedVideoFrames(EventTime eventTime, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
    }
    ...
    default void onPlayerStateChanged(EventTime eventTime, boolean z, int OplusGLSurfaceView_13) {
    }

    default void onPositionDiscontinuity(EventTime eventTime, int OplusGLSurfaceView_13) {
    }

    default void onPrepared(EventTime eventTime) {
    }
    ...
    default void onRepeatModeChanged(EventTime eventTime, int OplusGLSurfaceView_13) {
    }

    default void onSeekCompleted(int OplusGLSurfaceView_13, int i2) {
    }
    ...
    default void onSurfaceSizeChanged(EventTime eventTime, int OplusGLSurfaceView_13, int i2) {
    }

    default void onTimelineChanged(EventTime eventTime, int OplusGLSurfaceView_13) {
    }
    ...
    default void onVideoSizeChanged(EventTime eventTime, int OplusGLSurfaceView_13, int i2, int i3, float COUIBaseListPopupWindow_12) {
    }

    default void onVolumeChanged(EventTime eventTime, float COUIBaseListPopupWindow_12) {
    }
    ...
    public static final class EventTime {
        ...
        public EventTime(long OplusGLSurfaceView_15, Timeline timeline, int OplusGLSurfaceView_13, MediaSource.MediaPeriodId mediaPeriodId, long j2, long j3, long j4) {
            this.realtimeMs = OplusGLSurfaceView_15;
