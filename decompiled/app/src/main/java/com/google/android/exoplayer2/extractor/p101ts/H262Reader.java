    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            if (this.userDataReader != null) {
                ...
                if (this.userData.endNalUnit(OplusGLSurfaceView_13)) {
            ...
            if (i3 == 0 || i3 == 179) {
                ...
                if (!this.startedFirstSample || this.sampleHasPicture) {
                    ...
                    long OplusGLSurfaceView_15 = this.pesTimeUs;
                    if (OplusGLSurfaceView_15 == -9223372036854775807L) {
                        OplusGLSurfaceView_15 = this.startedFirstSample ? this.sampleTimeUs + this.frameDurationUs : 0L;
                    }
    ...
    */
    private static android.util.Pair<com.google.android.exoplayer2.Format, java.lang.Long> parseCsdBuffer(com.google.android.exoplayer2.extractor.ts.H262Reader.CsdBuffer r20, java.lang.String r21) {
        ...
        L4b:
            ...
            int r3 = r3 + (-1)
            if (r3 < 0) goto L90
            double[] r7 = com.google.android.exoplayer2.extractor.p101ts.H262Reader.FRAME_RATE_VALUES
            int r8 = r7.length
            if (r3 >= r8) goto L90
            r5 = r7[r3]
        ...
        L90:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p101ts.H262Reader.parseCsdBuffer(com.google.android.exoplayer2.extractor.ts.H262Reader$CsdBuffer, java.lang.String):android.util.Pair");
    }
    ...
    private static final class CsdBuffer {
        ...
        public CsdBuffer(int OplusGLSurfaceView_13) {
        ...
        public boolean onStartCode(int OplusGLSurfaceView_13, int i2) {
            if (this.isFilling) {
                this.length -= i2;
                if (this.sequenceExtensionPosition == 0 && OplusGLSurfaceView_13 == 181) {
                    this.sequenceExtensionPosition = this.length;
                } else {
                    this.isFilling = false;
                    return true;
                }
            } else if (OplusGLSurfaceView_13 == 179) {
                this.isFilling = true;
            }
        ...
        public void onData(byte[] bArr, int OplusGLSurfaceView_13, int i2) {
            if (this.isFilling) {
                ...
                System.arraycopy(bArr, OplusGLSurfaceView_13, this.data, this.length, i3);
                this.length += i3;
            }
        }
    }
