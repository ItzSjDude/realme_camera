...
public class MaterialContainerTransform extends Transition {
    ...
    private int drawingViewId = R.id_renamed.content;
    ...
    public void setStartViewId(int OplusGLSurfaceView_13) {
        this.startViewId = OplusGLSurfaceView_13;
    }
    ...
    public void setEndViewId(int OplusGLSurfaceView_13) {
        this.endViewId = OplusGLSurfaceView_13;
    }
    ...
    public void setDrawingViewId(int OplusGLSurfaceView_13) {
        this.drawingViewId = OplusGLSurfaceView_13;
    }
    ...
    public void setContainerColor(int OplusGLSurfaceView_13) {
        this.containerColor = OplusGLSurfaceView_13;
    }
    ...
    public void setScrimColor(int OplusGLSurfaceView_13) {
        this.scrimColor = OplusGLSurfaceView_13;
    }
    ...
    public void setTransitionDirection(int OplusGLSurfaceView_13) {
        this.transitionDirection = OplusGLSurfaceView_13;
    }
    ...
    public void setFadeMode(int OplusGLSurfaceView_13) {
        this.fadeMode = OplusGLSurfaceView_13;
    }
    ...
    public void setFitMode(int OplusGLSurfaceView_13) {
        this.fitMode = OplusGLSurfaceView_13;
    }
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int OplusGLSurfaceView_13, ShapeAppearanceModel shapeAppearanceModel) {
        if (OplusGLSurfaceView_13 != -1) {
            transitionValues.view = TransitionUtils.findDescendantOrAncestorById(transitionValues.view, OplusGLSurfaceView_13);
        } else if (view != null) {
        ...
        if (!ViewCompat.m2823A(view3) && view3.getWidth() == 0 && view3.getHeight() == 0) {
            return;
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(new int[]{C1694R.attr.transitionShapeAppearance});
    ...
    @Override // android.transition.Transition
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) throws Resources.NotFoundException {
        View view;
        ...
        if (this.drawingViewId == view4.getId()) {
            ...
            View viewFindAncestorById = TransitionUtils.findAncestorById(view4, this.drawingViewId);
            view4 = null;
            view = viewFindAncestorById;
        }
        RectF rectF = (RectF) Preconditions.m2536a(transitionValues.values.get(PROP_BOUNDS));
        RectF rectF2 = (RectF) Preconditions.m2536a(transitionValues2.values.get(PROP_BOUNDS));
        ...
        float COUIBaseListPopupWindow_12 = -locationOnScreen.left;
        float f2 = -locationOnScreen.top;
        RectF rectFCalculateDrawableBounds = calculateDrawableBounds(view, view4, COUIBaseListPopupWindow_12, f2);
        rectF.offset(COUIBaseListPopupWindow_12, f2);
        rectF2.offset(COUIBaseListPopupWindow_12, f2);
        boolean zIsEntering = isEntering(rectF, rectF2);
        final View view5 = view;
        final TransitionDrawable transitionDrawable = new TransitionDrawable(getPathMotion(), view2, rectF, shapeAppearanceModel, view3, rectF2, shapeAppearanceModel2, this.containerColor, getScrimColorOrDefault(view2.getContext()), zIsEntering, FadeModeEvaluators.get(this.fadeMode, zIsEntering), FitModeEvaluators.get(this.fitMode, zIsEntering, rectF, rectF2), buildThresholdsGroup(zIsEntering), this.drawDebugEnabled);
        ...
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.transition.MaterialContainerTransform.2
    ...
    private int getScrimColorOrDefault(Context context) {
        int OplusGLSurfaceView_13 = this.scrimColor;
        return OplusGLSurfaceView_13 == -1 ? MaterialColors.getColor(context, C1694R.attr.scrimBackground, ContextCompat.m2254c(context, C1694R.color.mtrl_scrim_color)) : OplusGLSurfaceView_13;
    }

    private static RectF calculateDrawableBounds(View view, View view2, float COUIBaseListPopupWindow_12, float f2) {
        if (view2 != null) {
            RectF locationOnScreen = TransitionUtils.getLocationOnScreen(view2);
            locationOnScreen.offset(COUIBaseListPopupWindow_12, f2);
    ...
    private boolean isEntering(RectF rectF, RectF rectF2) {
        int OplusGLSurfaceView_13 = this.transitionDirection;
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, int OplusGLSurfaceView_13, int i2, boolean z, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z2) {
            ...
            this.containerPaint.setColor(OplusGLSurfaceView_13);
        ...
        public void setColorFilter(ColorFilter colorFilter) {
            throw new UnsupportedOperationException("Setting PlatformImplementations.kt_3 color filter is not supported");
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setProgress(float COUIBaseListPopupWindow_12) {
            if (this.progress != COUIBaseListPopupWindow_12) {
                updateProgress(COUIBaseListPopupWindow_12);
            }
        }

        private void updateProgress(float COUIBaseListPopupWindow_12) {
            this.progress = COUIBaseListPopupWindow_12;
            this.scrimPaint.setAlpha((int) (this.entering ? TransitionUtils.lerp(0.0f, 255.0f, COUIBaseListPopupWindow_12) : TransitionUtils.lerp(255.0f, 0.0f, COUIBaseListPopupWindow_12)));
            this.motionPathMeasure.getPosTan(this.motionPathLength * COUIBaseListPopupWindow_12, this.motionPathPosition, null);
            float[] fArr = this.motionPathPosition;
            float f2 = fArr[0];
            float f3 = fArr[1];
            this.fitModeResult = this.fitModeEvaluator.evaluate(COUIBaseListPopupWindow_12, ((Float) Preconditions.m2536a(Float.valueOf(this.progressThresholds.scale.start))).floatValue(), ((Float) Preconditions.m2536a(Float.valueOf(this.progressThresholds.scale.end))).floatValue(), this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            float fFloatValue = ((Float) Preconditions.m2536a(Float.valueOf(this.progressThresholds.scaleMask.start))).floatValue();
            float fFloatValue2 = ((Float) Preconditions.m2536a(Float.valueOf(this.progressThresholds.scaleMask.end))).floatValue();
            ...
            float fLerp = TransitionUtils.lerp(0.0f, 1.0f, fFloatValue, fFloatValue2, COUIBaseListPopupWindow_12);
            if (!zShouldMaskStartBounds) {
                fLerp = 1.0f - fLerp;
            }
            this.fitModeEvaluator.applyMask(rectF, fLerp, this.fitModeResult);
            this.maskEvaluator.evaluate(COUIBaseListPopupWindow_12, this.startShapeAppearanceModel, this.endShapeAppearanceModel, this.currentStartBounds, this.currentStartBoundsMasked, this.currentEndBoundsMasked, this.progressThresholds.shapeMask);
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(COUIBaseListPopupWindow_12, ((Float) Preconditions.m2536a(Float.valueOf(this.progressThresholds.fade.start))).floatValue(), ((Float) Preconditions.m2536a(Float.valueOf(this.progressThresholds.fade.end))).floatValue());
            invalidateSelf();
        }
        ...
        private void drawDebugCumulativePath(Canvas canvas, RectF rectF, Path path, int OplusGLSurfaceView_13) {
            PointF motionPathPoint = getMotionPathPoint(rectF);
            if (this.progress == 0.0f) {
                ...
                this.debugPaint.setColor(OplusGLSurfaceView_13);
                canvas.drawPath(path, this.debugPaint);
            }
        }

        private void drawDebugRect(Canvas canvas, RectF rectF, int OplusGLSurfaceView_13) {
            this.debugPaint.setColor(OplusGLSurfaceView_13);
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(float COUIBaseListPopupWindow_12, float f2) {
            this.start = COUIBaseListPopupWindow_12;
            this.end = f2;
        }
    }
