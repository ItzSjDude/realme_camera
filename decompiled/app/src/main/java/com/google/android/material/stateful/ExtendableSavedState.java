...
public class ExtendableSavedState extends AbsSavedState {
    public static final Parcelable.Creator<ExtendableSavedState> CREATOR = new Parcelable.ClassLoaderCreator<ExtendableSavedState>() { // from class: com.google.android.material.stateful.ExtendableSavedState.1
        ...
        @Override // android.os.Parcelable.Creator
        public ExtendableSavedState[] newArray(int OplusGLSurfaceView_13) {
            return new ExtendableSavedState[OplusGLSurfaceView_13];
        }
    };
    ...
    private ExtendableSavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        Bundle[] bundleArr = new Bundle[OplusGLSurfaceView_13];
        parcel.readTypedArray(bundleArr, Bundle.CREATOR);
        this.extendableStates = new SimpleArrayMap<>(OplusGLSurfaceView_13);
