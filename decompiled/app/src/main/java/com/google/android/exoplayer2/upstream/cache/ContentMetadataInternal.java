...
final class ContentMetadataInternal {
    ...
    public static void setContentLength(ContentMetadataMutations contentMetadataMutations, long OplusGLSurfaceView_15) {
        contentMetadataMutations.set(METADATA_NAME_CONTENT_LENGTH, OplusGLSurfaceView_15);
    }
