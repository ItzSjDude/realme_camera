...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    SnackbarManager.Callback managerCallback = new SnackbarManager.Callback() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.5
        ...
        @Override // com.google.android.material.snackbar.SnackbarManager.Callback
        public void dismiss(int OplusGLSurfaceView_13) {
            BaseTransientBottomBar.handler.sendMessage(BaseTransientBottomBar.handler.obtainMessage(1, OplusGLSurfaceView_13, 0, BaseTransientBottomBar.this));
        }
    };
    ...
    public static abstract class BaseCallback<B> {
        ...
        public void onDismissed(B b2, int OplusGLSurfaceView_13) {
        }
    ...
    protected interface OnLayoutChangeListener {
        void onLayoutChange(View view, int OplusGLSurfaceView_13, int i2, int i3, int i4);
    }

    static {
        USE_OFFSET_API = Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT <= 19;
        SNACKBAR_STYLE_ATTR = new int[]{C1694R.attr.snackbarStyle};
    ...
    protected BaseTransientBottomBar(ViewGroup viewGroup, View view, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        ViewCompat.m2877d(this.view, 1);
        ViewCompat.m2867b((View) this.view, 1);
        ViewCompat.m2869b((View) this.view, true);
        ViewCompat.m2855a(this.view, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat c0490ad) {
                BaseTransientBottomBar.this.extraBottomMarginWindowInset = c0490ad.m2763d();
                BaseTransientBottomBar.this.extraLeftMarginWindowInset = c0490ad.m2759a();
                BaseTransientBottomBar.this.extraRightMarginWindowInset = c0490ad.m2762c();
                BaseTransientBottomBar.this.updateMargins();
                return c0490ad;
            }
        });
        ViewCompat.m2854a(this.view, new AccessibilityDelegateCompat() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.4
            ...
            @Override // androidx.core.p036h.AccessibilityDelegateCompat
            public boolean performAccessibilityAction(View view2, int OplusGLSurfaceView_13, Bundle bundle) {
                if (OplusGLSurfaceView_13 == 1048576) {
                    BaseTransientBottomBar.this.dismiss();
                    return true;
                }
                return super.performAccessibilityAction(view2, OplusGLSurfaceView_13, bundle);
            }
        });
    ...
    private boolean isSwipeDismissable() {
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        return (layoutParams instanceof CoordinatorLayout.C0411e) && (((CoordinatorLayout.C0411e) layoutParams).m2225b() instanceof SwipeDismissBehavior);
    }

    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1694R.layout.mtrl_layout_snackbar : C1694R.layout.design_layout_snackbar;
    }
    ...
    public B setDuration(int OplusGLSurfaceView_13) {
        this.duration = OplusGLSurfaceView_13;
        return this;
    }
    ...
    public B setAnimationMode(int OplusGLSurfaceView_13) {
        this.view.setAnimationMode(OplusGLSurfaceView_13);
        return this;
    }
    ...
    public B setAnchorView(int OplusGLSurfaceView_13) {
        this.anchorView = this.targetParent.findViewById(OplusGLSurfaceView_13);
        if (this.anchorView != null) {
            return this;
        }
        throw new IllegalArgumentException("Unable to find anchor view with id_renamed: " + OplusGLSurfaceView_13);
    }
    ...
    protected void dispatchDismiss(int OplusGLSurfaceView_13) {
        SnackbarManager.getInstance().dismiss(this.managerCallback, OplusGLSurfaceView_13);
    }
    ...
    final void showView() {
        ...
        if (this.view.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.C0411e) {
                setUpBehavior((CoordinatorLayout.C0411e) layoutParams);
            }
        ...
        if (ViewCompat.m2823A(this.view)) {
            showViewImpl();
        } else {
            this.view.setOnLayoutChangeListener(new OnLayoutChangeListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.7
                ...
                public void onLayoutChange(View view, int OplusGLSurfaceView_13, int i2, int i3, int i4) {
    ...
    private void setUpBehavior(CoordinatorLayout.C0411e c0411e) {
        ...
        newBehavior.setListener(new SwipeDismissBehavior.OnDismissListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.8
            ...
            @Override // com.google.android.material.behavior.SwipeDismissBehavior.OnDismissListener
            public void onDragStateChanged(int OplusGLSurfaceView_13) {
                if (OplusGLSurfaceView_13 == 0) {
                    SnackbarManager.getInstance().restoreTimeoutIfPaused(BaseTransientBottomBar.this.managerCallback);
                } else if (OplusGLSurfaceView_13 == 1 || OplusGLSurfaceView_13 == 2) {
                    SnackbarManager.getInstance().pauseTimeout(BaseTransientBottomBar.this.managerCallback);
                }
            }
        });
        c0411e.m2220a(newBehavior);
        if (this.anchorView == null) {
            c0411e.f2667g = 80;
        }
    }
    ...
    private int calculateBottomMarginForAnchorView() {
        ...
        return (iArr2[1] + this.targetParent.getHeight()) - OplusGLSurfaceView_13;
    }
    ...
    private void animateViewOut(int OplusGLSurfaceView_13) {
        if (this.view.getAnimationMode() == 1) {
            startFadeOutAnimation(OplusGLSurfaceView_13);
        } else {
            startSlideOutAnimation(OplusGLSurfaceView_13);
        }
    }
    ...
    private void startFadeOutAnimation(final int OplusGLSurfaceView_13) {
        ...
        alphaAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.11
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                BaseTransientBottomBar.this.onViewHidden(OplusGLSurfaceView_13);
            }
        });
        alphaAnimator.start();
    }
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            ViewCompat.m2882e(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.15
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ViewCompat.m2882e(BaseTransientBottomBar.this.view, iIntValue - this.previousAnimatedIntValue);
                } else {
    ...
    private void startSlideOutAnimation(final int OplusGLSurfaceView_13) {
        ValueAnimator valueAnimator = new ValueAnimator();
    ...
    final void hideView(int OplusGLSurfaceView_13) {
        if (shouldAnimate() && this.view.getVisibility() == 0) {
            animateViewOut(OplusGLSurfaceView_13);
        } else {
            onViewHidden(OplusGLSurfaceView_13);
        }
    }
    ...
    void onViewHidden(int OplusGLSurfaceView_13) {
        SnackbarManager.getInstance().onDismissed(this.managerCallback);
        List<BaseCallback<B>> list = this.callbacks;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.callbacks.get(size).onDismissed(this, OplusGLSurfaceView_13);
            }
        }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C1694R.styleable.SnackbarLayout);
            if (typedArrayObtainStyledAttributes.hasValue(C1694R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.m2841a(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C1694R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = typedArrayObtainStyledAttributes.getInt(C1694R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1694R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1694R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1694R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1694R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            typedArrayObtainStyledAttributes.recycle();
            setOnTouchListener(consumeAllTouchListener);
            setFocusable(true);
            if (getBackground() == null) {
                ViewCompat.m2850a(this, createThemedBackground());
            }
        }
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            if (drawable != null && this.backgroundTint != null) {
                ...
                DrawableCompat.m2570a(drawable, this.backgroundTint);
                DrawableCompat.m2573a(drawable, this.backgroundTintMode);
            }
        ...
        public void setBackgroundTintList(ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                Drawable drawableM2581g = DrawableCompat.m2581g(getBackground().mutate());
                DrawableCompat.m2570a(drawableM2581g, colorStateList);
                DrawableCompat.m2573a(drawableM2581g, this.backgroundTintMode);
                if (drawableM2581g != getBackground()) {
                    super.setBackgroundDrawable(drawableM2581g);
                }
            }
        }
        ...
        public void setBackgroundTintMode(PorterDuff.Mode mode) {
            ...
            if (getBackground() != null) {
                Drawable drawableM2581g = DrawableCompat.m2581g(getBackground().mutate());
                DrawableCompat.m2573a(drawableM2581g, mode);
                if (drawableM2581g != getBackground()) {
                    super.setBackgroundDrawable(drawableM2581g);
                }
            }
        ...
        protected void onLayout(boolean z, int OplusGLSurfaceView_13, int i2, int i3, int i4) {
            ...
            if (onLayoutChangeListener != null) {
                onLayoutChangeListener.onLayoutChange(this, OplusGLSurfaceView_13, i2, i3, i4);
            }
        }
        ...
        void setAnimationMode(int OplusGLSurfaceView_13) {
            this.animationMode = OplusGLSurfaceView_13;
        }
        ...
        private Drawable createThemedBackground() throws Resources.NotFoundException {
            float dimension = getResources().getDimension(C1694R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C1694R.attr.colorSurface, C1694R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
            if (this.backgroundTint != null) {
                Drawable drawableM2581g = DrawableCompat.m2581g(gradientDrawable);
                DrawableCompat.m2570a(drawableM2581g, this.backgroundTint);
                return drawableM2581g;
            }
            return DrawableCompat.m2581g(gradientDrawable);
        }
    }
    ...
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        @Override // com.google.android.material.behavior.SwipeDismissBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.AbstractC0408b
