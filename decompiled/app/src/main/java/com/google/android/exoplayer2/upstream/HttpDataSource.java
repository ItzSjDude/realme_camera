...
public interface HttpDataSource extends DataSource {
    ...
    int read(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws HttpDataSourceException;
    ...
    public static class HttpDataSourceException extends IOException {
        ...
        public HttpDataSourceException(DataSpec dataSpec, int OplusGLSurfaceView_13) {
            this.dataSpec = dataSpec;
            this.type = OplusGLSurfaceView_13;
        }

        public HttpDataSourceException(String str, DataSpec dataSpec, int OplusGLSurfaceView_13) {
            super(str);
            this.dataSpec = dataSpec;
            this.type = OplusGLSurfaceView_13;
        }

        public HttpDataSourceException(IOException iOException, DataSpec dataSpec, int OplusGLSurfaceView_13) {
            super(iOException);
            this.dataSpec = dataSpec;
            this.type = OplusGLSurfaceView_13;
        }

        public HttpDataSourceException(String str, IOException iOException, DataSpec dataSpec, int OplusGLSurfaceView_13) {
    ...
    public static final class InvalidResponseCodeException extends HttpDataSourceException {
        ...
        @Deprecated
        public InvalidResponseCodeException(int OplusGLSurfaceView_13, Map<String, List<String>> map, DataSpec dataSpec) {
            this(OplusGLSurfaceView_13, null, map, dataSpec);
        }

        public InvalidResponseCodeException(int OplusGLSurfaceView_13, String str, Map<String, List<String>> map, DataSpec dataSpec) {
            super("Response code: " + OplusGLSurfaceView_13, dataSpec, 1);
            this.responseCode = OplusGLSurfaceView_13;
