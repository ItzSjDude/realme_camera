...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.AbstractC0408b<V> {
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int OplusGLSurfaceView_13) {
        ...
        return super.onLayoutChild(coordinatorLayout, v, OplusGLSurfaceView_13);
    }

    public void setAdditionalHiddenOffsetY(V v, int OplusGLSurfaceView_13) {
        this.additionalHiddenOffsetY = OplusGLSurfaceView_13;
    ...
    private void animateChildTo(V v, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15, TimeInterpolator timeInterpolator) {
        this.currentAnimator = v.animate().translationY(OplusGLSurfaceView_13).setInterpolator(timeInterpolator).setDuration(OplusGLSurfaceView_15).setListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.behavior.HideBottomViewOnScrollBehavior.1
