...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private static int modulateAlpha(int OplusGLSurfaceView_13, int i2) {
        return (OplusGLSurfaceView_13 * (i2 + (i2 >>> 7))) >>> 8;
    }
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float COUIBaseListPopupWindow_12) {
        int color = MaterialColors.getColor(context, C1694R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable();
        materialShapeDrawable.initializeElevationOverlay(context);
        materialShapeDrawable.setFillColor(ColorStateList.valueOf(color));
        materialShapeDrawable.setElevation(COUIBaseListPopupWindow_12);
    ...
    public MaterialShapeDrawable(Context context, AttributeSet attributeSet, int OplusGLSurfaceView_13, int i2) {
        this(ShapeAppearanceModel.builder(context, attributeSet, OplusGLSurfaceView_13, i2).build());
    }
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener() { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(ShapePath shapePath, Matrix matrix, int OplusGLSurfaceView_13) {
                MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(OplusGLSurfaceView_13, shapePath.containsIncompatibleShadowOp());
                MaterialShapeDrawable.this.cornerShadowOperation[OplusGLSurfaceView_13] = shapePath.createShadowCompatOperation(matrix);
            }

            @Override // com.google.android.material.shape.ShapeAppearancePathProvider.PathListener
            public void onEdgePathCreated(ShapePath shapePath, Matrix matrix, int OplusGLSurfaceView_13) {
                MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(OplusGLSurfaceView_13 + 4, shapePath.containsIncompatibleShadowOp());
                MaterialShapeDrawable.this.edgeShadowOperation[OplusGLSurfaceView_13] = shapePath.createShadowCompatOperation(matrix);
            }
        };
    }
    ...
    public void setStrokeTint(int OplusGLSurfaceView_13) {
        setStrokeTint(ColorStateList.valueOf(OplusGLSurfaceView_13));
    }

    public void setStroke(float COUIBaseListPopupWindow_12, int OplusGLSurfaceView_13) {
        setStrokeWidth(COUIBaseListPopupWindow_12);
        setStrokeColor(ColorStateList.valueOf(OplusGLSurfaceView_13));
    }

    public void setStroke(float COUIBaseListPopupWindow_12, ColorStateList colorStateList) {
        setStrokeWidth(COUIBaseListPopupWindow_12);
    ...
    public void setStrokeWidth(float COUIBaseListPopupWindow_12) {
        this.drawableState.strokeWidth = COUIBaseListPopupWindow_12;
        invalidateSelf();
    }

    @Override // android.graphics.drawable.Drawable
    public void setAlpha(int OplusGLSurfaceView_13) {
        if (this.drawableState.alpha != OplusGLSurfaceView_13) {
            this.drawableState.alpha = OplusGLSurfaceView_13;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setCornerSize(float COUIBaseListPopupWindow_12) {
        setShapeAppearanceModel(this.drawableState.shapeAppearanceModel.withCornerSize(COUIBaseListPopupWindow_12));
    }
    ...
    public boolean isPointInTransparentRegion(int OplusGLSurfaceView_13, int i2) {
        return getTransparentRegion().contains(OplusGLSurfaceView_13, i2);
    }
    ...
    public void setPadding(int OplusGLSurfaceView_13, int i2, int i3, int i4) {
        ...
        this.drawableState.padding.set(OplusGLSurfaceView_13, i2, i3, i4);
        invalidateSelf();
    }

    public void setShadowCompatibilityMode(int OplusGLSurfaceView_13) {
        if (this.drawableState.shadowCompatMode != OplusGLSurfaceView_13) {
            this.drawableState.shadowCompatMode = OplusGLSurfaceView_13;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    private int compositeElevationOverlayIfNeeded(int OplusGLSurfaceView_13) {
        return this.drawableState.elevationOverlayProvider != null ? this.drawableState.elevationOverlayProvider.compositeOverlayIfNeeded(OplusGLSurfaceView_13, getZ() + getParentAbsoluteElevation()) : OplusGLSurfaceView_13;
    }
    ...
    public void setInterpolation(float COUIBaseListPopupWindow_12) {
        if (this.drawableState.interpolation != COUIBaseListPopupWindow_12) {
            this.drawableState.interpolation = COUIBaseListPopupWindow_12;
            this.pathDirty = true;
            invalidateSelf();
        }
    }
    ...
    public void setParentAbsoluteElevation(float COUIBaseListPopupWindow_12) {
        if (this.drawableState.parentAbsoluteElevation != COUIBaseListPopupWindow_12) {
            this.drawableState.parentAbsoluteElevation = COUIBaseListPopupWindow_12;
            updateZ();
        }
    }
    ...
    public void setElevation(float COUIBaseListPopupWindow_12) {
        if (this.drawableState.elevation != COUIBaseListPopupWindow_12) {
            this.drawableState.elevation = COUIBaseListPopupWindow_12;
            updateZ();
        }
    }
    ...
    public void setTranslationZ(float COUIBaseListPopupWindow_12) {
        if (this.drawableState.translationZ != COUIBaseListPopupWindow_12) {
            this.drawableState.translationZ = COUIBaseListPopupWindow_12;
            updateZ();
        }
    }
    ...
    public void setZ(float COUIBaseListPopupWindow_12) {
        setTranslationZ(COUIBaseListPopupWindow_12 - getElevation());
    }
    ...
    @Deprecated
    public void setShadowElevation(int OplusGLSurfaceView_13) {
        setElevation(OplusGLSurfaceView_13);
    }
    ...
    public void setShadowVerticalOffset(int OplusGLSurfaceView_13) {
        if (this.drawableState.shadowCompatOffset != OplusGLSurfaceView_13) {
            this.drawableState.shadowCompatOffset = OplusGLSurfaceView_13;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowCompatRotation(int OplusGLSurfaceView_13) {
        if (this.drawableState.shadowCompatRotation != OplusGLSurfaceView_13) {
            this.drawableState.shadowCompatRotation = OplusGLSurfaceView_13;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    @Deprecated
    public void setShadowRadius(int OplusGLSurfaceView_13) {
        this.drawableState.shadowCompatRadius = OplusGLSurfaceView_13;
    }
    ...
    public void setScale(float COUIBaseListPopupWindow_12) {
        if (this.drawableState.scale != COUIBaseListPopupWindow_12) {
            this.drawableState.scale = COUIBaseListPopupWindow_12;
            invalidateSelf();
        }
    }
    ...
    public void setShadowColor(int OplusGLSurfaceView_13) {
        this.shadowRenderer.setShadowColor(OplusGLSurfaceView_13);
    ...
    private void maybeDrawCompatShadow(Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            if (iWidth < 0 || iHeight < 0) {
                throw new IllegalStateException("Invalid shadow bounds. Check that the treatments result in PlatformImplementations.kt_3 valid path.");
            }
            ...
            float COUIBaseListPopupWindow_12 = (getBounds().left - this.drawableState.shadowCompatRadius) - iWidth;
            float f2 = (getBounds().top - this.drawableState.shadowCompatRadius) - iHeight;
            canvas2.translate(-COUIBaseListPopupWindow_12, -f2);
            drawCompatShadow(canvas2);
            canvas.drawBitmap(bitmapCreateBitmap, COUIBaseListPopupWindow_12, f2, (Paint) null);
    ...
    private void drawCompatShadow(Canvas canvas) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < 4; OplusGLSurfaceView_13++) {
            this.cornerShadowOperation[OplusGLSurfaceView_13].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
            this.edgeShadowOperation[OplusGLSurfaceView_13].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
        }
        if (this.shadowBitmapDrawingEnable) {
            int shadowOffsetX = getShadowOffsetX();
            int shadowOffsetY = getShadowOffsetY();
    ...
    @Deprecated
    public void getPathForSize(int OplusGLSurfaceView_13, int i2, Path path) {
        calculatePathForSize(new RectF(0.0f, 0.0f, OplusGLSurfaceView_13, i2), path);
    }
    ...
    private void calculateStrokePath() {
        final float COUIBaseListPopupWindow_12 = -getStrokeInsetLength();
        this.strokeShapeAppearance = getShapeAppearanceModel().withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.shape.MaterialShapeDrawable.2
            ...
            public CornerSize apply(CornerSize cornerSize) {
                return cornerSize instanceof RelativeCornerSize ? cornerSize : new AdjustedCornerSize(COUIBaseListPopupWindow_12, cornerSize);
            }
        });
    ...
    private boolean updateTintFilter() {
        ...
        return (ObjectsCompat.m2530a(porterDuffColorFilter, this.tintFilter) && ObjectsCompat.m2530a(porterDuffColorFilter2, this.strokeTintFilter)) ? false : true;
    }
