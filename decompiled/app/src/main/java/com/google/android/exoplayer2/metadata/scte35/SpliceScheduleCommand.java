...
public final class SpliceScheduleCommand extends SpliceCommand {
    public static final Parcelable.Creator<SpliceScheduleCommand> CREATOR = new Parcelable.Creator<SpliceScheduleCommand>() { // from class: com.google.android.exoplayer2.metadata.scte35.SpliceScheduleCommand.1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public SpliceScheduleCommand[] newArray(int OplusGLSurfaceView_13) {
            return new SpliceScheduleCommand[OplusGLSurfaceView_13];
        }
    };
    ...
    public static final class Event {
        ...
        private Event(long OplusGLSurfaceView_15, boolean z, boolean z2, boolean z3, List<ComponentSplice> list, long j2, boolean z4, long j3, int OplusGLSurfaceView_13, int i2, int i3) {
        ...
        public static Event parseFromSection(ParsableByteArray parsableByteArray) {
            ...
            if (z5) {
                ...
                z3 = z7;
                OplusGLSurfaceView_15 = unsignedInt3;
                j2 = unsignedInt;
                arrayList = arrayList2;
            ...
            return new Event(unsignedInt2, z5, z, z3, arrayList, OplusGLSurfaceView_15, z2, j2, OplusGLSurfaceView_13, i2, unsignedByte);
        }
        ...
        public void writeToParcel(Parcel parcel) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < size; OplusGLSurfaceView_13++) {
                this.componentSpliceList.get(OplusGLSurfaceView_13).writeToParcel(parcel);
            }
    ...
    public static final class ComponentSplice {
        ...
        private ComponentSplice(int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
            this.componentTag = OplusGLSurfaceView_13;
            this.utcSpliceTime = OplusGLSurfaceView_15;
        }
    ...
    static SpliceScheduleCommand parseFromSection(ParsableByteArray parsableByteArray) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < unsignedByte; OplusGLSurfaceView_13++) {
