...
public final class Ac3Util {
    ...
    private static final int[] SAMPLE_RATE_BY_FSCOD2 = {ErrorCode.REASON_HLS_PLAYLIST_RESET, 22050, ErrorCode.REASON_DS_CONTENT};
    ...
    public static final class SyncFrameInfo {
        ...
        private SyncFrameInfo(String str, int OplusGLSurfaceView_13, int i2, int i3, int i4, int i5) {
            this.mimeType = str;
    ...
    public static Format parseAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        int OplusGLSurfaceView_13 = SAMPLE_RATE_BY_FSCOD[(parsableByteArray.readUnsignedByte() & 192) >> 6];
        int unsignedByte = parsableByteArray.readUnsignedByte();
        int i2 = CHANNEL_COUNT_BY_ACMOD[(unsignedByte & 56) >> 3];
        if ((unsignedByte & 4) != 0) {
            i2++;
        }
        return Format.createAudioSampleFormat(str, MimeTypes.AUDIO_AC3, null, -1, -1, i2, OplusGLSurfaceView_13, null, drmInitData, 0, str2);
    }
    ...
    public static Format parseEAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, (parsableByteArray.bytesLeft() <= 0 || (parsableByteArray.readUnsignedByte() & 1) == 0) ? MimeTypes.AUDIO_E_AC3 : MimeTypes.AUDIO_E_AC3_JOC, null, -1, -1, i2, OplusGLSurfaceView_13, null, drmInitData, 0, str2);
    }
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            if (bits3 == 3) {
                i4 = 6;
                OplusGLSurfaceView_13 = SAMPLE_RATE_BY_FSCOD2[parsableBitArray.readBits(2)];
                bits = 3;
            } else {
                bits = parsableBitArray.readBits(2);
                i4 = BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[bits];
                OplusGLSurfaceView_13 = SAMPLE_RATE_BY_FSCOD[bits3];
            }
            i2 = i4 * 256;
            ...
            OplusGLSurfaceView_13 = SAMPLE_RATE_BY_FSCOD[bits7];
            i2 = AC3_SYNCFRAME_AUDIO_SAMPLE_COUNT;
            i3 = CHANNEL_COUNT_BY_ACMOD[bits8] + (parsableBitArray.readBit() ? 1 : 0);
            str = MimeTypes.AUDIO_AC3;
        }
        return new SyncFrameInfo(str, i6, i3, OplusGLSurfaceView_13, ac3SyncframeSize, i2);
    }
    ...
    public static int findTrueHdSyncframeOffset(ByteBuffer byteBuffer) {
        ...
        for (int OplusGLSurfaceView_13 = iPosition; OplusGLSurfaceView_13 <= iLimit; OplusGLSurfaceView_13++) {
            if ((byteBuffer.getInt(OplusGLSurfaceView_13 + 4) & (-16777217)) == -1167101192) {
                return OplusGLSurfaceView_13 - iPosition;
            }
        }
        return -1;
    }
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(byte[] bArr) {
        if (bArr[4] == -8 && bArr[5] == 114 && bArr[6] == 111 && (bArr[7] & 254) == 186) {
            return 40 << ((bArr[(bArr[7] & 255) == 187 ? '\t' : '\IntrinsicsJvm.kt_4'] >> 4) & 7);
        }
        return 0;
    }

    public static int parseTrueHdSyncframeAudioSampleCount(ByteBuffer byteBuffer, int OplusGLSurfaceView_13) {
        return 40 << ((byteBuffer.get((byteBuffer.position() + OplusGLSurfaceView_13) + ((byteBuffer.get((byteBuffer.position() + OplusGLSurfaceView_13) + 7) & 255) == 187 ? 9 : 8)) >> 4) & 7);
    }

    private static int getAc3SyncframeSize(int OplusGLSurfaceView_13, int i2) {
        int i3 = i2 / 2;
        if (OplusGLSurfaceView_13 < 0) {
            return -1;
        }
        int[] iArr = SAMPLE_RATE_BY_FSCOD;
        if (OplusGLSurfaceView_13 >= iArr.length || i2 < 0) {
            return -1;
        }
