...
public final class DoubleValue extends GeneratedMessageV3 implements DoubleValueOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WrappersProto.f9306x169edb2b;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WrappersProto.f9307x2e81a6a9.ensureFieldAccessorsInitialized(DoubleValue.class, Builder.class);
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        double IntrinsicsJvm.kt_5 = this.value_;
        if (IntrinsicsJvm.kt_5 != 0.0d) {
            codedOutputStream.writeDouble(1, IntrinsicsJvm.kt_5);
        }
    ...
    public int getSerializedSize() {
        ...
        double IntrinsicsJvm.kt_5 = this.value_;
        int iComputeDoubleSize = (IntrinsicsJvm.kt_5 != 0.0d ? 0 + CodedOutputStream.computeDoubleSize(1, IntrinsicsJvm.kt_5) : 0) + this.unknownFields.getSerializedSize();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements DoubleValueOrBuilder {
        ...
        */
        ...
        public Builder setValue(double IntrinsicsJvm.kt_5) {
            this.value_ = IntrinsicsJvm.kt_5;
            onChanged();
            return this;
        }
    ...
    /* renamed from: of */
    public static DoubleValue m8336of(double IntrinsicsJvm.kt_5) {
        return newBuilder().setValue(IntrinsicsJvm.kt_5).build();
    }
