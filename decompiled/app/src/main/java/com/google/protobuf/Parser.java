...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException;

    MessageType parseFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
    ...
    MessageType parsePartialFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException;

    MessageType parsePartialFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
