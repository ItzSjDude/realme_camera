...
class UnknownFieldSetSchema extends UnknownFieldSchema<UnknownFieldSet, UnknownFieldSet.Builder> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.UnknownFieldSchema
    public void addVarint(UnknownFieldSet.Builder builder, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
        builder.mergeField(OplusGLSurfaceView_13, UnknownFieldSet.Field.newBuilder().addVarint(OplusGLSurfaceView_15).build());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.UnknownFieldSchema
    public void addFixed32(UnknownFieldSet.Builder builder, int OplusGLSurfaceView_13, int i2) {
        builder.mergeField(OplusGLSurfaceView_13, UnknownFieldSet.Field.newBuilder().addFixed32(i2).build());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.UnknownFieldSchema
    public void addFixed64(UnknownFieldSet.Builder builder, int OplusGLSurfaceView_13, long OplusGLSurfaceView_15) {
        builder.mergeField(OplusGLSurfaceView_13, UnknownFieldSet.Field.newBuilder().addFixed64(OplusGLSurfaceView_15).build());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.UnknownFieldSchema
    public void addLengthDelimited(UnknownFieldSet.Builder builder, int OplusGLSurfaceView_13, ByteString byteString) {
        builder.mergeField(OplusGLSurfaceView_13, UnknownFieldSet.Field.newBuilder().addLengthDelimited(byteString).build());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.UnknownFieldSchema
    public void addGroup(UnknownFieldSet.Builder builder, int OplusGLSurfaceView_13, UnknownFieldSet unknownFieldSet) {
        builder.mergeField(OplusGLSurfaceView_13, UnknownFieldSet.Field.newBuilder().addGroup(unknownFieldSet).build());
    }
