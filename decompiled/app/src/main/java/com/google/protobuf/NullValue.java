...
public enum NullValue implements ProtocolMessageEnum {
    ...
    private static final Internal.EnumLiteMap<NullValue> internalValueMap = new Internal.EnumLiteMap<NullValue>() { // from class: com.google.protobuf.NullValue.1
        ...
        public NullValue findValueByNumber(int OplusGLSurfaceView_13) {
            return NullValue.forNumber(OplusGLSurfaceView_13);
        }
    };
    ...
    @Deprecated
    public static NullValue valueOf(int OplusGLSurfaceView_13) {
        return forNumber(OplusGLSurfaceView_13);
    }

    public static NullValue forNumber(int OplusGLSurfaceView_13) {
    ...
    NullValue(int OplusGLSurfaceView_13) {
