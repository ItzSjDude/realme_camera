...
public abstract class GeneratedMessageV3 extends AbstractMessage implements Serializable {
    ...
    public interface ExtendableMessageOrBuilder<MessageType extends ExtendableMessage> extends MessageOrBuilder {
        ...
        <Type> Type getExtension(Extension<MessageType, List<Type>> extension, int OplusGLSurfaceView_13);

        <Type> Type getExtension(ExtensionLite<MessageType, Type> extensionLite);

        <Type> Type getExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13);

        <Type> Type getExtension(GeneratedMessage.GeneratedExtension<MessageType, Type> generatedExtension);

        <Type> Type getExtension(GeneratedMessage.GeneratedExtension<MessageType, List<Type>> generatedExtension, int OplusGLSurfaceView_13);
    ...
    */
    ...
    @Override // com.google.protobuf.MessageOrBuilder
    public Object getRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
        return internalGetFieldAccessorTable().getField(fieldDescriptor).getRepeated(this, OplusGLSurfaceView_13);
    }
    ...
    protected boolean parseUnknownField(CodedInputStream codedInputStream, UnknownFieldSet.Builder builder, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
        if (codedInputStream.shouldDiscardUnknownFields()) {
            return codedInputStream.skipField(OplusGLSurfaceView_13);
        }
        return builder.mergeFieldFrom(OplusGLSurfaceView_13, codedInputStream);
    }

    protected boolean parseUnknownFieldProto3(CodedInputStream codedInputStream, UnknownFieldSet.Builder builder, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
        return parseUnknownField(codedInputStream, builder, extensionRegistryLite, OplusGLSurfaceView_13);
    }
    ...
    protected static <M extends Message> M parseWithIOException(Parser<M> parser, InputStream inputStream) throws IOException {
        try {
            ...
            throw COUIBaseListPopupWindow_8.unwrapIOException();
        }
    }
    ...
    public static abstract class Builder<BuilderType extends Builder<BuilderType>> extends AbstractMessage.Builder<BuilderType> {
        ...
        public Message.Builder getRepeatedFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
            return internalGetFieldAccessorTable().getField(fieldDescriptor).getRepeatedBuilder(this, OplusGLSurfaceView_13);
        }
        ...
        public BuilderType setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj) {
            internalGetFieldAccessorTable().getField(fieldDescriptor).setRepeated(this, OplusGLSurfaceView_13, obj);
            return this;
        }
        ...
        protected MapField internalGetMapField(int OplusGLSurfaceView_13) {
            throw new RuntimeException("No map fields found in " + getClass().getName());
        }

        protected MapField internalGetMutableMapField(int OplusGLSurfaceView_13) {
            throw new RuntimeException("No map fields found in " + getClass().getName());
        }
    }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage> extends GeneratedMessageV3 implements ExtendableMessageOrBuilder<MessageType> {
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.ExtendableMessageOrBuilder
        public final <Type> Type getExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13) {
            Extension<MessageType, ?> extensionCheckNotLite = GeneratedMessageV3.checkNotLite(extensionLite);
            verifyExtensionContainingType(extensionCheckNotLite);
            return (Type) extensionCheckNotLite.singularFromReflectionType(this.extensions.getRepeatedField(extensionCheckNotLite.getDescriptor(), OplusGLSurfaceView_13));
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.ExtendableMessageOrBuilder
        public final <Type> Type getExtension(Extension<MessageType, List<Type>> extension, int OplusGLSurfaceView_13) {
            return (Type) getExtension((ExtensionLite) extension, OplusGLSurfaceView_13);
        }

        @Override // com.google.protobuf.GeneratedMessageV3.ExtendableMessageOrBuilder
        public final <Type> Type getExtension(GeneratedMessage.GeneratedExtension<MessageType, List<Type>> generatedExtension, int OplusGLSurfaceView_13) {
            return (Type) getExtension((ExtensionLite) generatedExtension, OplusGLSurfaceView_13);
        }
        ...
        protected boolean parseUnknownField(CodedInputStream codedInputStream, UnknownFieldSet.Builder builder, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
            ...
            return MessageReflection.mergeFieldFrom(codedInputStream, builder, extensionRegistryLite, getDescriptorForType(), new MessageReflection.ExtensionAdapter(this.extensions), OplusGLSurfaceView_13);
        }
        ...
        protected class ExtensionWriter {
            ...
            public void writeUntil(int OplusGLSurfaceView_13, CodedOutputStream codedOutputStream) throws IOException {
                while (true) {
                    Map.Entry<Descriptors.FieldDescriptor, Object> entry = this.next;
                    if (entry == null || entry.getKey().getNumber() >= OplusGLSurfaceView_13) {
                        return;
                    }
        ...
        public Object getRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
            if (fieldDescriptor.isExtension()) {
                verifyContainingType(fieldDescriptor);
                return this.extensions.getRepeatedField(fieldDescriptor, OplusGLSurfaceView_13);
            }
            return super.getRepeatedField(fieldDescriptor, OplusGLSurfaceView_13);
        }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<BuilderType> implements ExtendableMessageOrBuilder<MessageType> {
        ...
        public final <Type> Type getExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13) {
            ...
            return (Type) extensionCheckNotLite.singularFromReflectionType(builder.getRepeatedField(descriptor, OplusGLSurfaceView_13));
        }
        ...
        public final <Type> BuilderType setExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13, Type type) {
            Extension<MessageType, ?> extensionCheckNotLite = GeneratedMessageV3.checkNotLite(extensionLite);
            verifyExtensionContainingType(extensionCheckNotLite);
            ensureExtensionsIsMutable();
            this.extensions.setRepeatedField(extensionCheckNotLite.getDescriptor(), OplusGLSurfaceView_13, extensionCheckNotLite.singularToReflectionType(type));
            onChanged();
            return this;
        }
        ...
        public <Type> BuilderType setExtension(GeneratedMessage.GeneratedExtension<MessageType, Type> generatedExtension, Type type) {
            return (BuilderType) setExtension((ExtensionLite<MessageType, GeneratedMessage.GeneratedExtension<MessageType, Type>>) generatedExtension, (GeneratedMessage.GeneratedExtension<MessageType, Type>) type);
        }

        public final <Type> BuilderType setExtension(Extension<MessageType, List<Type>> extension, int OplusGLSurfaceView_13, Type type) {
            return (BuilderType) setExtension((ExtensionLite<MessageType, List<int>>) extension, OplusGLSurfaceView_13, (int) type);
        }

        public <Type> BuilderType setExtension(GeneratedMessage.GeneratedExtension<MessageType, List<Type>> generatedExtension, int OplusGLSurfaceView_13, Type type) {
            return (BuilderType) setExtension((ExtensionLite<MessageType, List<int>>) generatedExtension, OplusGLSurfaceView_13, (int) type);
        }
        ...
        public <Type> BuilderType addExtension(GeneratedMessage.GeneratedExtension<MessageType, List<Type>> generatedExtension, Type type) {
            return (BuilderType) addExtension((ExtensionLite<MessageType, List<GeneratedMessage.GeneratedExtension<MessageType, List<Type>>>>) generatedExtension, (GeneratedMessage.GeneratedExtension<MessageType, List<Type>>) type);
        }
        ...
        public Message.Builder getFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor) {
            if (fieldDescriptor.isExtension()) {
                verifyContainingType(fieldDescriptor);
                if (fieldDescriptor.getJavaType() != Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                    throw new UnsupportedOperationException("getFieldBuilder() called on PlatformImplementations.kt_3 non-Message type.");
                }
                ensureExtensionsIsMutable();
                ...
                throw new UnsupportedOperationException("getRepeatedFieldBuilder() called on PlatformImplementations.kt_3 non-Message type.");
            }
        ...
        public Object getRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
            if (fieldDescriptor.isExtension()) {
                ...
                return builder.getRepeatedField(fieldDescriptor, OplusGLSurfaceView_13);
            }
            return super.getRepeatedField(fieldDescriptor, OplusGLSurfaceView_13);
        }
        ...
        public Message.Builder getRepeatedFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
            if (fieldDescriptor.isExtension()) {
                ...
                Object repeatedFieldAllowBuilders = this.extensions.getRepeatedFieldAllowBuilders(fieldDescriptor, OplusGLSurfaceView_13);
                ...
                if (repeatedFieldAllowBuilders instanceof Message) {
                    ...
                    this.extensions.setRepeatedField(fieldDescriptor, OplusGLSurfaceView_13, builder);
                    onChanged();
                    return builder;
                }
                throw new UnsupportedOperationException("getRepeatedFieldBuilder() called on PlatformImplementations.kt_3 non-Message type.");
            }
            return super.getRepeatedFieldBuilder(fieldDescriptor, OplusGLSurfaceView_13);
        }
        ...
        public BuilderType setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj) {
            if (fieldDescriptor.isExtension()) {
                verifyContainingType(fieldDescriptor);
                ensureExtensionsIsMutable();
                this.extensions.setRepeatedField(fieldDescriptor, OplusGLSurfaceView_13, obj);
                onChanged();
                return this;
            }
            return (BuilderType) super.setRepeatedField(fieldDescriptor, OplusGLSurfaceView_13, obj);
        }
    ...
    public static java.lang.reflect.Method getMethodOrDie(Class cls, String str, Class... clsArr) {
        try {
            ...
            throw new RuntimeException("Generated message class \"" + cls.getName() + "\" missing method \"" + str + "\".", COUIBaseListPopupWindow_8);
        }
    }
    ...
    public static Object invokeOrDie(java.lang.reflect.Method method, Object obj, Object... objArr) {
        try {
            ...
            throw new RuntimeException("Couldn't use Java reflection to implement protocol message reflection.", COUIBaseListPopupWindow_8);
    ...
    public static final class FieldAccessorTable {
        ...
        private interface FieldAccessor {
            ...
            Object getRepeated(Builder builder, int OplusGLSurfaceView_13);

            Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13);

            Message.Builder getRepeatedBuilder(Builder builder, int OplusGLSurfaceView_13);

            int getRepeatedCount(Builder builder);

            int getRepeatedCount(GeneratedMessageV3 generatedMessageV3);

            Object getRepeatedRaw(Builder builder, int OplusGLSurfaceView_13);

            Object getRepeatedRaw(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13);
            ...
            void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj);
        }
        ...
        public FieldAccessorTable ensureFieldAccessorsInitialized(Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2) {
            ...
            synchronized (this) {
                ...
                while (true) {
                    ...
                    Descriptors.FieldDescriptor fieldDescriptor = this.descriptor.getFields().get(OplusGLSurfaceView_13);
                    ...
                    if (fieldDescriptor.isRepeated()) {
                        if (fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                            if (fieldDescriptor.isMapField()) {
                                this.fields[OplusGLSurfaceView_13] = new MapFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2);
                            } else {
                                this.fields[OplusGLSurfaceView_13] = new RepeatedMessageFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2);
                            }
                        } else if (fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.ENUM) {
                            this.fields[OplusGLSurfaceView_13] = new RepeatedEnumFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2);
                        } else {
                            this.fields[OplusGLSurfaceView_13] = new RepeatedFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2);
                        }
                    } else if (fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                        this.fields[OplusGLSurfaceView_13] = new SingularMessageFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2, str);
                    } else if (fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.ENUM) {
                        this.fields[OplusGLSurfaceView_13] = new SingularEnumFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2, str);
                    } else if (fieldDescriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.STRING) {
                        this.fields[OplusGLSurfaceView_13] = new SingularStringFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2, str);
                    } else {
                        this.fields[OplusGLSurfaceView_13] = new SingularFieldAccessor(fieldDescriptor, this.camelCaseNames[OplusGLSurfaceView_13], cls, cls2, str);
                    }
        ...
        private static class SingularFieldAccessor implements FieldAccessor {
            ...
            private static final class ReflectionInvoker implements MethodInvoker {
                ...
                ReflectionInvoker(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessageV3> cls, Class<? extends Builder> cls2, String str2, boolean z, boolean z2) {
                    ...
                    if (z) {
                        methodOrDie4 = GeneratedMessageV3.getMethodOrDie(cls2, "get" + str2 + "Case", new Class[0]);
                    }
            ...
            private static final class MethodHandleInvoker implements MethodInvoker {
                ...
                MethodHandleInvoker(ReflectionInvoker reflectionInvoker) throws IllegalAccessException {
            ...
            static MethodInvoker tryGetMethodHandleInvoke(ReflectionInvoker reflectionInvoker) {
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                throw new UnsupportedOperationException("getRepeatedField() called on PlatformImplementations.kt_3 singular field.");
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeatedRaw(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                throw new UnsupportedOperationException("getRepeatedFieldRaw() called on PlatformImplementations.kt_3 singular field.");
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(Builder builder, int OplusGLSurfaceView_13) {
                throw new UnsupportedOperationException("getRepeatedField() called on PlatformImplementations.kt_3 singular field.");
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeatedRaw(Builder builder, int OplusGLSurfaceView_13) {
                throw new UnsupportedOperationException("getRepeatedFieldRaw() called on PlatformImplementations.kt_3 singular field.");
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                throw new UnsupportedOperationException("setRepeatedField() called on PlatformImplementations.kt_3 singular field.");
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public void addRepeated(Builder builder, Object obj) {
                throw new UnsupportedOperationException("addRepeatedField() called on PlatformImplementations.kt_3 singular field.");
            }
            ...
            public int getRepeatedCount(GeneratedMessageV3 generatedMessageV3) {
                throw new UnsupportedOperationException("getRepeatedFieldSize() called on PlatformImplementations.kt_3 singular field.");
            }
            ...
            public Message.Builder newBuilder() {
                throw new UnsupportedOperationException("newBuilderForField() called on PlatformImplementations.kt_3 non-Message type.");
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Message.Builder getRepeatedBuilder(Builder builder, int OplusGLSurfaceView_13) {
                throw new UnsupportedOperationException("getRepeatedFieldBuilder() called on PlatformImplementations.kt_3 non-Message type.");
            }
        }
        ...
        private static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            private static final class ReflectionInvoker implements MethodInvoker {
                ...
                @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor.MethodInvoker
                public Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                    return GeneratedMessageV3.invokeOrDie(this.getRepeatedMethod, generatedMessageV3, Integer.valueOf(OplusGLSurfaceView_13));
                }

                @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor.MethodInvoker
                public Object getRepeated(Builder<?> builder, int OplusGLSurfaceView_13) {
                    return GeneratedMessageV3.invokeOrDie(this.getRepeatedMethodBuilder, builder, Integer.valueOf(OplusGLSurfaceView_13));
                }

                @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor.MethodInvoker
                public void setRepeated(Builder<?> builder, int OplusGLSurfaceView_13, Object obj) {
                    GeneratedMessageV3.invokeOrDie(this.setRepeatedMethod, builder, Integer.valueOf(OplusGLSurfaceView_13), obj);
                }
            ...
            private static final class MethodHandleInvoker implements MethodInvoker {
                ...
                public Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                    try {
                        return (Object) this.getRepeatedMethod.invoke(generatedMessageV3, OplusGLSurfaceView_13);
                    } catch (Throwable th) {
                        throw GeneratedMessageV3.handleException(th);
                    }
                }
                ...
                public Object getRepeated(Builder<?> builder, int OplusGLSurfaceView_13) {
                    try {
                        return (Object) this.getRepeatedMethodBuilder.invoke(builder, OplusGLSurfaceView_13);
                    } catch (Throwable th) {
                        throw GeneratedMessageV3.handleException(th);
                    }
                }
                ...
                public void setRepeated(Builder<?> builder, int OplusGLSurfaceView_13, Object obj) {
                    try {
                        (void) this.setRepeatedMethod.invoke(builder, OplusGLSurfaceView_13, obj);
                    } catch (Throwable th) {
                        throw GeneratedMessageV3.handleException(th);
                    }
                }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                return this.invoker.getRepeated(generatedMessageV3, OplusGLSurfaceView_13);
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(Builder builder, int OplusGLSurfaceView_13) {
                return this.invoker.getRepeated((Builder<?>) builder, OplusGLSurfaceView_13);
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeatedRaw(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                return getRepeated(generatedMessageV3, OplusGLSurfaceView_13);
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeatedRaw(Builder builder, int OplusGLSurfaceView_13) {
                return getRepeated(builder, OplusGLSurfaceView_13);
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                this.invoker.setRepeated(builder, OplusGLSurfaceView_13, obj);
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public boolean has(GeneratedMessageV3 generatedMessageV3) {
                throw new UnsupportedOperationException("hasField() called on PlatformImplementations.kt_3 repeated field.");
            }
        ...
        private static class MapFieldAccessor implements FieldAccessor {
            ...
            public Object get(GeneratedMessageV3 generatedMessageV3) {
                ...
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < getRepeatedCount(generatedMessageV3); OplusGLSurfaceView_13++) {
                    arrayList.add(getRepeated(generatedMessageV3, OplusGLSurfaceView_13));
                }
            ...
            public Object get(Builder builder) {
                ArrayList arrayList = new ArrayList();
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < getRepeatedCount(builder); OplusGLSurfaceView_13++) {
                    arrayList.add(getRepeated(builder, OplusGLSurfaceView_13));
                }
                return Collections.unmodifiableList(arrayList);
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                return getMapField(generatedMessageV3).getList().get(OplusGLSurfaceView_13);
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(Builder builder, int OplusGLSurfaceView_13) {
                return getMapField(builder).getList().get(OplusGLSurfaceView_13);
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                getMutableMapField(builder).getMutableList().set(OplusGLSurfaceView_13, coerceType((Message) obj));
            }
        ...
        private static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            public Object get(GeneratedMessageV3 generatedMessageV3) {
                ...
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < repeatedCount; OplusGLSurfaceView_13++) {
                    arrayList.add(getRepeated(generatedMessageV3, OplusGLSurfaceView_13));
                }
                return Collections.unmodifiableList(arrayList);
            }
            ...
            public Object getRepeated(GeneratedMessageV3 generatedMessageV3, int OplusGLSurfaceView_13) {
                if (!this.supportUnknownEnumValue) {
                    return GeneratedMessageV3.invokeOrDie(this.getValueDescriptorMethod, super.getRepeated(generatedMessageV3, OplusGLSurfaceView_13), new Object[0]);
                }
                return this.enumDescriptor.findValueByNumberCreatingIfUnknown(((Integer) GeneratedMessageV3.invokeOrDie(this.getRepeatedValueMethod, generatedMessageV3, Integer.valueOf(OplusGLSurfaceView_13))).intValue());
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Object getRepeated(Builder builder, int OplusGLSurfaceView_13) {
                if (!this.supportUnknownEnumValue) {
                    return GeneratedMessageV3.invokeOrDie(this.getValueDescriptorMethod, super.getRepeated(builder, OplusGLSurfaceView_13), new Object[0]);
                }
                return this.enumDescriptor.findValueByNumberCreatingIfUnknown(((Integer) GeneratedMessageV3.invokeOrDie(this.getRepeatedValueMethodBuilder, builder, Integer.valueOf(OplusGLSurfaceView_13))).intValue());
            }

            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                if (this.supportUnknownEnumValue) {
                    GeneratedMessageV3.invokeOrDie(this.setRepeatedValueMethod, builder, Integer.valueOf(OplusGLSurfaceView_13), Integer.valueOf(((Descriptors.EnumValueDescriptor) obj).getNumber()));
                } else {
                    super.setRepeated(builder, OplusGLSurfaceView_13, GeneratedMessageV3.invokeOrDie(this.valueOfMethod, null, obj));
                }
            }
        ...
        private static final class RepeatedMessageFieldAccessor extends RepeatedFieldAccessor {
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                super.setRepeated(builder, OplusGLSurfaceView_13, coerceType(obj));
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessageV3.FieldAccessorTable.FieldAccessor
            public Message.Builder getRepeatedBuilder(Builder builder, int OplusGLSurfaceView_13) {
                return (Message.Builder) GeneratedMessageV3.invokeOrDie(this.getBuilderMethodBuilder, builder, Integer.valueOf(OplusGLSurfaceView_13));
            }
        }
    }
    ...
    protected static int computeStringSize(int OplusGLSurfaceView_13, Object obj) {
        if (obj instanceof String) {
            return CodedOutputStream.computeStringSize(OplusGLSurfaceView_13, (String) obj);
        }
        return CodedOutputStream.computeBytesSize(OplusGLSurfaceView_13, (ByteString) obj);
    }
    ...
    protected static void writeString(CodedOutputStream codedOutputStream, int OplusGLSurfaceView_13, Object obj) throws IOException {
        if (obj instanceof String) {
            codedOutputStream.writeString(OplusGLSurfaceView_13, (String) obj);
        } else {
            codedOutputStream.writeBytes(OplusGLSurfaceView_13, (ByteString) obj);
        }
    }
    ...
    protected static <V> void serializeIntegerMapTo(CodedOutputStream codedOutputStream, MapField<Integer, V> mapField, MapEntry<Integer, V> mapEntry, int OplusGLSurfaceView_13) throws IOException {
        Map<Integer, V> map = mapField.getMap();
        if (!codedOutputStream.isSerializationDeterministic()) {
            serializeMapTo(codedOutputStream, map, mapEntry, OplusGLSurfaceView_13);
            return;
        }
        ...
        Arrays.sort(iArr);
        for (int i3 : iArr) {
            codedOutputStream.writeMessage(OplusGLSurfaceView_13, mapEntry.newBuilderForType().setKey(Integer.valueOf(i3)).setValue(map.get(Integer.valueOf(i3))).build());
        }
    }

    protected static <V> void serializeLongMapTo(CodedOutputStream codedOutputStream, MapField<Long, V> mapField, MapEntry<Long, V> mapEntry, int OplusGLSurfaceView_13) throws IOException {
        ...
        for (long OplusGLSurfaceView_15 : jArr) {
            codedOutputStream.writeMessage(OplusGLSurfaceView_13, mapEntry.newBuilderForType().setKey(Long.valueOf(OplusGLSurfaceView_15)).setValue(map.get(Long.valueOf(OplusGLSurfaceView_15))).build());
        }
    }

    protected static <V> void serializeStringMapTo(CodedOutputStream codedOutputStream, MapField<String, V> mapField, MapEntry<String, V> mapEntry, int OplusGLSurfaceView_13) throws IOException {
        ...
        for (String str : strArr) {
            codedOutputStream.writeMessage(OplusGLSurfaceView_13, mapEntry.newBuilderForType().setKey(str).setValue(map.get(str)).build());
        }
    }

    protected static <V> void serializeBooleanMapTo(CodedOutputStream codedOutputStream, MapField<Boolean, V> mapField, MapEntry<Boolean, V> mapEntry, int OplusGLSurfaceView_13) throws IOException {
        Map<Boolean, V> map = mapField.getMap();
        if (!codedOutputStream.isSerializationDeterministic()) {
            serializeMapTo(codedOutputStream, map, mapEntry, OplusGLSurfaceView_13);
        } else {
            maybeSerializeBooleanEntryTo(codedOutputStream, map, mapEntry, OplusGLSurfaceView_13, false);
            maybeSerializeBooleanEntryTo(codedOutputStream, map, mapEntry, OplusGLSurfaceView_13, true);
        }
    }

    private static <V> void maybeSerializeBooleanEntryTo(CodedOutputStream codedOutputStream, Map<Boolean, V> map, MapEntry<Boolean, V> mapEntry, int OplusGLSurfaceView_13, boolean z) throws IOException {
        if (map.containsKey(Boolean.valueOf(z))) {
            codedOutputStream.writeMessage(OplusGLSurfaceView_13, mapEntry.newBuilderForType().setKey(Boolean.valueOf(z)).setValue(map.get(Boolean.valueOf(z))).build());
        }
    }

    private static <K, V> void serializeMapTo(CodedOutputStream codedOutputStream, Map<K, V> map, MapEntry<K, V> mapEntry, int OplusGLSurfaceView_13) throws IOException {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            codedOutputStream.writeMessage(OplusGLSurfaceView_13, mapEntry.newBuilderForType().setKey(entry.getKey()).setValue(entry.getValue()).build());
        }
    }
}
