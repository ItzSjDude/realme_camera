...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int OplusGLSurfaceView_13) {
        return (SmallSortedMap<FieldDescriptorType, Object>) new SmallSortedMap<FieldDescriptorType, Object>(OplusGLSurfaceView_13) { // from class: com.google.protobuf.SmallSortedMap.1
            @Override // com.google.protobuf.SmallSortedMap, java.util.AbstractMap, java.util.Map
            public /* bridge */ /* synthetic */ Object put(Object obj, Object obj2) {
                return super.put((C20781<FieldDescriptorType>) obj, (FieldSet.FieldDescriptorLite) obj2);
            }
    ...
    static <K extends Comparable<K>, V> SmallSortedMap<K, V> newInstanceForTest(int OplusGLSurfaceView_13) {
        return new SmallSortedMap<>(OplusGLSurfaceView_13);
    }

    private SmallSortedMap(int OplusGLSurfaceView_13) {
        this.maxArraySize = OplusGLSurfaceView_13;
    ...
    public Map.Entry<K, V> getArrayEntryAt(int OplusGLSurfaceView_13) {
        return this.entryList.get(OplusGLSurfaceView_13);
    }
    ...
    public V put(K OplusGLSurfaceView_5, V v) {
        checkMutable();
        int iBinarySearchInArray = binarySearchInArray(OplusGLSurfaceView_5);
        if (iBinarySearchInArray >= 0) {
            return this.entryList.get(iBinarySearchInArray).setValue(v);
        }
        ensureEntryArrayMutable();
        int OplusGLSurfaceView_13 = -(iBinarySearchInArray + 1);
        if (OplusGLSurfaceView_13 >= this.maxArraySize) {
            return getOverflowEntriesMutable().put(OplusGLSurfaceView_5, v);
        }
        ...
        this.entryList.add(OplusGLSurfaceView_13, new Entry(OplusGLSurfaceView_5, v));
        return null;
    }
    ...
    public V removeArrayEntryAt(int OplusGLSurfaceView_13) {
        checkMutable();
        V value = this.entryList.remove(OplusGLSurfaceView_13).getValue();
        if (!this.overflowEntries.isEmpty()) {
    ...
    private int binarySearchInArray(K OplusGLSurfaceView_5) {
        int size = this.entryList.size() - 1;
        if (size >= 0) {
            int iCompareTo = OplusGLSurfaceView_5.compareTo(this.entryList.get(size).getKey());
            if (iCompareTo > 0) {
                return -(size + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (OplusGLSurfaceView_13 <= size) {
            int i2 = (OplusGLSurfaceView_13 + size) / 2;
            int iCompareTo2 = OplusGLSurfaceView_5.compareTo(this.entryList.get(i2).getKey());
            if (iCompareTo2 < 0) {
                size = i2 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    private class Entry implements Comparable<SmallSortedMap<K, V>.Entry>, Map.Entry<K, V> {
        ...
        Entry(K OplusGLSurfaceView_5, V v) {
    ...
    private class EntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        public Map.Entry<K, V> next() {
            ...
            int OplusGLSurfaceView_13 = this.pos + 1;
            this.pos = OplusGLSurfaceView_13;
            if (OplusGLSurfaceView_13 < SmallSortedMap.this.entryList.size()) {
        ...
        public void remove() {
            ...
            if (this.pos < SmallSortedMap.this.entryList.size()) {
                ...
                smallSortedMap.removeArrayEntryAt(OplusGLSurfaceView_13);
                return;
            }
    ...
    private class DescendingEntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        public boolean hasNext() {
            int OplusGLSurfaceView_13 = this.pos;
            return (OplusGLSurfaceView_13 > 0 && OplusGLSurfaceView_13 <= SmallSortedMap.this.entryList.size()) || getOverflowIterator().hasNext();
        }
        ...
        public Map.Entry<K, V> next() {
            if (!getOverflowIterator().hasNext()) {
                ...
                int OplusGLSurfaceView_13 = this.pos - 1;
                this.pos = OplusGLSurfaceView_13;
                return (Map.Entry) list.get(OplusGLSurfaceView_13);
            }
            return getOverflowIterator().next();
        }
    ...
    public boolean equals(Object obj) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < numArrayEntries; OplusGLSurfaceView_13++) {
            if (!getArrayEntryAt(OplusGLSurfaceView_13).equals(smallSortedMap.getArrayEntryAt(OplusGLSurfaceView_13))) {
                return false;
            }
        }
    ...
    public int hashCode() {
        ...
        int iHashCode = 0;
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < numArrayEntries; OplusGLSurfaceView_13++) {
            iHashCode += this.entryList.get(OplusGLSurfaceView_13).hashCode();
        }
