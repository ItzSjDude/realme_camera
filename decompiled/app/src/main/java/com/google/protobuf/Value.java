...
public final class Value extends GeneratedMessageV3 implements ValueOrBuilder {
            ...
            try {
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 8) {
                                int OplusGLSurfaceView_13 = codedInputStream.readEnum();
                                this.kindCase_ = 1;
                                this.kind_ = Integer.valueOf(OplusGLSurfaceView_13);
                            } else if (tag == 17) {
                                this.kindCase_ = 2;
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return StructProto.f9291xa4251b78.ensureFieldAccessorsInitialized(Value.class, Builder.class);
    }
    ...
    public enum KindCase implements AbstractMessageLite.InternalOneOfEnum, Internal.EnumLite {
        ...
        KindCase(int OplusGLSurfaceView_13) {
            this.value = OplusGLSurfaceView_13;
        }

        @Deprecated
        public static KindCase valueOf(int OplusGLSurfaceView_13) {
            return forNumber(OplusGLSurfaceView_13);
        }

        public static KindCase forNumber(int OplusGLSurfaceView_13) {
    ...
    public int hashCode() {
        ...
        switch (this.kindCase_) {
            case 1:
                OplusGLSurfaceView_13 = ((iHashCode * 37) + 1) * 53;
                nullValueValue = getNullValueValue();
                break;
            case 2:
                OplusGLSurfaceView_13 = ((iHashCode * 37) + 2) * 53;
                nullValueValue = Internal.hashLong(Double.doubleToLongBits(getNumberValue()));
                break;
            case 3:
                OplusGLSurfaceView_13 = ((iHashCode * 37) + 3) * 53;
                nullValueValue = getStringValue().hashCode();
                break;
            case 4:
                OplusGLSurfaceView_13 = ((iHashCode * 37) + 4) * 53;
                nullValueValue = Internal.hashBoolean(getBoolValue());
                break;
            case 5:
                OplusGLSurfaceView_13 = ((iHashCode * 37) + 5) * 53;
                nullValueValue = getStructValue().hashCode();
                break;
            case 6:
                OplusGLSurfaceView_13 = ((iHashCode * 37) + 6) * 53;
        ...
        iHashCode = OplusGLSurfaceView_13 + nullValueValue;
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ValueOrBuilder {
        ...
        */
        ...
        public Builder setNullValueValue(int OplusGLSurfaceView_13) {
            this.kindCase_ = 1;
            this.kind_ = Integer.valueOf(OplusGLSurfaceView_13);
            onChanged();
            return this;
        ...
        public Builder setNumberValue(double IntrinsicsJvm.kt_5) {
            this.kindCase_ = 2;
            this.kind_ = Double.valueOf(IntrinsicsJvm.kt_5);
            onChanged();
            return this;
        }
