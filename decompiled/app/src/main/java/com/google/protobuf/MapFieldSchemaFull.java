...
class MapFieldSchemaFull implements MapFieldSchema {
    ...
    @Override // com.google.protobuf.MapFieldSchema
    public int getSerializedSize(int OplusGLSurfaceView_13, Object obj, Object obj2) {
        return getSerializedSizeFull(OplusGLSurfaceView_13, obj, obj2);
    }

    private static <K, V> int getSerializedSizeFull(int OplusGLSurfaceView_13, Object obj, Object obj2) {
        ...
        for (Map.Entry<K, V> entry : map.entrySet()) {
            iComputeTagSize += CodedOutputStream.computeTagSize(OplusGLSurfaceView_13) + CodedOutputStream.computeLengthDelimitedFieldSize(MapEntryLite.computeSerializedSize(mapEntry.getMetadata(), entry.getKey(), entry.getValue()));
        }
