...
public final class FloatValue extends GeneratedMessageV3 implements FloatValueOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WrappersProto.f9308xb685039c;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WrappersProto.f9309xabf4ce1a.ensureFieldAccessorsInitialized(FloatValue.class, Builder.class);
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        float COUIBaseListPopupWindow_12 = this.value_;
        if (COUIBaseListPopupWindow_12 != 0.0f) {
            codedOutputStream.writeFloat(1, COUIBaseListPopupWindow_12);
        }
    ...
    public int getSerializedSize() {
        ...
        float COUIBaseListPopupWindow_12 = this.value_;
        int iComputeFloatSize = (COUIBaseListPopupWindow_12 != 0.0f ? 0 + CodedOutputStream.computeFloatSize(1, COUIBaseListPopupWindow_12) : 0) + this.unknownFields.getSerializedSize();
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + Float.floatToIntBits(getValue())) * 29) + this.unknownFields.hashCode();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FloatValueOrBuilder {
        ...
        */
        ...
        public Builder setValue(float COUIBaseListPopupWindow_12) {
            this.value_ = COUIBaseListPopupWindow_12;
            onChanged();
            return this;
        }
    ...
    /* renamed from: of */
    public static FloatValue m8338of(float COUIBaseListPopupWindow_12) {
        return newBuilder().setValue(COUIBaseListPopupWindow_12).build();
    }
