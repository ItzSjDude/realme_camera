...
class MessageReflection {
    ...
    interface MergeTarget {
        ...
        ExtensionRegistry.ExtensionInfo findExtensionByNumber(ExtensionRegistry extensionRegistry, Descriptors.Descriptor descriptor, int OplusGLSurfaceView_13);
        ...
        MergeTarget setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj);
    }
    ...
    static int getSerializedSize(Message message, Map<Descriptors.FieldDescriptor, Object> map) {
        ...
        for (Map.Entry<Descriptors.FieldDescriptor, Object> entry : map.entrySet()) {
            ...
            OplusGLSurfaceView_13 += iComputeFieldSize;
        }
        UnknownFieldSet unknownFields = message.getUnknownFields();
        if (messageSetWireFormat) {
        ...
        return OplusGLSurfaceView_13 + serializedSize;
    }
    ...
    private static String subMessagePrefix(String str, Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
        ...
        for (Map.Entry<Descriptors.FieldDescriptor, Object> entry : messageOrBuilder.getAllFields().entrySet()) {
            ...
            if (key.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                if (key.isRepeated()) {
                    ...
                    while (it.hasNext()) {
                        findMissingFields((MessageOrBuilder) it.next(), subMessagePrefix(str, key, OplusGLSurfaceView_13), list);
    ...
    static class BuilderAdapter implements MergeTarget {
        ...
        @Override // com.google.protobuf.MessageReflection.MergeTarget
        public MergeTarget setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj) {
            this.builder.setRepeatedField(fieldDescriptor, OplusGLSurfaceView_13, obj);
            return this;
        }
        ...
        @Override // com.google.protobuf.MessageReflection.MergeTarget
        public ExtensionRegistry.ExtensionInfo findExtensionByNumber(ExtensionRegistry extensionRegistry, Descriptors.Descriptor descriptor, int OplusGLSurfaceView_13) {
            return extensionRegistry.findImmutableExtensionByNumber(descriptor, OplusGLSurfaceView_13);
        }
    ...
    */
    ...
    static /* synthetic */ class C20671 {
        ...
        /* renamed from: $SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$Type */
        static final /* synthetic */ int[] f9281x6f0f2e06 = new int[Descriptors.FieldDescriptor.Type.values().length];

        static {
            try {
                f9281x6f0f2e06[Descriptors.FieldDescriptor.Type.GROUP.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9281x6f0f2e06[Descriptors.FieldDescriptor.Type.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9281x6f0f2e06[Descriptors.FieldDescriptor.Type.ENUM.ordinal()] = 3;
