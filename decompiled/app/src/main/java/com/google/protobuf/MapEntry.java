...
public final class MapEntry<K, V> extends AbstractMessage {
    ...
    private MapEntry(Descriptors.Descriptor descriptor, WireFormat.FieldType fieldType, K OplusGLSurfaceView_5, WireFormat.FieldType fieldType2, V v) {
    ...
    private MapEntry(Metadata metadata, K OplusGLSurfaceView_5, V v) {
        this.cachedSerializedSize = -1;
        this.key = OplusGLSurfaceView_5;
        this.value = v;
    ...
    public static <K, V> MapEntry<K, V> newDefaultInstance(Descriptors.Descriptor descriptor, WireFormat.FieldType fieldType, K OplusGLSurfaceView_5, WireFormat.FieldType fieldType2, V v) {
        return new MapEntry<>(descriptor, fieldType, OplusGLSurfaceView_5, fieldType2, v);
    }
    ...
    public int getRepeatedFieldCount(Descriptors.FieldDescriptor fieldDescriptor) {
        throw new RuntimeException("There is no repeated field in PlatformImplementations.kt_3 map entry message.");
    }
    ...
    public static class Builder<K, V> extends AbstractMessage.Builder<Builder<K, V>> {
        ...
        private Builder(Metadata<K, V> metadata, K OplusGLSurfaceView_5, V v, boolean z, boolean z2) {
            this.metadata = metadata;
            this.key = OplusGLSurfaceView_5;
            this.value = v;
            this.hasKey = z;
        ...
        public Builder<K, V> setKey(K OplusGLSurfaceView_5) {
            this.key = OplusGLSurfaceView_5;
            this.hasKey = true;
            return this;
        }
        ...
        public Message.Builder newBuilderForField(Descriptors.FieldDescriptor fieldDescriptor) {
            ...
            if (fieldDescriptor.getNumber() != 2 || fieldDescriptor.getJavaType() != Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                throw new RuntimeException("\"" + fieldDescriptor.getFullName() + "\" is not PlatformImplementations.kt_3 message value field.");
            }
        ...
        @Override // com.google.protobuf.Message.Builder
        public Builder<K, V> setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj) {
            throw new RuntimeException("There is no repeated field in PlatformImplementations.kt_3 map entry message.");
        }
        ...
        /* renamed from: clone */
        public Builder<K, V> mo26289clone() {
