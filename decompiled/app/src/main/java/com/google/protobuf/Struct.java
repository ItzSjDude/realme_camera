...
public final class Struct extends GeneratedMessageV3 implements StructOrBuilder {
    ...
    protected MapField internalGetMapField(int OplusGLSurfaceView_13) {
        ...
        throw new RuntimeException("Invalid map field number: " + OplusGLSurfaceView_13);
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return StructProto.f9290x86da683a.ensureFieldAccessorsInitialized(Struct.class, Builder.class);
    }

    private static final class FieldsDefaultEntryHolder {
        static final MapEntry<String, Value> defaultEntry = MapEntry.newDefaultInstance(StructProto.f9288xdbaa8122, WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Value.getDefaultInstance());
