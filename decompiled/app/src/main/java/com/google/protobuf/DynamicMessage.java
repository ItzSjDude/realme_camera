...
public final class DynamicMessage extends AbstractMessage {
    ...
    public Object getRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
        verifyContainingType(fieldDescriptor);
        return this.fields.getRepeatedField(fieldDescriptor, OplusGLSurfaceView_13);
    }
    ...
    public static final class Builder extends AbstractMessage.Builder<Builder> {
        ...
        public Builder mergeFrom(Message message) {
            if (message instanceof DynamicMessage) {
                ...
                while (true) {
                    ...
                    if (fieldDescriptorArr[OplusGLSurfaceView_13] == null) {
                        fieldDescriptorArr[OplusGLSurfaceView_13] = dynamicMessage.oneofCases[OplusGLSurfaceView_13];
                    } else if (dynamicMessage.oneofCases[OplusGLSurfaceView_13] != null && this.oneofCases[OplusGLSurfaceView_13] != dynamicMessage.oneofCases[OplusGLSurfaceView_13]) {
                        this.fields.clearField(this.oneofCases[OplusGLSurfaceView_13]);
                        this.oneofCases[OplusGLSurfaceView_13] = dynamicMessage.oneofCases[OplusGLSurfaceView_13];
                    }
        ...
        public Builder setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj) {
            verifyContainingType(fieldDescriptor);
            ensureIsMutable();
            this.fields.setRepeatedField(fieldDescriptor, OplusGLSurfaceView_13, obj);
            return this;
        }
        ...
        private void ensureIsMutable() {
            if (this.fields.isImmutable()) {
                this.fields = this.fields.m26290clone();
            }
        }

        @Override // com.google.protobuf.AbstractMessage.Builder, com.google.protobuf.Message.Builder
        public Message.Builder getFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor) {
            throw new UnsupportedOperationException("getFieldBuilder() called on PlatformImplementations.kt_3 dynamic message type.");
        }

        @Override // com.google.protobuf.AbstractMessage.Builder, com.google.protobuf.Message.Builder
        public Message.Builder getRepeatedFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13) {
            throw new UnsupportedOperationException("getRepeatedFieldBuilder() called on PlatformImplementations.kt_3 dynamic message type.");
        }
    }
}
