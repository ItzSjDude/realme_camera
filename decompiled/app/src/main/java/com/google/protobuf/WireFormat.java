...
public final class WireFormat {
    ...
    public static int getTagFieldNumber(int OplusGLSurfaceView_13) {
        return OplusGLSurfaceView_13 >>> 3;
    }

    public static int getTagWireType(int OplusGLSurfaceView_13) {
        return OplusGLSurfaceView_13 & 7;
    }

    static int makeTag(int OplusGLSurfaceView_13, int i2) {
        return (OplusGLSurfaceView_13 << 3) | i2;
    }
    ...
    public static class FieldType {
        ...
        public static final FieldType FLOAT = new FieldType(NvsFxDescription.ParamInfoObject.PARAM_TYPE_FLOAT, 1, JavaType.FLOAT, 5);
        ...
        public static final FieldType BOOL = new FieldType(NvsFxDescription.ParamInfoObject.PARAM_TYPE_BOOL, 7, JavaType.BOOLEAN, 0);
        ...
        /* synthetic */ FieldType(String str, int OplusGLSurfaceView_13, JavaType javaType, int i2, C21001 c21001) {
            this(str, OplusGLSurfaceView_13, javaType, i2);
        }
        ...
        static {
            ...
            STRING = new FieldType(NvsFxDescription.ParamInfoObject.PARAM_TYPE_STRING, 8, JavaType.STRING, OplusGLSurfaceView_13) { // from class: com.google.protobuf.WireFormat.FieldType.1
                @Override // com.google.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            MESSAGE = new FieldType("MESSAGE", 10, JavaType.MESSAGE, OplusGLSurfaceView_13) { // from class: com.google.protobuf.WireFormat.FieldType.3
                @Override // com.google.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            BYTES = new FieldType("BYTES", 11, JavaType.BYTE_STRING, OplusGLSurfaceView_13) { // from class: com.google.protobuf.WireFormat.FieldType.4
                @Override // com.google.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
        ...
        private FieldType(String str, int OplusGLSurfaceView_13, JavaType javaType, int i2) {
    ...
    enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C21001 c21001) {
            this();
        }
    }
    ...
    static /* synthetic */ class C21001 {
        ...
        static final /* synthetic */ int[] f9301xbcb373fd = new int[FieldType.values().length];

        static {
            try {
                f9301xbcb373fd[FieldType.DOUBLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9301xbcb373fd[FieldType.FLOAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9301xbcb373fd[FieldType.INT64.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9301xbcb373fd[FieldType.UINT64.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9301xbcb373fd[FieldType.INT32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9301xbcb373fd[FieldType.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9301xbcb373fd[FieldType.FIXED32.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9301xbcb373fd[FieldType.BOOL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9301xbcb373fd[FieldType.BYTES.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9301xbcb373fd[FieldType.UINT32.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9301xbcb373fd[FieldType.SFIXED32.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9301xbcb373fd[FieldType.SFIXED64.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9301xbcb373fd[FieldType.SINT32.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9301xbcb373fd[FieldType.SINT64.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9301xbcb373fd[FieldType.STRING.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9301xbcb373fd[FieldType.GROUP.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9301xbcb373fd[FieldType.MESSAGE.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f9301xbcb373fd[FieldType.ENUM.ordinal()] = 18;
    ...
    static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C21001.f9301xbcb373fd[fieldType.ordinal()]) {
            case 1:
