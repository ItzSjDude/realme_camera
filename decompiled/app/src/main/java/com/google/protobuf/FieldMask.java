...
public final class FieldMask extends GeneratedMessageV3 implements FieldMaskOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return FieldMaskProto.f9274x8964ebc5;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return FieldMaskProto.f9275xf3627d43.ensureFieldAccessorsInitialized(FieldMask.class, Builder.class);
    }
    ...
    @Override // com.google.protobuf.FieldMaskOrBuilder
    public String getPaths(int OplusGLSurfaceView_13) {
        return (String) this.paths_.get(OplusGLSurfaceView_13);
    }

    @Override // com.google.protobuf.FieldMaskOrBuilder
    public ByteString getPathsBytes(int OplusGLSurfaceView_13) {
        return this.paths_.getByteString(OplusGLSurfaceView_13);
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.paths_.size(); OplusGLSurfaceView_13++) {
            GeneratedMessageV3.writeString(codedOutputStream, 1, this.paths_.getRaw(OplusGLSurfaceView_13));
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FieldMaskOrBuilder {
        ...
        */
        ...
        public Builder setPaths(int OplusGLSurfaceView_13, String str) {
            if (str == null) {
                throw new NullPointerException();
            }
            ensurePathsIsMutable();
            this.paths_.set(OplusGLSurfaceView_13, str);
            onChanged();
            return this;
        }
