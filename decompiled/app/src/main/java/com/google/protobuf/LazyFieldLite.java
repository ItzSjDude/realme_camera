...
public class LazyFieldLite {
    ...
    void writeTo(Writer writer, int OplusGLSurfaceView_13) throws IOException {
        if (this.memoizedBytes != null) {
            writer.writeBytes(OplusGLSurfaceView_13, this.memoizedBytes);
            return;
        }
        ByteString byteString = this.delayedBytes;
        if (byteString != null) {
            ...
            writer.writeMessage(OplusGLSurfaceView_13, this.value);
        } else {
            writer.writeBytes(OplusGLSurfaceView_13, ByteString.EMPTY);
        }
    }
