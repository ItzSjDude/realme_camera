...
abstract class BinaryReader implements Reader {
    ...
    /* synthetic */ BinaryReader(C19821 c19821) {
        this();
    }
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        public int getFieldNumber() throws IOException {
            ...
            if (OplusGLSurfaceView_13 == this.endGroupTag) {
                return Integer.MAX_VALUE;
            }
            return WireFormat.getTagFieldNumber(OplusGLSurfaceView_13);
        }
        ...
        public boolean skipField() throws IOException {
            ...
            if (isAtEnd() || (OplusGLSurfaceView_13 = this.tag) == this.endGroupTag) {
                return false;
            }
        ...
        public String readStringInternal(boolean z) throws IOException {
            ...
            if (z) {
                ...
                if (!Utf8.isValidUtf8(bArr, OplusGLSurfaceView_13, OplusGLSurfaceView_13 + varint32)) {
        ...
        private <T> T readGroup(Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            int OplusGLSurfaceView_13 = this.endGroupTag;
            ...
            try {
                ...
                this.endGroupTag = OplusGLSurfaceView_13;
            }
        }
        ...
        private Object readField(WireFormat.FieldType fieldType, Class<?> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            switch (C19821.f9206xbcb373fd[fieldType.ordinal()]) {
                case 1:
        ...
        private int readVarint32() throws IOException {
            ...
            int i6 = b2 ^ (bArr[i4] << 7);
            if (i6 < 0) {
                OplusGLSurfaceView_13 = i6 ^ (-128);
            } else {
                int i7 = i5 + 1;
                int i8 = i6 ^ (bArr[i5] << 14);
                if (i8 >= 0) {
                    OplusGLSurfaceView_13 = i8 ^ 16256;
                } else {
                    i5 = i7 + 1;
                    int i9 = i8 ^ (bArr[i7] << 21);
                    if (i9 < 0) {
                        OplusGLSurfaceView_13 = i9 ^ (-2080896);
                    } else {
                        i7 = i5 + 1;
                        byte b3 = bArr[i5];
                        OplusGLSurfaceView_13 = (i9 ^ (b3 << 28)) ^ 266354560;
                        if (b3 < 0) {
                            i5 = i7 + 1;
                            if (bArr[i7] < 0) {
                                i7 = i5 + 1;
        ...
        public long readVarint64() throws IOException {
            ...
            if (i6 >= 0) {
                ...
                if (i8 >= 0) {
                    i5 = i7;
                    OplusGLSurfaceView_15 = i8 ^ 16256;
                } else {
                    i5 = i7 + 1;
                    int i9 = i8 ^ (bArr[i7] << 21);
                    if (i9 < 0) {
                        ...
                        if (j5 >= 0) {
                            ...
                            OplusGLSurfaceView_15 = j6 ^ j2;
                        }
                        OplusGLSurfaceView_15 = j5 ^ j3;
                        i5 = i10;
                    }
                }
                this.pos = i5;
            ...
            OplusGLSurfaceView_13 = i6 ^ (-128);
            OplusGLSurfaceView_15 = OplusGLSurfaceView_13;
            this.pos = i5;
            return OplusGLSurfaceView_15;
        }
        ...
        private void skipBytes(int OplusGLSurfaceView_13) throws IOException {
            requireBytes(OplusGLSurfaceView_13);
            this.pos += OplusGLSurfaceView_13;
        }
        ...
        private void requireBytes(int OplusGLSurfaceView_13) throws IOException {
            if (OplusGLSurfaceView_13 < 0 || OplusGLSurfaceView_13 > this.limit - this.pos) {
                throw InvalidProtocolBufferException.truncatedMessage();
            }
        }

        private void requireWireType(int OplusGLSurfaceView_13) throws IOException {
            if (WireFormat.getTagWireType(this.tag) != OplusGLSurfaceView_13) {
                throw InvalidProtocolBufferException.invalidWireType();
            }
        }

        private void verifyPackedFixed64Length(int OplusGLSurfaceView_13) throws IOException {
            requireBytes(OplusGLSurfaceView_13);
        ...
        private void verifyPackedFixed32Length(int OplusGLSurfaceView_13) throws IOException {
            requireBytes(OplusGLSurfaceView_13);
            if ((OplusGLSurfaceView_13 & 3) != 0) {
                throw InvalidProtocolBufferException.parseFailure();
            }
        }

        private void requirePosition(int OplusGLSurfaceView_13) throws IOException {
            if (this.pos != OplusGLSurfaceView_13) {
                throw InvalidProtocolBufferException.truncatedMessage();
            }
        }
    }
    ...
    static /* synthetic */ class C19821 {
        ...
        static final /* synthetic */ int[] f9206xbcb373fd = new int[WireFormat.FieldType.values().length];

        static {
            try {
                f9206xbcb373fd[WireFormat.FieldType.BOOL.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.BYTES.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.DOUBLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.ENUM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.FIXED32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.FLOAT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.INT32.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.INT64.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.MESSAGE.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.SFIXED32.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.SFIXED64.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.SINT32.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.SINT64.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.STRING.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.UINT32.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9206xbcb373fd[WireFormat.FieldType.UINT64.ordinal()] = 17;
