...
public class MapField<K, V> implements MutabilityOracle {
    ...
    private interface Converter<K, V> {
        Message convertKeyAndValueToMessage(K OplusGLSurfaceView_5, V v);
    ...
    private static class ImmutableMessageConverter<K, V> implements Converter<K, V> {
        ...
        public Message convertKeyAndValueToMessage(K OplusGLSurfaceView_5, V v) {
            return this.defaultEntry.newBuilderForType().setKey(OplusGLSurfaceView_5).setValue(v).buildPartial();
        }
    ...
    private Message convertKeyAndValueToMessage(K OplusGLSurfaceView_5, V v) {
        return this.converter.convertKeyAndValueToMessage(OplusGLSurfaceView_5, v);
    }
    ...
    private static class MutatabilityAwareMap<K, V> implements Map<K, V> {
        ...
        public V put(K OplusGLSurfaceView_5, V v) {
            ...
            Internal.checkNotNull(OplusGLSurfaceView_5);
            Internal.checkNotNull(v);
            return this.delegate.put(OplusGLSurfaceView_5, v);
        }
        ...
        public void putAll(Map<? extends K, ? extends V> map) {
            this.mutabilityOracle.ensureMutable();
            for (K OplusGLSurfaceView_5 : map.keySet()) {
                Internal.checkNotNull(OplusGLSurfaceView_5);
                Internal.checkNotNull(map.get(OplusGLSurfaceView_5));
            }
        ...
        private static class MutatabilityAwareSet<E> implements Set<E> {
            ...
            public boolean add(E COUIBaseListPopupWindow_8) {
                this.mutabilityOracle.ensureMutable();
                return this.delegate.add(COUIBaseListPopupWindow_8);
            }
