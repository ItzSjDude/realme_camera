...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C20461 c20461) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C20461) null);
    }
    ...
    public FieldSet<T> m26290clone() {
        FieldSet<T> fieldSetNewFieldSet = newFieldSet();
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
            Map.Entry<K, Object> arrayEntryAt = this.fields.getArrayEntryAt(OplusGLSurfaceView_13);
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < smallSortedMap.getNumArrayEntries(); OplusGLSurfaceView_13++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(OplusGLSurfaceView_13), z);
        }
    ...
    public Object getRepeatedField(T t, int OplusGLSurfaceView_13) {
        if (!t.isRepeated()) {
            throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
        }
        Object field = getField(t);
        ...
        return ((List) field).get(OplusGLSurfaceView_13);
    }

    public void setRepeatedField(T t, int OplusGLSurfaceView_13, Object obj) {
        if (!t.isRepeated()) {
            throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
        }
        Object field = getField(t);
        ...
        verifyType(t.getLiteType(), obj);
        ((List) field).set(OplusGLSurfaceView_13, obj);
    }
    ...
    public boolean isInitialized() {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
            if (!isInitialized(this.fields.getArrayEntryAt(OplusGLSurfaceView_13))) {
                return false;
            }
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
    ...
    public void mergeFrom(FieldSet<T> fieldSet) {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < fieldSet.fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
            mergeFromField(fieldSet.fields.getArrayEntryAt(OplusGLSurfaceView_13));
        }
    ...
    public void writeMessageSetTo(CodedOutputStream codedOutputStream) throws IOException {
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
            writeMessageSetTo(this.fields.getArrayEntryAt(OplusGLSurfaceView_13), codedOutputStream);
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int OplusGLSurfaceView_13, Object obj) throws IOException {
        if (fieldType == WireFormat.FieldType.GROUP) {
            codedOutputStream.writeGroup(OplusGLSurfaceView_13, (MessageLite) obj);
        } else {
            codedOutputStream.writeTag(OplusGLSurfaceView_13, getWireFormatForFieldType(fieldType, false));
    ...
    static /* synthetic */ class C20461 {
        ...
        static final /* synthetic */ int[] f9276xbcb373fd = new int[WireFormat.FieldType.values().length];

        static {
            try {
                f9276xbcb373fd[WireFormat.FieldType.DOUBLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.FLOAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.INT64.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.UINT64.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.INT32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.FIXED32.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.BOOL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.GROUP.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.MESSAGE.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.STRING.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.BYTES.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.UINT32.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.SFIXED32.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.SFIXED64.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.SINT32.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.SINT64.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f9276xbcb373fd[WireFormat.FieldType.ENUM.ordinal()] = 18;
    ...
    static void writeElementNoTag(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, Object obj) throws IOException {
        switch (C20461.f9276xbcb373fd[fieldType.ordinal()]) {
            case 1:
    ...
    public int getMessageSetSerializedSize() {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
            messageSetSerializedSize += getMessageSetSerializedSize(this.fields.getArrayEntryAt(OplusGLSurfaceView_13));
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    static int computeElementSize(WireFormat.FieldType fieldType, int OplusGLSurfaceView_13, Object obj) {
        int iComputeTagSize = CodedOutputStream.computeTagSize(OplusGLSurfaceView_13);
        if (fieldType == WireFormat.FieldType.GROUP) {
            iComputeTagSize *= 2;
        }
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap) {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < smallSortedMap.getNumArrayEntries(); OplusGLSurfaceView_13++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(OplusGLSurfaceView_13));
            }
            Iterator it = smallSortedMap.getOverflowEntries().iterator();
            while (it.hasNext()) {
        ...
        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t, Object obj) {
            ...
            if (t.isRepeated()) {
                if (!(obj instanceof List)) {
                    throw new IllegalStateException("Repeated field should contains PlatformImplementations.kt_3 List but actually contains type: " + obj.getClass());
                }
                List arrayList = (List) obj;
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < arrayList.size(); OplusGLSurfaceView_13++) {
                    Object obj2 = arrayList.get(OplusGLSurfaceView_13);
                    Object objReplaceBuilder = replaceBuilder(obj2);
                    if (objReplaceBuilder != obj2) {
                        if (arrayList == obj) {
                            arrayList = new ArrayList(arrayList);
                        }
                        arrayList.set(OplusGLSurfaceView_13, objReplaceBuilder);
                    }
                }
                return arrayList;
            }
        ...
        public Object getRepeatedField(T t, int OplusGLSurfaceView_13) {
            ...
            return replaceBuilder(getRepeatedFieldAllowBuilders(t, OplusGLSurfaceView_13));
        }

        Object getRepeatedFieldAllowBuilders(T t, int OplusGLSurfaceView_13) {
            if (!t.isRepeated()) {
                throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
            }
            ...
            return ((List) fieldAllowBuilders).get(OplusGLSurfaceView_13);
        }
        ...
        public boolean isInitialized() {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
                if (!FieldSet.isInitialized(this.fields.getArrayEntryAt(OplusGLSurfaceView_13))) {
                    return false;
                }
            }
            Iterator it = this.fields.getOverflowEntries().iterator();
        ...
        public void mergeFrom(FieldSet<T> fieldSet) {
            ensureIsMutable();
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < ((FieldSet) fieldSet).fields.getNumArrayEntries(); OplusGLSurfaceView_13++) {
                mergeFromField(((FieldSet) fieldSet).fields.getArrayEntryAt(OplusGLSurfaceView_13));
            }
