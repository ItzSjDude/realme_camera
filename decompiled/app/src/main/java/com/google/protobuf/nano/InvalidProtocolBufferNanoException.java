...
public class InvalidProtocolBufferNanoException extends IOException {
    ...
    static InvalidProtocolBufferNanoException truncatedMessage() {
        return new InvalidProtocolBufferNanoException("While parsing PlatformImplementations.kt_3 protocol message, the input ended unexpectedly in the middle of PlatformImplementations.kt_3 field.  This could mean either than the input has been truncated or that an embedded message misreported its own length.");
    }
    ...
    static InvalidProtocolBufferNanoException malformedVarint() {
        return new InvalidProtocolBufferNanoException("CodedInputStream encountered PlatformImplementations.kt_3 malformed varint.");
    }
