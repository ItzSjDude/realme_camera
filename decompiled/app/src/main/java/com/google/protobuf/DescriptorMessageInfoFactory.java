...
final class DescriptorMessageInfoFactory implements MessageInfoFactory {
    ...
    private static Message getDefaultInstance(Class<?> cls) {
        try {
            ...
            throw new IllegalArgumentException("Unable to get default instance for message class " + cls.getName(), COUIBaseListPopupWindow_8);
        }
    }
    ...
    private static MessageInfo convert(Class<?> cls, Descriptors.Descriptor descriptor) {
        int OplusGLSurfaceView_13 = C19953.f9211x9b6bdfeb[descriptor.getFile().getSyntax().ordinal()];
    ...
    static class IsInitializedCheckAnalyzer {
        ...
        private static class Node {
            ...
            Node(Descriptors.Descriptor descriptor, int OplusGLSurfaceView_13) {
                this.descriptor = descriptor;
                this.index = OplusGLSurfaceView_13;
                this.lowLink = OplusGLSurfaceView_13;
            }
        }
        ...
        private Node dfs(Descriptors.Descriptor descriptor) {
            Node nodePop;
            int OplusGLSurfaceView_13 = this.index;
            this.index = OplusGLSurfaceView_13 + 1;
            Node node = new Node(descriptor, OplusGLSurfaceView_13);
    ...
    private static StructuralMessageInfo convertProto2(Class<?> cls, Descriptors.Descriptor descriptor) {
        ...
        int i2 = 0;
        int i3 = 1;
        while (OplusGLSurfaceView_13 < fields.size()) {
            final Descriptors.FieldDescriptor fieldDescriptor = fields.get(OplusGLSurfaceView_13);
    ...
    private static StructuralMessageInfo convertProto3(Class<?> cls, Descriptors.Descriptor descriptor) {
        ...
        OneofState oneofState = new OneofState();
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < fields.size(); OplusGLSurfaceView_13++) {
            Descriptors.FieldDescriptor fieldDescriptor = fields.get(OplusGLSurfaceView_13);
            if (fieldDescriptor.getContainingOneof() != null) {
    ...
    /* renamed from: com.google.protobuf.DescriptorMessageInfoFactory$3 */
    static /* synthetic */ class C19953 {

        /* renamed from: $SwitchMap$com$google$protobuf$Descriptors$FileDescriptor$Syntax */
        static final /* synthetic */ int[] f9211x9b6bdfeb;

        static {
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.BOOL.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.BYTES.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.DOUBLE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.ENUM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.FIXED32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.FLOAT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.GROUP.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.INT32.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.INT64.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.MESSAGE.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.SFIXED32.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.SFIXED64.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.SINT32.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.SINT64.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.STRING.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.UINT32.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f9210x6f0f2e06[Descriptors.FieldDescriptor.Type.UINT64.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            $SwitchMap$com$google$protobuf$JavaType = new int[JavaType.values().length];
            try {
            ...
            f9211x9b6bdfeb = new int[Descriptors.FileDescriptor.Syntax.values().length];
            try {
                f9211x9b6bdfeb[Descriptors.FileDescriptor.Syntax.PROTO2.ordinal()] = 1;
            } catch (NoSuchFieldError unused28) {
            }
            try {
                f9211x9b6bdfeb[Descriptors.FileDescriptor.Syntax.PROTO3.ordinal()] = 2;
    ...
    private static java.lang.reflect.Field bitField(Class<?> cls, int OplusGLSurfaceView_13) {
        return field(cls, "bitField" + OplusGLSurfaceView_13 + "_");
    }
