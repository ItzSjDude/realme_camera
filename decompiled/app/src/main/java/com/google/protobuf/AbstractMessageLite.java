...
public abstract class AbstractMessageLite<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite {
    ...
    public ByteString toByteString() {
        try {
            ...
            throw new RuntimeException(this.getSerializingExceptionMessage("ByteString"), COUIBaseListPopupWindow_8);
        }
    }
    ...
    public byte[] toByteArray() {
        try {
            ...
            throw new RuntimeException(getSerializingExceptionMessage("byte array"), COUIBaseListPopupWindow_8);
        }
    }
    ...
    private String getSerializingExceptionMessage(String str) {
        return "Serializing " + getClass().getName() + " to PlatformImplementations.kt_3 " + str + " threw an IOException (should never happen).";
    }
    ...
    public static abstract class Builder<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite.Builder {
        ...
        public abstract BuilderType mo26289clone();
        ...
        static final class LimitedInputStream extends FilterInputStream {
            ...
            LimitedInputStream(InputStream inputStream, int OplusGLSurfaceView_13) {
                super(inputStream);
            ...
            public int read() throws IOException {
                ...
                int OplusGLSurfaceView_13 = super.read();
            ...
            public int read(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws IOException {
                ...
                int i4 = super.read(bArr, OplusGLSurfaceView_13, Math.min(i2, i3));
                if (i4 >= 0) {
                    this.limit -= i4;
                }
                return i4;
            ...
            public long skip(long OplusGLSurfaceView_15) throws IOException {
                long jSkip = super.skip(Math.min(OplusGLSurfaceView_15, this.limit));
                if (jSkip >= 0) {
        ...
        public boolean mergeDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            mergeFrom((InputStream) new LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(OplusGLSurfaceView_13, inputStream)), extensionRegistryLite);
            return true;
        }
        ...
        private String getReadingExceptionMessage(String str) {
            return "Reading " + getClass().getName() + " from PlatformImplementations.kt_3 " + str + " threw an IOException (should never happen).";
        }
