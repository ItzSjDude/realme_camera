...
public final class Int64Value extends GeneratedMessageV3 implements Int64ValueOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WrappersProto.f9312x80eefe2d;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WrappersProto.f9313xcc87a7ab.ensureFieldAccessorsInitialized(Int64Value.class, Builder.class);
    }
    ...
    public int getSerializedSize() {
        ...
        long OplusGLSurfaceView_15 = this.value_;
        int iComputeInt64Size = (OplusGLSurfaceView_15 != 0 ? 0 + CodedOutputStream.computeInt64Size(1, OplusGLSurfaceView_15) : 0) + this.unknownFields.getSerializedSize();
    ...
    /* renamed from: of */
    public static Int64Value m8341of(long OplusGLSurfaceView_15) {
