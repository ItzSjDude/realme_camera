...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    protected boolean parseUnknownField(int OplusGLSurfaceView_13, CodedInputStream codedInputStream) throws IOException {
        if (WireFormat.getTagWireType(OplusGLSurfaceView_13) == 4) {
            return false;
        }
        ensureUnknownFieldsInitialized();
        return this.unknownFields.mergeFieldFrom(OplusGLSurfaceView_13, codedInputStream);
    }

    protected void mergeVarintField(int OplusGLSurfaceView_13, int i2) {
        ensureUnknownFieldsInitialized();
        this.unknownFields.mergeVarintField(OplusGLSurfaceView_13, i2);
    }

    protected void mergeLengthDelimitedField(int OplusGLSurfaceView_13, ByteString byteString) {
        ensureUnknownFieldsInitialized();
        this.unknownFields.mergeLengthDelimitedField(OplusGLSurfaceView_13, byteString);
    }
    ...
    void setMemoizedSerializedSize(int OplusGLSurfaceView_13) {
        this.memoizedSerializedSize = OplusGLSurfaceView_13;
    }
    ...
    static <T extends GeneratedMessageLite<?, ?>> T getDefaultInstance(Class<T> cls) throws ClassNotFoundException {
        ...
        if (generatedMessageLite == null) {
            try {
                ...
                throw new IllegalStateException("Class initialization cannot fail.", COUIBaseListPopupWindow_8);
            }
        }
        if (generatedMessageLite == null) {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public BuilderType mo26289clone() {
            ...
            extendableBuilder.mergeFrom((ExtendableBuilder) buildPartial());
        ...
        public BuilderType mergeFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            copyOnWrite();
            try {
                Protobuf.getInstance().schemaFor((Protobuf) this.instance).mergeFrom(this.instance, bArr, OplusGLSurfaceView_13, OplusGLSurfaceView_13 + i2, new ArrayDecoders.Registers(extensionRegistryLite));
                return this;
        ...
        public BuilderType mergeFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException {
            return (BuilderType) mergeFrom(bArr, OplusGLSurfaceView_13, i2, ExtensionRegistryLite.getEmptyRegistry());
        }
        ...
        public BuilderType mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            try {
                ...
                if (COUIBaseListPopupWindow_8.getCause() instanceof IOException) {
                    throw ((IOException) COUIBaseListPopupWindow_8.getCause());
                }
                throw COUIBaseListPopupWindow_8;
            }
        }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        protected <MessageType extends MessageLite> boolean parseUnknownField(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
            int tagFieldNumber = WireFormat.getTagFieldNumber(OplusGLSurfaceView_13);
            return parseExtension(codedInputStream, extensionRegistryLite, extensionRegistryLite.findLiteExtensionByNumber(messagetype, tagFieldNumber), OplusGLSurfaceView_13, tagFieldNumber);
        }
        ...
        */
        ...
        protected <MessageType extends MessageLite> boolean parseUnknownFieldAsMessageSet(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
            if (OplusGLSurfaceView_13 == WireFormat.MESSAGE_SET_ITEM_TAG) {
                mergeMessageSetExtensionFromCodedStream(messagetype, codedInputStream, extensionRegistryLite);
                return true;
            }
            if (WireFormat.getTagWireType(OplusGLSurfaceView_13) == 2) {
                return parseUnknownField(messagetype, codedInputStream, extensionRegistryLite, OplusGLSurfaceView_13);
            }
        ...
        private void eagerlyMergeMessageSetExtension(CodedInputStream codedInputStream, GeneratedExtension<?, ?> generatedExtension, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
            parseExtension(codedInputStream, extensionRegistryLite, generatedExtension, WireFormat.makeTag(OplusGLSurfaceView_13, 2), OplusGLSurfaceView_13);
        }
        ...
        private void verifyExtensionContainingType(GeneratedExtension<MessageType, ?> generatedExtension) {
            if (generatedExtension.getContainingTypeDefaultInstance() != getDefaultInstanceForType()) {
                throw new IllegalArgumentException("This extension is for PlatformImplementations.kt_3 different message type.  Please make sure that you are not suppressing any generics type warnings.");
            }
        }
        ...
        public final <Type> Type getExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13) {
            GeneratedExtension<MessageType, ?> generatedExtensionCheckIsLite = GeneratedMessageLite.checkIsLite(extensionLite);
            verifyExtensionContainingType(generatedExtensionCheckIsLite);
            return (Type) generatedExtensionCheckIsLite.singularFromFieldSetType(this.extensions.getRepeatedField(generatedExtensionCheckIsLite.descriptor, OplusGLSurfaceView_13));
        }
        ...
        protected class ExtensionWriter {
            ...
            /* synthetic */ ExtensionWriter(ExtendableMessage extendableMessage, boolean z, C20551 c20551) {
                this(z);
            }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        protected void copyOnWrite() {
            if (this.isBuilt) {
                super.copyOnWrite();
                ((ExtendableMessage) this.instance).extensions = ((ExtendableMessage) this.instance).extensions.m26290clone();
            }
        }
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            FieldSet fieldSetClone = fieldSet.m26290clone();
        ...
        @Override // com.google.protobuf.GeneratedMessageLite.ExtendableMessageOrBuilder
        public final <Type> Type getExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13) {
            return (Type) ((ExtendableMessage) this.instance).getExtension(extensionLite, OplusGLSurfaceView_13);
        }
        ...
        public final <Type> BuilderType setExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int OplusGLSurfaceView_13, Type type) {
            ...
            verifyExtensionContainingType(generatedExtensionCheckIsLite);
            copyOnWrite();
            ensureExtensionsAreMutable().setRepeatedField(generatedExtensionCheckIsLite.descriptor, OplusGLSurfaceView_13, generatedExtensionCheckIsLite.singularToFieldSetType(type));
            return this;
        }
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newSingularGeneratedExtension(ContainingType containingtype, Type type, MessageLite messageLite, Internal.EnumLiteMap<?> enumLiteMap, int OplusGLSurfaceView_13, WireFormat.FieldType fieldType, Class cls) {
        return new GeneratedExtension<>(containingtype, type, messageLite, new ExtensionDescriptor(enumLiteMap, OplusGLSurfaceView_13, fieldType, false, false), cls);
    }

    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newRepeatedGeneratedExtension(ContainingType containingtype, MessageLite messageLite, Internal.EnumLiteMap<?> enumLiteMap, int OplusGLSurfaceView_13, WireFormat.FieldType fieldType, boolean z, Class cls) {
        return new GeneratedExtension<>(containingtype, Collections.emptyList(), messageLite, new ExtensionDescriptor(enumLiteMap, OplusGLSurfaceView_13, fieldType, true, z), cls);
    }
    ...
    static final class ExtensionDescriptor implements FieldSet.FieldDescriptorLite<ExtensionDescriptor> {
        ...
        ExtensionDescriptor(Internal.EnumLiteMap<?> enumLiteMap, int OplusGLSurfaceView_13, WireFormat.FieldType fieldType, boolean z, boolean z2) {
    ...
    protected static final class SerializedForm implements Serializable {
        ...
        /* renamed from: of */
        public static SerializedForm m8339of(MessageLite messageLite) {
        ...
        protected Object readResolve() throws ObjectStreamException, NoSuchFieldException {
            try {
                ...
                throw new RuntimeException("Unable to understand proto buffer", COUIBaseListPopupWindow_8);
    ...
    public static <MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>, T> GeneratedExtension<MessageType, T> checkIsLite(ExtensionLite<MessageType, T> extensionLite) {
        if (!extensionLite.isLite()) {
            throw new IllegalArgumentException("Expected PlatformImplementations.kt_3 lite extension.");
        }
    ...
    public static class DefaultInstanceBasedParser<T extends GeneratedMessageLite<T, ?>> extends AbstractParser<T> {
        ...
        public T parsePartialFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return (T) GeneratedMessageLite.parsePartialFrom(this.defaultInstance, bArr, OplusGLSurfaceView_13, i2, extensionRegistryLite);
        }
    }
    ...
    static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        try {
            ...
            if (COUIBaseListPopupWindow_8.getCause() instanceof InvalidProtocolBufferException) {
                throw ((InvalidProtocolBufferException) COUIBaseListPopupWindow_8.getCause());
            }
            throw new InvalidProtocolBufferException(COUIBaseListPopupWindow_8.getMessage()).setUnfinishedMessage(t2);
    ...
    static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        T t2 = (T) t.dynamicMethod(MethodToInvoke.NEW_MUTABLE_INSTANCE);
        try {
            Schema schemaSchemaFor = Protobuf.getInstance().schemaFor((Protobuf) t2);
            schemaSchemaFor.mergeFrom(t2, bArr, OplusGLSurfaceView_13, OplusGLSurfaceView_13 + i2, new ArrayDecoders.Registers(extensionRegistryLite));
            schemaSchemaFor.makeImmutable(t2);
    ...
    private static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            ...
            try {
                ...
                throw COUIBaseListPopupWindow_8.setUnfinishedMessage(t2);
            }
    ...
    private static <T extends GeneratedMessageLite<T, ?>> T parsePartialDelimitedFrom(T t, InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        try {
            ...
            CodedInputStream codedInputStreamNewInstance = CodedInputStream.newInstance(new AbstractMessageLite.Builder.LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(OplusGLSurfaceView_13, inputStream)));
