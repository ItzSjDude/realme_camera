...
final class StructuralMessageInfo implements MessageInfo {
    ...
    public static Builder newBuilder(int OplusGLSurfaceView_13) {
        return new Builder(OplusGLSurfaceView_13);
    }
    ...
    public static final class Builder {
        ...
        public Builder(int OplusGLSurfaceView_13) {
            this.checkInitialized = null;
            this.fields = new ArrayList(OplusGLSurfaceView_13);
        }
        ...
        public StructuralMessageInfo build() {
            ...
            if (this.syntax == null) {
                throw new IllegalStateException("Must specify PlatformImplementations.kt_3 proto syntax");
            }
            this.wasBuilt = true;
