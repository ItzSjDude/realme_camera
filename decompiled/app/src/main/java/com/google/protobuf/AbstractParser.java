...
public abstract class AbstractParser<MessageType extends MessageLite> implements Parser<MessageType> {
    ...
    public MessageType parsePartialFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            ...
            try {
                ...
                throw COUIBaseListPopupWindow_8.setUnfinishedMessage(partialFrom);
            }
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parsePartialFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parsePartialFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException {
        return (MessageType) parsePartialFrom(bArr, OplusGLSurfaceView_13, i2, EMPTY_REGISTRY);
    }
    ...
    @Override // com.google.protobuf.Parser
    public MessageType parseFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return (MessageType) checkMessageInitialized(parsePartialFrom(bArr, OplusGLSurfaceView_13, i2, extensionRegistryLite));
    }

    @Override // com.google.protobuf.Parser
    public MessageType parseFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException {
        return (MessageType) parseFrom(bArr, OplusGLSurfaceView_13, i2, EMPTY_REGISTRY);
    }
    ...
    public MessageType parsePartialDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        try {
            ...
            return (MessageType) parsePartialFrom((InputStream) new AbstractMessageLite.Builder.LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(OplusGLSurfaceView_13, inputStream)), extensionRegistryLite);
        } catch (IOException COUIBaseListPopupWindow_8) {
            throw new InvalidProtocolBufferException(COUIBaseListPopupWindow_8);
        }
    }
