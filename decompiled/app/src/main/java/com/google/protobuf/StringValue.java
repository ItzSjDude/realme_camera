...
public final class StringValue extends GeneratedMessageV3 implements StringValueOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WrappersProto.f9314x4aac3f6b;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WrappersProto.f9315xd206cae9.ensureFieldAccessorsInitialized(StringValue.class, Builder.class);
    }
    ...
    public int getSerializedSize() {
        ...
        int iComputeStringSize = (getValueBytes().isEmpty() ? 0 : 0 + GeneratedMessageV3.computeStringSize(1, this.value_)) + this.unknownFields.getSerializedSize();
    ...
    /* renamed from: of */
    public static StringValue m8342of(String str) {
