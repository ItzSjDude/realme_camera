...
public final class UnknownFieldSet implements MessageLite {
    ...
    public boolean hasField(int OplusGLSurfaceView_13) {
        return this.fields.containsKey(Integer.valueOf(OplusGLSurfaceView_13));
    }

    public Field getField(int OplusGLSurfaceView_13) {
        Field field = this.fields.get(Integer.valueOf(OplusGLSurfaceView_13));
    ...
    public ByteString toByteString() {
        try {
            ...
            throw new RuntimeException("Serializing to PlatformImplementations.kt_3 ByteString threw an IOException (should never happen).", COUIBaseListPopupWindow_8);
        }
    }
    ...
    public static final class Builder implements MessageLite.Builder {
        ...
        private Field.Builder getFieldBuilder(int OplusGLSurfaceView_13) {
            ...
            Field field = this.fields.get(Integer.valueOf(OplusGLSurfaceView_13));
            this.lastFieldNumber = OplusGLSurfaceView_13;
        ...
        public Builder clearField(int OplusGLSurfaceView_13) {
            if (OplusGLSurfaceView_13 == 0) {
                throw new IllegalArgumentException("Zero is not PlatformImplementations.kt_3 valid field number.");
            }
            if (this.lastField != null && this.lastFieldNumber == OplusGLSurfaceView_13) {
                this.lastField = null;
                this.lastFieldNumber = 0;
            }
            if (this.fields.containsKey(Integer.valueOf(OplusGLSurfaceView_13))) {
                this.fields.remove(Integer.valueOf(OplusGLSurfaceView_13));
            }
            return this;
        }
        ...
        public Builder mergeField(int OplusGLSurfaceView_13, Field field) {
            if (OplusGLSurfaceView_13 == 0) {
                throw new IllegalArgumentException("Zero is not PlatformImplementations.kt_3 valid field number.");
            }
            if (hasField(OplusGLSurfaceView_13)) {
                getFieldBuilder(OplusGLSurfaceView_13).mergeFrom(field);
            } else {
                addField(OplusGLSurfaceView_13, field);
            }
            return this;
        }

        public Builder mergeVarintField(int OplusGLSurfaceView_13, int i2) {
            if (OplusGLSurfaceView_13 == 0) {
                throw new IllegalArgumentException("Zero is not PlatformImplementations.kt_3 valid field number.");
            }
            getFieldBuilder(OplusGLSurfaceView_13).addVarint(i2);
            return this;
        }

        public Builder mergeLengthDelimitedField(int OplusGLSurfaceView_13, ByteString byteString) {
            if (OplusGLSurfaceView_13 == 0) {
                throw new IllegalArgumentException("Zero is not PlatformImplementations.kt_3 valid field number.");
            }
            getFieldBuilder(OplusGLSurfaceView_13).addLengthDelimited(byteString);
            return this;
        }

        public boolean hasField(int OplusGLSurfaceView_13) {
            if (OplusGLSurfaceView_13 != 0) {
                return OplusGLSurfaceView_13 == this.lastFieldNumber || this.fields.containsKey(Integer.valueOf(OplusGLSurfaceView_13));
            }
            throw new IllegalArgumentException("Zero is not PlatformImplementations.kt_3 valid field number.");
        }

        public Builder addField(int OplusGLSurfaceView_13, Field field) {
            if (OplusGLSurfaceView_13 == 0) {
                throw new IllegalArgumentException("Zero is not PlatformImplementations.kt_3 valid field number.");
            }
            if (this.lastField != null && this.lastFieldNumber == OplusGLSurfaceView_13) {
            ...
            this.fields.put(Integer.valueOf(OplusGLSurfaceView_13), field);
            return this;
        }
        ...
        public boolean mergeFieldFrom(int OplusGLSurfaceView_13, CodedInputStream codedInputStream) throws IOException {
        ...
        public Builder mergeFrom(ByteString byteString) throws InvalidProtocolBufferException {
            try {
                ...
                throw new RuntimeException("Reading from PlatformImplementations.kt_3 ByteString threw an IOException (should never happen).", e2);
            }
        }
        ...
        public boolean mergeDelimitedFrom(InputStream inputStream) throws IOException {
            ...
            mergeFrom((InputStream) new AbstractMessageLite.Builder.LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(OplusGLSurfaceView_13, inputStream)));
            return true;
        }
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public Builder mergeFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException {
            try {
                CodedInputStream codedInputStreamNewInstance = CodedInputStream.newInstance(bArr, OplusGLSurfaceView_13, i2);
                mergeFrom(codedInputStreamNewInstance);
                codedInputStreamNewInstance.checkLastTagWas(0);
                return this;
            } catch (InvalidProtocolBufferException COUIBaseListPopupWindow_8) {
        ...
        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public Builder mergeFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return mergeFrom(bArr, OplusGLSurfaceView_13, i2);
        }
    ...
    public static final class Field {
        ...
        public ByteString toByteString(int OplusGLSurfaceView_13) {
            try {
                ByteString.CodedBuilder codedBuilderNewCodedBuilder = ByteString.newCodedBuilder(getSerializedSize(OplusGLSurfaceView_13));
                writeTo(OplusGLSurfaceView_13, codedBuilderNewCodedBuilder.getCodedOutput());
                return codedBuilderNewCodedBuilder.build();
            } catch (IOException COUIBaseListPopupWindow_8) {
                throw new RuntimeException("Serializing to PlatformImplementations.kt_3 ByteString should never fail with an IOException", COUIBaseListPopupWindow_8);
            }
        }

        public void writeTo(int OplusGLSurfaceView_13, CodedOutputStream codedOutputStream) throws IOException {
            Iterator<Long> it = this.varint.iterator();
            while (it.hasNext()) {
                codedOutputStream.writeUInt64(OplusGLSurfaceView_13, it.next().longValue());
            }
            Iterator<Integer> it2 = this.fixed32.iterator();
            while (it2.hasNext()) {
                codedOutputStream.writeFixed32(OplusGLSurfaceView_13, it2.next().intValue());
            }
            Iterator<Long> it3 = this.fixed64.iterator();
            while (it3.hasNext()) {
                codedOutputStream.writeFixed64(OplusGLSurfaceView_13, it3.next().longValue());
            }
            Iterator<ByteString> it4 = this.lengthDelimited.iterator();
            while (it4.hasNext()) {
                codedOutputStream.writeBytes(OplusGLSurfaceView_13, it4.next());
            }
            Iterator<UnknownFieldSet> it5 = this.group.iterator();
            while (it5.hasNext()) {
                codedOutputStream.writeGroup(OplusGLSurfaceView_13, it5.next());
            }
        }

        public int getSerializedSize(int OplusGLSurfaceView_13) {
            Iterator<Long> it = this.varint.iterator();
            int iComputeGroupSize = 0;
            while (it.hasNext()) {
                iComputeGroupSize += CodedOutputStream.computeUInt64Size(OplusGLSurfaceView_13, it.next().longValue());
            }
            Iterator<Integer> it2 = this.fixed32.iterator();
            while (it2.hasNext()) {
                iComputeGroupSize += CodedOutputStream.computeFixed32Size(OplusGLSurfaceView_13, it2.next().intValue());
            }
            Iterator<Long> it3 = this.fixed64.iterator();
            while (it3.hasNext()) {
                iComputeGroupSize += CodedOutputStream.computeFixed64Size(OplusGLSurfaceView_13, it3.next().longValue());
            }
            Iterator<ByteString> it4 = this.lengthDelimited.iterator();
            while (it4.hasNext()) {
                iComputeGroupSize += CodedOutputStream.computeBytesSize(OplusGLSurfaceView_13, it4.next());
            }
            Iterator<UnknownFieldSet> it5 = this.group.iterator();
            while (it5.hasNext()) {
                iComputeGroupSize += CodedOutputStream.computeGroupSize(OplusGLSurfaceView_13, it5.next());
            }
            return iComputeGroupSize;
        }

        public void writeAsMessageSetExtensionTo(int OplusGLSurfaceView_13, CodedOutputStream codedOutputStream) throws IOException {
            Iterator<ByteString> it = this.lengthDelimited.iterator();
            while (it.hasNext()) {
                codedOutputStream.writeRawMessageSetExtension(OplusGLSurfaceView_13, it.next());
            }
        }

        void writeTo(int OplusGLSurfaceView_13, Writer writer) throws IOException {
            writer.writeInt64List(OplusGLSurfaceView_13, this.varint, false);
            writer.writeFixed32List(OplusGLSurfaceView_13, this.fixed32, false);
            writer.writeFixed64List(OplusGLSurfaceView_13, this.fixed64, false);
            writer.writeBytesList(OplusGLSurfaceView_13, this.lengthDelimited);
            if (writer.fieldOrder() == Writer.FieldOrder.ASCENDING) {
                for (int i2 = 0; i2 < this.group.size(); i2++) {
                    writer.writeStartGroup(OplusGLSurfaceView_13);
                    this.group.get(i2).writeTo(writer);
                    writer.writeEndGroup(OplusGLSurfaceView_13);
                }
                return;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void writeAsMessageSetExtensionTo(int OplusGLSurfaceView_13, Writer writer) throws IOException {
            if (writer.fieldOrder() == Writer.FieldOrder.DESCENDING) {
                List<ByteString> list = this.lengthDelimited;
                ListIterator<ByteString> listIterator = list.listIterator(list.size());
                while (listIterator.hasPrevious()) {
                    writer.writeMessageSetItem(OplusGLSurfaceView_13, listIterator.previous());
                }
                return;
            }
            Iterator<ByteString> it = this.lengthDelimited.iterator();
            while (it.hasNext()) {
                writer.writeMessageSetItem(OplusGLSurfaceView_13, it.next());
            }
        }

        public int getSerializedSizeAsMessageSetExtension(int OplusGLSurfaceView_13) {
            Iterator<ByteString> it = this.lengthDelimited.iterator();
            int iComputeRawMessageSetExtensionSize = 0;
            while (it.hasNext()) {
                iComputeRawMessageSetExtensionSize += CodedOutputStream.computeRawMessageSetExtensionSize(OplusGLSurfaceView_13, it.next());
            }
        ...
        public static final class Builder {
            ...
            public Builder addVarint(long OplusGLSurfaceView_15) {
                if (this.result.varint == null) {
                    this.result.varint = new ArrayList();
                }
                this.result.varint.add(Long.valueOf(OplusGLSurfaceView_15));
                return this;
            }

            public Builder addFixed32(int OplusGLSurfaceView_13) {
                if (this.result.fixed32 == null) {
                    this.result.fixed32 = new ArrayList();
                }
                this.result.fixed32.add(Integer.valueOf(OplusGLSurfaceView_13));
                return this;
            }

            public Builder addFixed64(long OplusGLSurfaceView_15) {
                if (this.result.fixed64 == null) {
                    this.result.fixed64 = new ArrayList();
                }
                this.result.fixed64.add(Long.valueOf(OplusGLSurfaceView_15));
                return this;
            }
    ...
    public static final class Parser extends AbstractParser<UnknownFieldSet> {
        ...
        public UnknownFieldSet parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            ...
            try {
                ...
                throw COUIBaseListPopupWindow_8.setUnfinishedMessage(builderNewBuilder.buildPartial());
            } catch (IOException e2) {
