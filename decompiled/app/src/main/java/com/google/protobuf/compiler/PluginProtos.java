...
public final class PluginProtos {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\OplusGLSurfaceView_11%google/protobuf/compiler/plugin.proto\u0012\u0018google.protobuf.compiler\u001a google/protobuf/descriptor.proto\"F\OplusGLSurfaceView_11\u0007Version\u0012\r\OplusGLSurfaceView_11\u0005major\u0018\u0001 \u0001(\u0005\u0012\r\OplusGLSurfaceView_11\u0005minor\u0018\u0002 \u0001(\u0005\u0012\r\OplusGLSurfaceView_11\u0005patch\u0018\u0003 \u0001(\u0005\u0012\u000e\OplusGLSurfaceView_11\u0006suffix\u0018\u0004 \u0001(\t\"º\u0001\OplusGLSurfaceView_11\u0014CodeGeneratorRequest\u0012\u0018\OplusGLSurfaceView_11\u0010file_to_generate\u0018\u0001 \u0003(\t\u0012\u0011\OplusGLSurfaceView_11\tparameter\u0018\u0002 \u0001(\t\u00128\OplusGLSurfaceView_11\nproto_file\u0018\u000f \u0003(\u000b2$.google.protobuf.FileDescriptorProto\u0012;\OplusGLSurfaceView_11\u0010compiler_version\u0018\u0003 \u0001(\u000b2!.google.protobuf.compiler.Version\"ª\u0001\OplusGLSurfaceView_11\u0015CodeGeneratorResponse\u0012\r\OplusGLSurfaceView_11\u0005error\u0018\u0001 \u0001(\t\u0012B\OplusGLSurfaceView_11\u0004file\u0018\u000f \u0003(\u000b24.google.protobuf.compiler.CodeGeneratorResponse.File\u001a>\OplusGLSurfaceView_11\u0004File\u0012\COUIBaseListPopupWindow_12\OplusGLSurfaceView_11\u0004name\u0018\u0001 \u0001(\t\u0012\u0017\OplusGLSurfaceView_11\u000finsertion_point\u0018\u0002 \u0001(\t\u0012\u000f\OplusGLSurfaceView_11\u0007content\u0018\u000f \u0001(\tBg\OplusGLSurfaceView_11\u001ccom.google.protobuf.compilerB\fPluginProtosZ9github.com/golang/protobuf/protoc-gen-go/plugin;plugin_go"}, new Descriptors.FileDescriptor[]{DescriptorProtos.getDescriptor()});

    /* renamed from: internal_static_google_protobuf_compiler_Version_descriptor */
    private static final Descriptors.Descriptor f9326xb66160f9 = getDescriptor().getMessageTypes().get(0);

    /* renamed from: internal_static_google_protobuf_compiler_Version_fieldAccessorTable */
    private static final GeneratedMessageV3.FieldAccessorTable f9327xc9007e77 = new GeneratedMessageV3.FieldAccessorTable(f9326xb66160f9, new String[]{"Major", "Minor", "Patch", "Suffix"});

    /* renamed from: internal_static_google_protobuf_compiler_CodeGeneratorRequest_descriptor */
    private static final Descriptors.Descriptor f9320x36d642 = getDescriptor().getMessageTypes().get(1);

    /* renamed from: internal_static_google_protobuf_compiler_CodeGeneratorRequest_fieldAccessorTable */
    private static final GeneratedMessageV3.FieldAccessorTable f9321xfc149ac0 = new GeneratedMessageV3.FieldAccessorTable(f9320x36d642, new String[]{"FileToGenerate", "Parameter", "ProtoFile", "CompilerVersion"});

    /* renamed from: internal_static_google_protobuf_compiler_CodeGeneratorResponse_descriptor */
    private static final Descriptors.Descriptor f9324x140ff76a = getDescriptor().getMessageTypes().get(2);

    /* renamed from: internal_static_google_protobuf_compiler_CodeGeneratorResponse_fieldAccessorTable */
    private static final GeneratedMessageV3.FieldAccessorTable f9325x23ee13e8 = new GeneratedMessageV3.FieldAccessorTable(f9324x140ff76a, new String[]{"Error", "File"});

    /* renamed from: internal_static_google_protobuf_compiler_CodeGeneratorResponse_File_descriptor */
    private static final Descriptors.Descriptor f9322xcaba06d7 = f9324x140ff76a.getNestedTypes().get(0);

    /* renamed from: internal_static_google_protobuf_compiler_CodeGeneratorResponse_File_fieldAccessorTable */
    private static final GeneratedMessageV3.FieldAccessorTable f9323xb43c6655 = new GeneratedMessageV3.FieldAccessorTable(f9322xcaba06d7, new String[]{"Name", "InsertionPoint", "Content"});
    ...
    public interface CodeGeneratorRequestOrBuilder extends MessageOrBuilder {
        ...
        String getFileToGenerate(int OplusGLSurfaceView_13);

        ByteString getFileToGenerateBytes(int OplusGLSurfaceView_13);
        ...
        DescriptorProtos.FileDescriptorProto getProtoFile(int OplusGLSurfaceView_13);

        int getProtoFileCount();

        List<DescriptorProtos.FileDescriptorProto> getProtoFileList();

        DescriptorProtos.FileDescriptorProtoOrBuilder getProtoFileOrBuilder(int OplusGLSurfaceView_13);
    ...
    public interface CodeGeneratorResponseOrBuilder extends MessageOrBuilder {
        ...
        CodeGeneratorResponse.File getFile(int OplusGLSurfaceView_13);

        int getFileCount();

        List<CodeGeneratorResponse.File> getFileList();

        CodeGeneratorResponse.FileOrBuilder getFileOrBuilder(int OplusGLSurfaceView_13);
    ...
    public static final class Version extends GeneratedMessageV3 implements VersionOrBuilder {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return PluginProtos.f9326xb66160f9;
        }

        @Override // com.google.protobuf.GeneratedMessageV3
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return PluginProtos.f9327xc9007e77.ensureFieldAccessorsInitialized(Version.class, Builder.class);
        }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements VersionOrBuilder {
            ...
            public Version buildPartial() {
                ...
                version.bitField0_ = OplusGLSurfaceView_13;
                onBuilt();
                return version;
            }
            ...
            */
            ...
            public Builder setMajor(int OplusGLSurfaceView_13) {
                this.bitField0_ |= 1;
                this.major_ = OplusGLSurfaceView_13;
                onChanged();
                return this;
            }
            ...
            public Builder setMinor(int OplusGLSurfaceView_13) {
                this.bitField0_ |= 2;
                this.minor_ = OplusGLSurfaceView_13;
                onChanged();
                return this;
            }
            ...
            public Builder setPatch(int OplusGLSurfaceView_13) {
                this.bitField0_ |= 4;
                this.patch_ = OplusGLSurfaceView_13;
                onChanged();
                return this;
            }
    ...
    public static final class CodeGeneratorRequest extends GeneratedMessageV3 implements CodeGeneratorRequestOrBuilder {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return PluginProtos.f9320x36d642;
        }

        @Override // com.google.protobuf.GeneratedMessageV3
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return PluginProtos.f9321xfc149ac0.ensureFieldAccessorsInitialized(CodeGeneratorRequest.class, Builder.class);
        }
        ...
        @Override // com.google.protobuf.compiler.PluginProtos.CodeGeneratorRequestOrBuilder
        public String getFileToGenerate(int OplusGLSurfaceView_13) {
            return (String) this.fileToGenerate_.get(OplusGLSurfaceView_13);
        }

        @Override // com.google.protobuf.compiler.PluginProtos.CodeGeneratorRequestOrBuilder
        public ByteString getFileToGenerateBytes(int OplusGLSurfaceView_13) {
            return this.fileToGenerate_.getByteString(OplusGLSurfaceView_13);
        }
        ...
        @Override // com.google.protobuf.compiler.PluginProtos.CodeGeneratorRequestOrBuilder
        public DescriptorProtos.FileDescriptorProto getProtoFile(int OplusGLSurfaceView_13) {
            return this.protoFile_.get(OplusGLSurfaceView_13);
        }

        @Override // com.google.protobuf.compiler.PluginProtos.CodeGeneratorRequestOrBuilder
        public DescriptorProtos.FileDescriptorProtoOrBuilder getProtoFileOrBuilder(int OplusGLSurfaceView_13) {
            return this.protoFile_.get(OplusGLSurfaceView_13);
        }
        ...
        public final boolean isInitialized() {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < getProtoFileCount(); OplusGLSurfaceView_13++) {
                if (!getProtoFile(OplusGLSurfaceView_13).isInitialized()) {
        ...
        @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.AbstractMessage, com.google.protobuf.MessageLite
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.fileToGenerate_.size(); OplusGLSurfaceView_13++) {
                GeneratedMessageV3.writeString(codedOutputStream, 1, this.fileToGenerate_.getRaw(OplusGLSurfaceView_13));
            }
            if ((this.bitField0_ & 1) != 0) {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements CodeGeneratorRequestOrBuilder {
            ...
            public CodeGeneratorRequest buildPartial() {
                ...
                int i2 = (OplusGLSurfaceView_13 & 2) != 0 ? 1 : 0;
            ...
            */
            ...
            public Builder setFileToGenerate(int OplusGLSurfaceView_13, String str) {
                if (str == null) {
                    throw new NullPointerException();
                }
                ensureFileToGenerateIsMutable();
                this.fileToGenerate_.set(OplusGLSurfaceView_13, str);
                onChanged();
                return this;
            }
            ...
            public DescriptorProtos.FileDescriptorProto getProtoFile(int OplusGLSurfaceView_13) {
                ...
                return (DescriptorProtos.FileDescriptorProto) repeatedFieldBuilderV3.getMessage(OplusGLSurfaceView_13);
            }

            public Builder setProtoFile(int OplusGLSurfaceView_13, DescriptorProtos.FileDescriptorProto fileDescriptorProto) {
                RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> repeatedFieldBuilderV3 = this.protoFileBuilder_;
                if (repeatedFieldBuilderV3 != null) {
                    repeatedFieldBuilderV3.setMessage(OplusGLSurfaceView_13, fileDescriptorProto);
                } else {
                    if (fileDescriptorProto == null) {
                        throw new NullPointerException();
                    }
                    ensureProtoFileIsMutable();
                    this.protoFile_.set(OplusGLSurfaceView_13, fileDescriptorProto);
                    onChanged();
                }
                return this;
            }

            public Builder setProtoFile(int OplusGLSurfaceView_13, DescriptorProtos.FileDescriptorProto.Builder builder) {
                RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> repeatedFieldBuilderV3 = this.protoFileBuilder_;
                if (repeatedFieldBuilderV3 == null) {
                    ensureProtoFileIsMutable();
                    this.protoFile_.set(OplusGLSurfaceView_13, builder.build());
                    onChanged();
                } else {
            ...
            public Builder addProtoFile(int OplusGLSurfaceView_13, DescriptorProtos.FileDescriptorProto fileDescriptorProto) {
                RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> repeatedFieldBuilderV3 = this.protoFileBuilder_;
                if (repeatedFieldBuilderV3 != null) {
                    repeatedFieldBuilderV3.addMessage(OplusGLSurfaceView_13, fileDescriptorProto);
                } else {
                    if (fileDescriptorProto == null) {
                        throw new NullPointerException();
                    }
                    ensureProtoFileIsMutable();
                    this.protoFile_.add(OplusGLSurfaceView_13, fileDescriptorProto);
                    onChanged();
                }
                return this;
            }
            ...
            public Builder addProtoFile(int OplusGLSurfaceView_13, DescriptorProtos.FileDescriptorProto.Builder builder) {
                RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> repeatedFieldBuilderV3 = this.protoFileBuilder_;
                if (repeatedFieldBuilderV3 == null) {
                    ensureProtoFileIsMutable();
                    this.protoFile_.add(OplusGLSurfaceView_13, builder.build());
                    onChanged();
                } else {
            ...
            public Builder removeProtoFile(int OplusGLSurfaceView_13) {
                RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> repeatedFieldBuilderV3 = this.protoFileBuilder_;
                if (repeatedFieldBuilderV3 == null) {
                    ensureProtoFileIsMutable();
                    this.protoFile_.remove(OplusGLSurfaceView_13);
                    onChanged();
                } else {
            ...
            public DescriptorProtos.FileDescriptorProto.Builder getProtoFileBuilder(int OplusGLSurfaceView_13) {
                return (DescriptorProtos.FileDescriptorProto.Builder) getProtoFileFieldBuilder().getBuilder(OplusGLSurfaceView_13);
            }
            ...
            public DescriptorProtos.FileDescriptorProtoOrBuilder getProtoFileOrBuilder(int OplusGLSurfaceView_13) {
                ...
                return (DescriptorProtos.FileDescriptorProtoOrBuilder) repeatedFieldBuilderV3.getMessageOrBuilder(OplusGLSurfaceView_13);
            }
            ...
            public DescriptorProtos.FileDescriptorProto.Builder addProtoFileBuilder(int OplusGLSurfaceView_13) {
                return (DescriptorProtos.FileDescriptorProto.Builder) getProtoFileFieldBuilder().addBuilder(OplusGLSurfaceView_13, DescriptorProtos.FileDescriptorProto.getDefaultInstance());
            }
    ...
    public static final class CodeGeneratorResponse extends GeneratedMessageV3 implements CodeGeneratorResponseOrBuilder {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return PluginProtos.f9324x140ff76a;
        }

        @Override // com.google.protobuf.GeneratedMessageV3
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return PluginProtos.f9325x23ee13e8.ensureFieldAccessorsInitialized(CodeGeneratorResponse.class, Builder.class);
        }
        ...
        public static final class File extends GeneratedMessageV3 implements FileOrBuilder {
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return PluginProtos.f9322xcaba06d7;
            }

            @Override // com.google.protobuf.GeneratedMessageV3
            protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return PluginProtos.f9323xb43c6655.ensureFieldAccessorsInitialized(File.class, Builder.class);
            }
            ...
            public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FileOrBuilder {
                ...
                public File buildPartial() {
                    ...
                    int OplusGLSurfaceView_13 = this.bitField0_;
                    int i2 = (OplusGLSurfaceView_13 & 1) != 0 ? 1 : 0;
        ...
        @Override // com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponseOrBuilder
        public File getFile(int OplusGLSurfaceView_13) {
            return this.file_.get(OplusGLSurfaceView_13);
        }

        @Override // com.google.protobuf.compiler.PluginProtos.CodeGeneratorResponseOrBuilder
        public FileOrBuilder getFileOrBuilder(int OplusGLSurfaceView_13) {
            return this.file_.get(OplusGLSurfaceView_13);
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.file_.size(); OplusGLSurfaceView_13++) {
                codedOutputStream.writeMessage(15, this.file_.get(OplusGLSurfaceView_13));
            }
            this.unknownFields.writeTo(codedOutputStream);
        }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements CodeGeneratorResponseOrBuilder {
            ...
            public CodeGeneratorResponse buildPartial() {
                ...
                int OplusGLSurfaceView_13 = (this.bitField0_ & 1) == 0 ? 0 : 1;
                ...
                codeGeneratorResponse.bitField0_ = OplusGLSurfaceView_13;
                onBuilt();
            ...
            */
            ...
            public File getFile(int OplusGLSurfaceView_13) {
                ...
                return (File) repeatedFieldBuilderV3.getMessage(OplusGLSurfaceView_13);
            }

            public Builder setFile(int OplusGLSurfaceView_13, File file) {
                RepeatedFieldBuilderV3<File, File.Builder, FileOrBuilder> repeatedFieldBuilderV3 = this.fileBuilder_;
                if (repeatedFieldBuilderV3 != null) {
                    repeatedFieldBuilderV3.setMessage(OplusGLSurfaceView_13, file);
                } else {
                    if (file == null) {
                        throw new NullPointerException();
                    }
                    ensureFileIsMutable();
                    this.file_.set(OplusGLSurfaceView_13, file);
                    onChanged();
                }
                return this;
            }

            public Builder setFile(int OplusGLSurfaceView_13, File.Builder builder) {
                RepeatedFieldBuilderV3<File, File.Builder, FileOrBuilder> repeatedFieldBuilderV3 = this.fileBuilder_;
                if (repeatedFieldBuilderV3 == null) {
                    ensureFileIsMutable();
                    this.file_.set(OplusGLSurfaceView_13, builder.build());
                    onChanged();
                } else {
                    repeatedFieldBuilderV3.setMessage(OplusGLSurfaceView_13, builder.build());
                }
            ...
            public Builder addFile(int OplusGLSurfaceView_13, File file) {
                RepeatedFieldBuilderV3<File, File.Builder, FileOrBuilder> repeatedFieldBuilderV3 = this.fileBuilder_;
                if (repeatedFieldBuilderV3 != null) {
                    repeatedFieldBuilderV3.addMessage(OplusGLSurfaceView_13, file);
                } else {
                    if (file == null) {
                        throw new NullPointerException();
                    }
                    ensureFileIsMutable();
                    this.file_.add(OplusGLSurfaceView_13, file);
                    onChanged();
                }
                return this;
            }
            ...
            public Builder addFile(int OplusGLSurfaceView_13, File.Builder builder) {
                RepeatedFieldBuilderV3<File, File.Builder, FileOrBuilder> repeatedFieldBuilderV3 = this.fileBuilder_;
                if (repeatedFieldBuilderV3 == null) {
                    ensureFileIsMutable();
                    this.file_.add(OplusGLSurfaceView_13, builder.build());
                    onChanged();
                } else {
                    repeatedFieldBuilderV3.addMessage(OplusGLSurfaceView_13, builder.build());
                }
            ...
            public Builder removeFile(int OplusGLSurfaceView_13) {
                RepeatedFieldBuilderV3<File, File.Builder, FileOrBuilder> repeatedFieldBuilderV3 = this.fileBuilder_;
                if (repeatedFieldBuilderV3 == null) {
                    ensureFileIsMutable();
                    this.file_.remove(OplusGLSurfaceView_13);
                    onChanged();
                } else {
                    repeatedFieldBuilderV3.remove(OplusGLSurfaceView_13);
                }
            ...
            public File.Builder getFileBuilder(int OplusGLSurfaceView_13) {
                return (File.Builder) getFileFieldBuilder().getBuilder(OplusGLSurfaceView_13);
            }
            ...
            public FileOrBuilder getFileOrBuilder(int OplusGLSurfaceView_13) {
                ...
                return (FileOrBuilder) repeatedFieldBuilderV3.getMessageOrBuilder(OplusGLSurfaceView_13);
            }
            ...
            public File.Builder addFileBuilder(int OplusGLSurfaceView_13) {
                return (File.Builder) getFileFieldBuilder().addBuilder(OplusGLSurfaceView_13, File.getDefaultInstance());
            }
