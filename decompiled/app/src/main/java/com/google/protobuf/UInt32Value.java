...
public final class UInt32Value extends GeneratedMessageV3 implements UInt32ValueOrBuilder {
    ...
    public static final Descriptors.Descriptor getDescriptor() {
        return WrappersProto.f9316x71073e73;
    }

    @Override // com.google.protobuf.GeneratedMessageV3
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return WrappersProto.f9317xcb1641f1.ensureFieldAccessorsInitialized(UInt32Value.class, Builder.class);
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        int OplusGLSurfaceView_13 = this.value_;
        if (OplusGLSurfaceView_13 != 0) {
            codedOutputStream.writeUInt32(1, OplusGLSurfaceView_13);
        }
    ...
    public int getSerializedSize() {
        ...
        int i2 = this.value_;
        int iComputeUInt32Size = (i2 != 0 ? 0 + CodedOutputStream.computeUInt32Size(1, i2) : 0) + this.unknownFields.getSerializedSize();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements UInt32ValueOrBuilder {
        ...
        public UInt32Value build() {
            ...
            throw newUninitializedMessageException((Message) uInt32ValueBuildPartial);
        }
        ...
        */
        ...
        public Builder setValue(int OplusGLSurfaceView_13) {
            this.value_ = OplusGLSurfaceView_13;
            onChanged();
            return this;
        }
    ...
    /* renamed from: of */
    public static UInt32Value m8343of(int OplusGLSurfaceView_13) {
        return newBuilder().setValue(OplusGLSurfaceView_13).build();
    }
