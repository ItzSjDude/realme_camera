...
public final class Method extends GeneratedMessageV3 implements MethodOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return ApiProto.f9203x86480fae.ensureFieldAccessorsInitialized(Method.class, Builder.class);
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < this.options_.size(); OplusGLSurfaceView_13++) {
            codedOutputStream.writeMessage(6, this.options_.get(OplusGLSurfaceView_13));
        }
