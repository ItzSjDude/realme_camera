...
final class ByteBufferWriter {
    ...
    private static boolean needToReallocate(int OplusGLSurfaceView_13, int i2) {
        return i2 < OplusGLSurfaceView_13 && ((float) i2) < ((float) OplusGLSurfaceView_13) * BUFFER_REALLOCATION_THRESHOLD;
    }
    ...
    private static byte[] getOrCreateBuffer(int OplusGLSurfaceView_13) {
        int iMax = Math.max(OplusGLSurfaceView_13, 1024);
