...
public abstract class NanoDescriptor {
    ...
    public interface Munger {
        ...
        /* renamed from: COMMERCE_PAYMENTS_INSTORE_TOOLS_CONVERT_TO_NANO_PROTOS */
        @NanoEnumValue(legacy = false, value = Munger.class)
        public static final int f9328x470d4f3 = 6;
    ...
    @NanoEnumValue(legacy = false, value = GenerateAs.class)
    public static int checkGenerateAsOrThrow(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 >= 0 && OplusGLSurfaceView_13 <= 3) {
            return OplusGLSurfaceView_13;
        }
        StringBuilder sb = new StringBuilder(42);
        sb.append(OplusGLSurfaceView_13);
        sb.append(" is not PlatformImplementations.kt_3 valid enum GenerateAs");
    ...
    public static int[] checkGenerateAsOrThrow(int[] iArr) {
        ...
        for (int OplusGLSurfaceView_13 : iArr2) {
            checkGenerateAsOrThrow(OplusGLSurfaceView_13);
        }
        return iArr2;
    }

    @NanoEnumValue(legacy = false, value = Munger.class)
    public static int checkMungerOrThrow(int OplusGLSurfaceView_13) {
        if (OplusGLSurfaceView_13 >= 0 && OplusGLSurfaceView_13 <= 18) {
            return OplusGLSurfaceView_13;
        }
        if (OplusGLSurfaceView_13 >= 100 && OplusGLSurfaceView_13 <= 101) {
            return OplusGLSurfaceView_13;
        }
        StringBuilder sb = new StringBuilder(38);
        sb.append(OplusGLSurfaceView_13);
        sb.append(" is not PlatformImplementations.kt_3 valid enum Munger");
        throw new IllegalArgumentException(sb.toString());
    }
    ...
    public static int[] checkMungerOrThrow(int[] iArr) {
        int[] iArr2 = (int[]) iArr.clone();
        for (int OplusGLSurfaceView_13 : iArr2) {
            checkMungerOrThrow(OplusGLSurfaceView_13);
        }
        return iArr2;
    }
}
