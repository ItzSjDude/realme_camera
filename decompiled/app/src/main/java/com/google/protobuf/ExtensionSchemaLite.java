...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    <UT, UB> UB parseExtension(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<GeneratedMessageLite.ExtensionDescriptor> fieldSet, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            switch (C20401.f9273xbcb373fd[generatedExtension.getLiteType().ordinal()]) {
                case 1:
            ...
            if (generatedExtension.isRepeated()) {
                ...
                int OplusGLSurfaceView_13 = C20401.f9273xbcb373fd[generatedExtension.getLiteType().ordinal()];
                if ((OplusGLSurfaceView_13 == 17 || OplusGLSurfaceView_13 == 18) && (field = fieldSet.getField(generatedExtension.descriptor)) != null) {
    ...
    static /* synthetic */ class C20401 {
        ...
        static final /* synthetic */ int[] f9273xbcb373fd = new int[WireFormat.FieldType.values().length];

        static {
            try {
                f9273xbcb373fd[WireFormat.FieldType.DOUBLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.FLOAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.INT64.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.UINT64.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.INT32.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.FIXED64.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.FIXED32.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.BOOL.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.UINT32.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.SFIXED32.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.SFIXED64.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.SINT32.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.SINT64.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.ENUM.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.BYTES.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.STRING.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.GROUP.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f9273xbcb373fd[WireFormat.FieldType.MESSAGE.ordinal()] = 18;
    ...
    void serializeExtension(Writer writer, Map.Entry<?, ?> entry) throws IOException {
        ...
        if (extensionDescriptor.isRepeated()) {
            switch (C20401.f9273xbcb373fd[extensionDescriptor.getLiteType().ordinal()]) {
                case 1:
    ...
    Object findExtensionByNumber(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int OplusGLSurfaceView_13) {
        return extensionRegistryLite.findLiteExtensionByNumber(messageLite, OplusGLSurfaceView_13);
    }
