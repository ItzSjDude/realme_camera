...
class MapFieldSchemaLite implements MapFieldSchema {
    ...
    public int getSerializedSize(int OplusGLSurfaceView_13, Object obj, Object obj2) {
        return getSerializedSizeLite(OplusGLSurfaceView_13, obj, obj2);
    }

    private static <K, V> int getSerializedSizeLite(int OplusGLSurfaceView_13, Object obj, Object obj2) {
        ...
        for (Map.Entry<K, V> entry : mapFieldLite.entrySet()) {
            iComputeMessageSize += mapEntryLite.computeMessageSize(OplusGLSurfaceView_13, entry.getKey(), entry.getValue());
        }
