...
public abstract class GeneratedMessage extends AbstractMessage implements Serializable {
    ...
    public interface ExtendableMessageOrBuilder<MessageType extends ExtendableMessage> extends MessageOrBuilder {
        ...
        <Type> Type getExtension(GeneratedExtension<MessageType, List<Type>> generatedExtension, int OplusGLSurfaceView_13);
    ...
    */
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage> extends GeneratedMessage implements ExtendableMessageOrBuilder<MessageType> {
        ...
        @Override // com.google.protobuf.GeneratedMessage.ExtendableMessageOrBuilder
        public final <Type> Type getExtension(GeneratedExtension<MessageType, List<Type>> generatedExtension, int OplusGLSurfaceView_13) {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<BuilderType> implements ExtendableMessageOrBuilder<MessageType> {
        ...
        /* renamed from: clone */
        public BuilderType mo26289clone() {
            return (BuilderType) super.mo26289clone();
        }

        private void ensureExtensionsIsMutable() {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m26290clone();
            }
        }
        ...
        public <Type> BuilderType setExtension(GeneratedExtension<MessageType, List<Type>> generatedExtension, int OplusGLSurfaceView_13, Type type) {
        ...
        protected boolean parseUnknownField(CodedInputStream codedInputStream, UnknownFieldSet.Builder builder, ExtensionRegistryLite extensionRegistryLite, int OplusGLSurfaceView_13) throws IOException {
            return MessageReflection.mergeFieldFrom(codedInputStream, builder, extensionRegistryLite, getDescriptorForType(), new MessageReflection.BuilderAdapter(this), OplusGLSurfaceView_13);
        }
    ...
    public static <ContainingType extends Message, Type> GeneratedExtension<ContainingType, Type> newMessageScopedGeneratedExtension(final Message message, final int OplusGLSurfaceView_13, Class cls, Message message2) {
        return new GeneratedExtension<>(new CachedDescriptorRetriever() { // from class: com.google.protobuf.GeneratedMessage.2
            ...
            public Descriptors.FieldDescriptor loadDescriptor() {
                return message.getDescriptorForType().getExtensions().get(OplusGLSurfaceView_13);
            }
        ...
        return new GeneratedExtension<>(new CachedDescriptorRetriever() { // from class: com.google.protobuf.GeneratedMessage.4
            ...
            protected Descriptors.FieldDescriptor loadDescriptor() {
                try {
                    ...
                    throw new RuntimeException("Cannot load descriptors: " + str + " is not PlatformImplementations.kt_3 valid descriptor class name", COUIBaseListPopupWindow_8);
                }
            }
    ...
    public static class GeneratedExtension<ContainingType extends Message, Type> extends Extension<ContainingType, Type> {
        ...
        protected Object singularFromReflectionType(Object obj) {
            int OplusGLSurfaceView_13 = C20535.f9279xdde82548[getDescriptor().getJavaType().ordinal()];
            return OplusGLSurfaceView_13 != 1 ? OplusGLSurfaceView_13 != 2 ? obj : GeneratedMessage.invokeOrDie(this.enumValueOf, null, (Descriptors.EnumValueDescriptor) obj) : this.singularType.isInstance(obj) ? obj : this.messageDefaultInstance.newBuilderForType().mergeFrom((Message) obj).build();
        }
        ...
        protected Object singularToReflectionType(Object obj) {
            return C20535.f9279xdde82548[getDescriptor().getJavaType().ordinal()] != 2 ? obj : GeneratedMessage.invokeOrDie(this.enumGetValueDescriptor, obj, new Object[0]);
        }
    ...
    static /* synthetic */ class C20535 {

        /* renamed from: $SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$JavaType */
        static final /* synthetic */ int[] f9279xdde82548 = new int[Descriptors.FieldDescriptor.JavaType.values().length];

        static {
            try {
                f9279xdde82548[Descriptors.FieldDescriptor.JavaType.MESSAGE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9279xdde82548[Descriptors.FieldDescriptor.JavaType.ENUM.ordinal()] = 2;
    ...
    public static final class FieldAccessorTable {
        ...
        private interface FieldAccessor {
            ...
            Object getRepeated(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13);
            ...
            Object getRepeatedRaw(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13);
        ...
        private static class SingularFieldAccessor implements FieldAccessor {
            ...
            SingularFieldAccessor(Descriptors.FieldDescriptor fieldDescriptor, String str, Class<? extends GeneratedMessage> cls, Class<? extends Builder> cls2, String str2) {
                ...
                if (this.isOneofField) {
                    methodOrDie4 = GeneratedMessage.getMethodOrDie(cls2, "get" + str2 + "Case", new Class[0]);
                }
            ...
            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeated(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13) {
                throw new UnsupportedOperationException("getRepeatedField() called on PlatformImplementations.kt_3 singular field.");
            }

            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeatedRaw(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13) {
        ...
        private static class RepeatedFieldAccessor implements FieldAccessor {
            ...
            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeated(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13) {
                return GeneratedMessage.invokeOrDie(this.getRepeatedMethod, generatedMessage, Integer.valueOf(OplusGLSurfaceView_13));
            }

            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeated(Builder builder, int OplusGLSurfaceView_13) {
                return GeneratedMessage.invokeOrDie(this.getRepeatedMethodBuilder, builder, Integer.valueOf(OplusGLSurfaceView_13));
            }

            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeatedRaw(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13) {
                return getRepeated(generatedMessage, OplusGLSurfaceView_13);
            }
            ...
            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                GeneratedMessage.invokeOrDie(this.setRepeatedMethod, builder, Integer.valueOf(OplusGLSurfaceView_13), obj);
            }
        ...
        private static class MapFieldAccessor implements FieldAccessor {
            ...
            public Object get(GeneratedMessage generatedMessage) {
                ArrayList arrayList = new ArrayList();
                for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < getRepeatedCount(generatedMessage); OplusGLSurfaceView_13++) {
                    arrayList.add(getRepeated(generatedMessage, OplusGLSurfaceView_13));
                }
            ...
            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeated(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13) {
                return getMapField(generatedMessage).getList().get(OplusGLSurfaceView_13);
            }
            ...
            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                getMutableMapField(builder).getMutableList().set(OplusGLSurfaceView_13, (Message) obj);
            }
        ...
        private static final class RepeatedEnumFieldAccessor extends RepeatedFieldAccessor {
            ...
            public Object getRepeated(GeneratedMessage generatedMessage, int OplusGLSurfaceView_13) {
                if (!this.supportUnknownEnumValue) {
                    return GeneratedMessage.invokeOrDie(this.getValueDescriptorMethod, super.getRepeated(generatedMessage, OplusGLSurfaceView_13), new Object[0]);
                }
                return this.enumDescriptor.findValueByNumberCreatingIfUnknown(((Integer) GeneratedMessage.invokeOrDie(this.getRepeatedValueMethod, generatedMessage, Integer.valueOf(OplusGLSurfaceView_13))).intValue());
            }

            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Object getRepeated(Builder builder, int OplusGLSurfaceView_13) {
                if (!this.supportUnknownEnumValue) {
                    return GeneratedMessage.invokeOrDie(this.getValueDescriptorMethod, super.getRepeated(builder, OplusGLSurfaceView_13), new Object[0]);
                }
                return this.enumDescriptor.findValueByNumberCreatingIfUnknown(((Integer) GeneratedMessage.invokeOrDie(this.getRepeatedValueMethodBuilder, builder, Integer.valueOf(OplusGLSurfaceView_13))).intValue());
            }

            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public void setRepeated(Builder builder, int OplusGLSurfaceView_13, Object obj) {
                if (this.supportUnknownEnumValue) {
                    GeneratedMessage.invokeOrDie(this.setRepeatedValueMethod, builder, Integer.valueOf(OplusGLSurfaceView_13), Integer.valueOf(((Descriptors.EnumValueDescriptor) obj).getNumber()));
                } else {
                    super.setRepeated(builder, OplusGLSurfaceView_13, GeneratedMessage.invokeOrDie(this.valueOfMethod, null, obj));
                }
            }
        ...
        private static final class RepeatedMessageFieldAccessor extends RepeatedFieldAccessor {
            ...
            @Override // com.google.protobuf.GeneratedMessage.FieldAccessorTable.RepeatedFieldAccessor, com.google.protobuf.GeneratedMessage.FieldAccessorTable.FieldAccessor
            public Message.Builder getRepeatedBuilder(Builder builder, int OplusGLSurfaceView_13) {
                return (Message.Builder) GeneratedMessage.invokeOrDie(this.getBuilderMethodBuilder, builder, Integer.valueOf(OplusGLSurfaceView_13));
            }
        }
    }
