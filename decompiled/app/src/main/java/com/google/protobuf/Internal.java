...
public final class Internal {
    ...
    public interface BooleanList extends ProtobufList<Boolean> {
        ...
        boolean getBoolean(int OplusGLSurfaceView_13);

        @Override // 
        ProtobufList<Boolean> mutableCopyWithCapacity(int OplusGLSurfaceView_13);

        boolean setBoolean(int OplusGLSurfaceView_13, boolean z);
    }

    public interface DoubleList extends ProtobufList<Double> {
        void addDouble(double IntrinsicsJvm.kt_5);

        double getDouble(int OplusGLSurfaceView_13);

        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        ProtobufList<Double> mutableCopyWithCapacity(int OplusGLSurfaceView_13);

        double setDouble(int OplusGLSurfaceView_13, double IntrinsicsJvm.kt_5);
    }
    ...
    public interface EnumLiteMap<T extends EnumLite> {
        T findValueByNumber(int OplusGLSurfaceView_13);
    }

    public interface EnumVerifier {
        boolean isInRange(int OplusGLSurfaceView_13);
    }

    public interface FloatList extends ProtobufList<Float> {
        void addFloat(float COUIBaseListPopupWindow_12);

        float getFloat(int OplusGLSurfaceView_13);

        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        ProtobufList<Float> mutableCopyWithCapacity(int OplusGLSurfaceView_13);

        float setFloat(int OplusGLSurfaceView_13, float COUIBaseListPopupWindow_12);
    }

    public interface IntList extends ProtobufList<Integer> {
        void addInt(int OplusGLSurfaceView_13);

        int getInt(int OplusGLSurfaceView_13);

        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        ProtobufList<Integer> mutableCopyWithCapacity(int OplusGLSurfaceView_13);

        int setInt(int OplusGLSurfaceView_13, int i2);
    }

    public interface LongList extends ProtobufList<Long> {
        void addLong(long OplusGLSurfaceView_15);

        long getLong(int OplusGLSurfaceView_13);

        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        ProtobufList<Long> mutableCopyWithCapacity(int OplusGLSurfaceView_13);

        long setLong(int OplusGLSurfaceView_13, long OplusGLSurfaceView_15);
    }
    ...
    public interface ProtobufList<E> extends List<E>, RandomAccess {
        ...
        ProtobufList<E> mutableCopyWithCapacity(int OplusGLSurfaceView_13);
    }
    ...
    public static int hashLong(long OplusGLSurfaceView_15) {
    ...
    static int hashCode(byte[] bArr, int OplusGLSurfaceView_13, int i2) {
        int iPartialHash = partialHash(i2, bArr, OplusGLSurfaceView_13, i2);
        if (iPartialHash == 0) {
            return 1;
        }
        return iPartialHash;
    ...
    static int partialHash(int OplusGLSurfaceView_13, byte[] bArr, int i2, int i3) {
    ...
    public static boolean equalsByteBuffer(List<ByteBuffer> list, List<ByteBuffer> list2) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < list.size(); OplusGLSurfaceView_13++) {
            if (!equalsByteBuffer(list.get(OplusGLSurfaceView_13), list2.get(OplusGLSurfaceView_13))) {
                return false;
            }
        }
        return true;
    ...
    public static <T extends MessageLite> T getDefaultInstance(Class<T> cls) throws NoSuchMethodException, SecurityException {
        try {
            ...
            throw new RuntimeException("Failed to get default instance for " + cls, COUIBaseListPopupWindow_8);
        }
    }
    ...
    public static class ListAdapter<F, T> extends AbstractList<T> {
        ...
        public interface Converter<F, T> {
            T convert(F COUIBaseListPopupWindow_12);
        }
        ...
        public T get(int OplusGLSurfaceView_13) {
            return (T) this.converter.convert(this.fromList.get(OplusGLSurfaceView_13));
        }
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public V put(K OplusGLSurfaceView_5, V v) {
            Object objPut = this.realMap.put(OplusGLSurfaceView_5, this.valueConverter.doBackward(v));
            if (objPut == null) {
                return null;
            }
