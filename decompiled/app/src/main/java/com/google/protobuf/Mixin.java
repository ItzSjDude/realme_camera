...
public final class Mixin extends GeneratedMessageV3 implements MixinOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return ApiProto.f9204xf56da668.ensureFieldAccessorsInitialized(Mixin.class, Builder.class);
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements MixinOrBuilder {
        ...
        */
        ...
        public Builder setRootBytes(ByteString byteString) throws IllegalArgumentException {
            if (byteString == null) {
                throw new NullPointerException();
            }
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
