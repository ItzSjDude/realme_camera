...
public final class Descriptors {
    ...
    public static final class FileDescriptor extends GenericDescriptor {
        ...
        private static FileDescriptor[] findDescriptors(Class<?> cls, String[] strArr, String[] strArr2) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < strArr.length; OplusGLSurfaceView_13++) {
                try {
                    arrayList.add((FileDescriptor) cls.getClassLoader().loadClass(strArr[OplusGLSurfaceView_13]).getField("descriptor").get(null));
                } catch (Exception unused) {
                    Descriptors.logger.warning("Descriptors for \"" + strArr2[OplusGLSurfaceView_13] + "\" can not be found.");
                }
            }
                ...
                try {
                    ...
                    if (extensionRegistryAssignDescriptors != null) {
                        try {
                            ...
                            throw new IllegalArgumentException("Failed to parse protocol buffer descriptor for generated code.", COUIBaseListPopupWindow_8);
                        }
                    }
        ...
        public static FileDescriptor internalBuildGeneratedFileFrom(String[] strArr, FileDescriptor[] fileDescriptorArr) {
            try {
                ...
                } catch (DescriptorValidationException COUIBaseListPopupWindow_8) {
                    throw new IllegalArgumentException("Invalid embedded descriptor for \"" + from.getName() + "\".", COUIBaseListPopupWindow_8);
                }
        ...
        private FileDescriptor(DescriptorProtos.FileDescriptorProto fileDescriptorProto, FileDescriptor[] fileDescriptorArr, DescriptorPool descriptorPool, boolean z) throws DescriptorValidationException {
            ...
            ArrayList arrayList = new ArrayList();
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < fileDescriptorProto.getPublicDependencyCount(); OplusGLSurfaceView_13++) {
                int publicDependency = fileDescriptorProto.getPublicDependency(OplusGLSurfaceView_13);
                if (publicDependency < 0 || publicDependency >= fileDescriptorProto.getDependencyCount()) {
                    throw new DescriptorValidationException(this, "Invalid public dependency index.", c20301);
                }
                ...
                if (fileDescriptor2 != null) {
                    ...
                    throw new DescriptorValidationException(this, "Invalid public dependency: " + dependency, c20301);
                }
            }
            ...
            for (int i4 = 0; i4 < fileDescriptorProto.getServiceCount(); i4++) {
                this.services[i4] = new ServiceDescriptor(fileDescriptorProto.getService(i4), this, i4, c20301);
            }
        ...
        private void setProto(DescriptorProtos.FileDescriptorProto fileDescriptorProto) {
            ...
            while (true) {
                ...
                if (OplusGLSurfaceView_13 >= fieldDescriptorArr.length) {
                    return;
                }
                fieldDescriptorArr[OplusGLSurfaceView_13].setProto(fileDescriptorProto.getExtension(OplusGLSurfaceView_13));
    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        /* synthetic */ Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13, C20301 c20301) throws DescriptorValidationException {
            this(descriptorProto, fileDescriptor, descriptor, OplusGLSurfaceView_13);
        }
        ...
        public boolean isExtensionNumber(int OplusGLSurfaceView_13) {
            for (DescriptorProtos.DescriptorProto.ExtensionRange extensionRange : this.proto.getExtensionRangeList()) {
                if (extensionRange.getStart() <= OplusGLSurfaceView_13 && OplusGLSurfaceView_13 < extensionRange.getEnd()) {
                    return true;
                }
            }
            return false;
        ...
        public boolean isReservedNumber(int OplusGLSurfaceView_13) {
            for (DescriptorProtos.DescriptorProto.ReservedRange reservedRange : this.proto.getReservedRangeList()) {
                if (reservedRange.getStart() <= OplusGLSurfaceView_13 && OplusGLSurfaceView_13 < reservedRange.getEnd()) {
                    return true;
                }
            }
            return false;
        ...
        public FieldDescriptor findFieldByNumber(int OplusGLSurfaceView_13) {
            return (FieldDescriptor) this.file.pool.fieldsByNumber.get(new DescriptorPool.DescriptorIntPair(this, OplusGLSurfaceView_13));
        }
        ...
        private Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13) throws DescriptorValidationException {
            super(null);
        ...
        public void setProto(DescriptorProtos.DescriptorProto descriptorProto) {
            ...
            while (true) {
                ...
                if (OplusGLSurfaceView_13 >= fieldDescriptorArr2.length) {
                    return;
                }
                fieldDescriptorArr2[OplusGLSurfaceView_13].setProto(descriptorProto.getExtension(OplusGLSurfaceView_13));
                OplusGLSurfaceView_13++;
            }
        }
    }
    ...
    public static final class FieldDescriptor extends GenericDescriptor implements FieldSet.FieldDescriptorLite<FieldDescriptor>, Comparable<FieldDescriptor> {
        ...
        /* synthetic */ FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13, boolean z, C20301 c20301) throws DescriptorValidationException {
            this(fieldDescriptorProto, fileDescriptor, descriptor, OplusGLSurfaceView_13, z);
        }
        ...
        static {
            if (Type.values().length != DescriptorProtos.FieldDescriptorProto.Type.values().length) {
                throw new RuntimeException("descriptor.proto has PlatformImplementations.kt_3 new declared type but Descriptors.java wasn't updated.");
            }
        }
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < length; OplusGLSurfaceView_13++) {
                ...
                if (cCharAt == '_') {
                    ...
                    if ('PlatformImplementations.kt_3' <= cCharAt && cCharAt <= 'z') {
                        cCharAt = (char) ((cCharAt - 'PlatformImplementations.kt_3') + 65);
                    }
                    sb.append(cCharAt);
                    z = false;
                } else {
        ...
        /* JADX WARN: Illegal instructions before constructor call */
        private FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13, boolean z) throws DescriptorValidationException {
            C20301 c20301 = null;
            super(c20301);
            this.index = OplusGLSurfaceView_13;
            ...
            if (getNumber() > 0) {
                if (z) {
                    if (!fieldDescriptorProto.hasExtendee()) {
                        throw new DescriptorValidationException(this, "FieldDescriptorProto.extendee not set for extension field.", c20301);
                    }
                    this.containingType = null;
                    if (descriptor != null) {
                    ...
                    if (fieldDescriptorProto.hasOneofIndex()) {
                        throw new DescriptorValidationException(this, "FieldDescriptorProto.oneof_index set for extension field.", c20301);
                    }
                    this.containingOneof = null;
                } else {
                    if (fieldDescriptorProto.hasExtendee()) {
                        throw new DescriptorValidationException(this, "FieldDescriptorProto.extendee set for non-extension field.", c20301);
                    }
                    this.containingType = descriptor;
                    if (fieldDescriptorProto.hasOneofIndex()) {
                        if (fieldDescriptorProto.getOneofIndex() < 0 || fieldDescriptorProto.getOneofIndex() >= descriptor.toProto().getOneofDeclCount()) {
                            throw new DescriptorValidationException(this, "FieldDescriptorProto.oneof_index is out of range for type " + descriptor.getName(), c20301);
                        }
            ...
            throw new DescriptorValidationException(this, "Field numbers must be positive integers.", c20301);
        }
        ...
        public void crossLink() throws DescriptorValidationException {
            ...
            if (this.proto.hasExtendee()) {
                ...
                if (!(genericDescriptorLookupSymbol instanceof Descriptor)) {
                    throw new DescriptorValidationException(this, '\"' + this.proto.getExtendee() + "\" is not PlatformImplementations.kt_3 message type.", c20301);
                }
                this.containingType = (Descriptor) genericDescriptorLookupSymbol;
                if (!getContainingType().isExtensionNumber(getNumber())) {
                    throw new DescriptorValidationException(this, '\"' + getContainingType().getFullName() + "\" does not declare " + getNumber() + " as an extension number.", c20301);
                }
            }
            if (this.proto.hasTypeName()) {
                ...
                if (!this.proto.hasType()) {
                    if (genericDescriptorLookupSymbol2 instanceof Descriptor) {
                        ...
                        throw new DescriptorValidationException(this, '\"' + this.proto.getTypeName() + "\" is not PlatformImplementations.kt_3 type.", c20301);
                    }
                }
                if (getJavaType() == JavaType.MESSAGE) {
                    if (!(genericDescriptorLookupSymbol2 instanceof Descriptor)) {
                        throw new DescriptorValidationException(this, '\"' + this.proto.getTypeName() + "\" is not PlatformImplementations.kt_3 message type.", c20301);
                    }
                    this.messageType = (Descriptor) genericDescriptorLookupSymbol2;
                    if (this.proto.hasDefaultValue()) {
                        throw new DescriptorValidationException(this, "Messages can't have default values.", c20301);
                    }
                } else if (getJavaType() == JavaType.ENUM) {
                    if (!(genericDescriptorLookupSymbol2 instanceof EnumDescriptor)) {
                        throw new DescriptorValidationException(this, '\"' + this.proto.getTypeName() + "\" is not an enum type.", c20301);
                    }
                    this.enumType = (EnumDescriptor) genericDescriptorLookupSymbol2;
                } else {
                    throw new DescriptorValidationException(this, "Field with primitive type has type_name.", c20301);
                }
            } else if (getJavaType() == JavaType.MESSAGE || getJavaType() == JavaType.ENUM) {
                throw new DescriptorValidationException(this, "Field with message or enum type missing type_name.", c20301);
            }
            if (this.proto.getOptions().getPacked() && !isPackable()) {
                throw new DescriptorValidationException(this, "[packed = true] can only be specified for repeated primitive fields.", c20301);
            }
            if (this.proto.hasDefaultValue()) {
                if (isRepeated()) {
                    throw new DescriptorValidationException(this, "Repeated fields cannot have default values.", c20301);
                }
                try {
                    switch (getType()) {
                        case INT32:
                        ...
                        case BYTES:
                            try {
                                ...
                                break;
                            } catch (TextFormat.InvalidEscapeSequenceException COUIBaseListPopupWindow_8) {
                                throw new DescriptorValidationException(this, "Couldn't parse default value: " + COUIBaseListPopupWindow_8.getMessage(), COUIBaseListPopupWindow_8, c20301);
                            }
                        case ENUM:
                            this.defaultValue = this.enumType.findValueByName(this.proto.getDefaultValue());
                            if (this.defaultValue == null) {
                                throw new DescriptorValidationException(this, "Unknown enum default value: \"" + this.proto.getDefaultValue() + '\"', c20301);
                            }
                            break;
                        case MESSAGE:
                        case GROUP:
                            throw new DescriptorValidationException(this, "Message type had default value.", c20301);
                    }
                } catch (NumberFormatException e2) {
                    throw new DescriptorValidationException(this, "Could not parse default value: \"" + this.proto.getDefaultValue() + '\"', e2, c20301);
                }
            } else if (isRepeated()) {
                this.defaultValue = Collections.emptyList();
            } else {
                int OplusGLSurfaceView_13 = C20301.f9266xdde82548[getJavaType().ordinal()];
            ...
            if (isExtension()) {
                if (!isOptional() || getType() != Type.MESSAGE) {
                    throw new DescriptorValidationException(this, "Extensions of MessageSets must be optional messages.", c20301);
                }
                return;
            }
            throw new DescriptorValidationException(this, "MessageSets cannot have fields, only extensions.", c20301);
        }
    ...
    static /* synthetic */ class C20301 {
        ...
        static final /* synthetic */ int[] f9266xdde82548 = new int[FieldDescriptor.JavaType.values().length];

        static {
            try {
                f9266xdde82548[FieldDescriptor.JavaType.ENUM.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f9266xdde82548[FieldDescriptor.JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            f9267x6f0f2e06 = new int[FieldDescriptor.Type.values().length];
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.INT32.ordinal()] = 1;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.SINT32.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.SFIXED32.ordinal()] = 3;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.UINT32.ordinal()] = 4;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.FIXED32.ordinal()] = 5;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.INT64.ordinal()] = 6;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.SINT64.ordinal()] = 7;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.SFIXED64.ordinal()] = 8;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.UINT64.ordinal()] = 9;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.FIXED64.ordinal()] = 10;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.FLOAT.ordinal()] = 11;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.DOUBLE.ordinal()] = 12;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.BOOL.ordinal()] = 13;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.STRING.ordinal()] = 14;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.BYTES.ordinal()] = 15;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.ENUM.ordinal()] = 16;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.MESSAGE.ordinal()] = 17;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f9267x6f0f2e06[FieldDescriptor.Type.GROUP.ordinal()] = 18;
    ...
    public static final class EnumDescriptor extends GenericDescriptor implements Internal.EnumLiteMap<EnumValueDescriptor> {
        ...
        /* synthetic */ EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13, C20301 c20301) throws DescriptorValidationException {
            this(enumDescriptorProto, fileDescriptor, descriptor, OplusGLSurfaceView_13);
        }
        ...
        public EnumValueDescriptor findValueByNumber(int OplusGLSurfaceView_13) {
            return (EnumValueDescriptor) this.file.pool.enumValuesByNumber.get(new DescriptorPool.DescriptorIntPair(this, OplusGLSurfaceView_13));
        }

        public EnumValueDescriptor findValueByNumberCreatingIfUnknown(int OplusGLSurfaceView_13) {
            EnumValueDescriptor enumValueDescriptorFindValueByNumber = findValueByNumber(OplusGLSurfaceView_13);
            if (enumValueDescriptorFindValueByNumber != null) {
                return enumValueDescriptorFindValueByNumber;
            }
            synchronized (this) {
                Integer num = new Integer(OplusGLSurfaceView_13);
                ...
                if (enumValueDescriptorFindValueByNumber == null) {
                    enumValueDescriptorFindValueByNumber = new EnumValueDescriptor(this.file, this, num, (C20301) null);
        ...
        /* JADX WARN: Illegal instructions before constructor call */
        private EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13) throws DescriptorValidationException {
            C20301 c20301 = null;
            super(c20301);
            ...
            if (enumDescriptorProto.getValueCount() == 0) {
                throw new DescriptorValidationException(this, "Enums must contain at least one value.", c20301);
            }
        ...
        public void setProto(DescriptorProtos.EnumDescriptorProto enumDescriptorProto) {
            ...
            while (true) {
                ...
                if (OplusGLSurfaceView_13 >= enumValueDescriptorArr.length) {
                    return;
                }
                enumValueDescriptorArr[OplusGLSurfaceView_13].setProto(enumDescriptorProto.getValue(OplusGLSurfaceView_13));
                OplusGLSurfaceView_13++;
            }
        }
    }
    ...
    public static final class EnumValueDescriptor extends GenericDescriptor implements Internal.EnumLite {
        ...
        /* synthetic */ EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto enumValueDescriptorProto, FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, int OplusGLSurfaceView_13, C20301 c20301) throws DescriptorValidationException {
            this(enumValueDescriptorProto, fileDescriptor, enumDescriptor, OplusGLSurfaceView_13);
        }

        /* synthetic */ EnumValueDescriptor(FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, Integer num, C20301 c20301) {
        ...
        private EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto enumValueDescriptorProto, FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, int OplusGLSurfaceView_13) throws DescriptorValidationException {
            super(null);
            this.index = OplusGLSurfaceView_13;
    ...
    public static final class ServiceDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int OplusGLSurfaceView_13, C20301 c20301) throws DescriptorValidationException {
            this(serviceDescriptorProto, fileDescriptor, OplusGLSurfaceView_13);
        }
        ...
        private ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int OplusGLSurfaceView_13) throws DescriptorValidationException {
            super(null);
            this.index = OplusGLSurfaceView_13;
        ...
        public void setProto(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto) {
            ...
            while (true) {
                ...
                if (OplusGLSurfaceView_13 >= methodDescriptorArr.length) {
                    return;
                }
                methodDescriptorArr[OplusGLSurfaceView_13].setProto(serviceDescriptorProto.getMethod(OplusGLSurfaceView_13));
                OplusGLSurfaceView_13++;
            }
        }
    }
    ...
    public static final class MethodDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ MethodDescriptor(DescriptorProtos.MethodDescriptorProto methodDescriptorProto, FileDescriptor fileDescriptor, ServiceDescriptor serviceDescriptor, int OplusGLSurfaceView_13, C20301 c20301) throws DescriptorValidationException {
            this(methodDescriptorProto, fileDescriptor, serviceDescriptor, OplusGLSurfaceView_13);
        }
        ...
        private MethodDescriptor(DescriptorProtos.MethodDescriptorProto methodDescriptorProto, FileDescriptor fileDescriptor, ServiceDescriptor serviceDescriptor, int OplusGLSurfaceView_13) throws DescriptorValidationException {
            super(null);
            this.index = OplusGLSurfaceView_13;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void crossLink() throws DescriptorValidationException {
            GenericDescriptor genericDescriptorLookupSymbol = this.file.pool.lookupSymbol(this.proto.getInputType(), this, DescriptorPool.SearchFilter.TYPES_ONLY);
            C20301 c20301 = null;
            if (!(genericDescriptorLookupSymbol instanceof Descriptor)) {
                throw new DescriptorValidationException(this, '\"' + this.proto.getInputType() + "\" is not PlatformImplementations.kt_3 message type.", c20301);
            }
            this.inputType = (Descriptor) genericDescriptorLookupSymbol;
            GenericDescriptor genericDescriptorLookupSymbol2 = this.file.pool.lookupSymbol(this.proto.getOutputType(), this, DescriptorPool.SearchFilter.TYPES_ONLY);
            if (!(genericDescriptorLookupSymbol2 instanceof Descriptor)) {
                throw new DescriptorValidationException(this, '\"' + this.proto.getOutputType() + "\" is not PlatformImplementations.kt_3 message type.", c20301);
            }
    ...
    public static abstract class GenericDescriptor {
        ...
        /* synthetic */ GenericDescriptor(C20301 c20301) {
            this();
        }
    ...
    public static class DescriptorValidationException extends Exception {
        ...
        /* synthetic */ DescriptorValidationException(FileDescriptor fileDescriptor, String str, C20301 c20301) {
            this(fileDescriptor, str);
        }

        /* synthetic */ DescriptorValidationException(GenericDescriptor genericDescriptor, String str, C20301 c20301) {
            this(genericDescriptor, str);
        }

        /* synthetic */ DescriptorValidationException(GenericDescriptor genericDescriptor, String str, Throwable th, C20301 c20301) {
    ...
    private static final class DescriptorPool {
        ...
        DescriptorPool(FileDescriptor[] fileDescriptorArr, boolean z) {
            ...
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < fileDescriptorArr.length; OplusGLSurfaceView_13++) {
                this.dependencies.add(fileDescriptorArr[OplusGLSurfaceView_13]);
                importPublicDependencies(fileDescriptorArr[OplusGLSurfaceView_13]);
            }
        ...
        GenericDescriptor lookupSymbol(String str, GenericDescriptor genericDescriptor, SearchFilter searchFilter) throws DescriptorValidationException {
            ...
            if (str.startsWith(".")) {
                ...
                while (true) {
                    ...
                    int OplusGLSurfaceView_13 = iLastIndexOf + 1;
                    sb.setLength(OplusGLSurfaceView_13);
            ...
            if (this.allowUnknownDependencies && searchFilter == SearchFilter.TYPES_ONLY) {
                Descriptors.logger.warning("The descriptor for message type \"" + str + "\" can not be found and PlatformImplementations.kt_3 placeholder is created for it");
                Descriptor descriptor = new Descriptor(string);
                this.dependencies.add(descriptor.getFile());
                return descriptor;
            }
            throw new DescriptorValidationException(genericDescriptor, '\"' + str + "\" is not defined.", (C20301) null);
        }
        ...
        void addSymbol(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (genericDescriptorPut != null) {
                ...
                if (genericDescriptor.getFile() == genericDescriptorPut.getFile()) {
                    ...
                    if (iLastIndexOf == -1) {
                        throw new DescriptorValidationException(genericDescriptor, '\"' + fullName + "\" is already defined.", c20301);
                    }
                    throw new DescriptorValidationException(genericDescriptor, '\"' + fullName.substring(iLastIndexOf + 1) + "\" is already defined in \"" + fullName.substring(0, iLastIndexOf) + "\".", c20301);
                }
                throw new DescriptorValidationException(genericDescriptor, '\"' + fullName + "\" is already defined in file \"" + genericDescriptorPut.getFile().getName() + "\".", c20301);
            }
        }
        ...
        void addPackage(String str, FileDescriptor fileDescriptor) throws DescriptorValidationException {
            ...
            if (genericDescriptorPut != null) {
                ...
                throw new DescriptorValidationException(fileDescriptor, '\"' + strSubstring + "\" is already defined (as something other than PlatformImplementations.kt_3 package) in file \"" + genericDescriptorPut.getFile().getName() + "\".", (C20301) null);
            }
        }
        ...
        private static final class DescriptorIntPair {
            ...
            DescriptorIntPair(GenericDescriptor genericDescriptor, int OplusGLSurfaceView_13) {
                this.descriptor = genericDescriptor;
                this.number = OplusGLSurfaceView_13;
            }

            public int hashCode() {
                return (this.descriptor.hashCode() * NvsMediaFileConvertor.CONVERTOR_ERROR_UNKNOWN) + this.number;
            }
        ...
        void addFieldByNumber(FieldDescriptor fieldDescriptor) throws DescriptorValidationException {
            ...
            throw new DescriptorValidationException(fieldDescriptor, "Field number " + fieldDescriptor.getNumber() + " has already been used in \"" + fieldDescriptor.getContainingType().getFullName() + "\" by field \"" + fieldDescriptorPut.getName() + "\".", (C20301) null);
        }
        ...
        static void validateSymbolName(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            C20301 c20301 = null;
            if (name.length() == 0) {
                throw new DescriptorValidationException(genericDescriptor, "Missing name.", c20301);
            }
            for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < name.length(); OplusGLSurfaceView_13++) {
                char cCharAt = name.charAt(OplusGLSurfaceView_13);
                if (('PlatformImplementations.kt_3' > cCharAt || cCharAt > 'z') && (('A' > cCharAt || cCharAt > 'Z') && cCharAt != '_' && ('0' > cCharAt || cCharAt > '9' || OplusGLSurfaceView_13 <= 0))) {
                    throw new DescriptorValidationException(genericDescriptor, '\"' + name + "\" is not PlatformImplementations.kt_3 valid identifier.", c20301);
                }
            }
        }
    }
    ...
    public static final class OneofDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ OneofDescriptor(DescriptorProtos.OneofDescriptorProto oneofDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13, C20301 c20301) throws DescriptorValidationException {
            this(oneofDescriptorProto, fileDescriptor, descriptor, OplusGLSurfaceView_13);
        }

        static /* synthetic */ int access$2008(OneofDescriptor oneofDescriptor) {
            int OplusGLSurfaceView_13 = oneofDescriptor.fieldCount;
            oneofDescriptor.fieldCount = OplusGLSurfaceView_13 + 1;
        ...
        public FieldDescriptor getField(int OplusGLSurfaceView_13) {
            return this.fields[OplusGLSurfaceView_13];
        }
        ...
        private OneofDescriptor(DescriptorProtos.OneofDescriptorProto oneofDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int OplusGLSurfaceView_13) throws DescriptorValidationException {
            super(null);
            this.proto = oneofDescriptorProto;
