...
public interface Message extends MessageLite, MessageOrBuilder {
    ...
    public interface Builder extends MessageLite.Builder, MessageOrBuilder {
        ...
        Builder getRepeatedFieldBuilder(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13);
        ...
        Builder mergeFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2) throws InvalidProtocolBufferException;

        Builder mergeFrom(byte[] bArr, int OplusGLSurfaceView_13, int i2, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
        ...
        Builder setRepeatedField(Descriptors.FieldDescriptor fieldDescriptor, int OplusGLSurfaceView_13, Object obj);
