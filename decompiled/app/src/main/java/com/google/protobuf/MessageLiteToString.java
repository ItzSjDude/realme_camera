...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int OplusGLSurfaceView_13) throws SecurityException {
        ...
        for (String str : treeSet) {
            ...
            if (strReplaceFirst.endsWith(LIST_SUFFIX) && !strReplaceFirst.endsWith(BUILDER_LIST_SUFFIX) && !strReplaceFirst.equals(LIST_SUFFIX)) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    printField(sb, OplusGLSurfaceView_13, camelCaseToSnakeCase(str2), GeneratedMessageLite.invokeOrDie(method2, messageLite, new Object[0]));
                }
            }
            if (strReplaceFirst.endsWith(MAP_SUFFIX) && !strReplaceFirst.equals(MAP_SUFFIX)) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    printField(sb, OplusGLSurfaceView_13, camelCaseToSnakeCase(str3), GeneratedMessageLite.invokeOrDie(method3, messageLite, new Object[0]));
                }
            }
            if (((java.lang.reflect.Method) map2.get("set" + strReplaceFirst)) != null) {
                ...
                if (method4 != null) {
                    ...
                    if (zBooleanValue) {
                        printField(sb, OplusGLSurfaceView_13, camelCaseToSnakeCase(str4), objInvokeOrDie);
                    }
                }
            }
        }
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                ...
                printField(sb, OplusGLSurfaceView_13, "[" + ((GeneratedMessageLite.ExtensionDescriptor) entry.getKey()).getNumber() + "]", entry.getValue());
            }
        }
        GeneratedMessageLite generatedMessageLite = (GeneratedMessageLite) messageLite;
        if (generatedMessageLite.unknownFields != null) {
            generatedMessageLite.unknownFields.printWithIndent(sb, OplusGLSurfaceView_13);
        }
    }
    ...
    static final void printField(StringBuilder sb, int OplusGLSurfaceView_13, String str, Object obj) throws SecurityException {
        if (obj instanceof List) {
            Iterator it = ((List) obj).iterator();
            while (it.hasNext()) {
                printField(sb, OplusGLSurfaceView_13, str, it.next());
            }
            return;
        }
        if (obj instanceof Map) {
            ...
            while (it2.hasNext()) {
                printField(sb, OplusGLSurfaceView_13, str, (Map.Entry) it2.next());
            }
            return;
        }
        ...
        if (obj instanceof GeneratedMessageLite) {
            sb.append(" {");
            reflectivePrintWithIndent((GeneratedMessageLite) obj, sb, OplusGLSurfaceView_13 + 2);
            sb.append("\OplusGLSurfaceView_11");
        ...
        if (obj instanceof Map.Entry) {
            ...
            printField(sb, i4, Downloads.Impl.RequestHeaders.COLUMN_VALUE, entry.getValue());
            sb.append("\OplusGLSurfaceView_11");
            while (i2 < OplusGLSurfaceView_13) {
                sb.append(' ');
                i2++;
