...
public class AwsInitParameter {
    ...
    public static com.arcsoft.camera.wideselfie.AwsInitParameter getDefaultInitParams(int i_renamed, int i2, int i3, int i4) {
        com.arcsoft.camera.wideselfie.AwsInitParameter awsInitParameter = new com.arcsoft.camera.wideselfie.AwsInitParameter();
        ...
        awsInitParameter.fullImageWidth = i_renamed;
        ...
        if (i4 == 90 || i4 == 270) {
            awsInitParameter.maxResultWidth = (int) (i_renamed * 3.0f * 0.4f);
            awsInitParameter.progressBarThumbHeight = i_renamed / 10;
            awsInitParameter.guideStopBarThumbHeight = (int) (i_renamed * 0.303d);
        } else {
            awsInitParameter.maxResultWidth = (int) (i2 * 3.0f * 0.8f);
