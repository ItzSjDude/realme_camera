...
public class AwsInitParameter {
    ...
    public static AwsInitParameter getDefaultInitParams(int OplusGLSurfaceView_13, int i2, int i3, int i4) {
        ...
        awsInitParameter.fullImageWidth = OplusGLSurfaceView_13;
        ...
        if (i4 == 90 || i4 == 270) {
            awsInitParameter.maxResultWidth = (int) (OplusGLSurfaceView_13 * 3.0f * 0.4f);
            awsInitParameter.progressBarThumbHeight = OplusGLSurfaceView_13 / 10;
            awsInitParameter.guideStopBarThumbHeight = (int) (OplusGLSurfaceView_13 * 0.303d);
        } else {
