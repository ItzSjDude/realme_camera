...
public class BurstPMKInitParameter {
    ...
    public static BurstPMKInitParameter getDefaultInitParams(int OplusGLSurfaceView_13, int i2, int i3, int i4) {
        BurstPMKInitParameter burstPMKInitParameter = new BurstPMKInitParameter();
        burstPMKInitParameter.srcFullImageWidth = OplusGLSurfaceView_13;
