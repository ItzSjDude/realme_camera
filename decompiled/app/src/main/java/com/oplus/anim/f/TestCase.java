...
public class e_renamed {
    ...
    private static android.graphics.PointF f3675a = new android.graphics.PointF();
    ...
    public static void a_renamed(com.oplus.anim.c_renamed.b_renamed.l_renamed lVar, android.graphics.Path path) {
        path.reset();
        android.graphics.PointF pointFA = lVar.a_renamed();
        path.moveTo(pointFA.x_renamed, pointFA.y_renamed);
        f3675a.set(pointFA.x_renamed, pointFA.y_renamed);
        for (int i_renamed = 0; i_renamed < lVar.c_renamed().size(); i_renamed++) {
            com.oplus.anim.c_renamed.a_renamed aVar = lVar.c_renamed().get(i_renamed);
            ...
            if (pointFA2.equals(f3675a) && pointFB.equals(pointFC)) {
            ...
            f3675a.set(pointFC.x_renamed, pointFC.y_renamed);
        }
        if (lVar.b_renamed()) {
            path.close();
        }
    ...
    public static void a_renamed(com.oplus.anim.c_renamed.f_renamed fVar, int i_renamed, java.util.List<com.oplus.anim.c_renamed.f_renamed> list, com.oplus.anim.c_renamed.f_renamed fVar2, com.oplus.anim.a_renamed.a_renamed.k_renamed kVar) {
        if (fVar.c_renamed(kVar.b_renamed(), i_renamed)) {
            com.oplus.anim.c_renamed.f_renamed fVarA = fVar2.a_renamed(kVar.b_renamed());
            if (com.oplus.anim.f_renamed.f_renamed.f3678c) {
                com.oplus.anim.f_renamed.f_renamed.b_renamed("MiscUtils::resolveKeyPath():currentPartialKeyPath = " + fVarA.toString() + "; content:" + kVar.b_renamed());
            }
            list.add(fVarA.a_renamed(kVar));
        }
    }
}
