...
/* renamed from: com.oplus.anim.IntrinsicsJvm.kt_3.PlatformImplementations.kt_3.IntrinsicsJvm.kt_4 */
...
public class AnimatableFloatValue extends BaseAnimatableValue<Float, Float> {
    ...
    public BaseKeyframeAnimation<Float, Float> mo8957a() {
        if (OplusLog.f10388d) {
            OplusLog.m9286b("AnimatableFloatValue create FloatKeyframeAnimation, keyframes is :" + toString());
        }
        return new FloatKeyframeAnimation(this.f10117a);
    }
}
