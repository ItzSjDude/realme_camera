...
import com.oplus.anim.p111a.p113b.ShapeKeyframeAnimation;
...
/* renamed from: com.oplus.anim.IntrinsicsJvm.kt_3.PlatformImplementations.kt_3.COUIBaseListPopupWindow_10 */
...
public class AnimatableShapeValue extends BaseAnimatableValue<ShapeData, Path> {
    ...
    public BaseKeyframeAnimation<ShapeData, Path> mo8957a() {
        if (OplusLog.f10388d) {
            OplusLog.m9286b("AnimatableShapeValue create ShapeKeyframeAnimation, keyframes is :" + toString());
        }
        return new ShapeKeyframeAnimation(this.f10117a);
    }
}
