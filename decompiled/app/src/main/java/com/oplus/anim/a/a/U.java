...
public class n_renamed implements com.oplus.anim.a_renamed.a_renamed.k_renamed, com.oplus.anim.a_renamed.a_renamed.m_renamed, com.oplus.anim.a_renamed.b_renamed.a_renamed.BaseKeyframeAnimation_2 {

    /* renamed from: b_renamed, reason: collision with root package name */
    private final java.lang.String f3481b;

    /* renamed from: c_renamed, reason: collision with root package name */
    private final com.oplus.anim.b_renamed f3482c;
    private final com.oplus.anim.c_renamed.b_renamed.i_renamed.a_renamed d_renamed;
    ...
    private final com.oplus.anim.a_renamed.b_renamed.a_renamed<?, java.lang.Float> i_renamed;
    private final com.oplus.anim.a_renamed.b_renamed.a_renamed<?, java.lang.Float> j_renamed;
    private final com.oplus.anim.a_renamed.b_renamed.a_renamed<?, java.lang.Float> k_renamed;
    private final com.oplus.anim.a_renamed.b_renamed.a_renamed<?, java.lang.Float> l_renamed;
    private boolean n_renamed;

    /* renamed from: a_renamed, reason: collision with root package name */
    private final android.graphics.Path f3480a = new android.graphics.Path();
    private com.oplus.anim.a_renamed.a_renamed.b_renamed m_renamed = new com.oplus.anim.a_renamed.a_renamed.b_renamed();

    public n_renamed(com.oplus.anim.b_renamed bVar, com.oplus.anim.c_renamed.c_renamed.a_renamed aVar, com.oplus.anim.c_renamed.b_renamed.i_renamed iVar) {
        this.f3482c = bVar;
        this.f3481b = iVar.a_renamed();
        ...
        if (this.d_renamed == com.oplus.anim.c_renamed.b_renamed.i_renamed.a_renamed.STAR) {
    ...
    public android.graphics.Path e_renamed() {
        ...
        int i_renamed = com.oplus.anim.a_renamed.a_renamed.n_renamed.SceneLoader_2.f3483a[this.d_renamed.ordinal()];
        if (i_renamed == 1) {
            d_renamed();
        } else if (i_renamed == 2) {
            f_renamed();
        ...
        this.f3480a.close();
        this.m_renamed.a_renamed(this.f3480a);
        this.n_renamed = true;
        return this.f3480a;
    }

    /* compiled from: PolystarContent.java */
    /* renamed from: com.oplus.anim.a_renamed.a_renamed.n_renamed$1, reason: invalid class name */
    static /* synthetic */ class SceneLoader_2 {

        /* renamed from: a_renamed, reason: collision with root package name */
        static final /* synthetic */ int[] f3483a = new int[com.oplus.anim.c_renamed.b_renamed.i_renamed.a_renamed.values().length];

        static {
            try {
                f3483a[com.oplus.anim.c_renamed.b_renamed.i_renamed.a_renamed.STAR.ordinal()] = 1;
            } catch (java.lang.NoSuchFieldError unused) {
            }
            try {
                f3483a[com.oplus.anim.c_renamed.b_renamed.i_renamed.a_renamed.POLYGON.ordinal()] = 2;
    ...
    private void d_renamed() {
        ...
        com.oplus.anim.a_renamed.b_renamed.a_renamed<?, java.lang.Float> aVar = this.k_renamed;
        float fFloatValue4 = aVar != null ? aVar.g_renamed().floatValue() / 100.0f : 0.0f;
        com.oplus.anim.a_renamed.b_renamed.a_renamed<?, java.lang.Float> aVar2 = this.l_renamed;
        ...
        if (i2 != 0) {
            ...
            this.f3480a.moveTo(fCos2, fSin2);
            d2 = radians + f12;
            fCos = fCos2;
            fSin = fSin2;
            f_renamed = 0.0f;
        ...
        while (true) {
            ...
            if (d7 < dCeil) {
                ...
                if (fFloatValue4 == 0.0f && fFloatValue5 == 0.0f) {
                    this.f3480a.lineTo(fCos3, fSin3);
                    f10 = fSin3;
                    f7 = fFloatValue4;
                    f8 = fFloatValue5;
                    f9 = f_renamed;
                    ...
                    this.f3480a.cubicTo(f17 - f21, fSin - f22, fCos3 + f24, f10 + f25, fCos3, f10);
                }
                d6 += f16;
                z_renamed = !z_renamed;
                i3++;
                ...
                this.f3480a.offset(pointFG.x_renamed, pointFG.y_renamed);
                this.f3480a.close();
                return;
            }
        }
    ...
    private void f_renamed() {
        ...
        while (i2 < dCeil) {
            ...
            if (fFloatValue != 0.0f) {
                ...
                this.f3480a.cubicTo(fCos - (fCos3 * f_renamed), fSin - (fSin3 * f_renamed), fCos2 + (((float) java.lang.Math.cos(dAtan22)) * f_renamed), fSin2 + (f_renamed * ((float) java.lang.Math.sin(dAtan22))), fCos2, fSin2);
            } else {
                d_renamed = d7;
                d2 = d5;
                d3 = d6;
                i_renamed = i2;
                this.f3480a.lineTo(fCos2, fSin2);
            }
            d7 = d_renamed + d3;
            i2 = i_renamed + 1;
            fSin = fSin2;
    ...
    public <T_renamed> void a_renamed(T_renamed t_renamed, com.oplus.anim.g_renamed.b_renamed<T_renamed> bVar) {
        ...
        if (t_renamed == com.oplus.anim.d_renamed.q_renamed) {
            this.f_renamed.a_renamed((com.oplus.anim.g_renamed.b_renamed<java.lang.Float>) bVar);
            return;
        }
        if (t_renamed == com.oplus.anim.d_renamed.r_renamed) {
            this.h_renamed.a_renamed((com.oplus.anim.g_renamed.b_renamed<java.lang.Float>) bVar);
            return;
        }
        if (t_renamed == com.oplus.anim.d_renamed.h_renamed) {
            this.g_renamed.a_renamed((com.oplus.anim.g_renamed.b_renamed<android.graphics.PointF>) bVar);
            return;
        }
        if (t_renamed == com.oplus.anim.d_renamed.s_renamed && (aVar2 = this.i_renamed) != null) {
            aVar2.a_renamed((com.oplus.anim.g_renamed.b_renamed<java.lang.Float>) bVar);
            return;
        }
        if (t_renamed == com.oplus.anim.d_renamed.t_renamed) {
            this.j_renamed.a_renamed((com.oplus.anim.g_renamed.b_renamed<java.lang.Float>) bVar);
            return;
        }
        if (t_renamed == com.oplus.anim.d_renamed.u_renamed && (aVar = this.k_renamed) != null) {
            aVar.a_renamed((com.oplus.anim.g_renamed.b_renamed<java.lang.Float>) bVar);
        } else if (t_renamed == com.oplus.anim.d_renamed.v_renamed) {
            this.l_renamed.a_renamed((com.oplus.anim.g_renamed.b_renamed<java.lang.Float>) bVar);
        }
    }
}
