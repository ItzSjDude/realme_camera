...
public interface IMediaMetadataRetriever {
    ...
    String extractMetadata(int OplusGLSurfaceView_13);

    Bitmap getCoverPicture(int OplusGLSurfaceView_13, int i2, int i3);

    byte[] getEmbeddedPicture();

    Bitmap getFrameAtTime(long OplusGLSurfaceView_15);

    Bitmap getFrameAtTime(long OplusGLSurfaceView_15, int OplusGLSurfaceView_13);

    Bitmap getScaledFrameAtTime(long OplusGLSurfaceView_15, int OplusGLSurfaceView_13, int i2, int i3);
