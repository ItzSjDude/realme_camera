...
public abstract class HighSimpleDecoder<I_renamed extends com.google.android.exoplayer2.decoder.DecoderInputBuffer, O_renamed extends com.oplus.tblplayer.ffmpeg.OutputBuffer, E_renamed extends java.lang.Exception> implements com.google.android.exoplayer2.decoder.Decoder<I_renamed, O_renamed, E_renamed> {
    ...
    protected HighSimpleDecoder(I_renamed[] iArr, O_renamed[] oArr) {
        ...
        this.decodeThread = new java.lang.Thread("HighSimpleDecoder:Decode") { // from class: com.oplus.tblplayer.ffmpeg.HighSimpleDecoder.1
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
                com.oplus.tblplayer.ffmpeg.HighSimpleDecoder.this.run();
            }
        };
    ...
    private boolean decode() throws java.lang.InterruptedException {
        ...
        synchronized (this.lock) {
            ...
            if (iRemoveFirst.isEndOfStream()) {
                ...
                try {
                    e_renamed = (E_renamed) decode(iRemoveFirst, o_renamed, z_renamed);
                } catch (java.lang.OutOfMemoryError e2) {
                    e_renamed = (E_renamed) createUnexpectedDecodeException(e2);
                } catch (java.lang.RuntimeException e3) {
                    e_renamed = (E_renamed) createUnexpectedDecodeException(e3);
                }
                if (e_renamed != null) {
                    synchronized (this.lock) {
                        this.exception = e_renamed;
                    }
                    return false;
                }
            }
