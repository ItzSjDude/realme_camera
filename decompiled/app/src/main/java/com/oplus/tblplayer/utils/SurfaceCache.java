...
public final class SurfaceCache {
    ...
    private final com.oplus.tblplayer.utils.SurfaceCache.ComponentListener componentListener = new com.oplus.tblplayer.utils.SurfaceCache.ComponentListener();
    private boolean ownsSurface;
    private android.view.Surface surface;
    private android.view.SurfaceHolder surfaceHolder;
    private android.view.TextureView textureView;
    private final com.oplus.tblplayer.utils.SurfaceCache.OnUpdateSurfaceCallback updateSurfaceCallback;

    public interface OnUpdateSurfaceCallback {
        void updateSurface(android.view.Surface surface);
    }

    public SurfaceCache(com.oplus.tblplayer.utils.SurfaceCache.OnUpdateSurfaceCallback onUpdateSurfaceCallback) {
    ...
    private final class ComponentListener implements android.view.SurfaceHolder.Callback, android.view.TextureView.SurfaceTextureListener {
        ...
        public void surfaceCreated(android.view.SurfaceHolder surfaceHolder) {
            com.oplus.tblplayer.utils.SurfaceCache.this.setVideoSurfaceInternal(surfaceHolder.getSurface(), false);
        }

        @Override // android.view.SurfaceHolder.Callback
        public void surfaceDestroyed(android.view.SurfaceHolder surfaceHolder) {
            com.oplus.tblplayer.utils.SurfaceCache.this.setVideoSurfaceInternal(null, false);
        }

        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureAvailable(android.graphics.SurfaceTexture surfaceTexture, int i_renamed, int i2) {
            com.oplus.tblplayer.utils.SurfaceCache.this.setVideoSurfaceInternal(new android.view.Surface(surfaceTexture), true);
        }

        @Override // android.view.TextureView.SurfaceTextureListener
        public boolean onSurfaceTextureDestroyed(android.graphics.SurfaceTexture surfaceTexture) {
            com.oplus.tblplayer.utils.SurfaceCache.this.setVideoSurfaceInternal(null, true);
            return true;
        }
    }
