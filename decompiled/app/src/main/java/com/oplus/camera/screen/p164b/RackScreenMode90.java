...
/* renamed from: com.oplus.camera.screen.IntrinsicsJvm.kt_4.OplusGLSurfaceView_6 */
/* loaded from: classes2.dex */
public class RackScreenMode90 extends RackScreenMode {
    ...
    public Rect mo16558b(int OplusGLSurfaceView_13, int i2) throws Resources.NotFoundException {
        ...
        if (COUIBaseListPopupWindow_12 > this.f16005b / this.f16006c) {
            ...
            int screenWidth = this.f16014d ? 0 : Util.getScreenWidth() / 2;
    ...
    public boolean mo16556a(Activity activity, boolean z, float COUIBaseListPopupWindow_12, float f2) {
        return COUIBaseListPopupWindow_12 > ((float) activity.getResources().getDimensionPixelSize(R.dimen.rack_mode_mode_edit_confirm_root_layout_height));
    }

    @Override // com.oplus.camera.screen.p164b.RackScreenMode, com.oplus.camera.screen.p164b.ScreenModeFacade
    /* renamed from: PlatformImplementations.kt_3 */
    public boolean mo16555a(Activity activity, Rect rect) {
        return super.mo16555a(activity, rect);
    }

    @Override // com.oplus.camera.screen.p164b.RackScreenMode, com.oplus.camera.screen.p164b.ScreenModeFacade
    /* renamed from: IntrinsicsJvm.kt_4 */
    public boolean mo16561b(Activity activity, Rect rect) {
        return super.mo16561b(activity, rect);
    }
    ...
    protected void mo16629f(Activity activity, LayoutItem c2949c) throws Resources.NotFoundException {
        Resources resources = activity.getResources();
        LayoutItem c2949c2 = new LayoutItem(new int[]{11, 0, 10, 0}, new int[]{0, resources.getDimensionPixelSize(R.dimen.rack_mode_out_screen_preview_switch_button_margin_top), resources.getDimensionPixelSize(R.dimen.rack_mode_out_screen_preview_switch_button_margin_right), 0});
        c2949c2.f16021d = 90;
    ...
    protected void mo16621a(Activity activity, LayoutItem c2949c, LayoutItem c2949c2) {
        super.mo16621a(activity, c2949c, new LayoutItem(new int[]{11, 0, 12, 0}, new int[]{0, 0, activity.getResources().getDimensionPixelSize(R.dimen.rack_mode_control_panel_button_margin_right) + Math.round(Util.m24198Z() / 5.0f), 0}));
    }
    ...
    protected void mo16626d(Activity activity, LayoutItem c2949c) {
        Resources resources = activity.getResources();
        super.mo16626d(activity, new LayoutItem(new int[]{9, 0, 12, 0}, new int[]{resources.getDimensionPixelOffset(R.dimen.rack_mode_effect_button_margin_start), 0, 0, resources.getDimensionPixelOffset(R.dimen.rack_mode_effect_button_margin_bottom)}));
    }
    ...
    protected void mo16623b(Activity activity, LayoutItem c2949c) throws Resources.NotFoundException {
        ...
        super.mo16623b(activity, new LayoutItem(new int[]{9, 0, 12, 0}, new int[]{((-dimensionPixelSize) / 2) + dimensionPixelSize2, 0, 0, ((dimensionPixelSize / 2) - resources.getDimensionPixelSize(R.dimen.rack_mode_zoom_focus_circle_margin_bottom)) - dimensionPixelSize2}));
    }
    ...
    protected void mo16625c(Activity activity, LayoutItem c2949c) {
        Resources resources = activity.getResources();
        super.mo16625c(activity, new LayoutItem(new int[]{9, 0, 12, 0}, new int[]{resources.getDimensionPixelOffset(R.dimen.rack_mode_effect_button_margin_start), 0, 0, resources.getDimensionPixelOffset(R.dimen.rack_mode_blur_button_margin_bottom)}));
    }

    @Override // com.oplus.camera.screen.p164b.BaseScreenMode
    /* renamed from: COUIBaseListPopupWindow_10 */
    public String mo16516h() {
        return this.f16014d ? "low90" : "rack90";
    }
}
