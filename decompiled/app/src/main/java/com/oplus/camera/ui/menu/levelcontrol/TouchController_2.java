...
public class m_renamed extends com.oplus.camera.ui.menu.levelcontrol.k_renamed {
    public m_renamed(android.content.Context context, int i_renamed, int i2) {
    ...
    protected void k_renamed() {
        if (270 == this.H_renamed) {
            ...
            com.oplus.camera.ui.menu.levelcontrol.p_renamed.b_renamed(this.d_renamed.n_renamed, this.d_renamed.m_renamed, 1.0f);
            com.oplus.camera.ui.menu.levelcontrol.p_renamed.a_renamed(0.0f, (this.f_renamed / this.d_renamed.d_renamed) * 1.0f * 2.0f, 0.0f);
            com.oplus.camera.ui.menu.levelcontrol.p_renamed.a_renamed(90.0f, 0.0f, 0.0f, 1.0f);
        ...
        float f_renamed = this.p_renamed.n_renamed() ? 1.0f : -1.0f;
        com.oplus.camera.ui.menu.levelcontrol.p_renamed.b_renamed(1.0f, this.d_renamed.m_renamed, 1.0f);
        com.oplus.camera.ui.menu.levelcontrol.p_renamed.a_renamed(0.0f, f_renamed * (this.f_renamed / this.d_renamed.f6474c) * 2.0f, 0.0f);
        com.oplus.camera.gl_renamed.i_renamed.i_renamed();
    }
    ...
    protected int c_renamed(com.oplus.camera.ui.menu.levelcontrol.i_renamed iVar) {
        ...
        return java.lang.Math.round(java.lang.Math.round((iVar.r_renamed() + iVar.s_renamed()) * iVar.a_renamed().size()));
    }
