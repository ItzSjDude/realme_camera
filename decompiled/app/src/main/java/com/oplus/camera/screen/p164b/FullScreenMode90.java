...
/* renamed from: com.oplus.camera.screen.IntrinsicsJvm.kt_4.COUIBaseListPopupWindow_12 */
/* loaded from: classes2.dex */
public class FullScreenMode90 extends FullScreenModeRotate {
    ...
    protected void mo16553a(final Activity activity, LayoutItem c2949c, LayoutItem c2949c2, LayoutItem c2949c3, LayoutItem c2949c4) {
        LayoutItem c2949c5 = new LayoutItem(new int[]{11, 0}, new int[]{0, 0, 0, 0});
        LayoutItem c2949c6 = new LayoutItem(new int[]{11, 0, 15, 0}, new int[]{0, 0, (int) Util.m24456h(R.dimen.fold_full_professional_params_bar_margin_right), 0});
        LayoutItem c2949c7 = new LayoutItem(new int[]{10, 0, 11, 0}, new int[]{0, Util.m24460i(R.dimen.fold_full_professional_params_slide_bar_panel_margin_top), Util.m24460i(R.dimen.fold_full_professional_params_slide_bar_panel_margin_right), 0});
        LayoutItem c2949c8 = new LayoutItem(new int[]{11, 0, 10, 0}, new int[]{0, Util.m24460i(R.dimen.fold_full_professional_guide_entry_margin_top), Util.m24460i(R.dimen.fold_full_professional_guide_entry_margin_right), 0});
        c2949c8.f16023f = new LayoutItem.PlatformImplementations.kt_3() { // from class: com.oplus.camera.screen.IntrinsicsJvm.kt_4.-$$Lambda$COUIBaseListPopupWindow_12$a0kXrENQNrWRrcC2PwWBF_Mqk88
            @Override // com.oplus.camera.screen.LayoutItem.PlatformImplementations.kt_3
            public final void call(View view) {
                FullScreenMode90.m16582a(activity, view);
            }
        };
    ...
    /* renamed from: PlatformImplementations.kt_3 */
    public static /* synthetic */ void m16582a(Activity activity, View view) {
    ...
    protected void mo16562c(Activity activity, LayoutItem c2949c) throws Resources.NotFoundException {
        ...
        LayoutItem c2949c2 = new LayoutItem(new int[]{9, 0, 12, 0}, new int[]{(-dimensionPixelSize) / 2, 0, 0, resources.getDimensionPixelSize(R.dimen.zoom_arc_seekbar_full_margin_bottom_full_screen_90) + (dimensionPixelSize / 2)});
        c2949c2.f16021d = 90;
    ...
    protected void mo16551a(Activity activity, LayoutItem c2949c, LayoutItem c2949c2) throws Resources.NotFoundException {
        ...
        this.f16004a.put(Integer.valueOf(R.id_renamed.review_control_layout), new LayoutItem(new int[]{11, 0}, new int[]{0, 0, dimensionPixelSize, 0}));
    }
    ...
    protected void mo16499a(Activity activity, LayoutItem c2949c) {
        Resources resources = activity.getResources();
        super.mo16499a(activity, new LayoutItem(new int[]{11, 0, 12, 0}, new int[]{0, 0, resources.getDimensionPixelSize(R.dimen.vertical_headline_margin_right), resources.getDimensionPixelSize(R.dimen.vertical_headline_rotate_margin_bottom)}));
    }
    ...
    protected void mo16563c(Activity activity, LayoutItem c2949c, LayoutItem c2949c2) throws Resources.NotFoundException {
        ...
        LayoutItem c2949c3 = new LayoutItem(iArr, new int[]{0, dimensionPixelSize, dimensionPixelSize2, 0});
        c2949c3.f16021d = 90;
        LayoutItem c2949c4 = new LayoutItem(iArr, new int[]{0, dimensionPixelSize3, dimensionPixelSize4, 0});
        c2949c4.f16021d = 90;
    ...
    protected void mo16566d(Activity activity, LayoutItem c2949c) {
        Resources resources = activity.getResources();
        super.mo16566d(activity, new LayoutItem(new int[]{9, 0, 12, 0}, new int[]{resources.getDimensionPixelOffset(R.dimen.vertical_effect_button_margin_start), 0, 0, resources.getDimensionPixelOffset(R.dimen.vertical_effect_button_margin_bottom_rotate_90)}));
    }
    ...
    protected void mo16567e(Activity activity, LayoutItem c2949c) {
        Resources resources = activity.getResources();
        super.mo16567e(activity, new LayoutItem(new int[]{9, 0, 12, 0}, new int[]{resources.getDimensionPixelOffset(R.dimen.vertical_blur_button_margin_start), 0, 0, resources.getDimensionPixelOffset(R.dimen.vertical_blur_button_margin_bottom_rotate_90)}));
    }
    ...
    protected void mo16560b(Activity activity, LayoutItem c2949c, LayoutItem c2949c2) throws Resources.NotFoundException {
        ...
        super.mo16560b(activity, new LayoutItem(new int[]{20, 0}, new int[]{0, 0, 0, 0}), c2949c2);
    }
    ...
    protected void mo16569f(Activity activity, LayoutItem c2949c) {
        Resources resources = activity.getResources();
        super.mo16569f(activity, new LayoutItem(new int[]{20, 0, 10, 0}, new int[]{resources.getDimensionPixelOffset(R.dimen.vertical_effect_menu_margin_left), resources.getDimensionPixelOffset(R.dimen.vertical_effect_menu_margin_top), 0, 0}));
    }
    ...
    public float[] mo16530a(View view, float COUIBaseListPopupWindow_12, float f2) {
        ...
        float[] fArr = {f2 - r3[1], r3[0] - COUIBaseListPopupWindow_12};
    ...
    public boolean mo16555a(Activity activity, Rect rect) {
        return super.mo16555a(activity, m16581a(rect));
    }

    @Override // com.oplus.camera.screen.p164b.FullScreenModeRotate, com.oplus.camera.screen.p164b.FullScreenMode, com.oplus.camera.screen.p164b.ScreenModeFacade
    /* renamed from: IntrinsicsJvm.kt_4 */
    public boolean mo16561b(Activity activity, Rect rect) {
        return super.mo16561b(activity, m16581a(rect));
    }

    /* renamed from: PlatformImplementations.kt_3 */
    private Rect m16581a(Rect rect) {
        return new Rect(rect.left - rect.height(), rect.top, rect.left, rect.top + rect.width());
    }
    ...
    public void mo16501a(HistogramProcessorManager.PlatformImplementations.kt_3 aVar, int OplusGLSurfaceView_13, int i2) {
        ...
        int iM24460i2 = Util.m24460i(R.dimen.fold_full_professional_histogram_margin_top);
        aVar.f14814d = Util.m24460i(R.dimen.fold_full_professional_histogram_margin_left);
        aVar.f14815e = 0;
        if (this.f16006c - rectMo16558b.right > iM24460i2) {
            aVar.f14812b = (this.f16006c - rectMo16558b.right) + iM24460i;
        } else {
            aVar.f14812b = iM24460i2;
        }
    }
}
