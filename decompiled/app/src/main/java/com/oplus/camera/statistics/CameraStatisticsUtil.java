...
public class CameraStatisticsUtil extends OplusTrack {
    ...
    private static final String LOGTAG_STICKER = "205";
    ...
    public static class FaceCoordinate {
        ...
        /* renamed from: L1 */
        public String f16137L1;

        /* renamed from: L2 */
        public String f16138L2;

        /* renamed from: L3 */
        public String f16139L3;

        /* renamed from: L4 */
        public String f16140L4;
    }

    public static class FaceSize {

        /* renamed from: N1 */
        public String f16141N1;

        /* renamed from: N2 */
        public String f16142N2;
    }
    ...
    public static class MakerNote {
        ...
        /* renamed from: L */
        public ArrayList<FaceCoordinate> f16150L;

        /* renamed from: M */
        public String f16151M;

        /* renamed from: N */
        public ArrayList<FaceSize> f16152N;
        ...
        /* renamed from: T */
        public TouchCenter f16158T;

        /* renamed from: U */
        public String f16159U;

        /* renamed from: V */
        public String f16160V;

        /* renamed from: W */
        public String f16161W;
    ...
    public static class TouchCenter {
        ...
        /* renamed from: T1 */
        public String f16162T1;

        /* renamed from: T2 */
        public String f16163T2;
    }

    public static void onDebug(Context context, boolean z) {
        OplusTrack.onDebug(context, z);
    }

    public static void setSessionTimeOut(Context context, int OplusGLSurfaceView_13) {
        OplusTrack.setSessionTimeOut(context, OplusGLSurfaceView_13);
    }
    ...
    public static void onCommon(Context context, String str, String str2) {
        String str3;
        if (Util.m24342ae()) {
            CameraLog.m12959b(TAG, "onCommon, monkey is running do not report");
            return;
        }
        HashMap<String, String> mapPutEventMap = putEventMap(str2, new HashMap());
        switch (str) {
            case "enter":
            case "exit":
            case "RUS":
        ...
        OplusTrack.onCommon(context, str3, str, mapPutEventMap);
    }

    private static HashMap<String, String> putEventMap(String str, HashMap<String, String> map) {
        if (str != null) {
