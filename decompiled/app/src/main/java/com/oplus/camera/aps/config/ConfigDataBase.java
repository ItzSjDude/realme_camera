...
public class ConfigDataBase {
    ...
    /* renamed from: KEY_AI_ENHANCEMENT_VIDEO_FRONT_OPEN_DEFAULT_SUPPORT */
    public static final String f12541xacd6d020 = "com.oplus.feature.ai.enhancement.video.front.open.default.support";
    ...
    /* renamed from: KEY_CAMERA_VIDEO_BRIGHTNESS_SECOND_DECREASE_SUPPORT */
    public static final String f12542x7bcc43c9 = "com.oplus.camera.video.brightness.second.decrease.support";
    ...
    public static final String KEY_DISABLE_SHUTTER_BUTTON_DOWN_VIBRATE = "com.oplus.disable.shutter.button.down.vibrate";
    public static final String KEY_DISABLE_SHUTTER_BUTTON_UP_VIBRATE = "com.oplus.disable.shutter.button.up.vibrate";
    ...
    public static final String KEY_EXPLORER_SUPPORT = "com.oplus.feature.explorer.support";
    ...
    public static final String KEY_FISH_EYE = "com.oplus.feature.fish.eye.support";
    ...
    public static final String KEY_GESTURE_DETECT_IN_APS = "com.oplus.gesture.detect.in.aps";
    ...
    public static final String KEY_ID_PHOTO = "com.oplus.feature.id_renamed.photo.support";
    ...
    public static final String KEY_LONG_EXPOSURE_SCENE_TYPE_ARRAY = "com.oplus.long.exposure.scene.type.array";
    ...
    public static final String KEY_MICROSCOPE_VIDEO_PREVIEW_SIZE = "com.oplus.microscope.video.previewsize";
    ...
    public static final String KEY_MONO_FILTER_LOGIC_ID_IS_SAT = "com.oplus.mono.id_renamed.include.in.sat";
    ...
    public static final String KEY_MOVIE_MODE_PICTURE_SIZE = "com.oplus.movie.picturesize";
    public static final String KEY_MOVIE_MODE_SECOND_ZOOM_POINT_SPECIFIC_VALUE = "com.oplus.movie.second.zoom.point.specific.value";
    ...
    public static final String KEY_ONEPLUS_VIBRATE_SUPPORT = "com.oplus.strong.vibrate.support";
    ...
    public static final String KEY_PORTRAIT_FACEVIEW_INSENSOR_ZOOM_SUPPORT = "com.oplus.feature.portrait.faceview.insensor.zoom.support";
    ...
    public static final String KEY_QUALCOMM_PHYSICAL_ID_SUPPORT = "com.oplus.qualcomm.physical.id_renamed.support";
    ...
    public static final String KEY_SECNES_FORCE_ATHENA = "com.oplus.scenes.force.athena";
    ...
    public static final String KEY_STOP_SERVICE_ON_DESTROY_SUPPORT = "com.oplus.stop.service.on.destroy.support";
    public static final String KEY_STREAM_SUPPORT_PREVERSION = "com.oplus.stream.support.preversion";
    public static final String KEY_STREET_FILTER_TYPE_DEFAULT = "com.oplus.street.filter.type.default";
    ...
    public static final String KEY_STREET_LONG_EXPOSURE_SUPPORT = "com.oplus.feature.street.long.exposure.support";
    public static final String KEY_STREET_TRACK_UI_SUPPORT = "com.oplus.feature.street.track.ui.support";
    ...
    public static final String KEY_SUPPORT_DEFAULT_MTK_WEIGHT_3A_REGION = "com.oplus.feature.default.mtk.weight.3A.region.support";
    ...
    /* renamed from: KEY_SUPPORT_MEDIA_RECORDER_CUSTOM_FOCUS_SECTOR_WIDTH */
    public static final String f12543x6a81d9ec = "com.oplus.feature.media.recorder.custom.focus.sector.width.support";
    ...
    public static final String KEY_ULTRA_WIDE_HIGH_SUPPORTED_PICTURE_SIZE = "com.oplus.ultra.wide.high.supported.picturesize";
    ...
    public static final String KEY_VIDEO_ASD_AISCENE_V3_SUPPORT = "com.oplus.video.asd.aiscene.v3.support";
    public static final String KEY_VIDEO_BLUR_APP_FRONT_LIST = "com.oplus.video.blur.app.front.list";
    public static final String KEY_VIDEO_BLUR_APP_FRONT_PARAMS = "com.oplus.video.blur.app.front.params";
    public static final String KEY_VIDEO_BLUR_APP_REAR_LIST = "com.oplus.video.blur.app.back.list";
    public static final String KEY_VIDEO_BLUR_APP_REAR_PARAMS = "com.oplus.video.blur.app.rear.params";
    public static final String KEY_VIDEO_BLUR_CACHE_PATH = "com.oplus.video.blur.cache.path";
    ...
    /* renamed from: KEY_VIDEO_NONE_SAT_ULTRA_WIDE_ANGLE_RESOLUTION_LIMIT */
    public static final String f12544x95833f71 = "com.oplus.feature.video.resolution.limit.ultrawide.support";
    ...
    public static final String KEY_VIDEO_SUPER_EIS_WIDE_TIPS = "com.oplus.feature.video.super.eis.wide.tips";
    ...
    public static final String KEY_MICROSCOPE_SUPPORT = "com.oplus.feature.microscope.support";
    public static final String KEY_LEGACY_MICROSCOPE_SUPPORT = Util.m24249a(KEY_MICROSCOPE_SUPPORT, BuildConfig.FLAVOR, "b3Bwbw==");
    protected List<String> mMenuPanelList = null;
    protected List<String> mMenuSettingList = null;
    protected HashMap<String, String> mAppSetting = null;
    protected List<OptionItemConfig> mOptionItemConfigList = null;
    protected HashMap<String, String> mDefaultMenuSettingConfigMap = null;

    public HashMap<String, String> getAppSettingMap() {
    ...
    public void parseMenuPanel() {
        ...
        this.mMenuPanelList.add(CameraUIInterface.KEY_VIDEO_HYPER_LAPSE_MENU);
        this.mMenuPanelList.add(CameraUIInterface.KEY_TIME_LAPSE_RATE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_TORCH_MODE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_FLASH_MODE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_VIDEO_FLASH_MODE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_VIDEO_SUPER_EIS_MENU);
        if (CameraConfig.getConfigBooleanValue(KEY_SUPPORT_VIDEO_3HDR) || CameraConfig.getConfigBooleanValue(KEY_SUPPORT_VIDEO_LIVE_HDR)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_VIDEO_HDR);
        }
        this.mMenuPanelList.add(CameraUIInterface.KEY_AI_ENHANCEMENT_VIDEO);
        if (CameraConfig.getConfigBooleanValue(KEY_EXPLORER_SUPPORT)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_DISABLE_AI_ENHANCEMENT_VIDEO);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_ULTRA_NIGHT_VIDEO)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_ULTRA_NIGHT_VIDEO);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_STREET_FIX_FOCUS)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_STREET_FIX_FOCUS_CONTROL);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_SUPPORT_STREET_MODE)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_STREET_FILTER_MENU);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_STREET_LONG_EXPOSURE_SUPPORT)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_STREET_LONG_EXPOSURE_MENU);
        }
        this.mMenuPanelList.add(CameraUIInterface.KEY_CAMERA_HDR_MODE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_NIGHT_TRIPOD_MODE);
        if (CameraConfig.getConfigBooleanValue(KEY_PI_AI)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_PI_AI);
        } else {
            this.mMenuPanelList.add(CameraUIInterface.KEY_PI);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_SUPPORT_AUTO_MICRO)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_MACRO_SWITCH);
        }
        this.mMenuPanelList.add(CameraUIInterface.KEY_VIVID_EFFECT);
        this.mMenuPanelList.add(CameraUIInterface.KEY_HIGH_RESOLUTION);
        this.mMenuPanelList.add(CameraUIInterface.KEY_PORTRAIT_NEW_STYLE_MENU);
        this.mMenuPanelList.add(CameraUIInterface.KEY_PARAMETER_SAVING);
        this.mMenuPanelList.add(CameraUIInterface.KEY_SWITCH_CAMERA);
        this.mMenuPanelList.add(CameraUIInterface.KEY_PRO_HISTOGRAM);
        this.mMenuPanelList.add(CameraUIInterface.KEY_RAW_CONTROL);
        this.mMenuPanelList.add(CameraUIInterface.KEY_SUPER_RAW_CONTROL);
        this.mMenuPanelList.add(CameraUIInterface.KEY_SLOW_VIDEO_FRAME_SEEK_BAR_MENU);
        this.mMenuPanelList.add(CameraUIInterface.KEY_INTELLIGENT_HIGH_FRAME_SELECTED);
        this.mMenuPanelList.add(CameraUIInterface.KEY_MULTI_CAMERA_TYPE_MENU);
        this.mMenuPanelList.add(CameraUIInterface.KEY_FOCUS_PEAKING);
        if (!CameraConfig.getConfigBooleanValue(KEY_SUPPORT_HIGH_DEFINITION)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_PHOTO_HIGH_RESOLUTION);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_HIGH_PIXEL_SUPPORT)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_AI_HIGH_PIXEL);
        }
        this.mMenuPanelList.add(CameraUIInterface.KEY_CAMERA_TIMER_SHUTTER);
        this.mMenuPanelList.add(CameraUIInterface.KEY_NIGHT_STARBURST_MODE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_PHOTO_RATIO);
        this.mMenuPanelList.add(CameraUIInterface.KEY_VIDEO_SIZE);
        this.mMenuPanelList.add(CameraUIInterface.KEY_VIDEO_FPS);
        this.mMenuPanelList.add(CameraUIInterface.KEY_PLATFORM_SLOW_VIDEO_FPS);
        if (CameraConfig.getConfigBooleanValue(KEY_SUPPORT_SLOWVIDEO_1080P)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_SLOW_VIDEO_SIZE);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_SUPPORT_FAST_VIDEO_RESOLUTION_SWITCH)) {
            this.mMenuPanelList.add(CameraUIInterface.KEY_FAST_VIDEO_SIZE);
        }
        this.mMenuPanelList.add(CameraUIInterface.KEY_SETTING);
        this.mMenuPanelList.add(CameraUIInterface.KEY_SUB_SETTING);
        this.mMenuPanelList.add(CameraUIInterface.KEY_SUB_HOLD_SETTING);
        ComboPreferences.m11063a(this.mMenuPanelList);
    }
    ...
    public void parseMenuSetting() {
        ...
        if (Util.m24459h("oplus.software.fingerprint.shutter")) {
            this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_FINGERPRINT_SHUTTER);
        }
        this.mMenuSettingList.add(CameraUIInterface.KEY_VOLUME_KEY_FUNCTION);
        this.mMenuSettingList.add(CameraUIInterface.KEY_ASSIST_GRADIENTER);
        this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_SOUND);
        this.mMenuSettingList.add(CameraUIInterface.KEY_RECORD_LOCATION);
        this.mMenuSettingList.add(CameraUIInterface.KEY_STORAGE_PLACE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_MIRROR);
        this.mMenuSettingList.add(CameraUIInterface.KEY_MIRROR_SETTING);
        this.mMenuSettingList.add(CameraUIInterface.KEY_LENS_DIRTY_DETECTION);
        this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_QUCIK_LAUNCH);
        this.mMenuSettingList.add(CameraUIInterface.KEY_SHARE_AND_MARK);
        this.mMenuSettingList.add(CameraUIInterface.KEY_10_BITS_HEIC_ENCODE);
        if (!CameraConfig.getConfigBooleanValue(KEY_PI_AI)) {
            this.mMenuSettingList.add(CameraUIInterface.KEY_AI_SCN);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_SUPER_CLEAR_PORTRAIT)) {
            this.mMenuSettingList.add(CameraUIInterface.KEY_SUPER_CLEAR_PORTRAIT);
        }
        this.mMenuSettingList.add(CameraUIInterface.KEY_FACE_RECTIFY);
        this.mMenuSettingList.add(CameraUIInterface.KEY_PHOTO_RATIO);
        this.mMenuSettingList.add(CameraUIInterface.KEY_COUNTDOWN_EFFECT_SHUTTER);
        this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_TAP_SHUTTER);
        this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_GESTURE_SHUTTER);
        if (MyRegionAdapter.m14513c() && this.mMenuSettingList.contains(CameraUIInterface.KEY_CAMERA_SOUND)) {
            this.mMenuSettingList.remove(CameraUIInterface.KEY_CAMERA_SOUND);
        }
        this.mMenuSettingList.add(CameraUIInterface.KEY_SLOGAN_CUSTOMIZE);
        this.mMenuSettingList.add(CameraUIInterface.PRE_KEY_WATERMARK_VISUAL_FUNCTION);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_CODEC);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_SOUND_MODE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_RATIO_FPS);
        this.mMenuSettingList.add(CameraUIInterface.KEY_TRACK_FOCUS);
        this.mMenuSettingList.add(CameraUIInterface.KEY_SLOW_VIDEO_SIZE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_FAST_VIDEO_SIZE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_SOUND_REAR);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_SOUND_FRONT);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_SELL_EIS);
        this.mMenuSettingList.add(CameraUIInterface.KEY_HELP_AND_FEEDBACK);
        this.mMenuSettingList.add(CameraUIInterface.KEY_ADVANCE_SETTING_IMAGE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_BUILD_IMAGE_SETTING);
        this.mMenuSettingList.add(CameraUIInterface.KEY_WATERMARK_SETTING_IMAGE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_CODEC);
        this.mMenuSettingList.add(CameraUIInterface.KEY_SHUTTER_HELP);
        this.mMenuSettingList.add(CameraUIInterface.KEY_VIDEO_SOUND_EFFECT_KEY);
        if (CameraConfig.getConfigBooleanValue(KEY_SUPPORT_QR_CODE_ENABLE) && MyRegionAdapter.m14514d()) {
            this.mMenuSettingList.add(CameraUIInterface.KEY_QR_CODE);
        }
        if (CameraConfig.getConfigBooleanValue(KEY_QUICK_VIDEO_SUPPORT)) {
            this.mMenuSettingList.add(CameraUIInterface.KEY_LONG_PROCESS_SHUTTER_CHOICE);
        }
        this.mMenuSettingList.add(CameraUIInterface.KEY_REFERENCE_LINE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_HEIF_FORMAT);
        this.mMenuSettingList.add(CameraUIInterface.KEY_CAMERA_HDR_MODE);
        this.mMenuSettingList.add(CameraUIInterface.KEY_HEVC_VIDEO_FORMAT);
        this.mMenuSettingList.add(CameraUIInterface.KEY_SETTING_ABOUT);
        this.mMenuSettingList.add(CameraUIInterface.KEY_BOTTOM_BLANK);
    }
    ...
    public void parseDefaultProjectConfig() {
        if (this.mAppSetting == null) {
            this.mAppSetting = new HashMap<>();
        }
        this.mAppSetting.clear();
        if (Util.m24495t()) {
            this.mAppSetting.put(KEY_FOLDER_FULL_SCREEN_SIZE, "1920,1792");
        }
        this.mAppSetting.put(KEY_SUPPORT_BREENO_SCAN, RegionCommonFeatureAdapter.m14537f() ? "1" : "0");
    }

    public void parseProjectConfigFromConfigFile(Context context) {
        CameraLog.m12952a("initCameraUnitConfigData");
        CameraUnitUtils.initConfigData(context);
        CameraLog.m12958b("initCameraUnitConfigData");
    }
    ...
    public void parseDefaultMenuSettingConfigMap() {
        ...
        this.mDefaultMenuSettingConfigMap.put("pref_camera_hdr_mode_key_default_back_camera", "auto");
        this.mDefaultMenuSettingConfigMap.put("pref_camera_hdr_mode_key_default_front_camera", "auto");
        this.mDefaultMenuSettingConfigMap.put("pref_video_size_key_default_back_camera", "video_size_1080p");
        this.mDefaultMenuSettingConfigMap.put("pref_video_size_key_default_front_camera", CameraConfig.getConfigStringArrayValue(KEY_VIDEO_FACE_BEAUTY_SUPPORT_SIZE) != null ? CameraConfig.getConfigStringArrayValue(KEY_VIDEO_FACE_BEAUTY_SUPPORT_SIZE)[0] : "video_size_1080p");
    ...
    private void addVideoBackOptionItem() {
        OptionItemConfig c3241c = new OptionItemConfig();
        c3241c.m20469a("pref_video_size_key_back_camera_supported");
        c3241c.m20471b("video_size_720p");
        c3241c.m20471b("video_size_1080p");
        if (CameraConfig.getConfigBooleanValue(KEY_VIDEO_SIZE_4K)) {
            c3241c.m20471b("video_size_4kuhd");
        }
        if (CameraConfig.getConfigBooleanValue(KEY_VIDEO_SIZE_8K)) {
            c3241c.m20471b("video_size_8k");
        }
        this.mOptionItemConfigList.add(c3241c);
    }

    private void addVideoFrontOptionItem() {
        OptionItemConfig c3241c = new OptionItemConfig();
        c3241c.m20469a("pref_video_size_key_front_camera_supported");
        c3241c.m20471b("video_size_1080p");
        c3241c.m20471b("video_size_720p");
        this.mOptionItemConfigList.add(c3241c);
    }
    ...
    private void addTorchModeOptionItem() {
        OptionItemConfig c3241c = new OptionItemConfig();
        c3241c.m20469a(CameraUIInterface.KEY_TORCH_MODE);
        c3241c.m20471b("off");
        c3241c.m20471b("on");
    ...
    private void addSlowMotionOptionItem() {
        OptionItemConfig c3241c = new OptionItemConfig();
        c3241c.m20469a("pref_platform_slow_video_fps_key_back_camera_supported");
        if (CameraConfig.isApsSupportVendorTag(KEY_SLOW_VIDEO_HFR_120FPS_VIDOETYPE)) {
            c3241c.m20471b(String.valueOf(120));
        }
        if (CameraConfig.isApsSupportVendorTag(KEY_SLOW_VIDEO_HFR_240FPS_VIDOETYPE)) {
            c3241c.m20471b(String.valueOf(240));
        }
        if (CameraConfig.isApsSupportVendorTag(KEY_SLOW_VIDEO_HFR_480FPS_VIDOETYPE)) {
            c3241c.m20471b(String.valueOf(CameraParameter.VideoFps.FPS_480));
        }
        if (CameraConfig.isApsSupportVendorTag(KEY_SLOW_VIDEO_HFR_960FPS_VIDOETYPE)) {
            c3241c.m20471b(String.valueOf(CameraParameter.VideoFps.FPS_960));
        }
        this.mOptionItemConfigList.add(c3241c);
    }

    public List<OptionItemConfig> getOptionItemConfigs() {
