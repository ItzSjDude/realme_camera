...
public class MenuClickMsgData extends DcsMsgData {
    public static final String EVENT_FUNCTION_ITEM_CLICK = "funcValue_select";
    ...
    public static final int FUNC_KEY_AI_HIGH_PIXEL = 86;
    public static final int FUNC_KEY_ANC_FILTER = 64;
    public static final int FUNC_KEY_BEAUTY = 2;
    public static final int FUNC_KEY_BLUR = 9;
    public static final int FUNC_KEY_DELETE = 83;
    ...
    public static final int FUNC_KEY_FULL_SPLIT_SWITCH = 88;
    ...
    public static final int FUNC_KEY_LONG_EXPOSURE_BUSY_TRAFFIC = 73;
    public static final int FUNC_KEY_LONG_EXPOSURE_FLOWING_CLOUDS_AND_WATER = 74;
    public static final int FUNC_KEY_LONG_EXPOSURE_GUIDE = 76;
    public static final int FUNC_KEY_LONG_EXPOSURE_LIGHT_PAINTING = 75;
    public static final int FUNC_KEY_LONG_EXPOSURE_MOVING_CROWD = 87;
    public static final int FUNC_KEY_LONG_EXPOSURE_STREAMER_PORTRAIT = 72;
    public static final int FUNC_KEY_MACRO = 70;
    ...
    public static final int FUNC_KEY_OUT_SCREEN_SWITCH = 71;
    public static final int FUNC_KEY_PANORAMA_DIRECTION = 19;
    public static final int FUNC_KEY_PAUSE_PLAY = 82;
    ...
    public static final int FUNC_KEY_PROFESSION_FOCUS_PEAKING = 79;
    public static final int FUNC_KEY_PROFESSION_HISTOGRAM = 78;
    public static final int FUNC_KEY_PROFESSION_ISO = 28;
    public static final int FUNC_KEY_PROFESSION_PARAMETER_DEFAULT = 77;
    public static final int FUNC_KEY_PROFESSION_PHOTO_FORMAT = 80;
    public static final int FUNC_KEY_PROFESSION_RESET = 81;
    ...
    public static final int FUNC_KEY_SLOW_VIDEO_RSL = 65;
    ...
    public static final int FUNC_KEY_TIMELAPSE_SPEED = 56;
    ...
    public static final int FUNC_KEY_VIDEO_FILTER = 4;
    public static final int FUNC_KEY_VIDEO_FPS = 61;
    public static final int FUNC_KEY_VIDEO_RSL = 60;
    public static final int FUNC_KEY_VIDEO_SUPER_EIS = 25;
    public static final int FUNC_KEY_VIDEO_ULTRA_NIGHT = 50;
    private static final String KEY_10BITS_HEIC_ENCODE = "10bit_image";
    ...
    private static final String KEY_FUNC_SLOGAN_AUTHOR = "slogan_author";
    private static final String KEY_FUNC_SLOGAN_CONTENT = "slogan_content";
    private static final String KEY_FUNC_SLOGAN_INFO = "slogan_info";
    ...
    private static final String KEY_IS_HEIF_CODEC_TYPE = "is_heif_codec_type";
    private static final String KEY_IS_HEVC_VIDEO_TYPE = "is_hevc_video_type";
    ...
    private static final String KEY_IS_TRACK_FOCUS_TYPE = "is_track_focus_type";
    private static final String KEY_LENS_DIRTY_DETECTION = "lens_dirty_detection";
    public static final String KEY_MAKEUP = "makeup";
    public static final String KEY_MAKEUP_CLEAR = "makeup_clear";
    public static final int KEY_MAKEUP_NONE = 0;
    ...
    private static final String KEY_QUICK_VIDEO = "quick_take";
    ...
    public static final String KEY_RESULT_DELETE = "delete";
    public static final int KEY_RESULT_FULL_TO_SPLIT = 1;
    public static final int KEY_RESULT_HIDE = 2;
    public static final int KEY_RESULT_PAUSE = 1;
    public static final int KEY_RESULT_PLAY = 2;
    public static final int KEY_RESULT_SHOW = 1;
    public static final int KEY_RESULT_SPLIT_TO_FULL = 2;
    ...
    public static final String KEY_SMOOTH = "self_smooth";
    public static final int KEY_SMOOTH_NONE = 0;
    ...
    public static final String MODE_FUNCKEY_ITEM_CANCEL = "cancel";
    public static final String MODE_FUNCKEY_ITEM_EDIT_KEY = "edit_key";
    public static final String MODE_FUNCKEY_ITEM_HOLD_EDIT = "hold_edit";
    public static final String MODE_FUNCKEY_ITEM_SAVE = "save";
    ...
    public static final String VALUE_GESTURE_CANCEL_BACK = "4";
    public static final String VALUE_GESTURE_CANCEL_BAT = "1";
    public static final String VALUE_GESTURE_CANCEL_OUT = "2";
    public static final String VALUE_GESTURE_CANCEL_PULL = "3";
    public static final String VALUE_GESTURE_SAVE = "0";
    public static final String VALUE_GESTURE_SAVE_AUTO = "5";
    public static final String VALUE_INNER_FRONT_TO_OUT_REAR = "2";
    public static final String VALUE_INNER_REAR_TO_OUT_PREVIEW = "0";
    public static final String VALUE_OUT_FRONT_TO_OUT_REAR = "3";
    public static final String VALUE_OUT_PREVIEW_TO_OUT_REAR = "1";
    ...
    public int mFuncKeyId;
    public int mFuncKeyResult;
    public String mGuesture;
    public String mItem;
    ...
    private static final String[] FUNC_KEY_PHOTO_RATIO_VALUE = {"standard", "square", DcsMsgData.FULL, "16_9", "standard_high"};
    private static final String[] FUNC_KEY_TIMER_VALUE = {"normal", "3", FocusAimMsgData.KEY_INTELLIGENCE_VIEW_FOCUS_TYPE};

    public MenuClickMsgData(Context context) {
        super(context, DcsMsgData.LOGTAG_CAPTURE, "");
        this.mFuncKeyId = -1;
        this.mFuncKeyResult = -1;
        this.mItem = "";
        this.mItemValue = "";
    ...
    */
    public void report() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oplus.camera.statistics.model.MenuClickMsgData.report():void");
    }

    public void buildMenuClick(ComboPreferences comboPreferences, String str, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        if (TextUtils.isEmpty(str) || z) {
            return;
        }
        this.mEventId = "funcKey_click";
        this.mFuncKeyResult = z2 ? 2 : 1;
        String string = comboPreferences.getString(str, "off");
        String strM13305d = CameraEntry.m13305d(str);
        if (CameraUIInterface.KEY_FLASH_MODE.equals(strM13305d) || CameraUIInterface.KEY_TORCH_MODE.equals(strM13305d) || CameraUIInterface.KEY_VIDEO_FLASH_MODE.equals(strM13305d)) {
            this.mFuncKeyId = 3;
            this.mFuncKeyResult = z3 ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_CAMERA_HDR_MODE.equals(strM13305d)) {
            this.mFuncKeyId = 8;
            this.mFuncKeyResult = z3 ? 2 : 1;
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItemValue = comboPreferences.getString(CameraUIInterface.KEY_CAMERA_HDR_MODE, "off");
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_VIDEO_HDR.equals(strM13305d)) {
            ...
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItemValue = comboPreferences.getString(CameraUIInterface.KEY_VIDEO_HDR, "off");
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_PORTRAIT_NEW_STYLE_MENU.equals(strM13305d)) {
            this.mFuncKeyId = 10;
            this.mFuncKeyResult = z3 ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_VIDEO_FILTER_MENU.equals(strM13305d)) {
            this.mFuncKeyId = z5 ? 64 : 4;
            this.mFuncKeyResult = z3 ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_FILTER_MENU.equals(strM13305d)) {
            this.mFuncKeyId = z5 ? 64 : 4;
            this.mFuncKeyResult = z3 ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_NIGHT_FILTER_MENU.equals(strM13305d)) {
            this.mFuncKeyId = 50;
            this.mFuncKeyResult = z3 ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_VIDEO_SIZE.equals(strM13305d)) {
            this.mFuncKeyId = 60;
            return;
        }
        if (CameraUIInterface.KEY_SLOW_VIDEO_SIZE.equals(strM13305d)) {
            this.mFuncKeyId = 65;
            return;
        }
        if (CameraUIInterface.KEY_VIDEO_BLUR_MENU.equals(strM13305d)) {
            this.mFuncKeyId = 23;
            this.mFuncKeyResult = z3 ? 2 : 1;
            return;
        }
        ...
        if (CameraUIInterface.KEY_NIGHT_TRIPOD_MODE.equals(strM13305d)) {
            this.mFuncKeyId = 32;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
            return;
        }
        ...
        if (CameraUIInterface.KEY_VIDEO_HYPER_LAPSE_MENU.equals(strM13305d)) {
            this.mFuncKeyId = 36;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_SUB_SETTING.equals(strM13305d)) {
            this.mFuncKeyId = 26;
            this.mFuncKeyResult = "on".equals(comboPreferences.getString(strM13305d, "off")) ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_PHOTO_HIGH_RESOLUTION.equals(strM13305d)) {
            ...
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItemValue = String.valueOf(comboPreferences.getBoolean(CameraUIInterface.KEY_HIGH_PICTURE_SIZE, false) ? 1 : 2);
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_PHOTO_RATIO.equals(strM13305d)) {
            ...
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItemValue = comboPreferences.getString(CameraUIInterface.KEY_PHOTO_RATIO, null);
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_CAMERA_TIMER_SHUTTER.equals(strM13305d)) {
            ...
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItemValue = comboPreferences.getString(CameraUIInterface.KEY_CAMERA_TIMER_SHUTTER, "normal");
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_RAW_CONTROL.equals(strM13305d) || CameraUIInterface.KEY_SUPER_RAW_CONTROL.equals(strM13305d)) {
            this.mFuncKeyId = 80;
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItemValue = ProfessionalMsgData.buildPhotoFormat(comboPreferences.getString(strM13305d, "off"));
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_SLOW_VIDEO_FRAME_SEEK_BAR_MENU.equals(strM13305d)) {
            this.mFuncKeyId = 51;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_INTELLIGENT_HIGH_FRAME_SELECTED.equals(strM13305d)) {
            this.mFuncKeyId = 35;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
            return;
        }
        ...
        if (CameraUIInterface.KEY_MULTI_CAMERA_TYPE_MENU.equals(strM13305d)) {
            this.mFuncKeyId = 54;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
            return;
        }
        ...
        if (CameraUIInterface.KEY_TIME_LAPSE_RATE.equals(strM13305d)) {
            this.mFuncKeyId = 56;
            return;
        }
        if (CameraUIInterface.KEY_PLATFORM_SLOW_VIDEO_FPS.equals(strM13305d)) {
            this.mFuncKeyId = 51;
            return;
        }
        if (CameraUIInterface.KEY_MACRO_SWITCH.equals(strM13305d)) {
            this.mFuncKeyId = 70;
            this.mFuncKeyResult = "auto".equals(comboPreferences.getString(strM13305d, "auto")) ? 2 : 1;
            return;
        }
        if (CameraUIInterface.KEY_PARAMETER_SAVING.equals(strM13305d)) {
            this.mFuncKeyId = 77;
            if (z4) {
                this.mEventId = "funcValue_select";
                this.mItem = ProfessionalMsgData.buildParameterSaving(comboPreferences.getString(CameraUIInterface.KEY_PARAMETER_SAVING, "off"));
                this.mItemValue = ProfessionalMsgData.VALUE_PROFESSION_USE;
                return;
            }
            return;
        }
        if (CameraUIInterface.KEY_PRO_HISTOGRAM.equals(strM13305d)) {
            this.mFuncKeyId = 78;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
        } else if (CameraUIInterface.KEY_FOCUS_PEAKING.equals(strM13305d)) {
            this.mFuncKeyId = 79;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
        } else if (CameraUIInterface.KEY_AI_HIGH_PIXEL.equals(strM13305d)) {
            this.mFuncKeyId = 86;
            this.mFuncKeyResult = "on".equals(string) ? 2 : 1;
        }
    }
    ...
    private String getNextValueOfArray(String[] strArr, String str) {
        ...
        for (int OplusGLSurfaceView_13 = 0; OplusGLSurfaceView_13 < strArr.length; OplusGLSurfaceView_13++) {
            ...
            if (str.equals(strArr[OplusGLSurfaceView_13]) && OplusGLSurfaceView_13 < strArr.length - 1) {
                return strArr[OplusGLSurfaceView_13 + 1];
            }
        }
        return "";
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void buildMenuItem(java.lang.String r18, com.oplus.camera.ComboPreferences r19, int r20) {
        /*
            Method dump skipped, instructions count: 648
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oplus.camera.statistics.model.MenuClickMsgData.buildMenuItem(java.lang.String, com.oplus.camera.ComboPreferences, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void buildSettingJumpItem(java.lang.String r4) {
        /*
            r3 = this;
        ...
        L7:
            r0 = 5
            r3.mFuncKeyId = r0
            java.lang.String r1 = "funcMenu_select"
            r3.mEventId = r1
            java.lang.String r4 = com.oplus.camera.entry.CameraEntry.m13305d(r4)
            r1 = -1
            int r2 = r4.hashCode()
            switch(r2) {
                case -1760868457: goto L6b;
                case -1348209696: goto L61;
                case -1211960062: goto L58;
                case -731027105: goto L4e;
                case -299354421: goto L44;
                case 193590031: goto L3a;
                case 249158521: goto L30;
                case 257795138: goto L25;
                case 963801656: goto L1b;
                default: goto L1a;
            }
        L1a:
            goto L75
        L1b:
            java.lang.String r0 = "pref_watermark_size_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 6
            goto L76
        L25:
            java.lang.String r0 = "pref_watermark_display_info_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 8
            goto L76
        L30:
            java.lang.String r0 = "pref_watermark_setting_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 2
            goto L76
        L3a:
            java.lang.String r0 = "pref_shutter_help_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 0
            goto L76
        L44:
            java.lang.String r0 = "pref_camera_code_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 3
            goto L76
        L4e:
            java.lang.String r0 = "pref_build_image_setting_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 4
            goto L76
        L58:
            java.lang.String r2 = "pref_watermark_author_key"
            boolean r4 = r4.equals(r2)
            if (r4 == 0) goto L75
            goto L76
        L61:
            java.lang.String r0 = "pref_watermark_position_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 7
            goto L76
        L6b:
            java.lang.String r0 = "pref_advance_setting_key"
            boolean r4 = r4.equals(r0)
            if (r4 == 0) goto L75
            r0 = 1
            goto L76
        ...
        L79:
            ...
            goto Laa
        L7e:
            java.lang.String r4 = "slogan_info"
            r3.mItem = r4
            goto Laa
        L83:
            java.lang.String r4 = "slogan_locate"
            r3.mItem = r4
            goto Laa
        L88:
            java.lang.String r4 = "slogan_size"
            r3.mItem = r4
            goto Laa
        L8d:
            java.lang.String r4 = "slogan_author"
            r3.mItem = r4
            goto Laa
        L92:
            ...
            goto Laa
        L97:
            java.lang.String r4 = "shoot_format"
            r3.mItem = r4
            goto Laa
        L9c:
            java.lang.String r4 = "is_slogan"
            r3.mItem = r4
            goto Laa
        La1:
            java.lang.String r4 = "high_grade"
            r3.mItem = r4
            goto Laa
        La6:
            java.lang.String r4 = "shutter_assist"
            r3.mItem = r4
        Laa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oplus.camera.statistics.model.MenuClickMsgData.buildSettingJumpItem(java.lang.String):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void buildSettingMenuItem(java.lang.String r4, java.lang.Object r5) {
        /*
            Method dump skipped, instructions count: 1054
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oplus.camera.statistics.model.MenuClickMsgData.buildSettingMenuItem(java.lang.String, java.lang.Object):void");
    }

    public void buildTopMenuEvent(String str, String str2, int OplusGLSurfaceView_13) {
        if (TextUtils.isEmpty(str)) {
            return;
        }
        char c2 = 65535;
        int iHashCode = str.hashCode();
        if (iHashCode != -1462460857) {
            if (iHashCode != -622376663) {
                if (iHashCode == 1650892289 && str.equals(CameraUIInterface.KEY_VIDEO_SIZE)) {
                    c2 = 0;
                }
            } else if (str.equals(CameraUIInterface.KEY_VIDEO_FPS)) {
                c2 = 1;
            }
        } else if (str.equals(CameraUIInterface.KEY_SLOW_VIDEO_SIZE)) {
            c2 = 2;
        }
        if (c2 == 0) {
            this.mFuncKeyId = 60;
        ...
        if (TextUtils.isEmpty(str2) && OplusGLSurfaceView_13 > 0) {
            this.mEventId = "funcKey_click";
            this.mFuncKeyResult = OplusGLSurfaceView_13;
        } else {
            this.mEventId = "funcValue_select";
            this.mItem = "";
    ...
    public void buildMenuSelect() {
        this.mEventId = "funcMenu_select";
    }

    @Override // com.oplus.camera.statistics.model.DcsMsgData
    public boolean isValid() {
        if (this.mFuncKeyId <= 0) {
            CameraLog.m12959b(TAG, "isValid, " + toString());
            return false;
        }
