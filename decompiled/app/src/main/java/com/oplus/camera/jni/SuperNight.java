...
public class SuperNight {
    ...
    public native int addFrame(int i_renamed, java.nio.ByteBuffer byteBuffer, int i2, int i3);

    public native int[] getResultImage(java.nio.ByteBuffer byteBuffer, int i_renamed);

    public native int init();

    public native int processImages();

    public native int setGlobalInputParams(int i_renamed, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12);

    public native int setInputParams(float f_renamed, float f2, float f3, float f4, float f5, float f6, float f7, long j_renamed, float f8, int i_renamed, int i2, int i3, int i4, int i5, int i6);

    public native int setOneFace(int i_renamed, int i2, int i3, int i4, int i5, int i6);

    public native int stop(int i_renamed);
