...
public class ReminderMsgData extends DcsMsgData {
    public static final String CODE_10BITS_UNSUPPORT_CONTINUOUS = "10bit_unsupport_continuous";
    public static final String CODE_BATTERY_FLASH = "battery_flash";
    public static final String CODE_BATTERY_VIDEO = "battery_video";
    public static final String CODE_CAMERA_HIGH_TEMPERATURE_OUT_PREVIEW_DISABLE = "camera_high_temperature_out_preview_disable";
    ...
    public static final String CODE_IMMOVABLE_MODE = "immovable_mode";
    ...
    public static final String CODE_TEMP_STOP_ALL_VIDEO = "temp_stop_all_video";
    public static final String CODE_TEMP_STOP_HIGH_CONSUMPTION_VIDEO = "temp_stop_high_consumption_video";
    public static final String CODE_TIME_SHORT = "time_short";
    public static final String CODE_TRY_WIDE_ANGLE = "try_wide_angle";
    ...
    public static final String EVENT_AI_SCENE_CLICK = "ai_effect_click";
    public static final String EVENT_ID = "reminder";
    ...
    private static final String KEY_SUPER_TEXT_SWITCH = "superText_switch";
    private static final String KEY_ULTRA_WIDE_SWITCH = "ultraWide_switch";
    ...
    public String mReminderAISuperTextSwitch;
    public String mReminderAIUltraWideSwitch;
    ...
    public ReminderMsgData(Context context, boolean z) {
        super(context, z ? DcsMsgData.LOGTAG_CAPTURE : DcsMsgData.LOGTAG_VIDEO, EVENT_ID);
