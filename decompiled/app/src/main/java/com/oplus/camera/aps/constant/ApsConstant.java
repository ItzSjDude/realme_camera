...
public final class ApsConstant {
    ...
    public static final String CAPTURE_MODE_BREENO_SCAN = "breenoScan";
    ...
    public static final String CAPTURE_MODE_HIGH_PIXEL = "highPixel";
    ...
    public static final String CAPTURE_MODE_MORE = "more";
    ...
    public static final String CAPTURE_MODE_TILT_SHIFT = "tiltShift";
    ...
    public static final String REC_MODE_QUICK_VIDEO = "quickVideo";
    ...
    public static final String REC_MODE_TILT_SHIFT_FAST_VIDEO = "tiltShiftFastVideo";
