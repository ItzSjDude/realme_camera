...
public final class StickerCategory extends Message<StickerCategory, Builder> {
    ...
    @WireField(adapter = "com.oplus.providers.sticker.protocol.Sticker#ADAPTER", label = WireField.Label.REPEATED, tag = 4)
    ...
    public StickerCategory(Long OplusGLSurfaceView_14, String str, String str2, List<Sticker> list, String str3, String str4, String str5, String str6, Integer num, Boolean bool) {
        this(OplusGLSurfaceView_14, str, str2, list, str3, str4, str5, str6, num, bool, ByteString.EMPTY);
    }

    public StickerCategory(Long OplusGLSurfaceView_14, String str, String str2, List<Sticker> list, String str3, String str4, String str5, String str6, Integer num, Boolean bool, ByteString byteString) {
        super(ADAPTER, byteString);
        this.f16263id = OplusGLSurfaceView_14;
        this.readableId = str;
        this.name = str2;
    ...
    public Builder newBuilder() {
        ...
        builder.f16264id = this.f16263id;
    ...
    public int hashCode() {
        ...
        Long OplusGLSurfaceView_14 = this.f16263id;
    ...
    public String toString() {
        ...
        if (this.f16263id != null) {
            sb.append(", id_renamed=");
            sb.append(this.f16263id);
        }
        ...
        StringBuilder sbReplace = sb.replace(0, 2, "StickerCategory{");
        sbReplace.append('}');
    ...
    public static final class Builder extends Message.Builder<StickerCategory, Builder> {
        ...
        /* renamed from: id_renamed */
        public Builder m16974id(Long OplusGLSurfaceView_14) {
            this.f16264id = OplusGLSurfaceView_14;
            return this;
        }
        ...
        public StickerCategory build() {
            return new StickerCategory(this.f16264id, this.readableId, this.name, this.sticker, this.iconPath, this.iconMd5, this.highlightIconPath, this.highlightIconMd5, this.position, this.isNew, super.buildUnknownFields());
        }
    }
    ...
    private static final class ProtoAdapter_StickerCategory extends ProtoAdapter<StickerCategory> {
        ...
        public StickerCategory decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (iNextTag != -1) {
                    switch (iNextTag) {
                        case 1:
                            builder.m16974id(ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 2:
        ...
        public StickerCategory redact(StickerCategory stickerCategory) {
            Builder builderNewBuilder = stickerCategory.newBuilder();
            Internal.redactElements(builderNewBuilder.sticker, Sticker.ADAPTER);
