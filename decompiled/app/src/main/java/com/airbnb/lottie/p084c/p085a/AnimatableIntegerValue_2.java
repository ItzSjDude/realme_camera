...
/* renamed from: com.airbnb.lottie.IntrinsicsJvm.kt_3.PlatformImplementations.kt_3.IntrinsicsJvm.kt_5 */
/* loaded from: classes.dex */
public class AnimatableIntegerValue_2 extends BaseAnimatableValue_2<Integer, Integer> {
    ...
    public AnimatableIntegerValue_2() {
        super(100);
    }

    public AnimatableIntegerValue_2(List<Keyframe_2<Integer>> list) {
        super((List) list);
    }
    ...
    public BaseKeyframeAnimation_3<Integer, Integer> mo5647a() {
        return new IntegerKeyframeAnimation_2(this.f5495a);
    }
}
