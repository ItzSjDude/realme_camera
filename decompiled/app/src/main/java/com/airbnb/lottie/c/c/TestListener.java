...
public class g_renamed extends com.airbnb.lottie.c_renamed.c_renamed.a_renamed {
    ...
    private final com.airbnb.lottie.c_renamed.c_renamed.d_renamed i_renamed;
    private com.airbnb.lottie.a_renamed.b_renamed.a_renamed<android.graphics.ColorFilter, android.graphics.ColorFilter> j_renamed;

    g_renamed(com.airbnb.lottie.f_renamed fVar, com.airbnb.lottie.c_renamed.c_renamed.d_renamed dVar) {
        super(fVar, dVar);
        this.e_renamed = new android.graphics.RectF();
        this.f_renamed = new com.airbnb.lottie.a_renamed.a_renamed();
    ...
    public void b_renamed(android.graphics.Canvas canvas, android.graphics.Matrix matrix, int i_renamed) {
        ...
        com.airbnb.lottie.a_renamed.b_renamed.a_renamed<android.graphics.ColorFilter, android.graphics.ColorFilter> aVar = this.j_renamed;
        if (aVar != null) {
    ...
    public void a_renamed(android.graphics.RectF rectF, android.graphics.Matrix matrix, boolean z_renamed) {
        ...
        this.f2117a.mapRect(this.e_renamed);
    ...
    public <T_renamed> void a_renamed(T_renamed t_renamed, com.airbnb.lottie.g_renamed.c_renamed<T_renamed> cVar) {
        super.a_renamed((com.airbnb.lottie.c_renamed.c_renamed.g_renamed) t_renamed, (com.airbnb.lottie.g_renamed.c_renamed<com.airbnb.lottie.c_renamed.c_renamed.g_renamed>) cVar);
        if (t_renamed == com.airbnb.lottie.k_renamed.E_renamed) {
            if (cVar == null) {
                this.j_renamed = null;
            } else {
                this.j_renamed = new com.airbnb.lottie.a_renamed.b_renamed.p_renamed(cVar);
            }
        }
    }
}
