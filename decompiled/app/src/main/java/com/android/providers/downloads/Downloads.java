...
public final class Downloads {
    ...
    public static final class Impl implements android.provider.BaseColumns {
        ...
        public static boolean isNotificationToBeDisplayed(int i_renamed) {
            return i_renamed == 1 || i_renamed == 3;
        }

        public static boolean isStatusClientError(int i_renamed) {
            return i_renamed >= 400 && i_renamed < 500;
        }

        public static boolean isStatusCompleted(int i_renamed) {
            return (i_renamed >= 200 && i_renamed < 300) || (i_renamed >= 400 && i_renamed < 600);
        }

        public static boolean isStatusError(int i_renamed) {
            return i_renamed >= 400 && i_renamed < 600;
        }

        public static boolean isStatusInformational(int i_renamed) {
            return i_renamed >= 100 && i_renamed < 200;
        }

        public static boolean isStatusServerError(int i_renamed) {
            return i_renamed >= 500 && i_renamed < 600;
        }

        public static boolean isStatusSuccess(int i_renamed) {
        ...
        public static java.lang.String statusToString(int i_renamed) {
            if (i_renamed == 190) {
                return "PENDING";
            }
            if (i_renamed == 400) {
    ...
    public static final void removeAllDownloadsByPackage(android.content.Context context, java.lang.String str, java.lang.String str2) {
        context.getContentResolver().delete(com.android.providers.downloads.Downloads.Impl.CONTENT_URI, QUERY_WHERE_CLAUSE, new java.lang.String[]{str, str2});
    }
}
