...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
        ...
        public static boolean isNotificationToBeDisplayed(int OplusGLSurfaceView_13) {
            return OplusGLSurfaceView_13 == 1 || OplusGLSurfaceView_13 == 3;
        }

        public static boolean isStatusClientError(int OplusGLSurfaceView_13) {
            return OplusGLSurfaceView_13 >= 400 && OplusGLSurfaceView_13 < 500;
        }

        public static boolean isStatusCompleted(int OplusGLSurfaceView_13) {
            return (OplusGLSurfaceView_13 >= 200 && OplusGLSurfaceView_13 < 300) || (OplusGLSurfaceView_13 >= 400 && OplusGLSurfaceView_13 < 600);
        }

        public static boolean isStatusError(int OplusGLSurfaceView_13) {
            return OplusGLSurfaceView_13 >= 400 && OplusGLSurfaceView_13 < 600;
        }

        public static boolean isStatusInformational(int OplusGLSurfaceView_13) {
            return OplusGLSurfaceView_13 >= 100 && OplusGLSurfaceView_13 < 200;
        }

        public static boolean isStatusServerError(int OplusGLSurfaceView_13) {
            return OplusGLSurfaceView_13 >= 500 && OplusGLSurfaceView_13 < 600;
        }

        public static boolean isStatusSuccess(int OplusGLSurfaceView_13) {
        ...
        public static String statusToString(int OplusGLSurfaceView_13) {
            if (OplusGLSurfaceView_13 == 190) {
                return "PENDING";
            }
            if (OplusGLSurfaceView_13 == 400) {
                return "BAD_REQUEST";
            }
            if (OplusGLSurfaceView_13 == 406) {
                return "NOT_ACCEPTABLE";
            }
            if (OplusGLSurfaceView_13 == 411) {
                return "LENGTH_REQUIRED";
            }
            if (OplusGLSurfaceView_13 == 412) {
